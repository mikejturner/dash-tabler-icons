...
export dti_icondialpadoff

"""
    dti_icondialpadoff(;kwargs...)

An IconDialpadOff component.
...
"""
function dti_icondialpadoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondialpadoff", "IconDialpadOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
