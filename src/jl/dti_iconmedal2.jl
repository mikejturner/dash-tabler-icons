...
export dti_iconmedal2

"""
    dti_iconmedal2(;kwargs...)

An IconMedal2 component.
...
"""
function dti_iconmedal2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmedal2", "IconMedal2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
