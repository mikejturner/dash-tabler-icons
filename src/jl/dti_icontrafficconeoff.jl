...
export dti_icontrafficconeoff

"""
    dti_icontrafficconeoff(;kwargs...)

An IconTrafficConeOff component.
...
"""
function dti_icontrafficconeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrafficconeoff", "IconTrafficConeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
