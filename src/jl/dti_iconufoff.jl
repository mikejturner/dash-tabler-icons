...
export dti_iconufoff

"""
    dti_iconufoff(;kwargs...)

An IconUfOff component.
...
"""
function dti_iconufoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconufoff", "IconUfOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
