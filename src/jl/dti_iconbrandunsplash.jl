...
export dti_iconbrandunsplash

"""
    dti_iconbrandunsplash(;kwargs...)

An IconBrandUnsplash component.
...
"""
function dti_iconbrandunsplash(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandunsplash", "IconBrandUnsplash", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
