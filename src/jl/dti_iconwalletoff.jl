...
export dti_iconwalletoff

"""
    dti_iconwalletoff(;kwargs...)

An IconWalletOff component.
...
"""
function dti_iconwalletoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwalletoff", "IconWalletOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
