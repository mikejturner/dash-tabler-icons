...
export dti_iconbordervertical

"""
    dti_iconbordervertical(;kwargs...)

An IconBorderVertical component.
...
"""
function dti_iconbordervertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbordervertical", "IconBorderVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
