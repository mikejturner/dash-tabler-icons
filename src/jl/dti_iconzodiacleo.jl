...
export dti_iconzodiacleo

"""
    dti_iconzodiacleo(;kwargs...)

An IconZodiacLeo component.
...
"""
function dti_iconzodiacleo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacleo", "IconZodiacLeo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
