...
export dti_iconhourglasshigh

"""
    dti_iconhourglasshigh(;kwargs...)

An IconHourglassHigh component.
...
"""
function dti_iconhourglasshigh(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhourglasshigh", "IconHourglassHigh", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
