...
export dti_iconlineheight

"""
    dti_iconlineheight(;kwargs...)

An IconLineHeight component.
...
"""
function dti_iconlineheight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlineheight", "IconLineHeight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
