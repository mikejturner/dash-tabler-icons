...
export dti_iconbrandgrammarly

"""
    dti_iconbrandgrammarly(;kwargs...)

An IconBrandGrammarly component.
...
"""
function dti_iconbrandgrammarly(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgrammarly", "IconBrandGrammarly", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
