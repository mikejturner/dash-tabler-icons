...
export dti_iconcommand

"""
    dti_iconcommand(;kwargs...)

An IconCommand component.
...
"""
function dti_iconcommand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcommand", "IconCommand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
