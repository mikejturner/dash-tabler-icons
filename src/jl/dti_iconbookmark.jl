...
export dti_iconbookmark

"""
    dti_iconbookmark(;kwargs...)

An IconBookmark component.
...
"""
function dti_iconbookmark(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbookmark", "IconBookmark", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
