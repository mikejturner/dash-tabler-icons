...
export dti_iconrefreshdot

"""
    dti_iconrefreshdot(;kwargs...)

An IconRefreshDot component.
...
"""
function dti_iconrefreshdot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrefreshdot", "IconRefreshDot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
