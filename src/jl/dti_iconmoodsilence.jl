...
export dti_iconmoodsilence

"""
    dti_iconmoodsilence(;kwargs...)

An IconMoodSilence component.
...
"""
function dti_iconmoodsilence(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsilence", "IconMoodSilence", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
