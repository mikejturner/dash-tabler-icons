...
export dti_icondevicesim1

"""
    dti_icondevicesim1(;kwargs...)

An IconDeviceSim1 component.
...
"""
function dti_icondevicesim1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicesim1", "IconDeviceSim1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
