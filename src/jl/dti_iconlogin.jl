...
export dti_iconlogin

"""
    dti_iconlogin(;kwargs...)

An IconLogin component.
...
"""
function dti_iconlogin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogin", "IconLogin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
