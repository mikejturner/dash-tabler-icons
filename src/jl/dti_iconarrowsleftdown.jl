...
export dti_iconarrowsleftdown

"""
    dti_iconarrowsleftdown(;kwargs...)

An IconArrowsLeftDown component.
...
"""
function dti_iconarrowsleftdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsleftdown", "IconArrowsLeftDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
