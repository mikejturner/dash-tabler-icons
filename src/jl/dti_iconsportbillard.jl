...
export dti_iconsportbillard

"""
    dti_iconsportbillard(;kwargs...)

An IconSportBillard component.
...
"""
function dti_iconsportbillard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsportbillard", "IconSportBillard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
