...
export dti_iconbrandlinkedin

"""
    dti_iconbrandlinkedin(;kwargs...)

An IconBrandLinkedin component.
...
"""
function dti_iconbrandlinkedin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandlinkedin", "IconBrandLinkedin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
