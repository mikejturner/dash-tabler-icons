...
export dti_iconhexagonlettern

"""
    dti_iconhexagonlettern(;kwargs...)

An IconHexagonLetterN component.
...
"""
function dti_iconhexagonlettern(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonlettern", "IconHexagonLetterN", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
