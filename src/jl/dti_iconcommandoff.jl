...
export dti_iconcommandoff

"""
    dti_iconcommandoff(;kwargs...)

An IconCommandOff component.
...
"""
function dti_iconcommandoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcommandoff", "IconCommandOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
