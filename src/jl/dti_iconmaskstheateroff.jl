...
export dti_iconmaskstheateroff

"""
    dti_iconmaskstheateroff(;kwargs...)

An IconMasksTheaterOff component.
...
"""
function dti_iconmaskstheateroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmaskstheateroff", "IconMasksTheaterOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
