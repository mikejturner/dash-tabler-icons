...
export dti_iconcameraplus

"""
    dti_iconcameraplus(;kwargs...)

An IconCameraPlus component.
...
"""
function dti_iconcameraplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcameraplus", "IconCameraPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
