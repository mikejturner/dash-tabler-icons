...
export dti_icontoolsoff

"""
    dti_icontoolsoff(;kwargs...)

An IconToolsOff component.
...
"""
function dti_icontoolsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoolsoff", "IconToolsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
