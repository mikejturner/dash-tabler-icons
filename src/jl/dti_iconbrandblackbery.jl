...
export dti_iconbrandblackbery

"""
    dti_iconbrandblackbery(;kwargs...)

An IconBrandBlackbery component.
...
"""
function dti_iconbrandblackbery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandblackbery", "IconBrandBlackbery", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
