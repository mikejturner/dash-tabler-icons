...
export dti_icontableshortcut

"""
    dti_icontableshortcut(;kwargs...)

An IconTableShortcut component.
...
"""
function dti_icontableshortcut(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontableshortcut", "IconTableShortcut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
