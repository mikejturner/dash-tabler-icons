...
export dti_iconplaneoff

"""
    dti_iconplaneoff(;kwargs...)

An IconPlaneOff component.
...
"""
function dti_iconplaneoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaneoff", "IconPlaneOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
