...
export dti_iconmeeple

"""
    dti_iconmeeple(;kwargs...)

An IconMeeple component.
...
"""
function dti_iconmeeple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmeeple", "IconMeeple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
