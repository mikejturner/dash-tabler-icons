...
export dti_iconlocationbroken

"""
    dti_iconlocationbroken(;kwargs...)

An IconLocationBroken component.
...
"""
function dti_iconlocationbroken(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlocationbroken", "IconLocationBroken", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
