...
export dti_iconhammeroff

"""
    dti_iconhammeroff(;kwargs...)

An IconHammerOff component.
...
"""
function dti_iconhammeroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhammeroff", "IconHammerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
