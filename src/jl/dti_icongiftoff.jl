...
export dti_icongiftoff

"""
    dti_icongiftoff(;kwargs...)

An IconGiftOff component.
...
"""
function dti_icongiftoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongiftoff", "IconGiftOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
