...
export dti_iconexposureoff

"""
    dti_iconexposureoff(;kwargs...)

An IconExposureOff component.
...
"""
function dti_iconexposureoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposureoff", "IconExposureOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
