...
export dti_iconbrandpushover

"""
    dti_iconbrandpushover(;kwargs...)

An IconBrandPushover component.
...
"""
function dti_iconbrandpushover(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpushover", "IconBrandPushover", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
