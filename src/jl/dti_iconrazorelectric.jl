...
export dti_iconrazorelectric

"""
    dti_iconrazorelectric(;kwargs...)

An IconRazorElectric component.
...
"""
function dti_iconrazorelectric(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrazorelectric", "IconRazorElectric", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
