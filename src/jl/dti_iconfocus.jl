...
export dti_iconfocus

"""
    dti_iconfocus(;kwargs...)
...
"""
function dti_iconfocus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfocus", "IconFocus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
