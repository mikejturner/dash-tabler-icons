...
export dti_iconcookieoff

"""
    dti_iconcookieoff(;kwargs...)

An IconCookieOff component.
...
"""
function dti_iconcookieoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcookieoff", "IconCookieOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
