...
export dti_iconbellx

"""
    dti_iconbellx(;kwargs...)

An IconBellX component.
...
"""
function dti_iconbellx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellx", "IconBellX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
