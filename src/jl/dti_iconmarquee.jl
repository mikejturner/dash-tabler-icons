...
export dti_iconmarquee

"""
    dti_iconmarquee(;kwargs...)

An IconMarquee component.
...
"""
function dti_iconmarquee(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmarquee", "IconMarquee", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
