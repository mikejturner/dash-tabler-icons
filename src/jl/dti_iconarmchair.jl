...
export dti_iconarmchair

"""
    dti_iconarmchair(;kwargs...)

An IconArmchair component.
...
"""
function dti_iconarmchair(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarmchair", "IconArmchair", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
