...
export dti_iconscaleoutline

"""
    dti_iconscaleoutline(;kwargs...)

An IconScaleOutline component.
...
"""
function dti_iconscaleoutline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscaleoutline", "IconScaleOutline", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
