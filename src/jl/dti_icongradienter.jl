...
export dti_icongradienter

"""
    dti_icongradienter(;kwargs...)

An IconGradienter component.
...
"""
function dti_icongradienter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongradienter", "IconGradienter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
