...
export dti_iconphonepause

"""
    dti_iconphonepause(;kwargs...)

An IconPhonePause component.
...
"""
function dti_iconphonepause(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphonepause", "IconPhonePause", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
