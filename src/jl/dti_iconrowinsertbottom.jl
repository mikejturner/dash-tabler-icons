...
export dti_iconrowinsertbottom

"""
    dti_iconrowinsertbottom(;kwargs...)

An IconRowInsertBottom component.
...
"""
function dti_iconrowinsertbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrowinsertbottom", "IconRowInsertBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
