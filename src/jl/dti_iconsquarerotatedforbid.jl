...
export dti_iconsquarerotatedforbid

"""
    dti_iconsquarerotatedforbid(;kwargs...)

An IconSquareRotatedForbid component.
...
"""
function dti_iconsquarerotatedforbid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarerotatedforbid", "IconSquareRotatedForbid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
