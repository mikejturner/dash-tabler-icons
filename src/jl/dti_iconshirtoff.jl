...
export dti_iconshirtoff

"""
    dti_iconshirtoff(;kwargs...)

An IconShirtOff component.
...
"""
function dti_iconshirtoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshirtoff", "IconShirtOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
