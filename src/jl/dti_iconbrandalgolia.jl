...
export dti_iconbrandalgolia

"""
    dti_iconbrandalgolia(;kwargs...)

An IconBrandAlgolia component.
...
"""
function dti_iconbrandalgolia(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandalgolia", "IconBrandAlgolia", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
