...
export dti_iconsnowman

"""
    dti_iconsnowman(;kwargs...)

An IconSnowman component.
...
"""
function dti_iconsnowman(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsnowman", "IconSnowman", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
