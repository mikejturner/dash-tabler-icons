...
export dti_iconsquareletterw

"""
    dti_iconsquareletterw(;kwargs...)

An IconSquareLetterW component.
...
"""
function dti_iconsquareletterw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterw", "IconSquareLetterW", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
