...
export dti_iconcalculatoroff

"""
    dti_iconcalculatoroff(;kwargs...)

An IconCalculatorOff component.
...
"""
function dti_iconcalculatoroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalculatoroff", "IconCalculatorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
