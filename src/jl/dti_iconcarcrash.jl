...
export dti_iconcarcrash

"""
    dti_iconcarcrash(;kwargs...)

An IconCarCrash component.
...
"""
function dti_iconcarcrash(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcarcrash", "IconCarCrash", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
