...
export dti_iconrotateclockwise2

"""
    dti_iconrotateclockwise2(;kwargs...)

An IconRotateClockwise2 component.
...
"""
function dti_iconrotateclockwise2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrotateclockwise2", "IconRotateClockwise2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
