...
export dti_iconbrandtabler

"""
    dti_iconbrandtabler(;kwargs...)

An IconBrandTabler component.
...
"""
function dti_iconbrandtabler(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtabler", "IconBrandTabler", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
