...
export dti_icongavel

"""
    dti_icongavel(;kwargs...)

An IconGavel component.
...
"""
function dti_icongavel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongavel", "IconGavel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
