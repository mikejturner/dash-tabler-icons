...
export dti_iconadjustments

"""
    dti_iconadjustments(;kwargs...)

An IconAdjustments component.
...
"""
function dti_iconadjustments(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconadjustments", "IconAdjustments", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
