...
export dti_iconcalendarplus

"""
    dti_iconcalendarplus(;kwargs...)

An IconCalendarPlus component.
...
"""
function dti_iconcalendarplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendarplus", "IconCalendarPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
