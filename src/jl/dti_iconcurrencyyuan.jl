...
export dti_iconcurrencyyuan

"""
    dti_iconcurrencyyuan(;kwargs...)

An IconCurrencyYuan component.
...
"""
function dti_iconcurrencyyuan(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyyuan", "IconCurrencyYuan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
