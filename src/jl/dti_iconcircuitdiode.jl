...
export dti_iconcircuitdiode

"""
    dti_iconcircuitdiode(;kwargs...)

An IconCircuitDiode component.
...
"""
function dti_iconcircuitdiode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitdiode", "IconCircuitDiode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
