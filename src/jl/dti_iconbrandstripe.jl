...
export dti_iconbrandstripe

"""
    dti_iconbrandstripe(;kwargs...)

An IconBrandStripe component.
...
"""
function dti_iconbrandstripe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandstripe", "IconBrandStripe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
