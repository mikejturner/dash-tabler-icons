...
export dti_iconbrandbandcamp

"""
    dti_iconbrandbandcamp(;kwargs...)

An IconBrandBandcamp component.
...
"""
function dti_iconbrandbandcamp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbandcamp", "IconBrandBandcamp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
