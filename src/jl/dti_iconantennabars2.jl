...
export dti_iconantennabars2

"""
    dti_iconantennabars2(;kwargs...)

An IconAntennaBars2 component.
...
"""
function dti_iconantennabars2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennabars2", "IconAntennaBars2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
