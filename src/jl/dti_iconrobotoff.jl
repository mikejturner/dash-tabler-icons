...
export dti_iconrobotoff

"""
    dti_iconrobotoff(;kwargs...)

An IconRobotOff component.
...
"""
function dti_iconrobotoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrobotoff", "IconRobotOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
