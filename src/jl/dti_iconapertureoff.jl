...
export dti_iconapertureoff

"""
    dti_iconapertureoff(;kwargs...)

An IconApertureOff component.
...
"""
function dti_iconapertureoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconapertureoff", "IconApertureOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
