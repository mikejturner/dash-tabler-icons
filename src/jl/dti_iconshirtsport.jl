...
export dti_iconshirtsport

"""
    dti_iconshirtsport(;kwargs...)

An IconShirtSport component.
...
"""
function dti_iconshirtsport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshirtsport", "IconShirtSport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
