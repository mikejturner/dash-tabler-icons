...
export dti_iconbrandvimeo

"""
    dti_iconbrandvimeo(;kwargs...)

An IconBrandVimeo component.
...
"""
function dti_iconbrandvimeo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvimeo", "IconBrandVimeo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
