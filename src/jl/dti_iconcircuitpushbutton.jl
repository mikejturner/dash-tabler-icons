...
export dti_iconcircuitpushbutton

"""
    dti_iconcircuitpushbutton(;kwargs...)

An IconCircuitPushbutton component.
...
"""
function dti_iconcircuitpushbutton(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitpushbutton", "IconCircuitPushbutton", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
