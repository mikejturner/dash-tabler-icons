...
export dti_iconcalendartime

"""
    dti_iconcalendartime(;kwargs...)

An IconCalendarTime component.
...
"""
function dti_iconcalendartime(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendartime", "IconCalendarTime", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
