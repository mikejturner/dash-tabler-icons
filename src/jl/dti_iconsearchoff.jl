...
export dti_iconsearchoff

"""
    dti_iconsearchoff(;kwargs...)

An IconSearchOff component.
...
"""
function dti_iconsearchoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsearchoff", "IconSearchOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
