...
export dti_iconvipoff

"""
    dti_iconvipoff(;kwargs...)

An IconVipOff component.
...
"""
function dti_iconvipoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvipoff", "IconVipOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
