...
export dti_iconchartpie2

"""
    dti_iconchartpie2(;kwargs...)

An IconChartPie2 component.
...
"""
function dti_iconchartpie2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartpie2", "IconChartPie2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
