...
export dti_icondiscgolf

"""
    dti_icondiscgolf(;kwargs...)

An IconDiscGolf component.
...
"""
function dti_icondiscgolf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscgolf", "IconDiscGolf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
