...
export dti_iconmoonstars

"""
    dti_iconmoonstars(;kwargs...)

An IconMoonStars component.
...
"""
function dti_iconmoonstars(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoonstars", "IconMoonStars", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
