...
export dti_icontypographyoff

"""
    dti_icontypographyoff(;kwargs...)

An IconTypographyOff component.
...
"""
function dti_icontypographyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontypographyoff", "IconTypographyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
