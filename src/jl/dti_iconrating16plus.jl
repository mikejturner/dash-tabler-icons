...
export dti_iconrating16plus

"""
    dti_iconrating16plus(;kwargs...)

An IconRating16Plus component.
...
"""
function dti_iconrating16plus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrating16plus", "IconRating16Plus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
