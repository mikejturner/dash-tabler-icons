...
export dti_iconcurrencydollar

"""
    dti_iconcurrencydollar(;kwargs...)

An IconCurrencyDollar component.
...
"""
function dti_iconcurrencydollar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollar", "IconCurrencyDollar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
