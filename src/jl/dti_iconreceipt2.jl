...
export dti_iconreceipt2

"""
    dti_iconreceipt2(;kwargs...)

An IconReceipt2 component.
...
"""
function dti_iconreceipt2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreceipt2", "IconReceipt2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
