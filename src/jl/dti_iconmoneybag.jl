...
export dti_iconmoneybag

"""
    dti_iconmoneybag(;kwargs...)

An IconMoneybag component.
...
"""
function dti_iconmoneybag(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoneybag", "IconMoneybag", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
