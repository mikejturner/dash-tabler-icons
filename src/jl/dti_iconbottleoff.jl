...
export dti_iconbottleoff

"""
    dti_iconbottleoff(;kwargs...)

An IconBottleOff component.
...
"""
function dti_iconbottleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbottleoff", "IconBottleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
