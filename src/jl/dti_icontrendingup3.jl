...
export dti_icontrendingup3

"""
    dti_icontrendingup3(;kwargs...)

An IconTrendingUp3 component.
...
"""
function dti_icontrendingup3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrendingup3", "IconTrendingUp3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
