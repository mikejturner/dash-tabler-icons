...
export dti_iconheartratemonitor

"""
    dti_iconheartratemonitor(;kwargs...)

An IconHeartRateMonitor component.
...
"""
function dti_iconheartratemonitor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartratemonitor", "IconHeartRateMonitor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
