...
export dti_iconphysotherapist

"""
    dti_iconphysotherapist(;kwargs...)

An IconPhysotherapist component.
...
"""
function dti_iconphysotherapist(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphysotherapist", "IconPhysotherapist", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
