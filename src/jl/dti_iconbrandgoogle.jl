...
export dti_iconbrandgoogle

"""
    dti_iconbrandgoogle(;kwargs...)

An IconBrandGoogle component.
...
"""
function dti_iconbrandgoogle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgoogle", "IconBrandGoogle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
