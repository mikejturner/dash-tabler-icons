...
export dti_iconstaroff

"""
    dti_iconstaroff(;kwargs...)

An IconStarOff component.
...
"""
function dti_iconstaroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstaroff", "IconStarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
