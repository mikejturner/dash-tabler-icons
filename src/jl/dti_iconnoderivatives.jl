...
export dti_iconnoderivatives

"""
    dti_iconnoderivatives(;kwargs...)

An IconNoDerivatives component.
...
"""
function dti_iconnoderivatives(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnoderivatives", "IconNoDerivatives", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
