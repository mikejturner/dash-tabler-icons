...
export dti_iconcornerupright

"""
    dti_iconcornerupright(;kwargs...)

An IconCornerUpRight component.
...
"""
function dti_iconcornerupright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerupright", "IconCornerUpRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
