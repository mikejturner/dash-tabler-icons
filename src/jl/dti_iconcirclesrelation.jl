...
export dti_iconcirclesrelation

"""
    dti_iconcirclesrelation(;kwargs...)

An IconCirclesRelation component.
...
"""
function dti_iconcirclesrelation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclesrelation", "IconCirclesRelation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
