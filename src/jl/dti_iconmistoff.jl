...
export dti_iconmistoff

"""
    dti_iconmistoff(;kwargs...)

An IconMistOff component.
...
"""
function dti_iconmistoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmistoff", "IconMistOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
