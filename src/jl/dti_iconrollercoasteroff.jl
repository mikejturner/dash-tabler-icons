...
export dti_iconrollercoasteroff

"""
    dti_iconrollercoasteroff(;kwargs...)

An IconRollercoasterOff component.
...
"""
function dti_iconrollercoasteroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrollercoasteroff", "IconRollercoasterOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
