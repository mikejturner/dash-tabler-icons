...
export dti_iconcoinyen

"""
    dti_iconcoinyen(;kwargs...)

An IconCoinYen component.
...
"""
function dti_iconcoinyen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinyen", "IconCoinYen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
