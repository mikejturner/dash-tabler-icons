...
export dti_iconboxalignbottom

"""
    dti_iconboxalignbottom(;kwargs...)

An IconBoxAlignBottom component.
...
"""
function dti_iconboxalignbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxalignbottom", "IconBoxAlignBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
