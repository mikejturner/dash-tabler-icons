...
export dti_iconheading

"""
    dti_iconheading(;kwargs...)

An IconHeading component.
...
"""
function dti_iconheading(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheading", "IconHeading", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
