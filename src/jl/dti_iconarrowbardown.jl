...
export dti_iconarrowbardown

"""
    dti_iconarrowbardown(;kwargs...)

An IconArrowBarDown component.
...
"""
function dti_iconarrowbardown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbardown", "IconArrowBarDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
