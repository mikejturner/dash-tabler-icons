...
export dti_iconsocial

"""
    dti_iconsocial(;kwargs...)

An IconSocial component.
...
"""
function dti_iconsocial(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsocial", "IconSocial", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
