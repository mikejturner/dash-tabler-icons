...
export dti_iconomega

"""
    dti_iconomega(;kwargs...)

An IconOmega component.
...
"""
function dti_iconomega(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconomega", "IconOmega", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
