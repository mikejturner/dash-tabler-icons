...
export dti_iconzodiacscorpio

"""
    dti_iconzodiacscorpio(;kwargs...)

An IconZodiacScorpio component.
...
"""
function dti_iconzodiacscorpio(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacscorpio", "IconZodiacScorpio", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
