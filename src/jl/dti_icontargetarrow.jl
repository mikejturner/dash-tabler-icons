...
export dti_icontargetarrow

"""
    dti_icontargetarrow(;kwargs...)

An IconTargetArrow component.
...
"""
function dti_icontargetarrow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontargetarrow", "IconTargetArrow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
