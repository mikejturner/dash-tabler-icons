...
export dti_icontemplate

"""
    dti_icontemplate(;kwargs...)

An IconTemplate component.
...
"""
function dti_icontemplate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemplate", "IconTemplate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
