...
export dti_iconsunhigh

"""
    dti_iconsunhigh(;kwargs...)

An IconSunHigh component.
...
"""
function dti_iconsunhigh(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunhigh", "IconSunHigh", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
