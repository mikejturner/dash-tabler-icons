...
export dti_iconbrandbehance

"""
    dti_iconbrandbehance(;kwargs...)

An IconBrandBehance component.
...
"""
function dti_iconbrandbehance(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbehance", "IconBrandBehance", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
