...
export dti_icondirectionhorizontal

"""
    dti_icondirectionhorizontal(;kwargs...)

An IconDirectionHorizontal component.
...
"""
function dti_icondirectionhorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondirectionhorizontal", "IconDirectionHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
