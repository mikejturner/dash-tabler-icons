...
export dti_iconsquarelettery

"""
    dti_iconsquarelettery(;kwargs...)

An IconSquareLetterY component.
...
"""
function dti_iconsquarelettery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarelettery", "IconSquareLetterY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
