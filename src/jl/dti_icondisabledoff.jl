...
export dti_icondisabledoff

"""
    dti_icondisabledoff(;kwargs...)

An IconDisabledOff component.
...
"""
function dti_icondisabledoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondisabledoff", "IconDisabledOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
