...
export dti_iconchartdonut4

"""
    dti_iconchartdonut4(;kwargs...)

An IconChartDonut4 component.
...
"""
function dti_iconchartdonut4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdonut4", "IconChartDonut4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
