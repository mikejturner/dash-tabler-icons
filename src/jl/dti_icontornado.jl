...
export dti_icontornado

"""
    dti_icontornado(;kwargs...)

An IconTornado component.
...
"""
function dti_icontornado(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontornado", "IconTornado", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
