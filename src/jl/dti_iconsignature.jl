...
export dti_iconsignature

"""
    dti_iconsignature(;kwargs...)

An IconSignature component.
...
"""
function dti_iconsignature(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignature", "IconSignature", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
