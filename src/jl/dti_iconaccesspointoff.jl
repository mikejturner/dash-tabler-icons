...
export dti_iconaccesspointoff

"""
    dti_iconaccesspointoff(;kwargs...)

An IconAccessPointOff component.
...
"""
function dti_iconaccesspointoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaccesspointoff", "IconAccessPointOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
