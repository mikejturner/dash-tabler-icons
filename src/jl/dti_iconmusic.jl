...
export dti_iconmusic

"""
    dti_iconmusic(;kwargs...)

An IconMusic component.
...
"""
function dti_iconmusic(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmusic", "IconMusic", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
