...
export dti_iconcellsignal3

"""
    dti_iconcellsignal3(;kwargs...)

An IconCellSignal3 component.
...
"""
function dti_iconcellsignal3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcellsignal3", "IconCellSignal3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
