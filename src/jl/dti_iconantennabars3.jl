...
export dti_iconantennabars3

"""
    dti_iconantennabars3(;kwargs...)

An IconAntennaBars3 component.
...
"""
function dti_iconantennabars3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennabars3", "IconAntennaBars3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
