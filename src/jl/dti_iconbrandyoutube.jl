...
export dti_iconbrandyoutube

"""
    dti_iconbrandyoutube(;kwargs...)

An IconBrandYoutube component.
...
"""
function dti_iconbrandyoutube(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandyoutube", "IconBrandYoutube", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
