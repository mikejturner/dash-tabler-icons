...
export dti_iconfilearrowright

"""
    dti_iconfilearrowright(;kwargs...)

An IconFileArrowRight component.
...
"""
function dti_iconfilearrowright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilearrowright", "IconFileArrowRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
