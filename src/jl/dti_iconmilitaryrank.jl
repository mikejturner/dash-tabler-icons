...
export dti_iconmilitaryrank

"""
    dti_iconmilitaryrank(;kwargs...)

An IconMilitaryRank component.
...
"""
function dti_iconmilitaryrank(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmilitaryrank", "IconMilitaryRank", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
