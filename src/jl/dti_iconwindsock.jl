...
export dti_iconwindsock

"""
    dti_iconwindsock(;kwargs...)

An IconWindsock component.
...
"""
function dti_iconwindsock(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindsock", "IconWindsock", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
