...
export dti_iconbrandpinterest

"""
    dti_iconbrandpinterest(;kwargs...)

An IconBrandPinterest component.
...
"""
function dti_iconbrandpinterest(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpinterest", "IconBrandPinterest", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
