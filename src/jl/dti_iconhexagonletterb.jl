...
export dti_iconhexagonletterb

"""
    dti_iconhexagonletterb(;kwargs...)

An IconHexagonLetterB component.
...
"""
function dti_iconhexagonletterb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterb", "IconHexagonLetterB", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
