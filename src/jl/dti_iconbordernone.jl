...
export dti_iconbordernone

"""
    dti_iconbordernone(;kwargs...)

An IconBorderNone component.
...
"""
function dti_iconbordernone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbordernone", "IconBorderNone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
