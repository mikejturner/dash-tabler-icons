...
export dti_iconsendoff

"""
    dti_iconsendoff(;kwargs...)

An IconSendOff component.
...
"""
function dti_iconsendoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsendoff", "IconSendOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
