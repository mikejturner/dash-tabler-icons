...
export dti_iconzoomreplace

"""
    dti_iconzoomreplace(;kwargs...)

An IconZoomReplace component.
...
"""
function dti_iconzoomreplace(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomreplace", "IconZoomReplace", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
