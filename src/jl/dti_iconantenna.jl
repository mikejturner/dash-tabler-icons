...
export dti_iconantenna

"""
    dti_iconantenna(;kwargs...)

An IconAntenna component.
...
"""
function dti_iconantenna(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantenna", "IconAntenna", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
