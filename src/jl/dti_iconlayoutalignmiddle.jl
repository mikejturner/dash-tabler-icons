...
export dti_iconlayoutalignmiddle

"""
    dti_iconlayoutalignmiddle(;kwargs...)

An IconLayoutAlignMiddle component.
...
"""
function dti_iconlayoutalignmiddle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutalignmiddle", "IconLayoutAlignMiddle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
