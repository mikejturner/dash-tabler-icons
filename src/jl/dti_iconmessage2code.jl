...
export dti_iconmessage2code

"""
    dti_iconmessage2code(;kwargs...)

An IconMessage2Code component.
...
"""
function dti_iconmessage2code(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessage2code", "IconMessage2Code", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
