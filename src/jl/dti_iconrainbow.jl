...
export dti_iconrainbow

"""
    dti_iconrainbow(;kwargs...)

An IconRainbow component.
...
"""
function dti_iconrainbow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrainbow", "IconRainbow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
