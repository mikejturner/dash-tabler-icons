...
export dti_iconhierarchy2

"""
    dti_iconhierarchy2(;kwargs...)

An IconHierarchy2 component.
...
"""
function dti_iconhierarchy2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhierarchy2", "IconHierarchy2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
