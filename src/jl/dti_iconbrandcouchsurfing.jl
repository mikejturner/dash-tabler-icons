...
export dti_iconbrandcouchsurfing

"""
    dti_iconbrandcouchsurfing(;kwargs...)

An IconBrandCouchsurfing component.
...
"""
function dti_iconbrandcouchsurfing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcouchsurfing", "IconBrandCouchsurfing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
