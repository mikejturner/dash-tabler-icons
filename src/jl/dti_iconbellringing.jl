...
export dti_iconbellringing

"""
    dti_iconbellringing(;kwargs...)

An IconBellRinging component.
...
"""
function dti_iconbellringing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellringing", "IconBellRinging", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
