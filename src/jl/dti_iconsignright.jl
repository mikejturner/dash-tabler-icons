...
export dti_iconsignright

"""
    dti_iconsignright(;kwargs...)

An IconSignRight component.
...
"""
function dti_iconsignright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignright", "IconSignRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
