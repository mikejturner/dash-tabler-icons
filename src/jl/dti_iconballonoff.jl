...
export dti_iconballonoff

"""
    dti_iconballonoff(;kwargs...)

An IconBallonOff component.
...
"""
function dti_iconballonoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballonoff", "IconBallonOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
