...
export dti_iconbrandbulma

"""
    dti_iconbrandbulma(;kwargs...)

An IconBrandBulma component.
...
"""
function dti_iconbrandbulma(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbulma", "IconBrandBulma", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
