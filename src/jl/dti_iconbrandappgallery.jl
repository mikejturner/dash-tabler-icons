...
export dti_iconbrandappgallery

"""
    dti_iconbrandappgallery(;kwargs...)

An IconBrandAppgallery component.
...
"""
function dti_iconbrandappgallery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandappgallery", "IconBrandAppgallery", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
