...
export dti_iconphotoplus

"""
    dti_iconphotoplus(;kwargs...)

An IconPhotoPlus component.
...
"""
function dti_iconphotoplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotoplus", "IconPhotoPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
