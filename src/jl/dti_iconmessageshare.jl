...
export dti_iconmessageshare

"""
    dti_iconmessageshare(;kwargs...)

An IconMessageShare component.
...
"""
function dti_iconmessageshare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessageshare", "IconMessageShare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
