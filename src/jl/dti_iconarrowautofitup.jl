...
export dti_iconarrowautofitup

"""
    dti_iconarrowautofitup(;kwargs...)

An IconArrowAutofitUp component.
...
"""
function dti_iconarrowautofitup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitup", "IconArrowAutofitUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
