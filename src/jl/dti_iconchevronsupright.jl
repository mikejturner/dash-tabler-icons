...
export dti_iconchevronsupright

"""
    dti_iconchevronsupright(;kwargs...)

An IconChevronsUpRight component.
...
"""
function dti_iconchevronsupright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsupright", "IconChevronsUpRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
