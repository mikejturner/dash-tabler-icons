...
export dti_iconvariable

"""
    dti_iconvariable(;kwargs...)

An IconVariable component.
...
"""
function dti_iconvariable(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvariable", "IconVariable", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
