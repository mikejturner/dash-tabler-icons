...
export dti_iconbranddayscounter

"""
    dti_iconbranddayscounter(;kwargs...)

An IconBrandDaysCounter component.
...
"""
function dti_iconbranddayscounter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddayscounter", "IconBrandDaysCounter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
