...
export dti_iconpencil

"""
    dti_iconpencil(;kwargs...)

An IconPencil component.
...
"""
function dti_iconpencil(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpencil", "IconPencil", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
