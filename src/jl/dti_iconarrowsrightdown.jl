...
export dti_iconarrowsrightdown

"""
    dti_iconarrowsrightdown(;kwargs...)

An IconArrowsRightDown component.
...
"""
function dti_iconarrowsrightdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsrightdown", "IconArrowsRightDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
