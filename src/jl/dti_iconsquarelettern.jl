...
export dti_iconsquarelettern

"""
    dti_iconsquarelettern(;kwargs...)

An IconSquareLetterN component.
...
"""
function dti_iconsquarelettern(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarelettern", "IconSquareLetterN", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
