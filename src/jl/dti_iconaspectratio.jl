...
export dti_iconaspectratio

"""
    dti_iconaspectratio(;kwargs...)

An IconAspectRatio component.
...
"""
function dti_iconaspectratio(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaspectratio", "IconAspectRatio", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
