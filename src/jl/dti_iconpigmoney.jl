...
export dti_iconpigmoney

"""
    dti_iconpigmoney(;kwargs...)

An IconPigMoney component.
...
"""
function dti_iconpigmoney(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpigmoney", "IconPigMoney", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
