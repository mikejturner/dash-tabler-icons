...
export dti_iconhexagonnumber8

"""
    dti_iconhexagonnumber8(;kwargs...)

An IconHexagonNumber8 component.
...
"""
function dti_iconhexagonnumber8(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber8", "IconHexagonNumber8", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
