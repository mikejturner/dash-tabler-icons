...
export dti_iconprison

"""
    dti_iconprison(;kwargs...)

An IconPrison component.
...
"""
function dti_iconprison(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconprison", "IconPrison", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
