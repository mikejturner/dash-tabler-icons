...
export dti_icontextincrease

"""
    dti_icontextincrease(;kwargs...)

An IconTextIncrease component.
...
"""
function dti_icontextincrease(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextincrease", "IconTextIncrease", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
