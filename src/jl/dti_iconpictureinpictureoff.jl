...
export dti_iconpictureinpictureoff

"""
    dti_iconpictureinpictureoff(;kwargs...)

An IconPictureInPictureOff component.
...
"""
function dti_iconpictureinpictureoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpictureinpictureoff", "IconPictureInPictureOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
