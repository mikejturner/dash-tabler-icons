...
export dti_iconkeyboardshow

"""
    dti_iconkeyboardshow(;kwargs...)

An IconKeyboardShow component.
...
"""
function dti_iconkeyboardshow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyboardshow", "IconKeyboardShow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
