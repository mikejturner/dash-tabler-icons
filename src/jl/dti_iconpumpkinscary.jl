...
export dti_iconpumpkinscary

"""
    dti_iconpumpkinscary(;kwargs...)

An IconPumpkinScary component.
...
"""
function dti_iconpumpkinscary(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpumpkinscary", "IconPumpkinScary", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
