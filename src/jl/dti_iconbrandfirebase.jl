...
export dti_iconbrandfirebase

"""
    dti_iconbrandfirebase(;kwargs...)

An IconBrandFirebase component.
...
"""
function dti_iconbrandfirebase(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfirebase", "IconBrandFirebase", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
