...
export dti_iconplaystationsquare

"""
    dti_iconplaystationsquare(;kwargs...)

An IconPlaystationSquare component.
...
"""
function dti_iconplaystationsquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaystationsquare", "IconPlaystationSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
