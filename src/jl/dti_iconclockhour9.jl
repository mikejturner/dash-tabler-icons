...
export dti_iconclockhour9

"""
    dti_iconclockhour9(;kwargs...)

An IconClockHour9 component.
...
"""
function dti_iconclockhour9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour9", "IconClockHour9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
