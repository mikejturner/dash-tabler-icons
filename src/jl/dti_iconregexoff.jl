...
export dti_iconregexoff

"""
    dti_iconregexoff(;kwargs...)

An IconRegexOff component.
...
"""
function dti_iconregexoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconregexoff", "IconRegexOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
