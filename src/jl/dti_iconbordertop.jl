...
export dti_iconbordertop

"""
    dti_iconbordertop(;kwargs...)

An IconBorderTop component.
...
"""
function dti_iconbordertop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbordertop", "IconBorderTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
