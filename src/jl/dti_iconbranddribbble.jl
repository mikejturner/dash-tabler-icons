...
export dti_iconbranddribbble

"""
    dti_iconbranddribbble(;kwargs...)

An IconBrandDribbble component.
...
"""
function dti_iconbranddribbble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddribbble", "IconBrandDribbble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
