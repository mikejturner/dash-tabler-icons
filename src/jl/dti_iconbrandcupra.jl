...
export dti_iconbrandcupra

"""
    dti_iconbrandcupra(;kwargs...)

An IconBrandCupra component.
...
"""
function dti_iconbrandcupra(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcupra", "IconBrandCupra", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
