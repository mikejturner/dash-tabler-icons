...
export dti_iconsteeringwheeloff

"""
    dti_iconsteeringwheeloff(;kwargs...)

An IconSteeringWheelOff component.
...
"""
function dti_iconsteeringwheeloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsteeringwheeloff", "IconSteeringWheelOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
