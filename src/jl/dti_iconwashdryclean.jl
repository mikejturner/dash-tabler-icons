...
export dti_iconwashdryclean

"""
    dti_iconwashdryclean(;kwargs...)

An IconWashDryclean component.
...
"""
function dti_iconwashdryclean(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryclean", "IconWashDryclean", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
