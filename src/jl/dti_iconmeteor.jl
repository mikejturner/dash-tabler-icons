...
export dti_iconmeteor

"""
    dti_iconmeteor(;kwargs...)

An IconMeteor component.
...
"""
function dti_iconmeteor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmeteor", "IconMeteor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
