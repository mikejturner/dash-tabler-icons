...
export dti_iconmoodsuprised

"""
    dti_iconmoodsuprised(;kwargs...)

An IconMoodSuprised component.
...
"""
function dti_iconmoodsuprised(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsuprised", "IconMoodSuprised", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
