...
export dti_iconcameraselfie

"""
    dti_iconcameraselfie(;kwargs...)

An IconCameraSelfie component.
...
"""
function dti_iconcameraselfie(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcameraselfie", "IconCameraSelfie", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
