...
export dti_iconkeyframe

"""
    dti_iconkeyframe(;kwargs...)

An IconKeyframe component.
...
"""
function dti_iconkeyframe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyframe", "IconKeyframe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
