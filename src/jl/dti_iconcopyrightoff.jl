...
export dti_iconcopyrightoff

"""
    dti_iconcopyrightoff(;kwargs...)

An IconCopyrightOff component.
...
"""
function dti_iconcopyrightoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcopyrightoff", "IconCopyrightOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
