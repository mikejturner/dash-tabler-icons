...
export dti_iconcompass

"""
    dti_iconcompass(;kwargs...)

An IconCompass component.
...
"""
function dti_iconcompass(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcompass", "IconCompass", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
