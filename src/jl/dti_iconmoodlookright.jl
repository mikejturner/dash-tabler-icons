...
export dti_iconmoodlookright

"""
    dti_iconmoodlookright(;kwargs...)

An IconMoodLookRight component.
...
"""
function dti_iconmoodlookright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodlookright", "IconMoodLookRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
