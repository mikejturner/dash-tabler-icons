...
export dti_iconbrandmercedes

"""
    dti_iconbrandmercedes(;kwargs...)

An IconBrandMercedes component.
...
"""
function dti_iconbrandmercedes(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmercedes", "IconBrandMercedes", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
