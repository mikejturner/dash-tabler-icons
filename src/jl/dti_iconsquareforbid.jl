...
export dti_iconsquareforbid

"""
    dti_iconsquareforbid(;kwargs...)

An IconSquareForbid component.
...
"""
function dti_iconsquareforbid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareforbid", "IconSquareForbid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
