...
export dti_iconbrandzalando

"""
    dti_iconbrandzalando(;kwargs...)

An IconBrandZalando component.
...
"""
function dti_iconbrandzalando(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandzalando", "IconBrandZalando", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
