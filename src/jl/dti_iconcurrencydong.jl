...
export dti_iconcurrencydong

"""
    dti_iconcurrencydong(;kwargs...)

An IconCurrencyDong component.
...
"""
function dti_iconcurrencydong(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydong", "IconCurrencyDong", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
