...
export dti_iconchartpie3

"""
    dti_iconchartpie3(;kwargs...)

An IconChartPie3 component.
...
"""
function dti_iconchartpie3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartpie3", "IconChartPie3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
