...
export dti_iconbrandmastodon

"""
    dti_iconbrandmastodon(;kwargs...)

An IconBrandMastodon component.
...
"""
function dti_iconbrandmastodon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmastodon", "IconBrandMastodon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
