...
export dti_iconlayoutnavbar

"""
    dti_iconlayoutnavbar(;kwargs...)

An IconLayoutNavbar component.
...
"""
function dti_iconlayoutnavbar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutnavbar", "IconLayoutNavbar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
