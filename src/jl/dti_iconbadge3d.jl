...
export dti_iconbadge3d

"""
    dti_iconbadge3d(;kwargs...)

An IconBadge3d component.
...
"""
function dti_iconbadge3d(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadge3d", "IconBadge3d", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
