...
export dti_iconbrandvue

"""
    dti_iconbrandvue(;kwargs...)

An IconBrandVue component.
...
"""
function dti_iconbrandvue(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvue", "IconBrandVue", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
