...
export dti_iconbracketscontainend

"""
    dti_iconbracketscontainend(;kwargs...)

An IconBracketsContainEnd component.
...
"""
function dti_iconbracketscontainend(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbracketscontainend", "IconBracketsContainEnd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
