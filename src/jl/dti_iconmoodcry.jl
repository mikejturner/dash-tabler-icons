...
export dti_iconmoodcry

"""
    dti_iconmoodcry(;kwargs...)

An IconMoodCry component.
...
"""
function dti_iconmoodcry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodcry", "IconMoodCry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
