...
export dti_iconpackgeimport

"""
    dti_iconpackgeimport(;kwargs...)

An IconPackgeImport component.
...
"""
function dti_iconpackgeimport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpackgeimport", "IconPackgeImport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
