...
export dti_iconcirclecaretdown

"""
    dti_iconcirclecaretdown(;kwargs...)

An IconCircleCaretDown component.
...
"""
function dti_iconcirclecaretdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclecaretdown", "IconCircleCaretDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
