...
export dti_iconairballoon

"""
    dti_iconairballoon(;kwargs...)

An IconAirBalloon component.
...
"""
function dti_iconairballoon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconairballoon", "IconAirBalloon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
