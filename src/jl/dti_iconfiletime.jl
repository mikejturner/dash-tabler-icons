...
export dti_iconfiletime

"""
    dti_iconfiletime(;kwargs...)

An IconFileTime component.
...
"""
function dti_iconfiletime(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiletime", "IconFileTime", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
