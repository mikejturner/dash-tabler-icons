...
export dti_iconloaderquarter

"""
    dti_iconloaderquarter(;kwargs...)

An IconLoaderQuarter component.
...
"""
function dti_iconloaderquarter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconloaderquarter", "IconLoaderQuarter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
