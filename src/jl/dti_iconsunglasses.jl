...
export dti_iconsunglasses

"""
    dti_iconsunglasses(;kwargs...)

An IconSunglasses component.
...
"""
function dti_iconsunglasses(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunglasses", "IconSunglasses", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
