...
export dti_iconroute2

"""
    dti_iconroute2(;kwargs...)

An IconRoute2 component.
...
"""
function dti_iconroute2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconroute2", "IconRoute2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
