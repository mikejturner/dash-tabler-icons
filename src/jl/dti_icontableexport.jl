...
export dti_icontableexport

"""
    dti_icontableexport(;kwargs...)

An IconTableExport component.
...
"""
function dti_icontableexport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontableexport", "IconTableExport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
