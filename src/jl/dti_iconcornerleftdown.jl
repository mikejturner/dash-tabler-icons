...
export dti_iconcornerleftdown

"""
    dti_iconcornerleftdown(;kwargs...)

An IconCornerLeftDown component.
...
"""
function dti_iconcornerleftdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerleftdown", "IconCornerLeftDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
