...
export dti_iconsquareletters

"""
    dti_iconsquareletters(;kwargs...)

An IconSquareLetterS component.
...
"""
function dti_iconsquareletters(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletters", "IconSquareLetterS", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
