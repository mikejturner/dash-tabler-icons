...
export dti_iconplayertracknext

"""
    dti_iconplayertracknext(;kwargs...)

An IconPlayerTrackNext component.
...
"""
function dti_iconplayertracknext(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayertracknext", "IconPlayerTrackNext", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
