...
export dti_iconbraces

"""
    dti_iconbraces(;kwargs...)

An IconBraces component.
...
"""
function dti_iconbraces(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbraces", "IconBraces", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
