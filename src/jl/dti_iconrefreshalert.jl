...
export dti_iconrefreshalert

"""
    dti_iconrefreshalert(;kwargs...)

An IconRefreshAlert component.
...
"""
function dti_iconrefreshalert(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrefreshalert", "IconRefreshAlert", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
