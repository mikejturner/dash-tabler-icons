...
export dti_iconbadgear

"""
    dti_iconbadgear(;kwargs...)

An IconBadgeAr component.
...
"""
function dti_iconbadgear(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgear", "IconBadgeAr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
