...
export dti_iconbrandnordvpn

"""
    dti_iconbrandnordvpn(;kwargs...)

An IconBrandNordVpn component.
...
"""
function dti_iconbrandnordvpn(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnordvpn", "IconBrandNordVpn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
