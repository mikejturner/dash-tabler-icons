...
export dti_iconwindowmaximize

"""
    dti_iconwindowmaximize(;kwargs...)

An IconWindowMaximize component.
...
"""
function dti_iconwindowmaximize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindowmaximize", "IconWindowMaximize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
