...
export dti_icongitcommit

"""
    dti_icongitcommit(;kwargs...)

An IconGitCommit component.
...
"""
function dti_icongitcommit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitcommit", "IconGitCommit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
