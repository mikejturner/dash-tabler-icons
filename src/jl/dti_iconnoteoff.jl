...
export dti_iconnoteoff

"""
    dti_iconnoteoff(;kwargs...)

An IconNoteOff component.
...
"""
function dti_iconnoteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnoteoff", "IconNoteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
