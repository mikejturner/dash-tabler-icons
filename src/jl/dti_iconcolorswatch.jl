...
export dti_iconcolorswatch

"""
    dti_iconcolorswatch(;kwargs...)

An IconColorSwatch component.
...
"""
function dti_iconcolorswatch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolorswatch", "IconColorSwatch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
