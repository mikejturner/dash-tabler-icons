...
export dti_iconcategory2

"""
    dti_iconcategory2(;kwargs...)

An IconCategory2 component.
...
"""
function dti_iconcategory2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcategory2", "IconCategory2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
