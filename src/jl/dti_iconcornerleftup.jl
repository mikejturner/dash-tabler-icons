...
export dti_iconcornerleftup

"""
    dti_iconcornerleftup(;kwargs...)

An IconCornerLeftUp component.
...
"""
function dti_iconcornerleftup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerleftup", "IconCornerLeftUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
