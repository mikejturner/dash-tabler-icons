...
export dti_icondevicemobileoff

"""
    dti_icondevicemobileoff(;kwargs...)

An IconDeviceMobileOff component.
...
"""
function dti_icondevicemobileoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicemobileoff", "IconDeviceMobileOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
