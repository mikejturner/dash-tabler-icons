...
export dti_icongrillspatula

"""
    dti_icongrillspatula(;kwargs...)

An IconGrillSpatula component.
...
"""
function dti_icongrillspatula(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrillspatula", "IconGrillSpatula", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
