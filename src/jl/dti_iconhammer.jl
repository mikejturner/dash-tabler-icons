...
export dti_iconhammer

"""
    dti_iconhammer(;kwargs...)

An IconHammer component.
...
"""
function dti_iconhammer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhammer", "IconHammer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
