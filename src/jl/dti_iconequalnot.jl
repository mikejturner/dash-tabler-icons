...
export dti_iconequalnot

"""
    dti_iconequalnot(;kwargs...)

An IconEqualNot component.
...
"""
function dti_iconequalnot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconequalnot", "IconEqualNot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
