...
export dti_iconbrandsharik

"""
    dti_iconbrandsharik(;kwargs...)

An IconBrandSharik component.
...
"""
function dti_iconbrandsharik(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsharik", "IconBrandSharik", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
