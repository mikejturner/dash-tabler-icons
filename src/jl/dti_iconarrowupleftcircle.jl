...
export dti_iconarrowupleftcircle

"""
    dti_iconarrowupleftcircle(;kwargs...)

An IconArrowUpLeftCircle component.
...
"""
function dti_iconarrowupleftcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowupleftcircle", "IconArrowUpLeftCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
