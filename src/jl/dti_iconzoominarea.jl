...
export dti_iconzoominarea

"""
    dti_iconzoominarea(;kwargs...)

An IconZoomInArea component.
...
"""
function dti_iconzoominarea(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoominarea", "IconZoomInArea", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
