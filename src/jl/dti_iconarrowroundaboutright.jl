...
export dti_iconarrowroundaboutright

"""
    dti_iconarrowroundaboutright(;kwargs...)

An IconArrowRoundaboutRight component.
...
"""
function dti_iconarrowroundaboutright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowroundaboutright", "IconArrowRoundaboutRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
