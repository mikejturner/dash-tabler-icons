...
export dti_iconmedicalcross

"""
    dti_iconmedicalcross(;kwargs...)

An IconMedicalCross component.
...
"""
function dti_iconmedicalcross(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmedicalcross", "IconMedicalCross", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
