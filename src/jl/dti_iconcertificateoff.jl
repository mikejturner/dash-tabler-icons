...
export dti_iconcertificateoff

"""
    dti_iconcertificateoff(;kwargs...)

An IconCertificateOff component.
...
"""
function dti_iconcertificateoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcertificateoff", "IconCertificateOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
