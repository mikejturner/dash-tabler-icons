...
export dti_iconbarrel

"""
    dti_iconbarrel(;kwargs...)

An IconBarrel component.
...
"""
function dti_iconbarrel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarrel", "IconBarrel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
