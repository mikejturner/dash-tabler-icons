...
export dti_iconarrowsdoublesenw

"""
    dti_iconarrowsdoublesenw(;kwargs...)

An IconArrowsDoubleSeNw component.
...
"""
function dti_iconarrowsdoublesenw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdoublesenw", "IconArrowsDoubleSeNw", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
