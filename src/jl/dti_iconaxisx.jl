...
export dti_iconaxisx

"""
    dti_iconaxisx(;kwargs...)

An IconAxisX component.
...
"""
function dti_iconaxisx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaxisx", "IconAxisX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
