...
export dti_iconsquaredot

"""
    dti_iconsquaredot(;kwargs...)

An IconSquareDot component.
...
"""
function dti_iconsquaredot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaredot", "IconSquareDot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
