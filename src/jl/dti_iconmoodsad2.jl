...
export dti_iconmoodsad2

"""
    dti_iconmoodsad2(;kwargs...)

An IconMoodSad2 component.
...
"""
function dti_iconmoodsad2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsad2", "IconMoodSad2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
