...
export dti_iconcurrencyreal

"""
    dti_iconcurrencyreal(;kwargs...)

An IconCurrencyReal component.
...
"""
function dti_iconcurrencyreal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyreal", "IconCurrencyReal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
