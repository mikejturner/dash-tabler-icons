...
export dti_iconcurrencydollarcanadian

"""
    dti_iconcurrencydollarcanadian(;kwargs...)

An IconCurrencyDollarCanadian component.
...
"""
function dti_iconcurrencydollarcanadian(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollarcanadian", "IconCurrencyDollarCanadian", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
