...
export dti_icongitmerge

"""
    dti_icongitmerge(;kwargs...)

An IconGitMerge component.
...
"""
function dti_icongitmerge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitmerge", "IconGitMerge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
