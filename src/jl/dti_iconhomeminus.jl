...
export dti_iconhomeminus

"""
    dti_iconhomeminus(;kwargs...)

An IconHomeMinus component.
...
"""
function dti_iconhomeminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeminus", "IconHomeMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
