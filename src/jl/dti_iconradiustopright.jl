...
export dti_iconradiustopright

"""
    dti_iconradiustopright(;kwargs...)

An IconRadiusTopRight component.
...
"""
function dti_iconradiustopright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradiustopright", "IconRadiusTopRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
