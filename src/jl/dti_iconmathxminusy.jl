...
export dti_iconmathxminusy

"""
    dti_iconmathxminusy(;kwargs...)

An IconMathXMinusY component.
...
"""
function dti_iconmathxminusy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxminusy", "IconMathXMinusY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
