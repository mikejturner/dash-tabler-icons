...
export dti_iconfacemaskoff

"""
    dti_iconfacemaskoff(;kwargs...)

An IconFaceMaskOff component.
...
"""
function dti_iconfacemaskoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfacemaskoff", "IconFaceMaskOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
