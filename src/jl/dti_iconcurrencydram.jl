...
export dti_iconcurrencydram

"""
    dti_iconcurrencydram(;kwargs...)

An IconCurrencyDram component.
...
"""
function dti_iconcurrencydram(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydram", "IconCurrencyDram", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
