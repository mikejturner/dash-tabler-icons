...
export dti_iconrocket

"""
    dti_iconrocket(;kwargs...)

An IconRocket component.
...
"""
function dti_iconrocket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrocket", "IconRocket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
