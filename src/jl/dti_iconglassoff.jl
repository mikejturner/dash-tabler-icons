...
export dti_iconglassoff

"""
    dti_iconglassoff(;kwargs...)

An IconGlassOff component.
...
"""
function dti_iconglassoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconglassoff", "IconGlassOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
