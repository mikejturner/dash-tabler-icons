...
export dti_iconminimize

"""
    dti_iconminimize(;kwargs...)

An IconMinimize component.
...
"""
function dti_iconminimize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconminimize", "IconMinimize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
