...
export dti_iconcurrencytenge

"""
    dti_iconcurrencytenge(;kwargs...)

An IconCurrencyTenge component.
...
"""
function dti_iconcurrencytenge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencytenge", "IconCurrencyTenge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
