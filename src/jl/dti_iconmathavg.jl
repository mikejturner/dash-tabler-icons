...
export dti_iconmathavg

"""
    dti_iconmathavg(;kwargs...)

An IconMathAvg component.
...
"""
function dti_iconmathavg(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathavg", "IconMathAvg", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
