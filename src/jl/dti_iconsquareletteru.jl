...
export dti_iconsquareletteru

"""
    dti_iconsquareletteru(;kwargs...)

An IconSquareLetterU component.
...
"""
function dti_iconsquareletteru(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletteru", "IconSquareLetterU", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
