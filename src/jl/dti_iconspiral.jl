...
export dti_iconspiral

"""
    dti_iconspiral(;kwargs...)

An IconSpiral component.
...
"""
function dti_iconspiral(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspiral", "IconSpiral", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
