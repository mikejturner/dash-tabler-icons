...
export dti_iconsquaretogglehorizontal

"""
    dti_iconsquaretogglehorizontal(;kwargs...)

An IconSquareToggleHorizontal component.
...
"""
function dti_iconsquaretogglehorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaretogglehorizontal", "IconSquareToggleHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
