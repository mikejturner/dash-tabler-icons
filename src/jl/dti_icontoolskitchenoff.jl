...
export dti_icontoolskitchenoff

"""
    dti_icontoolskitchenoff(;kwargs...)

An IconToolsKitchenOff component.
...
"""
function dti_icontoolskitchenoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoolskitchenoff", "IconToolsKitchenOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
