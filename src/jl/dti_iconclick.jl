...
export dti_iconclick

"""
    dti_iconclick(;kwargs...)

An IconClick component.
...
"""
function dti_iconclick(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclick", "IconClick", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
