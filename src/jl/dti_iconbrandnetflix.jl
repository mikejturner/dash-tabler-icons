...
export dti_iconbrandnetflix

"""
    dti_iconbrandnetflix(;kwargs...)

An IconBrandNetflix component.
...
"""
function dti_iconbrandnetflix(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnetflix", "IconBrandNetflix", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
