...
export dti_iconsortdescending2

"""
    dti_iconsortdescending2(;kwargs...)

An IconSortDescending2 component.
...
"""
function dti_iconsortdescending2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortdescending2", "IconSortDescending2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
