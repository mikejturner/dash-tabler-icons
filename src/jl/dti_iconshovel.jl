...
export dti_iconshovel

"""
    dti_iconshovel(;kwargs...)

An IconShovel component.
...
"""
function dti_iconshovel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshovel", "IconShovel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
