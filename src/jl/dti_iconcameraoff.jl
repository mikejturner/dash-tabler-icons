...
export dti_iconcameraoff

"""
    dti_iconcameraoff(;kwargs...)

An IconCameraOff component.
...
"""
function dti_iconcameraoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcameraoff", "IconCameraOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
