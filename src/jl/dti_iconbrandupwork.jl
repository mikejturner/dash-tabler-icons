...
export dti_iconbrandupwork

"""
    dti_iconbrandupwork(;kwargs...)

An IconBrandUpwork component.
...
"""
function dti_iconbrandupwork(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandupwork", "IconBrandUpwork", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
