...
export dti_iconarrowautofitright

"""
    dti_iconarrowautofitright(;kwargs...)

An IconArrowAutofitRight component.
...
"""
function dti_iconarrowautofitright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitright", "IconArrowAutofitRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
