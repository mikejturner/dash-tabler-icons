...
export dti_iconbarrierblockoff

"""
    dti_iconbarrierblockoff(;kwargs...)

An IconBarrierBlockOff component.
...
"""
function dti_iconbarrierblockoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarrierblockoff", "IconBarrierBlockOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
