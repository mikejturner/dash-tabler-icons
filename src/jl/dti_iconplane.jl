...
export dti_iconplane

"""
    dti_iconplane(;kwargs...)

An IconPlane component.
...
"""
function dti_iconplane(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplane", "IconPlane", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
