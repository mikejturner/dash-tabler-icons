...
export dti_iconcircleplus

"""
    dti_iconcircleplus(;kwargs...)

An IconCirclePlus component.
...
"""
function dti_iconcircleplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleplus", "IconCirclePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
