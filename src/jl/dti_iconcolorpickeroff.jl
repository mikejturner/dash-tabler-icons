...
export dti_iconcolorpickeroff

"""
    dti_iconcolorpickeroff(;kwargs...)

An IconColorPickerOff component.
...
"""
function dti_iconcolorpickeroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolorpickeroff", "IconColorPickerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
