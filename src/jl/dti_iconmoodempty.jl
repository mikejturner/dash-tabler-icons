...
export dti_iconmoodempty

"""
    dti_iconmoodempty(;kwargs...)

An IconMoodEmpty component.
...
"""
function dti_iconmoodempty(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodempty", "IconMoodEmpty", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
