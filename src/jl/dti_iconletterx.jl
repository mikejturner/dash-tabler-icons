...
export dti_iconletterx

"""
    dti_iconletterx(;kwargs...)

An IconLetterX component.
...
"""
function dti_iconletterx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterx", "IconLetterX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
