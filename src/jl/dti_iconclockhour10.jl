...
export dti_iconclockhour10

"""
    dti_iconclockhour10(;kwargs...)

An IconClockHour10 component.
...
"""
function dti_iconclockhour10(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour10", "IconClockHour10", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
