...
export dti_iconalignboxlefttop

"""
    dti_iconalignboxlefttop(;kwargs...)

An IconAlignBoxLeftTop component.
...
"""
function dti_iconalignboxlefttop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxlefttop", "IconAlignBoxLeftTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
