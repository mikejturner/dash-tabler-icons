...
export dti_iconluggage

"""
    dti_iconluggage(;kwargs...)

An IconLuggage component.
...
"""
function dti_iconluggage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconluggage", "IconLuggage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
