...
export dti_icontableoptions

"""
    dti_icontableoptions(;kwargs...)

An IconTableOptions component.
...
"""
function dti_icontableoptions(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontableoptions", "IconTableOptions", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
