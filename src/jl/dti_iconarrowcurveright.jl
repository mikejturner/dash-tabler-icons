...
export dti_iconarrowcurveright

"""
    dti_iconarrowcurveright(;kwargs...)

An IconArrowCurveRight component.
...
"""
function dti_iconarrowcurveright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowcurveright", "IconArrowCurveRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
