...
export dti_iconletteri

"""
    dti_iconletteri(;kwargs...)

An IconLetterI component.
...
"""
function dti_iconletteri(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletteri", "IconLetterI", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
