...
export dti_iconmilkoff

"""
    dti_iconmilkoff(;kwargs...)

An IconMilkOff component.
...
"""
function dti_iconmilkoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmilkoff", "IconMilkOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
