...
export dti_icontoggleright

"""
    dti_icontoggleright(;kwargs...)

An IconToggleRight component.
...
"""
function dti_icontoggleright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoggleright", "IconToggleRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
