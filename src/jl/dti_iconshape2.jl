...
export dti_iconshape2

"""
    dti_iconshape2(;kwargs...)

An IconShape2 component.
...
"""
function dti_iconshape2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshape2", "IconShape2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
