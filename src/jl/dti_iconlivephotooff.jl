...
export dti_iconlivephotooff

"""
    dti_iconlivephotooff(;kwargs...)

An IconLivePhotoOff component.
...
"""
function dti_iconlivephotooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlivephotooff", "IconLivePhotoOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
