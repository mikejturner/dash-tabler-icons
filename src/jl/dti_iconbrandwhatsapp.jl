...
export dti_iconbrandwhatsapp

"""
    dti_iconbrandwhatsapp(;kwargs...)

An IconBrandWhatsapp component.
...
"""
function dti_iconbrandwhatsapp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwhatsapp", "IconBrandWhatsapp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
