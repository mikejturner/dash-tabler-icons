...
export dti_iconbarrierblock

"""
    dti_iconbarrierblock(;kwargs...)

An IconBarrierBlock component.
...
"""
function dti_iconbarrierblock(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarrierblock", "IconBarrierBlock", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
