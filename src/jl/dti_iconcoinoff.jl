...
export dti_iconcoinoff

"""
    dti_iconcoinoff(;kwargs...)

An IconCoinOff component.
...
"""
function dti_iconcoinoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinoff", "IconCoinOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
