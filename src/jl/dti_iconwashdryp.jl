...
export dti_iconwashdryp

"""
    dti_iconwashdryp(;kwargs...)

An IconWashDryP component.
...
"""
function dti_iconwashdryp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryp", "IconWashDryP", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
