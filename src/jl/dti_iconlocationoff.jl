...
export dti_iconlocationoff

"""
    dti_iconlocationoff(;kwargs...)

An IconLocationOff component.
...
"""
function dti_iconlocationoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlocationoff", "IconLocationOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
