...
export dti_iconoctagon

"""
    dti_iconoctagon(;kwargs...)

An IconOctagon component.
...
"""
function dti_iconoctagon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconoctagon", "IconOctagon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
