...
export dti_iconrefreshoff

"""
    dti_iconrefreshoff(;kwargs...)

An IconRefreshOff component.
...
"""
function dti_iconrefreshoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrefreshoff", "IconRefreshOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
