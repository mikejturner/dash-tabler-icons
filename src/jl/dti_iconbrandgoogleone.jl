...
export dti_iconbrandgoogleone

"""
    dti_iconbrandgoogleone(;kwargs...)

An IconBrandGoogleOne component.
...
"""
function dti_iconbrandgoogleone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgoogleone", "IconBrandGoogleOne", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
