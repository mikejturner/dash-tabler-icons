...
export dti_iconwashoff

"""
    dti_iconwashoff(;kwargs...)

An IconWashOff component.
...
"""
function dti_iconwashoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashoff", "IconWashOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
