...
export dti_icontimeline

"""
    dti_icontimeline(;kwargs...)

An IconTimeline component.
...
"""
function dti_icontimeline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontimeline", "IconTimeline", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
