...
export dti_iconlegooff

"""
    dti_iconlegooff(;kwargs...)

An IconLegoOff component.
...
"""
function dti_iconlegooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlegooff", "IconLegoOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
