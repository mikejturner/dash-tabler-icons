...
export dti_iconsquarex

"""
    dti_iconsquarex(;kwargs...)

An IconSquareX component.
...
"""
function dti_iconsquarex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarex", "IconSquareX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
