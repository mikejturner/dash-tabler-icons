...
export dti_icondevicespeakeroff

"""
    dti_icondevicespeakeroff(;kwargs...)

An IconDeviceSpeakerOff component.
...
"""
function dti_icondevicespeakeroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicespeakeroff", "IconDeviceSpeakerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
