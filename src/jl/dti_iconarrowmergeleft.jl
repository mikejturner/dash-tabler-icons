...
export dti_iconarrowmergeleft

"""
    dti_iconarrowmergeleft(;kwargs...)

An IconArrowMergeLeft component.
...
"""
function dti_iconarrowmergeleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmergeleft", "IconArrowMergeLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
