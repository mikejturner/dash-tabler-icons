...
export dti_iconbracketscontainstart

"""
    dti_iconbracketscontainstart(;kwargs...)

An IconBracketsContainStart component.
...
"""
function dti_iconbracketscontainstart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbracketscontainstart", "IconBracketsContainStart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
