...
export dti_iconpackgeexport

"""
    dti_iconpackgeexport(;kwargs...)

An IconPackgeExport component.
...
"""
function dti_iconpackgeexport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpackgeexport", "IconPackgeExport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
