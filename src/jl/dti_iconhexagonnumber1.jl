...
export dti_iconhexagonnumber1

"""
    dti_iconhexagonnumber1(;kwargs...)

An IconHexagonNumber1 component.
...
"""
function dti_iconhexagonnumber1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber1", "IconHexagonNumber1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
