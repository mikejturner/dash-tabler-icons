...
export dti_iconborderstyle2

"""
    dti_iconborderstyle2(;kwargs...)

An IconBorderStyle2 component.
...
"""
function dti_iconborderstyle2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderstyle2", "IconBorderStyle2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
