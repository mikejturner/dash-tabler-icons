...
export dti_iconmickey

"""
    dti_iconmickey(;kwargs...)

An IconMickey component.
...
"""
function dti_iconmickey(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmickey", "IconMickey", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
