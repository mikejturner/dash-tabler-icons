...
export dti_icontrendingdown2

"""
    dti_icontrendingdown2(;kwargs...)

An IconTrendingDown2 component.
...
"""
function dti_icontrendingdown2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrendingdown2", "IconTrendingDown2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
