...
export dti_iconchalkboardoff

"""
    dti_iconchalkboardoff(;kwargs...)

An IconChalkboardOff component.
...
"""
function dti_iconchalkboardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchalkboardoff", "IconChalkboardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
