...
export dti_iconarrowautofitcontent

"""
    dti_iconarrowautofitcontent(;kwargs...)

An IconArrowAutofitContent component.
...
"""
function dti_iconarrowautofitcontent(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitcontent", "IconArrowAutofitContent", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
