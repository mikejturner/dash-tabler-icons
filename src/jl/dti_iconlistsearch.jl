...
export dti_iconlistsearch

"""
    dti_iconlistsearch(;kwargs...)

An IconListSearch component.
...
"""
function dti_iconlistsearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlistsearch", "IconListSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
