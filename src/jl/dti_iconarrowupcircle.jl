...
export dti_iconarrowupcircle

"""
    dti_iconarrowupcircle(;kwargs...)

An IconArrowUpCircle component.
...
"""
function dti_iconarrowupcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowupcircle", "IconArrowUpCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
