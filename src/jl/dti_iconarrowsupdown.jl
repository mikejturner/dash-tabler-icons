...
export dti_iconarrowsupdown

"""
    dti_iconarrowsupdown(;kwargs...)

An IconArrowsUpDown component.
...
"""
function dti_iconarrowsupdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsupdown", "IconArrowsUpDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
