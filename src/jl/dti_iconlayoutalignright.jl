...
export dti_iconlayoutalignright

"""
    dti_iconlayoutalignright(;kwargs...)

An IconLayoutAlignRight component.
...
"""
function dti_iconlayoutalignright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutalignright", "IconLayoutAlignRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
