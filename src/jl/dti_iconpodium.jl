...
export dti_iconpodium

"""
    dti_iconpodium(;kwargs...)

An IconPodium component.
...
"""
function dti_iconpodium(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpodium", "IconPodium", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
