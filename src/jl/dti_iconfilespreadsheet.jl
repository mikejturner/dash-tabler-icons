...
export dti_iconfilespreadsheet

"""
    dti_iconfilespreadsheet(;kwargs...)

An IconFileSpreadsheet component.
...
"""
function dti_iconfilespreadsheet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilespreadsheet", "IconFileSpreadsheet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
