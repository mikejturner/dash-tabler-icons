...
export dti_iconhelmetoff

"""
    dti_iconhelmetoff(;kwargs...)

An IconHelmetOff component.
...
"""
function dti_iconhelmetoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhelmetoff", "IconHelmetOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
