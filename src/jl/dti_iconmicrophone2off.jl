...
export dti_iconmicrophone2off

"""
    dti_iconmicrophone2off(;kwargs...)

An IconMicrophone2Off component.
...
"""
function dti_iconmicrophone2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicrophone2off", "IconMicrophone2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
