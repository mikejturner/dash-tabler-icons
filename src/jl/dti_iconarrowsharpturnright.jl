...
export dti_iconarrowsharpturnright

"""
    dti_iconarrowsharpturnright(;kwargs...)

An IconArrowSharpTurnRight component.
...
"""
function dti_iconarrowsharpturnright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsharpturnright", "IconArrowSharpTurnRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
