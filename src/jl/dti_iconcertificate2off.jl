...
export dti_iconcertificate2off

"""
    dti_iconcertificate2off(;kwargs...)

An IconCertificate2Off component.
...
"""
function dti_iconcertificate2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcertificate2off", "IconCertificate2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
