...
export dti_iconcactus

"""
    dti_iconcactus(;kwargs...)

An IconCactus component.
...
"""
function dti_iconcactus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcactus", "IconCactus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
