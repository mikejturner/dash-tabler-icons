...
export dti_iconarrowleftcircle

"""
    dti_iconarrowleftcircle(;kwargs...)

An IconArrowLeftCircle component.
...
"""
function dti_iconarrowleftcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowleftcircle", "IconArrowLeftCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
