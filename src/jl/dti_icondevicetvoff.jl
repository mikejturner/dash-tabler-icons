...
export dti_icondevicetvoff

"""
    dti_icondevicetvoff(;kwargs...)

An IconDeviceTvOff component.
...
"""
function dti_icondevicetvoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicetvoff", "IconDeviceTvOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
