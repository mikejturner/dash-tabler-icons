...
export dti_iconwashdrycleanoff

"""
    dti_iconwashdrycleanoff(;kwargs...)

An IconWashDrycleanOff component.
...
"""
function dti_iconwashdrycleanoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdrycleanoff", "IconWashDrycleanOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
