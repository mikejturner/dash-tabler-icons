...
export dti_iconmagnetoff

"""
    dti_iconmagnetoff(;kwargs...)

An IconMagnetOff component.
...
"""
function dti_iconmagnetoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmagnetoff", "IconMagnetOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
