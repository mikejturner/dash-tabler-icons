...
export dti_iconmoodboy

"""
    dti_iconmoodboy(;kwargs...)

An IconMoodBoy component.
...
"""
function dti_iconmoodboy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodboy", "IconMoodBoy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
