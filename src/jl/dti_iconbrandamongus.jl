...
export dti_iconbrandamongus

"""
    dti_iconbrandamongus(;kwargs...)

An IconBrandAmongus component.
...
"""
function dti_iconbrandamongus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandamongus", "IconBrandAmongus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
