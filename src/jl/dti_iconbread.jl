...
export dti_iconbread

"""
    dti_iconbread(;kwargs...)

An IconBread component.
...
"""
function dti_iconbread(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbread", "IconBread", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
