...
export dti_iconclipboardoff

"""
    dti_iconclipboardoff(;kwargs...)

An IconClipboardOff component.
...
"""
function dti_iconclipboardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardoff", "IconClipboardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
