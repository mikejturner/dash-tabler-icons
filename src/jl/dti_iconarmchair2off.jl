...
export dti_iconarmchair2off

"""
    dti_iconarmchair2off(;kwargs...)

An IconArmchair2Off component.
...
"""
function dti_iconarmchair2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarmchair2off", "IconArmchair2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
