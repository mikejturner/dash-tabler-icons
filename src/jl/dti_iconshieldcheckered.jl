...
export dti_iconshieldcheckered

"""
    dti_iconshieldcheckered(;kwargs...)

An IconShieldCheckered component.
...
"""
function dti_iconshieldcheckered(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldcheckered", "IconShieldCheckered", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
