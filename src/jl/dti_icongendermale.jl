...
export dti_icongendermale

"""
    dti_icongendermale(;kwargs...)

An IconGenderMale component.
...
"""
function dti_icongendermale(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongendermale", "IconGenderMale", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
