...
export dti_iconzoomout

"""
    dti_iconzoomout(;kwargs...)

An IconZoomOut component.
...
"""
function dti_iconzoomout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomout", "IconZoomOut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
