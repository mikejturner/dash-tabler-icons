...
export dti_iconhandfinger

"""
    dti_iconhandfinger(;kwargs...)

An IconHandFinger component.
...
"""
function dti_iconhandfinger(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandfinger", "IconHandFinger", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
