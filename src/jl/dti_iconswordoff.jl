...
export dti_iconswordoff

"""
    dti_iconswordoff(;kwargs...)

An IconSwordOff component.
...
"""
function dti_iconswordoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswordoff", "IconSwordOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
