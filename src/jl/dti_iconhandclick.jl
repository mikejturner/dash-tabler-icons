...
export dti_iconhandclick

"""
    dti_iconhandclick(;kwargs...)

An IconHandClick component.
...
"""
function dti_iconhandclick(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandclick", "IconHandClick", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
