...
export dti_iconchartradar

"""
    dti_iconchartradar(;kwargs...)

An IconChartRadar component.
...
"""
function dti_iconchartradar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartradar", "IconChartRadar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
