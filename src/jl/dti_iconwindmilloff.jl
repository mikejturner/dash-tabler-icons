...
export dti_iconwindmilloff

"""
    dti_iconwindmilloff(;kwargs...)

An IconWindmillOff component.
...
"""
function dti_iconwindmilloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindmilloff", "IconWindmillOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
