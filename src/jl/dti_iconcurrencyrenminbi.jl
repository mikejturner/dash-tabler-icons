...
export dti_iconcurrencyrenminbi

"""
    dti_iconcurrencyrenminbi(;kwargs...)

An IconCurrencyRenminbi component.
...
"""
function dti_iconcurrencyrenminbi(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyrenminbi", "IconCurrencyRenminbi", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
