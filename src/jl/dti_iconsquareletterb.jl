...
export dti_iconsquareletterb

"""
    dti_iconsquareletterb(;kwargs...)

An IconSquareLetterB component.
...
"""
function dti_iconsquareletterb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterb", "IconSquareLetterB", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
