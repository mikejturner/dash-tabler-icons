...
export dti_iconbrandandroid

"""
    dti_iconbrandandroid(;kwargs...)

An IconBrandAndroid component.
...
"""
function dti_iconbrandandroid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandandroid", "IconBrandAndroid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
