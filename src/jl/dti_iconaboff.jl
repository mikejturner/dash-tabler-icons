...
export dti_iconaboff

"""
    dti_iconaboff(;kwargs...)

An IconABOff component.
...
"""
function dti_iconaboff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaboff", "IconABOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
