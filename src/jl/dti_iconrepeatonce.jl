...
export dti_iconrepeatonce

"""
    dti_iconrepeatonce(;kwargs...)

An IconRepeatOnce component.
...
"""
function dti_iconrepeatonce(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrepeatonce", "IconRepeatOnce", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
