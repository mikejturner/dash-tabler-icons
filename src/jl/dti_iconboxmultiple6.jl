...
export dti_iconboxmultiple6

"""
    dti_iconboxmultiple6(;kwargs...)

An IconBoxMultiple6 component.
...
"""
function dti_iconboxmultiple6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple6", "IconBoxMultiple6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
