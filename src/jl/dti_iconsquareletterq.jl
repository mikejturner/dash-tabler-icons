...
export dti_iconsquareletterq

"""
    dti_iconsquareletterq(;kwargs...)

An IconSquareLetterQ component.
...
"""
function dti_iconsquareletterq(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterq", "IconSquareLetterQ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
