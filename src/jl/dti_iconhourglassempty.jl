...
export dti_iconhourglassempty

"""
    dti_iconhourglassempty(;kwargs...)

An IconHourglassEmpty component.
...
"""
function dti_iconhourglassempty(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhourglassempty", "IconHourglassEmpty", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
