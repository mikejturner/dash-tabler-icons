...
export dti_iconfilesearch

"""
    dti_iconfilesearch(;kwargs...)

An IconFileSearch component.
...
"""
function dti_iconfilesearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilesearch", "IconFileSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
