...
export dti_iconcreativecommonssa

"""
    dti_iconcreativecommonssa(;kwargs...)

An IconCreativeCommonsSa component.
...
"""
function dti_iconcreativecommonssa(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommonssa", "IconCreativeCommonsSa", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
