...
export dti_icondroneoff

"""
    dti_icondroneoff(;kwargs...)

An IconDroneOff component.
...
"""
function dti_icondroneoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondroneoff", "IconDroneOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
