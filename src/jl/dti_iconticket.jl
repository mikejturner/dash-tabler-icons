...
export dti_iconticket

"""
    dti_iconticket(;kwargs...)

An IconTicket component.
...
"""
function dti_iconticket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconticket", "IconTicket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
