...
export dti_iconbookmarksoff

"""
    dti_iconbookmarksoff(;kwargs...)

An IconBookmarksOff component.
...
"""
function dti_iconbookmarksoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbookmarksoff", "IconBookmarksOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
