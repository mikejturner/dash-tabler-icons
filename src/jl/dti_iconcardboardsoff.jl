...
export dti_iconcardboardsoff

"""
    dti_iconcardboardsoff(;kwargs...)

An IconCardboardsOff component.
...
"""
function dti_iconcardboardsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcardboardsoff", "IconCardboardsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
