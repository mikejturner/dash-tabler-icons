...
export dti_iconsquareletterc

"""
    dti_iconsquareletterc(;kwargs...)

An IconSquareLetterC component.
...
"""
function dti_iconsquareletterc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterc", "IconSquareLetterC", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
