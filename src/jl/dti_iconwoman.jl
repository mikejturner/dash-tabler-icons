...
export dti_iconwoman

"""
    dti_iconwoman(;kwargs...)

An IconWoman component.
...
"""
function dti_iconwoman(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwoman", "IconWoman", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
