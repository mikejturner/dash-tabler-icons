...
export dti_iconcaretdown

"""
    dti_iconcaretdown(;kwargs...)

An IconCaretDown component.
...
"""
function dti_iconcaretdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaretdown", "IconCaretDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
