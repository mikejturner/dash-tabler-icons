...
export dti_iconcellsignaloff

"""
    dti_iconcellsignaloff(;kwargs...)

An IconCellSignalOff component.
...
"""
function dti_iconcellsignaloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcellsignaloff", "IconCellSignalOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
