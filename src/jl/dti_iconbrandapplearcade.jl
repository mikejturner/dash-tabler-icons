...
export dti_iconbrandapplearcade

"""
    dti_iconbrandapplearcade(;kwargs...)

An IconBrandAppleArcade component.
...
"""
function dti_iconbrandapplearcade(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandapplearcade", "IconBrandAppleArcade", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
