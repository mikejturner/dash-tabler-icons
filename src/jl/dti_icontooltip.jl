...
export dti_icontooltip

"""
    dti_icontooltip(;kwargs...)

An IconTooltip component.
...
"""
function dti_icontooltip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontooltip", "IconTooltip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
