...
export dti_iconfunction

"""
    dti_iconfunction(;kwargs...)

An IconFunction component.
...
"""
function dti_iconfunction(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfunction", "IconFunction", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
