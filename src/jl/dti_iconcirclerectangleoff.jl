...
export dti_iconcirclerectangleoff

"""
    dti_iconcirclerectangleoff(;kwargs...)

An IconCircleRectangleOff component.
...
"""
function dti_iconcirclerectangleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclerectangleoff", "IconCircleRectangleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
