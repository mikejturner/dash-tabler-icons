...
export dti_iconcards

"""
    dti_iconcards(;kwargs...)

An IconCards component.
...
"""
function dti_iconcards(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcards", "IconCards", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
