...
export dti_iconsquarerotatedforbid2

"""
    dti_iconsquarerotatedforbid2(;kwargs...)

An IconSquareRotatedForbid2 component.
...
"""
function dti_iconsquarerotatedforbid2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarerotatedforbid2", "IconSquareRotatedForbid2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
