...
export dti_iconpooloff

"""
    dti_iconpooloff(;kwargs...)

An IconPoolOff component.
...
"""
function dti_iconpooloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpooloff", "IconPoolOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
