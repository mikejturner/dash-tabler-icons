...
export dti_icongendertransgender

"""
    dti_icongendertransgender(;kwargs...)

An IconGenderTransgender component.
...
"""
function dti_icongendertransgender(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongendertransgender", "IconGenderTransgender", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
