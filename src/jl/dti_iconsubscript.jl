...
export dti_iconsubscript

"""
    dti_iconsubscript(;kwargs...)

An IconSubscript component.
...
"""
function dti_iconsubscript(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsubscript", "IconSubscript", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
