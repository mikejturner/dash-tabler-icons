...
export dti_icondroplethalf2

"""
    dti_icondroplethalf2(;kwargs...)

An IconDropletHalf2 component.
...
"""
function dti_icondroplethalf2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondroplethalf2", "IconDropletHalf2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
