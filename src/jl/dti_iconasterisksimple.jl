...
export dti_iconasterisksimple

"""
    dti_iconasterisksimple(;kwargs...)

An IconAsteriskSimple component.
...
"""
function dti_iconasterisksimple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconasterisksimple", "IconAsteriskSimple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
