...
export dti_icondiamonds

"""
    dti_icondiamonds(;kwargs...)

An IconDiamonds component.
...
"""
function dti_icondiamonds(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiamonds", "IconDiamonds", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
