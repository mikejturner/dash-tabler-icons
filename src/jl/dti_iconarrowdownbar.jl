...
export dti_iconarrowdownbar

"""
    dti_iconarrowdownbar(;kwargs...)

An IconArrowDownBar component.
...
"""
function dti_iconarrowdownbar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdownbar", "IconArrowDownBar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
