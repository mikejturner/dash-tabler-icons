...
export dti_iconbluroff

"""
    dti_iconbluroff(;kwargs...)

An IconBlurOff component.
...
"""
function dti_iconbluroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbluroff", "IconBlurOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
