...
export dti_iconbrandtelegram

"""
    dti_iconbrandtelegram(;kwargs...)

An IconBrandTelegram component.
...
"""
function dti_iconbrandtelegram(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtelegram", "IconBrandTelegram", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
