...
export dti_iconfilesignal

"""
    dti_iconfilesignal(;kwargs...)

An IconFileSignal component.
...
"""
function dti_iconfilesignal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilesignal", "IconFileSignal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
