...
export dti_iconexternallinkoff

"""
    dti_iconexternallinkoff(;kwargs...)

An IconExternalLinkOff component.
...
"""
function dti_iconexternallinkoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexternallinkoff", "IconExternalLinkOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
