...
export dti_iconclockoff

"""
    dti_iconclockoff(;kwargs...)

An IconClockOff component.
...
"""
function dti_iconclockoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockoff", "IconClockOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
