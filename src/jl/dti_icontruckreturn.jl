...
export dti_icontruckreturn

"""
    dti_icontruckreturn(;kwargs...)

An IconTruckReturn component.
...
"""
function dti_icontruckreturn(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontruckreturn", "IconTruckReturn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
