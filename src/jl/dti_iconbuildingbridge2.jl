...
export dti_iconbuildingbridge2

"""
    dti_iconbuildingbridge2(;kwargs...)

An IconBuildingBridge2 component.
...
"""
function dti_iconbuildingbridge2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingbridge2", "IconBuildingBridge2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
