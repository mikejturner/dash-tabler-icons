...
export dti_iconhandmove

"""
    dti_iconhandmove(;kwargs...)

An IconHandMove component.
...
"""
function dti_iconhandmove(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandmove", "IconHandMove", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
