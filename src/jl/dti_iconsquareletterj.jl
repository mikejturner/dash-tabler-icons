...
export dti_iconsquareletterj

"""
    dti_iconsquareletterj(;kwargs...)

An IconSquareLetterJ component.
...
"""
function dti_iconsquareletterj(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterj", "IconSquareLetterJ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
