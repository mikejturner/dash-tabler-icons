...
export dti_iconluggageoff

"""
    dti_iconluggageoff(;kwargs...)

An IconLuggageOff component.
...
"""
function dti_iconluggageoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconluggageoff", "IconLuggageOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
