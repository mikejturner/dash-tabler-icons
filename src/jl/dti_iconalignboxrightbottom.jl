...
export dti_iconalignboxrightbottom

"""
    dti_iconalignboxrightbottom(;kwargs...)

An IconAlignBoxRightBottom component.
...
"""
function dti_iconalignboxrightbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxrightbottom", "IconAlignBoxRightBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
