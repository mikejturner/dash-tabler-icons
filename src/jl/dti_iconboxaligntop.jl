...
export dti_iconboxaligntop

"""
    dti_iconboxaligntop(;kwargs...)

An IconBoxAlignTop component.
...
"""
function dti_iconboxaligntop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxaligntop", "IconBoxAlignTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
