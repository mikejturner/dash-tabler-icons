...
export dti_icondeviceheartmonitor

"""
    dti_icondeviceheartmonitor(;kwargs...)

An IconDeviceHeartMonitor component.
...
"""
function dti_icondeviceheartmonitor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondeviceheartmonitor", "IconDeviceHeartMonitor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
