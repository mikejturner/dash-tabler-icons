...
export dti_iconarrowsupleft

"""
    dti_iconarrowsupleft(;kwargs...)

An IconArrowsUpLeft component.
...
"""
function dti_iconarrowsupleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsupleft", "IconArrowsUpLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
