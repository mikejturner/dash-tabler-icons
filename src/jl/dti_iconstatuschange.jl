...
export dti_iconstatuschange

"""
    dti_iconstatuschange(;kwargs...)

An IconStatusChange component.
...
"""
function dti_iconstatuschange(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstatuschange", "IconStatusChange", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
