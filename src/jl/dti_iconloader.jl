...
export dti_iconloader

"""
    dti_iconloader(;kwargs...)

An IconLoader component.
...
"""
function dti_iconloader(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconloader", "IconLoader", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
