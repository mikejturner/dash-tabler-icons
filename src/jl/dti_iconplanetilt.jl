...
export dti_iconplanetilt

"""
    dti_iconplanetilt(;kwargs...)

An IconPlaneTilt component.
...
"""
function dti_iconplanetilt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplanetilt", "IconPlaneTilt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
