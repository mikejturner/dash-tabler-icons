...
export dti_iconbrandmedium

"""
    dti_iconbrandmedium(;kwargs...)

An IconBrandMedium component.
...
"""
function dti_iconbrandmedium(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmedium", "IconBrandMedium", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
