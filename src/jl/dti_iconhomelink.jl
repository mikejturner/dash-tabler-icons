...
export dti_iconhomelink

"""
    dti_iconhomelink(;kwargs...)

An IconHomeLink component.
...
"""
function dti_iconhomelink(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomelink", "IconHomeLink", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
