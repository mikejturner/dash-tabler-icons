...
export dti_iconarrowup

"""
    dti_iconarrowup(;kwargs...)

An IconArrowUp component.
...
"""
function dti_iconarrowup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowup", "IconArrowUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
