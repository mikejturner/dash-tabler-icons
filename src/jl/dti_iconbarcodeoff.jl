...
export dti_iconbarcodeoff

"""
    dti_iconbarcodeoff(;kwargs...)

An IconBarcodeOff component.
...
"""
function dti_iconbarcodeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarcodeoff", "IconBarcodeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
