...
export dti_iconwallpaper

"""
    dti_iconwallpaper(;kwargs...)

An IconWallpaper component.
...
"""
function dti_iconwallpaper(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwallpaper", "IconWallpaper", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
