...
export dti_iconusercheck

"""
    dti_iconusercheck(;kwargs...)

An IconUserCheck component.
...
"""
function dti_iconusercheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconusercheck", "IconUserCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
