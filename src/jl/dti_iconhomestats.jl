...
export dti_iconhomestats

"""
    dti_iconhomestats(;kwargs...)

An IconHomeStats component.
...
"""
function dti_iconhomestats(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomestats", "IconHomeStats", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
