...
export dti_iconphoto

"""
    dti_iconphoto(;kwargs...)

An IconPhoto component.
...
"""
function dti_iconphoto(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphoto", "IconPhoto", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
