...
export dti_iconradioactive

"""
    dti_iconradioactive(;kwargs...)

An IconRadioactive component.
...
"""
function dti_iconradioactive(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradioactive", "IconRadioactive", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
