...
export dti_iconbrackets

"""
    dti_iconbrackets(;kwargs...)

An IconBrackets component.
...
"""
function dti_iconbrackets(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrackets", "IconBrackets", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
