...
export dti_iconeyeglassoff

"""
    dti_iconeyeglassoff(;kwargs...)

An IconEyeglassOff component.
...
"""
function dti_iconeyeglassoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeyeglassoff", "IconEyeglassOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
