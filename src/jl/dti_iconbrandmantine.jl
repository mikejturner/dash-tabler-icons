...
export dti_iconbrandmantine

"""
    dti_iconbrandmantine(;kwargs...)

An IconBrandMantine component.
...
"""
function dti_iconbrandmantine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmantine", "IconBrandMantine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
