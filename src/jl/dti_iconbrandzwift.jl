...
export dti_iconbrandzwift

"""
    dti_iconbrandzwift(;kwargs...)

An IconBrandZwift component.
...
"""
function dti_iconbrandzwift(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandzwift", "IconBrandZwift", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
