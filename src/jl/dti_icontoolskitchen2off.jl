...
export dti_icontoolskitchen2off

"""
    dti_icontoolskitchen2off(;kwargs...)

An IconToolsKitchen2Off component.
...
"""
function dti_icontoolskitchen2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoolskitchen2off", "IconToolsKitchen2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
