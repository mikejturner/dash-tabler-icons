...
export dti_icontextdecrease

"""
    dti_icontextdecrease(;kwargs...)

An IconTextDecrease component.
...
"""
function dti_icontextdecrease(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextdecrease", "IconTextDecrease", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
