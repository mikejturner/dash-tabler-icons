...
export dti_iconcarrotoff

"""
    dti_iconcarrotoff(;kwargs...)

An IconCarrotOff component.
...
"""
function dti_iconcarrotoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcarrotoff", "IconCarrotOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
