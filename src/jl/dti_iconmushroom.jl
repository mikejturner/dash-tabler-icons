...
export dti_iconmushroom

"""
    dti_iconmushroom(;kwargs...)

An IconMushroom component.
...
"""
function dti_iconmushroom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmushroom", "IconMushroom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
