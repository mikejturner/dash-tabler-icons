...
export dti_iconvectorspline

"""
    dti_iconvectorspline(;kwargs...)

An IconVectorSpline component.
...
"""
function dti_iconvectorspline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectorspline", "IconVectorSpline", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
