...
export dti_iconchartcandle

"""
    dti_iconchartcandle(;kwargs...)

An IconChartCandle component.
...
"""
function dti_iconchartcandle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartcandle", "IconChartCandle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
