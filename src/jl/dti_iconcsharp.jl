...
export dti_iconcsharp

"""
    dti_iconcsharp(;kwargs...)

An IconCSharp component.
...
"""
function dti_iconcsharp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcsharp", "IconCSharp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
