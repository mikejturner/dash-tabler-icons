...
export dti_iconnetworkoff

"""
    dti_iconnetworkoff(;kwargs...)

An IconNetworkOff component.
...
"""
function dti_iconnetworkoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnetworkoff", "IconNetworkOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
