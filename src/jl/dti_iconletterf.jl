...
export dti_iconletterf

"""
    dti_iconletterf(;kwargs...)

An IconLetterF component.
...
"""
function dti_iconletterf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterf", "IconLetterF", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
