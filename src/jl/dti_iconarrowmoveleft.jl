...
export dti_iconarrowmoveleft

"""
    dti_iconarrowmoveleft(;kwargs...)

An IconArrowMoveLeft component.
...
"""
function dti_iconarrowmoveleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmoveleft", "IconArrowMoveLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
