...
export dti_icontoiletpaperoff

"""
    dti_icontoiletpaperoff(;kwargs...)

An IconToiletPaperOff component.
...
"""
function dti_icontoiletpaperoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoiletpaperoff", "IconToiletPaperOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
