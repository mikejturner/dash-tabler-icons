...
export dti_iconarrowdown

"""
    dti_iconarrowdown(;kwargs...)

An IconArrowDown component.
...
"""
function dti_iconarrowdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdown", "IconArrowDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
