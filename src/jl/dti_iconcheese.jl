...
export dti_iconcheese

"""
    dti_iconcheese(;kwargs...)

An IconCheese component.
...
"""
function dti_iconcheese(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcheese", "IconCheese", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
