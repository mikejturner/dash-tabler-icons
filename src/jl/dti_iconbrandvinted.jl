...
export dti_iconbrandvinted

"""
    dti_iconbrandvinted(;kwargs...)

An IconBrandVinted component.
...
"""
function dti_iconbrandvinted(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvinted", "IconBrandVinted", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
