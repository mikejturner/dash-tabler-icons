...
export dti_iconbrandbackbone

"""
    dti_iconbrandbackbone(;kwargs...)

An IconBrandBackbone component.
...
"""
function dti_iconbrandbackbone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbackbone", "IconBrandBackbone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
