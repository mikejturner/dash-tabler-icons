...
export dti_iconaxisy

"""
    dti_iconaxisy(;kwargs...)

An IconAxisY component.
...
"""
function dti_iconaxisy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaxisy", "IconAxisY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
