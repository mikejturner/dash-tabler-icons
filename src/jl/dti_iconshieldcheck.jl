...
export dti_iconshieldcheck

"""
    dti_iconshieldcheck(;kwargs...)

An IconShieldCheck component.
...
"""
function dti_iconshieldcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldcheck", "IconShieldCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
