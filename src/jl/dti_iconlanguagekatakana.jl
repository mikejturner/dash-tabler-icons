...
export dti_iconlanguagekatakana

"""
    dti_iconlanguagekatakana(;kwargs...)

An IconLanguageKatakana component.
...
"""
function dti_iconlanguagekatakana(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlanguagekatakana", "IconLanguageKatakana", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
