...
export dti_iconhandoff

"""
    dti_iconhandoff(;kwargs...)

An IconHandOff component.
...
"""
function dti_iconhandoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandoff", "IconHandOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
