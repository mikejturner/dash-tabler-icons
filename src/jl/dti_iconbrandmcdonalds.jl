...
export dti_iconbrandmcdonalds

"""
    dti_iconbrandmcdonalds(;kwargs...)

An IconBrandMcdonalds component.
...
"""
function dti_iconbrandmcdonalds(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmcdonalds", "IconBrandMcdonalds", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
