...
export dti_iconhandthreefingers

"""
    dti_iconhandthreefingers(;kwargs...)

An IconHandThreeFingers component.
...
"""
function dti_iconhandthreefingers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandthreefingers", "IconHandThreeFingers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
