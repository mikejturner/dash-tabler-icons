...
export dti_iconbrandtripadvisor

"""
    dti_iconbrandtripadvisor(;kwargs...)

An IconBrandTripadvisor component.
...
"""
function dti_iconbrandtripadvisor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtripadvisor", "IconBrandTripadvisor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
