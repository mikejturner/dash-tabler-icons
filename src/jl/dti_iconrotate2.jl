...
export dti_iconrotate2

"""
    dti_iconrotate2(;kwargs...)

An IconRotate2 component.
...
"""
function dti_iconrotate2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrotate2", "IconRotate2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
