...
export dti_icongrowth

"""
    dti_icongrowth(;kwargs...)

An IconGrowth component.
...
"""
function dti_icongrowth(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrowth", "IconGrowth", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
