...
export dti_iconarticleoff

"""
    dti_iconarticleoff(;kwargs...)

An IconArticleOff component.
...
"""
function dti_iconarticleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarticleoff", "IconArticleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
