...
export dti_iconstairsdown

"""
    dti_iconstairsdown(;kwargs...)

An IconStairsDown component.
...
"""
function dti_iconstairsdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstairsdown", "IconStairsDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
