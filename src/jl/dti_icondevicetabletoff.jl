...
export dti_icondevicetabletoff

"""
    dti_icondevicetabletoff(;kwargs...)

An IconDeviceTabletOff component.
...
"""
function dti_icondevicetabletoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicetabletoff", "IconDeviceTabletOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
