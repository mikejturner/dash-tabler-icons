...
export dti_iconarrowsexchange

"""
    dti_iconarrowsexchange(;kwargs...)

An IconArrowsExchange component.
...
"""
function dti_iconarrowsexchange(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsexchange", "IconArrowsExchange", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
