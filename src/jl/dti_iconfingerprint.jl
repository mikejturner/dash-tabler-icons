...
export dti_iconfingerprint

"""
    dti_iconfingerprint(;kwargs...)

An IconFingerprint component.
...
"""
function dti_iconfingerprint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfingerprint", "IconFingerprint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
