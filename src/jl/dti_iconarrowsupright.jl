...
export dti_iconarrowsupright

"""
    dti_iconarrowsupright(;kwargs...)

An IconArrowsUpRight component.
...
"""
function dti_iconarrowsupright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsupright", "IconArrowsUpRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
