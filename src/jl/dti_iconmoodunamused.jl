...
export dti_iconmoodunamused

"""
    dti_iconmoodunamused(;kwargs...)

An IconMoodUnamused component.
...
"""
function dti_iconmoodunamused(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodunamused", "IconMoodUnamused", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
