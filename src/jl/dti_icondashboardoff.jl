...
export dti_icondashboardoff

"""
    dti_icondashboardoff(;kwargs...)

An IconDashboardOff component.
...
"""
function dti_icondashboardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondashboardoff", "IconDashboardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
