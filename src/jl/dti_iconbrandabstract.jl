...
export dti_iconbrandabstract

"""
    dti_iconbrandabstract(;kwargs...)

An IconBrandAbstract component.
...
"""
function dti_iconbrandabstract(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandabstract", "IconBrandAbstract", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
