...
export dti_iconsquareforbid2

"""
    dti_iconsquareforbid2(;kwargs...)

An IconSquareForbid2 component.
...
"""
function dti_iconsquareforbid2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareforbid2", "IconSquareForbid2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
