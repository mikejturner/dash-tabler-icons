...
export dti_iconbrandsuperhuman

"""
    dti_iconbrandsuperhuman(;kwargs...)

An IconBrandSuperhuman component.
...
"""
function dti_iconbrandsuperhuman(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsuperhuman", "IconBrandSuperhuman", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
