...
export dti_iconclouddownload

"""
    dti_iconclouddownload(;kwargs...)

An IconCloudDownload component.
...
"""
function dti_iconclouddownload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclouddownload", "IconCloudDownload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
