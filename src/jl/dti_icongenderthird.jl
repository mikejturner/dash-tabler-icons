...
export dti_icongenderthird

"""
    dti_icongenderthird(;kwargs...)

An IconGenderThird component.
...
"""
function dti_icongenderthird(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderthird", "IconGenderThird", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
