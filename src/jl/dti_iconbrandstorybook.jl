...
export dti_iconbrandstorybook

"""
    dti_iconbrandstorybook(;kwargs...)

An IconBrandStorybook component.
...
"""
function dti_iconbrandstorybook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandstorybook", "IconBrandStorybook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
