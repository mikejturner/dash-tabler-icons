...
export dti_iconarrowlefttail

"""
    dti_iconarrowlefttail(;kwargs...)

An IconArrowLeftTail component.
...
"""
function dti_iconarrowlefttail(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowlefttail", "IconArrowLeftTail", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
