...
export dti_iconcircuitmotor

"""
    dti_iconcircuitmotor(;kwargs...)

An IconCircuitMotor component.
...
"""
function dti_iconcircuitmotor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitmotor", "IconCircuitMotor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
