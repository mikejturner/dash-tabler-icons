...
export dti_iconbuilding

"""
    dti_iconbuilding(;kwargs...)

An IconBuilding component.
...
"""
function dti_iconbuilding(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuilding", "IconBuilding", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
