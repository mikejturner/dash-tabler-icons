...
export dti_iconchartdots

"""
    dti_iconchartdots(;kwargs...)

An IconChartDots component.
...
"""
function dti_iconchartdots(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdots", "IconChartDots", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
