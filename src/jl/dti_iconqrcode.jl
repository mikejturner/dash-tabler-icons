...
export dti_iconqrcode

"""
    dti_iconqrcode(;kwargs...)

An IconQrcode component.
...
"""
function dti_iconqrcode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconqrcode", "IconQrcode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
