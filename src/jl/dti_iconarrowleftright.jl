...
export dti_iconarrowleftright

"""
    dti_iconarrowleftright(;kwargs...)

An IconArrowLeftRight component.
...
"""
function dti_iconarrowleftright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowleftright", "IconArrowLeftRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
