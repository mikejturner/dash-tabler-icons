...
export dti_iconarrowupleft

"""
    dti_iconarrowupleft(;kwargs...)

An IconArrowUpLeft component.
...
"""
function dti_iconarrowupleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowupleft", "IconArrowUpLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
