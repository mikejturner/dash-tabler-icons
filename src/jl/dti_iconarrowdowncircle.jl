...
export dti_iconarrowdowncircle

"""
    dti_iconarrowdowncircle(;kwargs...)

An IconArrowDownCircle component.
...
"""
function dti_iconarrowdowncircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdowncircle", "IconArrowDownCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
