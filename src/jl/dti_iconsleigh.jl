...
export dti_iconsleigh

"""
    dti_iconsleigh(;kwargs...)

An IconSleigh component.
...
"""
function dti_iconsleigh(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsleigh", "IconSleigh", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
