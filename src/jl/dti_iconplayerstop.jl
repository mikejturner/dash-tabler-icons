...
export dti_iconplayerstop

"""
    dti_iconplayerstop(;kwargs...)

An IconPlayerStop component.
...
"""
function dti_iconplayerstop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayerstop", "IconPlayerStop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
