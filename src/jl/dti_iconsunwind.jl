...
export dti_iconsunwind

"""
    dti_iconsunwind(;kwargs...)

An IconSunWind component.
...
"""
function dti_iconsunwind(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunwind", "IconSunWind", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
