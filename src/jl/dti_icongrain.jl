...
export dti_icongrain

"""
    dti_icongrain(;kwargs...)

An IconGrain component.
...
"""
function dti_icongrain(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrain", "IconGrain", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
