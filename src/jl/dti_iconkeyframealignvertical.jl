...
export dti_iconkeyframealignvertical

"""
    dti_iconkeyframealignvertical(;kwargs...)

An IconKeyframeAlignVertical component.
...
"""
function dti_iconkeyframealignvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyframealignvertical", "IconKeyframeAlignVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
