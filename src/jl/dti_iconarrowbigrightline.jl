...
export dti_iconarrowbigrightline

"""
    dti_iconarrowbigrightline(;kwargs...)

An IconArrowBigRightLine component.
...
"""
function dti_iconarrowbigrightline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigrightline", "IconArrowBigRightLine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
