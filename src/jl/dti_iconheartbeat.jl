...
export dti_iconheartbeat

"""
    dti_iconheartbeat(;kwargs...)

An IconHeartbeat component.
...
"""
function dti_iconheartbeat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartbeat", "IconHeartbeat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
