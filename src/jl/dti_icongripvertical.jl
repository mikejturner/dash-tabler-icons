...
export dti_icongripvertical

"""
    dti_icongripvertical(;kwargs...)

An IconGripVertical component.
...
"""
function dti_icongripvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongripvertical", "IconGripVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
