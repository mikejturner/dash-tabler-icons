...
export dti_iconparenthesesoff

"""
    dti_iconparenthesesoff(;kwargs...)

An IconParenthesesOff component.
...
"""
function dti_iconparenthesesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconparenthesesoff", "IconParenthesesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
