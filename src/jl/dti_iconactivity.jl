...
export dti_iconactivity

"""
    dti_iconactivity(;kwargs...)

An IconActivity component.
...
"""
function dti_iconactivity(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconactivity", "IconActivity", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
