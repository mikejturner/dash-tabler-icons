...
export dti_iconcursortext

"""
    dti_iconcursortext(;kwargs...)

An IconCursorText component.
...
"""
function dti_iconcursortext(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcursortext", "IconCursorText", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
