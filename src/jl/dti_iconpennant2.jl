...
export dti_iconpennant2

"""
    dti_iconpennant2(;kwargs...)

An IconPennant2 component.
...
"""
function dti_iconpennant2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpennant2", "IconPennant2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
