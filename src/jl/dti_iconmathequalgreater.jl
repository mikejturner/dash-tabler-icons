...
export dti_iconmathequalgreater

"""
    dti_iconmathequalgreater(;kwargs...)

An IconMathEqualGreater component.
...
"""
function dti_iconmathequalgreater(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathequalgreater", "IconMathEqualGreater", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
