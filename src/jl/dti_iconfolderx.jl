...
export dti_iconfolderx

"""
    dti_iconfolderx(;kwargs...)

An IconFolderX component.
...
"""
function dti_iconfolderx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolderx", "IconFolderX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
