...
export dti_iconnumber8

"""
    dti_iconnumber8(;kwargs...)

An IconNumber8 component.
...
"""
function dti_iconnumber8(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber8", "IconNumber8", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
