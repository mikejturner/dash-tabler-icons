...
export dti_iconbrandskype

"""
    dti_iconbrandskype(;kwargs...)

An IconBrandSkype component.
...
"""
function dti_iconbrandskype(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandskype", "IconBrandSkype", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
