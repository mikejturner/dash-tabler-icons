...
export dti_iconparentheses

"""
    dti_iconparentheses(;kwargs...)

An IconParentheses component.
...
"""
function dti_iconparentheses(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconparentheses", "IconParentheses", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
