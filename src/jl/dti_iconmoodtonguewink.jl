...
export dti_iconmoodtonguewink

"""
    dti_iconmoodtonguewink(;kwargs...)

An IconMoodTongueWink component.
...
"""
function dti_iconmoodtonguewink(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodtonguewink", "IconMoodTongueWink", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
