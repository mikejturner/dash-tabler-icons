...
export dti_iconlambda

"""
    dti_iconlambda(;kwargs...)

An IconLambda component.
...
"""
function dti_iconlambda(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlambda", "IconLambda", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
