...
export dti_iconarrowssplit2

"""
    dti_iconarrowssplit2(;kwargs...)

An IconArrowsSplit2 component.
...
"""
function dti_iconarrowssplit2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowssplit2", "IconArrowsSplit2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
