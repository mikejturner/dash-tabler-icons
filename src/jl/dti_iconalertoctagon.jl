...
export dti_iconalertoctagon

"""
    dti_iconalertoctagon(;kwargs...)

An IconAlertOctagon component.
...
"""
function dti_iconalertoctagon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalertoctagon", "IconAlertOctagon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
