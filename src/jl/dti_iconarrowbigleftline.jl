...
export dti_iconarrowbigleftline

"""
    dti_iconarrowbigleftline(;kwargs...)

An IconArrowBigLeftLine component.
...
"""
function dti_iconarrowbigleftline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigleftline", "IconArrowBigLeftLine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
