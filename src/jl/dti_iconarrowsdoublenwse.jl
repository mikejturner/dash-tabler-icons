...
export dti_iconarrowsdoublenwse

"""
    dti_iconarrowsdoublenwse(;kwargs...)

An IconArrowsDoubleNwSe component.
...
"""
function dti_iconarrowsdoublenwse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdoublenwse", "IconArrowsDoubleNwSe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
