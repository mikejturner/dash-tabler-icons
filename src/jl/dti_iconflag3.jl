...
export dti_iconflag3

"""
    dti_iconflag3(;kwargs...)

An IconFlag3 component.
...
"""
function dti_iconflag3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflag3", "IconFlag3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
