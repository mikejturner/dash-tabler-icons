...
export dti_icondivide

"""
    dti_icondivide(;kwargs...)

An IconDivide component.
...
"""
function dti_icondivide(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondivide", "IconDivide", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
