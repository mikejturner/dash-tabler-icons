...
export dti_iconsoupoff

"""
    dti_iconsoupoff(;kwargs...)

An IconSoupOff component.
...
"""
function dti_iconsoupoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsoupoff", "IconSoupOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
