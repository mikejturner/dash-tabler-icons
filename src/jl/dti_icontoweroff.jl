...
export dti_icontoweroff

"""
    dti_icontoweroff(;kwargs...)

An IconTowerOff component.
...
"""
function dti_icontoweroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoweroff", "IconTowerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
