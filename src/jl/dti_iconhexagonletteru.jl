...
export dti_iconhexagonletteru

"""
    dti_iconhexagonletteru(;kwargs...)

An IconHexagonLetterU component.
...
"""
function dti_iconhexagonletteru(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletteru", "IconHexagonLetterU", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
