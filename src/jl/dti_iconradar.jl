...
export dti_iconradar

"""
    dti_iconradar(;kwargs...)

An IconRadar component.
...
"""
function dti_iconradar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradar", "IconRadar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
