...
export dti_iconlayout

"""
    dti_iconlayout(;kwargs...)

An IconLayout component.
...
"""
function dti_iconlayout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayout", "IconLayout", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
