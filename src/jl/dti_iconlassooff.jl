...
export dti_iconlassooff

"""
    dti_iconlassooff(;kwargs...)

An IconLassoOff component.
...
"""
function dti_iconlassooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlassooff", "IconLassoOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
