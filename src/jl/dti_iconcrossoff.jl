...
export dti_iconcrossoff

"""
    dti_iconcrossoff(;kwargs...)

An IconCrossOff component.
...
"""
function dti_iconcrossoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrossoff", "IconCrossOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
