...
export dti_iconblade

"""
    dti_iconblade(;kwargs...)

An IconBlade component.
...
"""
function dti_iconblade(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconblade", "IconBlade", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
