...
export dti_iconmathgreater

"""
    dti_iconmathgreater(;kwargs...)

An IconMathGreater component.
...
"""
function dti_iconmathgreater(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathgreater", "IconMathGreater", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
