...
export dti_iconeyetable

"""
    dti_iconeyetable(;kwargs...)

An IconEyeTable component.
...
"""
function dti_iconeyetable(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeyetable", "IconEyeTable", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
