...
export dti_iconexposureminus2

"""
    dti_iconexposureminus2(;kwargs...)

An IconExposureMinus2 component.
...
"""
function dti_iconexposureminus2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposureminus2", "IconExposureMinus2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
