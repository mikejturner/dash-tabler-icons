...
export dti_iconbrandflutter

"""
    dti_iconbrandflutter(;kwargs...)

An IconBrandFlutter component.
...
"""
function dti_iconbrandflutter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandflutter", "IconBrandFlutter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
