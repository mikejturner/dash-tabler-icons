...
export dti_iconmicroscope

"""
    dti_iconmicroscope(;kwargs...)

An IconMicroscope component.
...
"""
function dti_iconmicroscope(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicroscope", "IconMicroscope", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
