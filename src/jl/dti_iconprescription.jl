...
export dti_iconprescription

"""
    dti_iconprescription(;kwargs...)

An IconPrescription component.
...
"""
function dti_iconprescription(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconprescription", "IconPrescription", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
