...
export dti_iconsectionsign

"""
    dti_iconsectionsign(;kwargs...)

An IconSectionSign component.
...
"""
function dti_iconsectionsign(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsectionsign", "IconSectionSign", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
