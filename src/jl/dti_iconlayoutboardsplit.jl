...
export dti_iconlayoutboardsplit

"""
    dti_iconlayoutboardsplit(;kwargs...)

An IconLayoutBoardSplit component.
...
"""
function dti_iconlayoutboardsplit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutboardsplit", "IconLayoutBoardSplit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
