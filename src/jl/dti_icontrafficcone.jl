...
export dti_icontrafficcone

"""
    dti_icontrafficcone(;kwargs...)

An IconTrafficCone component.
...
"""
function dti_icontrafficcone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrafficcone", "IconTrafficCone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
