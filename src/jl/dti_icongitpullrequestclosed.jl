...
export dti_icongitpullrequestclosed

"""
    dti_icongitpullrequestclosed(;kwargs...)

An IconGitPullRequestClosed component.
...
"""
function dti_icongitpullrequestclosed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitpullrequestclosed", "IconGitPullRequestClosed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
