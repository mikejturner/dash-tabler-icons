...
export dti_iconarrowbearright

"""
    dti_iconarrowbearright(;kwargs...)

An IconArrowBearRight component.
...
"""
function dti_iconarrowbearright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbearright", "IconArrowBearRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
