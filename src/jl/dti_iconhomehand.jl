...
export dti_iconhomehand

"""
    dti_iconhomehand(;kwargs...)

An IconHomeHand component.
...
"""
function dti_iconhomehand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomehand", "IconHomeHand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
