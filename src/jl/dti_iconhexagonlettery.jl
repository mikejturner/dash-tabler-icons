...
export dti_iconhexagonlettery

"""
    dti_iconhexagonlettery(;kwargs...)

An IconHexagonLetterY component.
...
"""
function dti_iconhexagonlettery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonlettery", "IconHexagonLetterY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
