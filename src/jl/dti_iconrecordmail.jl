...
export dti_iconrecordmail

"""
    dti_iconrecordmail(;kwargs...)

An IconRecordMail component.
...
"""
function dti_iconrecordmail(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrecordmail", "IconRecordMail", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
