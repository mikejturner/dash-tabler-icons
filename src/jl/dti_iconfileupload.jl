...
export dti_iconfileupload

"""
    dti_iconfileupload(;kwargs...)

An IconFileUpload component.
...
"""
function dti_iconfileupload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileupload", "IconFileUpload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
