...
export dti_iconchevronsright

"""
    dti_iconchevronsright(;kwargs...)

An IconChevronsRight component.
...
"""
function dti_iconchevronsright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsright", "IconChevronsRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
