...
export dti_iconpigoff

"""
    dti_iconpigoff(;kwargs...)

An IconPigOff component.
...
"""
function dti_iconpigoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpigoff", "IconPigOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
