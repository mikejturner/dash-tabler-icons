...
export dti_icontictac

"""
    dti_icontictac(;kwargs...)

An IconTicTac component.
...
"""
function dti_icontictac(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontictac", "IconTicTac", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
