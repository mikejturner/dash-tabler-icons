...
export dti_iconerror404

"""
    dti_iconerror404(;kwargs...)

An IconError404 component.
...
"""
function dti_iconerror404(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconerror404", "IconError404", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
