...
export dti_iconbrowserplus

"""
    dti_iconbrowserplus(;kwargs...)

An IconBrowserPlus component.
...
"""
function dti_iconbrowserplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrowserplus", "IconBrowserPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
