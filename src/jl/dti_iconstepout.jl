...
export dti_iconstepout

"""
    dti_iconstepout(;kwargs...)

An IconStepOut component.
...
"""
function dti_iconstepout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstepout", "IconStepOut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
