...
export dti_icondevicecctvoff

"""
    dti_icondevicecctvoff(;kwargs...)

An IconDeviceCctvOff component.
...
"""
function dti_icondevicecctvoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicecctvoff", "IconDeviceCctvOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
