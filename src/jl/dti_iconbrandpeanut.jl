...
export dti_iconbrandpeanut

"""
    dti_iconbrandpeanut(;kwargs...)

An IconBrandPeanut component.
...
"""
function dti_iconbrandpeanut(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpeanut", "IconBrandPeanut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
