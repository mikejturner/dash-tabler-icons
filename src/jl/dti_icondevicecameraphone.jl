...
export dti_icondevicecameraphone

"""
    dti_icondevicecameraphone(;kwargs...)

An IconDeviceCameraPhone component.
...
"""
function dti_icondevicecameraphone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicecameraphone", "IconDeviceCameraPhone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
