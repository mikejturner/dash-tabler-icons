...
export dti_iconarrowloopright

"""
    dti_iconarrowloopright(;kwargs...)

An IconArrowLoopRight component.
...
"""
function dti_iconarrowloopright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowloopright", "IconArrowLoopRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
