...
export dti_iconplaylistoff

"""
    dti_iconplaylistoff(;kwargs...)

An IconPlaylistOff component.
...
"""
function dti_iconplaylistoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaylistoff", "IconPlaylistOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
