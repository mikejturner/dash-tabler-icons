...
export dti_iconfilehorizontal

"""
    dti_iconfilehorizontal(;kwargs...)

An IconFileHorizontal component.
...
"""
function dti_iconfilehorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilehorizontal", "IconFileHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
