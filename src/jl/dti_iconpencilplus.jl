...
export dti_iconpencilplus

"""
    dti_iconpencilplus(;kwargs...)

An IconPencilPlus component.
...
"""
function dti_iconpencilplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpencilplus", "IconPencilPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
