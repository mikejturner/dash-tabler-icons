...
export dti_iconbrandasana

"""
    dti_iconbrandasana(;kwargs...)

An IconBrandAsana component.
...
"""
function dti_iconbrandasana(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandasana", "IconBrandAsana", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
