...
export dti_iconlayoutaligncenter

"""
    dti_iconlayoutaligncenter(;kwargs...)

An IconLayoutAlignCenter component.
...
"""
function dti_iconlayoutaligncenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutaligncenter", "IconLayoutAlignCenter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
