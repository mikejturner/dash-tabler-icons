...
export dti_iconappwindow

"""
    dti_iconappwindow(;kwargs...)

An IconAppWindow component.
...
"""
function dti_iconappwindow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconappwindow", "IconAppWindow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
