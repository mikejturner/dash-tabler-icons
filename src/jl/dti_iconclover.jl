...
export dti_iconclover

"""
    dti_iconclover(;kwargs...)

An IconClover component.
...
"""
function dti_iconclover(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclover", "IconClover", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
