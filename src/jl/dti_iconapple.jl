...
export dti_iconapple

"""
    dti_iconapple(;kwargs...)

An IconApple component.
...
"""
function dti_iconapple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconapple", "IconApple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
