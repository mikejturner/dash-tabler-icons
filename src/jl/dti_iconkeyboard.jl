...
export dti_iconkeyboard

"""
    dti_iconkeyboard(;kwargs...)

An IconKeyboard component.
...
"""
function dti_iconkeyboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyboard", "IconKeyboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
