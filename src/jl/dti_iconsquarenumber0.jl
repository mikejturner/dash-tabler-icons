...
export dti_iconsquarenumber0

"""
    dti_iconsquarenumber0(;kwargs...)

An IconSquareNumber0 component.
...
"""
function dti_iconsquarenumber0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber0", "IconSquareNumber0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
