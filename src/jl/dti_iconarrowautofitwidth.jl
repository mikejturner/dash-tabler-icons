...
export dti_iconarrowautofitwidth

"""
    dti_iconarrowautofitwidth(;kwargs...)

An IconArrowAutofitWidth component.
...
"""
function dti_iconarrowautofitwidth(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitwidth", "IconArrowAutofitWidth", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
