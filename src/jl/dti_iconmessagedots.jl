...
export dti_iconmessagedots

"""
    dti_iconmessagedots(;kwargs...)

An IconMessageDots component.
...
"""
function dti_iconmessagedots(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagedots", "IconMessageDots", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
