...
export dti_iconresize

"""
    dti_iconresize(;kwargs...)

An IconResize component.
...
"""
function dti_iconresize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconresize", "IconResize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
