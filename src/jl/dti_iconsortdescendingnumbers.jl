...
export dti_iconsortdescendingnumbers

"""
    dti_iconsortdescendingnumbers(;kwargs...)

An IconSortDescendingNumbers component.
...
"""
function dti_iconsortdescendingnumbers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortdescendingnumbers", "IconSortDescendingNumbers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
