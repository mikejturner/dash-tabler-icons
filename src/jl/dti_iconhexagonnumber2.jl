...
export dti_iconhexagonnumber2

"""
    dti_iconhexagonnumber2(;kwargs...)

An IconHexagonNumber2 component.
...
"""
function dti_iconhexagonnumber2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber2", "IconHexagonNumber2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
