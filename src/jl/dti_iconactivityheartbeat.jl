...
export dti_iconactivityheartbeat

"""
    dti_iconactivityheartbeat(;kwargs...)

An IconActivityHeartbeat component.
...
"""
function dti_iconactivityheartbeat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconactivityheartbeat", "IconActivityHeartbeat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
