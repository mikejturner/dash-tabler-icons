...
export dti_iconphotominus

"""
    dti_iconphotominus(;kwargs...)

An IconPhotoMinus component.
...
"""
function dti_iconphotominus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotominus", "IconPhotoMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
