...
export dti_iconarrowleftsquare

"""
    dti_iconarrowleftsquare(;kwargs...)

An IconArrowLeftSquare component.
...
"""
function dti_iconarrowleftsquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowleftsquare", "IconArrowLeftSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
