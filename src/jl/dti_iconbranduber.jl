...
export dti_iconbranduber

"""
    dti_iconbranduber(;kwargs...)

An IconBrandUber component.
...
"""
function dti_iconbranduber(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranduber", "IconBrandUber", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
