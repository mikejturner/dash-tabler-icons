...
export dti_icontriangles

"""
    dti_icontriangles(;kwargs...)

An IconTriangles component.
...
"""
function dti_icontriangles(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontriangles", "IconTriangles", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
