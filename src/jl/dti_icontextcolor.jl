...
export dti_icontextcolor

"""
    dti_icontextcolor(;kwargs...)

An IconTextColor component.
...
"""
function dti_icontextcolor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextcolor", "IconTextColor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
