...
export dti_iconlayoutbottombarcollapse

"""
    dti_iconlayoutbottombarcollapse(;kwargs...)

An IconLayoutBottombarCollapse component.
...
"""
function dti_iconlayoutbottombarcollapse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutbottombarcollapse", "IconLayoutBottombarCollapse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
