...
export dti_iconvectorbezier

"""
    dti_iconvectorbezier(;kwargs...)

An IconVectorBezier component.
...
"""
function dti_iconvectorbezier(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectorbezier", "IconVectorBezier", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
