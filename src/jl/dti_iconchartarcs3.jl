...
export dti_iconchartarcs3

"""
    dti_iconchartarcs3(;kwargs...)

An IconChartArcs3 component.
...
"""
function dti_iconchartarcs3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartarcs3", "IconChartArcs3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
