...
export dti_iconfilearrowleft

"""
    dti_iconfilearrowleft(;kwargs...)

An IconFileArrowLeft component.
...
"""
function dti_iconfilearrowleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilearrowleft", "IconFileArrowLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
