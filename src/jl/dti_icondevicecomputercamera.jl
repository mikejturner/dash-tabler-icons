...
export dti_icondevicecomputercamera

"""
    dti_icondevicecomputercamera(;kwargs...)

An IconDeviceComputerCamera component.
...
"""
function dti_icondevicecomputercamera(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicecomputercamera", "IconDeviceComputerCamera", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
