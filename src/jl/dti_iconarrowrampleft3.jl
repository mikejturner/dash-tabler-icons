...
export dti_iconarrowrampleft3

"""
    dti_iconarrowrampleft3(;kwargs...)

An IconArrowRampLeft3 component.
...
"""
function dti_iconarrowrampleft3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrampleft3", "IconArrowRampLeft3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
