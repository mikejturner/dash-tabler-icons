...
export dti_iconbrandrevolut

"""
    dti_iconbrandrevolut(;kwargs...)

An IconBrandRevolut component.
...
"""
function dti_iconbrandrevolut(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandrevolut", "IconBrandRevolut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
