...
export dti_icondroplet

"""
    dti_icondroplet(;kwargs...)

An IconDroplet component.
...
"""
function dti_icondroplet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondroplet", "IconDroplet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
