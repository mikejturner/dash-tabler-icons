...
export dti_icontypography

"""
    dti_icontypography(;kwargs...)

An IconTypography component.
...
"""
function dti_icontypography(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontypography", "IconTypography", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
