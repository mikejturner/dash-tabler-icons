...
export dti_iconmovie

"""
    dti_iconmovie(;kwargs...)

An IconMovie component.
...
"""
function dti_iconmovie(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmovie", "IconMovie", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
