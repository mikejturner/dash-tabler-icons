...
export dti_iconcurrencylyd

"""
    dti_iconcurrencylyd(;kwargs...)

An IconCurrencyLyd component.
...
"""
function dti_iconcurrencylyd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencylyd", "IconCurrencyLyd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
