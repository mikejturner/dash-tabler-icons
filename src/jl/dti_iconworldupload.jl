...
export dti_iconworldupload

"""
    dti_iconworldupload(;kwargs...)

An IconWorldUpload component.
...
"""
function dti_iconworldupload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworldupload", "IconWorldUpload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
