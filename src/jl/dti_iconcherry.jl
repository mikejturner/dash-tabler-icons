...
export dti_iconcherry

"""
    dti_iconcherry(;kwargs...)

An IconCherry component.
...
"""
function dti_iconcherry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcherry", "IconCherry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
