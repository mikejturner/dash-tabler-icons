...
export dti_iconnfcoff

"""
    dti_iconnfcoff(;kwargs...)

An IconNfcOff component.
...
"""
function dti_iconnfcoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnfcoff", "IconNfcOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
