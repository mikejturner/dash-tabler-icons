...
export dti_icongriddots

"""
    dti_icongriddots(;kwargs...)

An IconGridDots component.
...
"""
function dti_icongriddots(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongriddots", "IconGridDots", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
