...
export dti_iconpaint

"""
    dti_iconpaint(;kwargs...)

An IconPaint component.
...
"""
function dti_iconpaint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpaint", "IconPaint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
