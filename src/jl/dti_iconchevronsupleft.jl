...
export dti_iconchevronsupleft

"""
    dti_iconchevronsupleft(;kwargs...)

An IconChevronsUpLeft component.
...
"""
function dti_iconchevronsupleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsupleft", "IconChevronsUpLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
