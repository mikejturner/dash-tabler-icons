...
export dti_icon3drotate

"""
    dti_icon3drotate(;kwargs...)

An Icon3dRotate component.
...
"""
function dti_icon3drotate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icon3drotate", "Icon3dRotate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
