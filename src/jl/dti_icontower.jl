...
export dti_icontower

"""
    dti_icontower(;kwargs...)

An IconTower component.
...
"""
function dti_icontower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontower", "IconTower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
