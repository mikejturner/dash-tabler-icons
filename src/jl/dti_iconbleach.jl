...
export dti_iconbleach

"""
    dti_iconbleach(;kwargs...)

An IconBleach component.
...
"""
function dti_iconbleach(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbleach", "IconBleach", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
