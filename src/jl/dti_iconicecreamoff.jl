...
export dti_iconicecreamoff

"""
    dti_iconicecreamoff(;kwargs...)

An IconIceCreamOff component.
...
"""
function dti_iconicecreamoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconicecreamoff", "IconIceCreamOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
