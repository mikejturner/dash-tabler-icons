...
export dti_iconhexagonlettera

"""
    dti_iconhexagonlettera(;kwargs...)

An IconHexagonLetterA component.
...
"""
function dti_iconhexagonlettera(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonlettera", "IconHexagonLetterA", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
