...
export dti_iconrecycleoff

"""
    dti_iconrecycleoff(;kwargs...)

An IconRecycleOff component.
...
"""
function dti_iconrecycleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrecycleoff", "IconRecycleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
