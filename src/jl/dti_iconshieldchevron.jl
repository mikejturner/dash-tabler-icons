...
export dti_iconshieldchevron

"""
    dti_iconshieldchevron(;kwargs...)

An IconShieldChevron component.
...
"""
function dti_iconshieldchevron(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldchevron", "IconShieldChevron", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
