...
export dti_iconbrandvercel

"""
    dti_iconbrandvercel(;kwargs...)

An IconBrandVercel component.
...
"""
function dti_iconbrandvercel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvercel", "IconBrandVercel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
