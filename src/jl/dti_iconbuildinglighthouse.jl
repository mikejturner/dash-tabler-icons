...
export dti_iconbuildinglighthouse

"""
    dti_iconbuildinglighthouse(;kwargs...)

An IconBuildingLighthouse component.
...
"""
function dti_iconbuildinglighthouse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildinglighthouse", "IconBuildingLighthouse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
