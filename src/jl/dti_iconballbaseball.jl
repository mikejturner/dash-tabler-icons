...
export dti_iconballbaseball

"""
    dti_iconballbaseball(;kwargs...)

An IconBallBaseball component.
...
"""
function dti_iconballbaseball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballbaseball", "IconBallBaseball", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
