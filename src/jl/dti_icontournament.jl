...
export dti_icontournament

"""
    dti_icontournament(;kwargs...)

An IconTournament component.
...
"""
function dti_icontournament(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontournament", "IconTournament", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
