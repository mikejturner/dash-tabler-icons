...
export dti_iconpresentationoff

"""
    dti_iconpresentationoff(;kwargs...)

An IconPresentationOff component.
...
"""
function dti_iconpresentationoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpresentationoff", "IconPresentationOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
