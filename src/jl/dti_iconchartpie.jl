...
export dti_iconchartpie

"""
    dti_iconchartpie(;kwargs...)

An IconChartPie component.
...
"""
function dti_iconchartpie(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartpie", "IconChartPie", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
