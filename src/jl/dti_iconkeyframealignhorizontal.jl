...
export dti_iconkeyframealignhorizontal

"""
    dti_iconkeyframealignhorizontal(;kwargs...)

An IconKeyframeAlignHorizontal component.
...
"""
function dti_iconkeyframealignhorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyframealignhorizontal", "IconKeyframeAlignHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
