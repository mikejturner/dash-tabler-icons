...
export dti_iconcurlyloop

"""
    dti_iconcurlyloop(;kwargs...)

An IconCurlyLoop component.
...
"""
function dti_iconcurlyloop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurlyloop", "IconCurlyLoop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
