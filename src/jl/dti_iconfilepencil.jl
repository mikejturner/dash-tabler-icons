...
export dti_iconfilepencil

"""
    dti_iconfilepencil(;kwargs...)

An IconFilePencil component.
...
"""
function dti_iconfilepencil(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilepencil", "IconFilePencil", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
