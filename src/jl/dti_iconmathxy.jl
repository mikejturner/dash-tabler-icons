...
export dti_iconmathxy

"""
    dti_iconmathxy(;kwargs...)

An IconMathXy component.
...
"""
function dti_iconmathxy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxy", "IconMathXy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
