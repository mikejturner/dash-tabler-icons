...
export dti_iconplantoff

"""
    dti_iconplantoff(;kwargs...)

An IconPlantOff component.
...
"""
function dti_iconplantoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplantoff", "IconPlantOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
