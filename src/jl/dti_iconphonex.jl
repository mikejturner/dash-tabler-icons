...
export dti_iconphonex

"""
    dti_iconphonex(;kwargs...)

An IconPhoneX component.
...
"""
function dti_iconphonex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphonex", "IconPhoneX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
