...
export dti_iconbrandadobe

"""
    dti_iconbrandadobe(;kwargs...)

An IconBrandAdobe component.
...
"""
function dti_iconbrandadobe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandadobe", "IconBrandAdobe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
