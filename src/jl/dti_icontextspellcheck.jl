...
export dti_icontextspellcheck

"""
    dti_icontextspellcheck(;kwargs...)

An IconTextSpellcheck component.
...
"""
function dti_icontextspellcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextspellcheck", "IconTextSpellcheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
