...
export dti_iconviewfinderoff

"""
    dti_iconviewfinderoff(;kwargs...)

An IconViewfinderOff component.
...
"""
function dti_iconviewfinderoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconviewfinderoff", "IconViewfinderOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
