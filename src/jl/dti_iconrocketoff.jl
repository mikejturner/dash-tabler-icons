...
export dti_iconrocketoff

"""
    dti_iconrocketoff(;kwargs...)

An IconRocketOff component.
...
"""
function dti_iconrocketoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrocketoff", "IconRocketOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
