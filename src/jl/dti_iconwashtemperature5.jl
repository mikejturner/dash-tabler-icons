...
export dti_iconwashtemperature5

"""
    dti_iconwashtemperature5(;kwargs...)

An IconWashTemperature5 component.
...
"""
function dti_iconwashtemperature5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtemperature5", "IconWashTemperature5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
