...
export dti_iconapiappoff

"""
    dti_iconapiappoff(;kwargs...)

An IconApiAppOff component.
...
"""
function dti_iconapiappoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconapiappoff", "IconApiAppOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
