...
export dti_iconpepper

"""
    dti_iconpepper(;kwargs...)

An IconPepper component.
...
"""
function dti_iconpepper(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpepper", "IconPepper", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
