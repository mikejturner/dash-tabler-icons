...
export dti_iconbrandpocket

"""
    dti_iconbrandpocket(;kwargs...)

An IconBrandPocket component.
...
"""
function dti_iconbrandpocket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpocket", "IconBrandPocket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
