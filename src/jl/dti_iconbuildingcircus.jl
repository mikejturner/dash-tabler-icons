...
export dti_iconbuildingcircus

"""
    dti_iconbuildingcircus(;kwargs...)

An IconBuildingCircus component.
...
"""
function dti_iconbuildingcircus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingcircus", "IconBuildingCircus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
