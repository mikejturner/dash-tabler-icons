...
export dti_iconlistdetails

"""
    dti_iconlistdetails(;kwargs...)

An IconListDetails component.
...
"""
function dti_iconlistdetails(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlistdetails", "IconListDetails", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
