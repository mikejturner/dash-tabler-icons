...
export dti_iconfilteroff

"""
    dti_iconfilteroff(;kwargs...)

An IconFilterOff component.
...
"""
function dti_iconfilteroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilteroff", "IconFilterOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
