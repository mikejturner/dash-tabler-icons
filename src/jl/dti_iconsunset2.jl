...
export dti_iconsunset2

"""
    dti_iconsunset2(;kwargs...)

An IconSunset2 component.
...
"""
function dti_iconsunset2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunset2", "IconSunset2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
