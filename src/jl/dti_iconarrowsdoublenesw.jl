...
export dti_iconarrowsdoublenesw

"""
    dti_iconarrowsdoublenesw(;kwargs...)

An IconArrowsDoubleNeSw component.
...
"""
function dti_iconarrowsdoublenesw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdoublenesw", "IconArrowsDoubleNeSw", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
