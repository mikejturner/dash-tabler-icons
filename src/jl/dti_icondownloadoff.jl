...
export dti_icondownloadoff

"""
    dti_icondownloadoff(;kwargs...)

An IconDownloadOff component.
...
"""
function dti_icondownloadoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondownloadoff", "IconDownloadOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
