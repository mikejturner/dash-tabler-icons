...
export dti_iconmapsearch

"""
    dti_iconmapsearch(;kwargs...)

An IconMapSearch component.
...
"""
function dti_iconmapsearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmapsearch", "IconMapSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
