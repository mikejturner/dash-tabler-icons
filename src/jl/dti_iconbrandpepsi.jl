...
export dti_iconbrandpepsi

"""
    dti_iconbrandpepsi(;kwargs...)

An IconBrandPepsi component.
...
"""
function dti_iconbrandpepsi(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpepsi", "IconBrandPepsi", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
