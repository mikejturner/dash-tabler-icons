...
export dti_iconbrandsafari

"""
    dti_iconbrandsafari(;kwargs...)

An IconBrandSafari component.
...
"""
function dti_iconbrandsafari(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsafari", "IconBrandSafari", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
