...
export dti_iconblockquote

"""
    dti_iconblockquote(;kwargs...)

An IconBlockquote component.
...
"""
function dti_iconblockquote(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconblockquote", "IconBlockquote", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
