...
export dti_iconolympics

"""
    dti_iconolympics(;kwargs...)

An IconOlympics component.
...
"""
function dti_iconolympics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconolympics", "IconOlympics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
