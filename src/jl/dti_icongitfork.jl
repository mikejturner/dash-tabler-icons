...
export dti_icongitfork

"""
    dti_icongitfork(;kwargs...)

An IconGitFork component.
...
"""
function dti_icongitfork(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitfork", "IconGitFork", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
