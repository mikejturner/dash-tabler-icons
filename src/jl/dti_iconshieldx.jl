...
export dti_iconshieldx

"""
    dti_iconshieldx(;kwargs...)

An IconShieldX component.
...
"""
function dti_iconshieldx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldx", "IconShieldX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
