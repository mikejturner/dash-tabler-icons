...
export dti_iconwashtemperature2

"""
    dti_iconwashtemperature2(;kwargs...)

An IconWashTemperature2 component.
...
"""
function dti_iconwashtemperature2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtemperature2", "IconWashTemperature2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
