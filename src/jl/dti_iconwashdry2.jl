...
export dti_iconwashdry2

"""
    dti_iconwashdry2(;kwargs...)

An IconWashDry2 component.
...
"""
function dti_iconwashdry2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdry2", "IconWashDry2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
