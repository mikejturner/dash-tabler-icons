...
export dti_iconcraneoff

"""
    dti_iconcraneoff(;kwargs...)

An IconCraneOff component.
...
"""
function dti_iconcraneoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcraneoff", "IconCraneOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
