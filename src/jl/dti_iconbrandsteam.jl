...
export dti_iconbrandsteam

"""
    dti_iconbrandsteam(;kwargs...)

An IconBrandSteam component.
...
"""
function dti_iconbrandsteam(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsteam", "IconBrandSteam", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
