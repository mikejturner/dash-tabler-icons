...
export dti_iconlayoutalignbottom

"""
    dti_iconlayoutalignbottom(;kwargs...)

An IconLayoutAlignBottom component.
...
"""
function dti_iconlayoutalignbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutalignbottom", "IconLayoutAlignBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
