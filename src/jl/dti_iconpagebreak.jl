...
export dti_iconpagebreak

"""
    dti_iconpagebreak(;kwargs...)

An IconPageBreak component.
...
"""
function dti_iconpagebreak(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpagebreak", "IconPageBreak", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
