...
export dti_iconhangeroff

"""
    dti_iconhangeroff(;kwargs...)

An IconHangerOff component.
...
"""
function dti_iconhangeroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhangeroff", "IconHangerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
