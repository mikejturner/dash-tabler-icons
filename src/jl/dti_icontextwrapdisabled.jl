...
export dti_icontextwrapdisabled

"""
    dti_icontextwrapdisabled(;kwargs...)

An IconTextWrapDisabled component.
...
"""
function dti_icontextwrapdisabled(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextwrapdisabled", "IconTextWrapDisabled", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
