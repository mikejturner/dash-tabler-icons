...
export dti_iconfileeuro

"""
    dti_iconfileeuro(;kwargs...)

An IconFileEuro component.
...
"""
function dti_iconfileeuro(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileeuro", "IconFileEuro", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
