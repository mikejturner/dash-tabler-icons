...
export dti_iconarrowcurveleft

"""
    dti_iconarrowcurveleft(;kwargs...)

An IconArrowCurveLeft component.
...
"""
function dti_iconarrowcurveleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowcurveleft", "IconArrowCurveLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
