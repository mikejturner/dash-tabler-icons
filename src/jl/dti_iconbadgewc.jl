...
export dti_iconbadgewc

"""
    dti_iconbadgewc(;kwargs...)

An IconBadgeWc component.
...
"""
function dti_iconbadgewc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgewc", "IconBadgeWc", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
