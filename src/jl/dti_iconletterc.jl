...
export dti_iconletterc

"""
    dti_iconletterc(;kwargs...)

An IconLetterC component.
...
"""
function dti_iconletterc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterc", "IconLetterC", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
