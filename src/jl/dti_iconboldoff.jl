...
export dti_iconboldoff

"""
    dti_iconboldoff(;kwargs...)

An IconBoldOff component.
...
"""
function dti_iconboldoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboldoff", "IconBoldOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
