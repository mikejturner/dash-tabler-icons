...
export dti_iconprinter

"""
    dti_iconprinter(;kwargs...)

An IconPrinter component.
...
"""
function dti_iconprinter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconprinter", "IconPrinter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
