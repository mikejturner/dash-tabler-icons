...
export dti_iconarrowmergeright

"""
    dti_iconarrowmergeright(;kwargs...)

An IconArrowMergeRight component.
...
"""
function dti_iconarrowmergeright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmergeright", "IconArrowMergeRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
