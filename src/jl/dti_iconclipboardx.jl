...
export dti_iconclipboardx

"""
    dti_iconclipboardx(;kwargs...)

An IconClipboardX component.
...
"""
function dti_iconclipboardx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardx", "IconClipboardX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
