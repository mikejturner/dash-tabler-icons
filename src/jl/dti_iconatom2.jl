...
export dti_iconatom2

"""
    dti_iconatom2(;kwargs...)

An IconAtom2 component.
...
"""
function dti_iconatom2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconatom2", "IconAtom2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
