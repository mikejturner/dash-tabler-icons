...
export dti_iconbuildingwindturbine

"""
    dti_iconbuildingwindturbine(;kwargs...)

An IconBuildingWindTurbine component.
...
"""
function dti_iconbuildingwindturbine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingwindturbine", "IconBuildingWindTurbine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
