...
export dti_iconbongoff

"""
    dti_iconbongoff(;kwargs...)

An IconBongOff component.
...
"""
function dti_iconbongoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbongoff", "IconBongOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
