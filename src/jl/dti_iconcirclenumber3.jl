...
export dti_iconcirclenumber3

"""
    dti_iconcirclenumber3(;kwargs...)

An IconCircleNumber3 component.
...
"""
function dti_iconcirclenumber3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber3", "IconCircleNumber3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
