...
export dti_iconcirclenumber2

"""
    dti_iconcirclenumber2(;kwargs...)

An IconCircleNumber2 component.
...
"""
function dti_iconcirclenumber2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber2", "IconCircleNumber2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
