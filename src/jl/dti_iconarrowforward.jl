...
export dti_iconarrowforward

"""
    dti_iconarrowforward(;kwargs...)

An IconArrowForward component.
...
"""
function dti_iconarrowforward(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowforward", "IconArrowForward", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
