...
export dti_iconfilesymlink

"""
    dti_iconfilesymlink(;kwargs...)

An IconFileSymlink component.
...
"""
function dti_iconfilesymlink(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilesymlink", "IconFileSymlink", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
