...
export dti_iconmoustache

"""
    dti_iconmoustache(;kwargs...)

An IconMoustache component.
...
"""
function dti_iconmoustache(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoustache", "IconMoustache", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
