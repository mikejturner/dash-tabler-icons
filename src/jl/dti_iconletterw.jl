...
export dti_iconletterw

"""
    dti_iconletterw(;kwargs...)

An IconLetterW component.
...
"""
function dti_iconletterw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterw", "IconLetterW", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
