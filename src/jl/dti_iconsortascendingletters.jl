...
export dti_iconsortascendingletters

"""
    dti_iconsortascendingletters(;kwargs...)

An IconSortAscendingLetters component.
...
"""
function dti_iconsortascendingletters(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortascendingletters", "IconSortAscendingLetters", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
