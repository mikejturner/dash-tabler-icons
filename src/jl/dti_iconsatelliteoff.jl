...
export dti_iconsatelliteoff

"""
    dti_iconsatelliteoff(;kwargs...)

An IconSatelliteOff component.
...
"""
function dti_iconsatelliteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsatelliteoff", "IconSatelliteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
