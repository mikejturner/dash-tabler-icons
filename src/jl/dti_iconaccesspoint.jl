...
export dti_iconaccesspoint

"""
    dti_iconaccesspoint(;kwargs...)

An IconAccessPoint component.
...
"""
function dti_iconaccesspoint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaccesspoint", "IconAccessPoint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
