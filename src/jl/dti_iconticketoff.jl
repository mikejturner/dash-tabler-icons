...
export dti_iconticketoff

"""
    dti_iconticketoff(;kwargs...)

An IconTicketOff component.
...
"""
function dti_iconticketoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconticketoff", "IconTicketOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
