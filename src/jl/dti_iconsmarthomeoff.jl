...
export dti_iconsmarthomeoff

"""
    dti_iconsmarthomeoff(;kwargs...)

An IconSmartHomeOff component.
...
"""
function dti_iconsmarthomeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsmarthomeoff", "IconSmartHomeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
