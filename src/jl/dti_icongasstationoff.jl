...
export dti_icongasstationoff

"""
    dti_icongasstationoff(;kwargs...)

An IconGasStationOff component.
...
"""
function dti_icongasstationoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongasstationoff", "IconGasStationOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
