...
export dti_iconlinkoff

"""
    dti_iconlinkoff(;kwargs...)

An IconLinkOff component.
...
"""
function dti_iconlinkoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlinkoff", "IconLinkOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
