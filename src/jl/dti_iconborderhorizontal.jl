...
export dti_iconborderhorizontal

"""
    dti_iconborderhorizontal(;kwargs...)

An IconBorderHorizontal component.
...
"""
function dti_iconborderhorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderhorizontal", "IconBorderHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
