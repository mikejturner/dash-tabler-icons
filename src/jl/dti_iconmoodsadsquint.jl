...
export dti_iconmoodsadsquint

"""
    dti_iconmoodsadsquint(;kwargs...)

An IconMoodSadSquint component.
...
"""
function dti_iconmoodsadsquint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsadsquint", "IconMoodSadSquint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
