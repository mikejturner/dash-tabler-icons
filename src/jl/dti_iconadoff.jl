...
export dti_iconadoff

"""
    dti_iconadoff(;kwargs...)

An IconAdOff component.
...
"""
function dti_iconadoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconadoff", "IconAdOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
