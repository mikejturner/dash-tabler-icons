...
export dti_iconhexagonletterm

"""
    dti_iconhexagonletterm(;kwargs...)

An IconHexagonLetterM component.
...
"""
function dti_iconhexagonletterm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterm", "IconHexagonLetterM", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
