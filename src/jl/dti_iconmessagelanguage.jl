...
export dti_iconmessagelanguage

"""
    dti_iconmessagelanguage(;kwargs...)

An IconMessageLanguage component.
...
"""
function dti_iconmessagelanguage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagelanguage", "IconMessageLanguage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
