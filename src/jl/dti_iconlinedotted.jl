...
export dti_iconlinedotted

"""
    dti_iconlinedotted(;kwargs...)

An IconLineDotted component.
...
"""
function dti_iconlinedotted(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlinedotted", "IconLineDotted", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
