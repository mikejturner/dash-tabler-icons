...
export dti_icontiltshift

"""
    dti_icontiltshift(;kwargs...)

An IconTiltShift component.
...
"""
function dti_icontiltshift(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontiltshift", "IconTiltShift", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
