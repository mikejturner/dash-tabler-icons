...
export dti_iconmoodconfuzed

"""
    dti_iconmoodconfuzed(;kwargs...)

An IconMoodConfuzed component.
...
"""
function dti_iconmoodconfuzed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodconfuzed", "IconMoodConfuzed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
