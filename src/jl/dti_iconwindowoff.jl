...
export dti_iconwindowoff

"""
    dti_iconwindowoff(;kwargs...)

An IconWindowOff component.
...
"""
function dti_iconwindowoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindowoff", "IconWindowOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
