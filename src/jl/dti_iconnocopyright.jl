...
export dti_iconnocopyright

"""
    dti_iconnocopyright(;kwargs...)

An IconNoCopyright component.
...
"""
function dti_iconnocopyright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnocopyright", "IconNoCopyright", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
