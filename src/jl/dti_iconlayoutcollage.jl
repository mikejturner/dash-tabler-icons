...
export dti_iconlayoutcollage

"""
    dti_iconlayoutcollage(;kwargs...)

An IconLayoutCollage component.
...
"""
function dti_iconlayoutcollage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutcollage", "IconLayoutCollage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
