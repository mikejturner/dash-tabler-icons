...
export dti_iconhexagonnumber0

"""
    dti_iconhexagonnumber0(;kwargs...)

An IconHexagonNumber0 component.
...
"""
function dti_iconhexagonnumber0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber0", "IconHexagonNumber0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
