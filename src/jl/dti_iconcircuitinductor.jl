...
export dti_iconcircuitinductor

"""
    dti_iconcircuitinductor(;kwargs...)

An IconCircuitInductor component.
...
"""
function dti_iconcircuitinductor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitinductor", "IconCircuitInductor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
