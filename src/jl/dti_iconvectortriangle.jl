...
export dti_iconvectortriangle

"""
    dti_iconvectortriangle(;kwargs...)

An IconVectorTriangle component.
...
"""
function dti_iconvectortriangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectortriangle", "IconVectorTriangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
