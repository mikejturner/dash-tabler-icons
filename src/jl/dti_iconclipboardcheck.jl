...
export dti_iconclipboardcheck

"""
    dti_iconclipboardcheck(;kwargs...)

An IconClipboardCheck component.
...
"""
function dti_iconclipboardcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardcheck", "IconClipboardCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
