...
export dti_iconbrandsamsungpass

"""
    dti_iconbrandsamsungpass(;kwargs...)

An IconBrandSamsungpass component.
...
"""
function dti_iconbrandsamsungpass(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsamsungpass", "IconBrandSamsungpass", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
