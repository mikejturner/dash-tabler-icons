...
export dti_iconcoffin

"""
    dti_iconcoffin(;kwargs...)

An IconCoffin component.
...
"""
function dti_iconcoffin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoffin", "IconCoffin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
