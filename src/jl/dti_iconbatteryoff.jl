...
export dti_iconbatteryoff

"""
    dti_iconbatteryoff(;kwargs...)

An IconBatteryOff component.
...
"""
function dti_iconbatteryoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbatteryoff", "IconBatteryOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
