...
export dti_iconzodiacpisces

"""
    dti_iconzodiacpisces(;kwargs...)

An IconZodiacPisces component.
...
"""
function dti_iconzodiacpisces(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacpisces", "IconZodiacPisces", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
