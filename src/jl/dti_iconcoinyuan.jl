...
export dti_iconcoinyuan

"""
    dti_iconcoinyuan(;kwargs...)

An IconCoinYuan component.
...
"""
function dti_iconcoinyuan(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinyuan", "IconCoinYuan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
