...
export dti_iconiconsoff

"""
    dti_iconiconsoff(;kwargs...)

An IconIconsOff component.
...
"""
function dti_iconiconsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconiconsoff", "IconIconsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
