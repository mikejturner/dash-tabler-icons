...
export dti_iconarrowbearright2

"""
    dti_iconarrowbearright2(;kwargs...)

An IconArrowBearRight2 component.
...
"""
function dti_iconarrowbearright2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbearright2", "IconArrowBearRight2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
