...
export dti_iconeditoff

"""
    dti_iconeditoff(;kwargs...)

An IconEditOff component.
...
"""
function dti_iconeditoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeditoff", "IconEditOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
