...
export dti_iconfilesoff

"""
    dti_iconfilesoff(;kwargs...)

An IconFilesOff component.
...
"""
function dti_iconfilesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilesoff", "IconFilesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
