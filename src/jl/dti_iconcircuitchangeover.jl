...
export dti_iconcircuitchangeover

"""
    dti_iconcircuitchangeover(;kwargs...)

An IconCircuitChangeover component.
...
"""
function dti_iconcircuitchangeover(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitchangeover", "IconCircuitChangeover", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
