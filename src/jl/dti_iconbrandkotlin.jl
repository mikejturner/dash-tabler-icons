...
export dti_iconbrandkotlin

"""
    dti_iconbrandkotlin(;kwargs...)

An IconBrandKotlin component.
...
"""
function dti_iconbrandkotlin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandkotlin", "IconBrandKotlin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
