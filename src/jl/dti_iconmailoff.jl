...
export dti_iconmailoff

"""
    dti_iconmailoff(;kwargs...)

An IconMailOff component.
...
"""
function dti_iconmailoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmailoff", "IconMailOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
