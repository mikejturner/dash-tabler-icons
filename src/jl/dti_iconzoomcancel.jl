...
export dti_iconzoomcancel

"""
    dti_iconzoomcancel(;kwargs...)

An IconZoomCancel component.
...
"""
function dti_iconzoomcancel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomcancel", "IconZoomCancel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
