...
export dti_iconcirclenumber9

"""
    dti_iconcirclenumber9(;kwargs...)

An IconCircleNumber9 component.
...
"""
function dti_iconcirclenumber9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber9", "IconCircleNumber9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
