...
export dti_iconsquarerotatedoff

"""
    dti_iconsquarerotatedoff(;kwargs...)

An IconSquareRotatedOff component.
...
"""
function dti_iconsquarerotatedoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarerotatedoff", "IconSquareRotatedOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
