...
export dti_iconcontainer

"""
    dti_iconcontainer(;kwargs...)

An IconContainer component.
...
"""
function dti_iconcontainer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcontainer", "IconContainer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
