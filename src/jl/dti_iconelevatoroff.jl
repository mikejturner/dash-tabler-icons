...
export dti_iconelevatoroff

"""
    dti_iconelevatoroff(;kwargs...)

An IconElevatorOff component.
...
"""
function dti_iconelevatoroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconelevatoroff", "IconElevatorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
