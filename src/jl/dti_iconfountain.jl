...
export dti_iconfountain

"""
    dti_iconfountain(;kwargs...)

An IconFountain component.
...
"""
function dti_iconfountain(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfountain", "IconFountain", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
