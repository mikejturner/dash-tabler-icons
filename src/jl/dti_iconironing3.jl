...
export dti_iconironing3

"""
    dti_iconironing3(;kwargs...)

An IconIroning3 component.
...
"""
function dti_iconironing3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconironing3", "IconIroning3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
