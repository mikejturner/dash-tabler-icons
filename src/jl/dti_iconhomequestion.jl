...
export dti_iconhomequestion

"""
    dti_iconhomequestion(;kwargs...)

An IconHomeQuestion component.
...
"""
function dti_iconhomequestion(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomequestion", "IconHomeQuestion", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
