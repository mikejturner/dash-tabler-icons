...
export dti_icontemperature

"""
    dti_icontemperature(;kwargs...)

An IconTemperature component.
...
"""
function dti_icontemperature(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemperature", "IconTemperature", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
