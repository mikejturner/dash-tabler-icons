...
export dti_iconboxmultiple9

"""
    dti_iconboxmultiple9(;kwargs...)

An IconBoxMultiple9 component.
...
"""
function dti_iconboxmultiple9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple9", "IconBoxMultiple9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
