...
export dti_iconboxpadding

"""
    dti_iconboxpadding(;kwargs...)

An IconBoxPadding component.
...
"""
function dti_iconboxpadding(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxpadding", "IconBoxPadding", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
