...
export dti_iconpaletteoff

"""
    dti_iconpaletteoff(;kwargs...)

An IconPaletteOff component.
...
"""
function dti_iconpaletteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpaletteoff", "IconPaletteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
