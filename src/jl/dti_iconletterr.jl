...
export dti_iconletterr

"""
    dti_iconletterr(;kwargs...)

An IconLetterR component.
...
"""
function dti_iconletterr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterr", "IconLetterR", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
