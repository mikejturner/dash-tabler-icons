...
export dti_iconlettero

"""
    dti_iconlettero(;kwargs...)

An IconLetterO component.
...
"""
function dti_iconlettero(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettero", "IconLetterO", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
