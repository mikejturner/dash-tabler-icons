...
export dti_iconpresentation

"""
    dti_iconpresentation(;kwargs...)

An IconPresentation component.
...
"""
function dti_iconpresentation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpresentation", "IconPresentation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
