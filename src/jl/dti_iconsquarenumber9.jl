...
export dti_iconsquarenumber9

"""
    dti_iconsquarenumber9(;kwargs...)

An IconSquareNumber9 component.
...
"""
function dti_iconsquarenumber9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber9", "IconSquareNumber9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
