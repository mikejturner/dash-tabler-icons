...
export dti_iconservercog

"""
    dti_iconservercog(;kwargs...)

An IconServerCog component.
...
"""
function dti_iconservercog(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconservercog", "IconServerCog", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
