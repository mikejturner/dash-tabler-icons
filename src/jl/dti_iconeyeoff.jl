...
export dti_iconeyeoff

"""
    dti_iconeyeoff(;kwargs...)

An IconEyeOff component.
...
"""
function dti_iconeyeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeyeoff", "IconEyeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
