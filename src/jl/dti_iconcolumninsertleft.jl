...
export dti_iconcolumninsertleft

"""
    dti_iconcolumninsertleft(;kwargs...)

An IconColumnInsertLeft component.
...
"""
function dti_iconcolumninsertleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolumninsertleft", "IconColumnInsertLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
