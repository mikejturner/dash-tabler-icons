...
export dti_icontrident

"""
    dti_icontrident(;kwargs...)

An IconTrident component.
...
"""
function dti_icontrident(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrident", "IconTrident", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
