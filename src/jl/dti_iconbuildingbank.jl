...
export dti_iconbuildingbank

"""
    dti_iconbuildingbank(;kwargs...)

An IconBuildingBank component.
...
"""
function dti_iconbuildingbank(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingbank", "IconBuildingBank", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
