...
export dti_iconcloudlock

"""
    dti_iconcloudlock(;kwargs...)

An IconCloudLock component.
...
"""
function dti_iconcloudlock(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudlock", "IconCloudLock", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
