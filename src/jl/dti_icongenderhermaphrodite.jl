...
export dti_icongenderhermaphrodite

"""
    dti_icongenderhermaphrodite(;kwargs...)

An IconGenderHermaphrodite component.
...
"""
function dti_icongenderhermaphrodite(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderhermaphrodite", "IconGenderHermaphrodite", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
