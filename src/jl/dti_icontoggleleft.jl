...
export dti_icontoggleleft

"""
    dti_icontoggleleft(;kwargs...)

An IconToggleLeft component.
...
"""
function dti_icontoggleleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoggleleft", "IconToggleLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
