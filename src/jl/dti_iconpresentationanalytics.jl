...
export dti_iconpresentationanalytics

"""
    dti_iconpresentationanalytics(;kwargs...)

An IconPresentationAnalytics component.
...
"""
function dti_iconpresentationanalytics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpresentationanalytics", "IconPresentationAnalytics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
