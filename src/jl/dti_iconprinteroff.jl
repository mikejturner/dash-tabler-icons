...
export dti_iconprinteroff

"""
    dti_iconprinteroff(;kwargs...)

An IconPrinterOff component.
...
"""
function dti_iconprinteroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconprinteroff", "IconPrinterOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
