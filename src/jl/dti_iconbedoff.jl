...
export dti_iconbedoff

"""
    dti_iconbedoff(;kwargs...)

An IconBedOff component.
...
"""
function dti_iconbedoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbedoff", "IconBedOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
