...
export dti_iconcircleletterx

"""
    dti_iconcircleletterx(;kwargs...)

An IconCircleLetterX component.
...
"""
function dti_iconcircleletterx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterx", "IconCircleLetterX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
