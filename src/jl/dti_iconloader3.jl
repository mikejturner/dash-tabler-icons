...
export dti_iconloader3

"""
    dti_iconloader3(;kwargs...)

An IconLoader3 component.
...
"""
function dti_iconloader3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconloader3", "IconLoader3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
