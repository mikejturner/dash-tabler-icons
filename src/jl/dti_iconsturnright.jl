...
export dti_iconsturnright

"""
    dti_iconsturnright(;kwargs...)

An IconSTurnRight component.
...
"""
function dti_iconsturnright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsturnright", "IconSTurnRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
