...
export dti_iconcurrencydollaraustralian

"""
    dti_iconcurrencydollaraustralian(;kwargs...)

An IconCurrencyDollarAustralian component.
...
"""
function dti_iconcurrencydollaraustralian(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollaraustralian", "IconCurrencyDollarAustralian", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
