...
export dti_iconmoodkid

"""
    dti_iconmoodkid(;kwargs...)

An IconMoodKid component.
...
"""
function dti_iconmoodkid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodkid", "IconMoodKid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
