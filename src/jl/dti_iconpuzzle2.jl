...
export dti_iconpuzzle2

"""
    dti_iconpuzzle2(;kwargs...)

An IconPuzzle2 component.
...
"""
function dti_iconpuzzle2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpuzzle2", "IconPuzzle2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
