...
export dti_iconcertificate

"""
    dti_iconcertificate(;kwargs...)

An IconCertificate component.
...
"""
function dti_iconcertificate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcertificate", "IconCertificate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
