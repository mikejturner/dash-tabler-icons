...
export dti_iconbrandzoom

"""
    dti_iconbrandzoom(;kwargs...)

An IconBrandZoom component.
...
"""
function dti_iconbrandzoom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandzoom", "IconBrandZoom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
