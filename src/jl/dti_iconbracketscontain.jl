...
export dti_iconbracketscontain

"""
    dti_iconbracketscontain(;kwargs...)

An IconBracketsContain component.
...
"""
function dti_iconbracketscontain(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbracketscontain", "IconBracketsContain", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
