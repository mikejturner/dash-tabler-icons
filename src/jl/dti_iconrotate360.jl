...
export dti_iconrotate360

"""
    dti_iconrotate360(;kwargs...)

An IconRotate360 component.
...
"""
function dti_iconrotate360(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrotate360", "IconRotate360", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
