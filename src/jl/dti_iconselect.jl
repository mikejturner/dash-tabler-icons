...
export dti_iconselect

"""
    dti_iconselect(;kwargs...)

An IconSelect component.
...
"""
function dti_iconselect(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconselect", "IconSelect", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
