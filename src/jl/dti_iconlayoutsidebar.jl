...
export dti_iconlayoutsidebar

"""
    dti_iconlayoutsidebar(;kwargs...)

An IconLayoutSidebar component.
...
"""
function dti_iconlayoutsidebar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutsidebar", "IconLayoutSidebar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
