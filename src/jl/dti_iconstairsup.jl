...
export dti_iconstairsup

"""
    dti_iconstairsup(;kwargs...)

An IconStairsUp component.
...
"""
function dti_iconstairsup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstairsup", "IconStairsUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
