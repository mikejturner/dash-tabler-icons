...
export dti_iconclockstop

"""
    dti_iconclockstop(;kwargs...)

An IconClockStop component.
...
"""
function dti_iconclockstop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockstop", "IconClockStop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
