...
export dti_iconmathyplusy

"""
    dti_iconmathyplusy(;kwargs...)

An IconMathYPlusY component.
...
"""
function dti_iconmathyplusy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathyplusy", "IconMathYPlusY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
