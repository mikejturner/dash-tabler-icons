...
export dti_iconviewportwide

"""
    dti_iconviewportwide(;kwargs...)

An IconViewportWide component.
...
"""
function dti_iconviewportwide(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconviewportwide", "IconViewportWide", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
