...
export dti_iconfilecode

"""
    dti_iconfilecode(;kwargs...)

An IconFileCode component.
...
"""
function dti_iconfilecode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilecode", "IconFileCode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
