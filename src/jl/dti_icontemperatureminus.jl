...
export dti_icontemperatureminus

"""
    dti_icontemperatureminus(;kwargs...)

An IconTemperatureMinus component.
...
"""
function dti_icontemperatureminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemperatureminus", "IconTemperatureMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
