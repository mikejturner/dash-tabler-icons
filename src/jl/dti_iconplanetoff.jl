...
export dti_iconplanetoff

"""
    dti_iconplanetoff(;kwargs...)

An IconPlanetOff component.
...
"""
function dti_iconplanetoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplanetoff", "IconPlanetOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
