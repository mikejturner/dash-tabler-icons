...
export dti_iconcannabis

"""
    dti_iconcannabis(;kwargs...)

An IconCannabis component.
...
"""
function dti_iconcannabis(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcannabis", "IconCannabis", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
