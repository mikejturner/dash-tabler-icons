...
export dti_iconcircleletterr

"""
    dti_iconcircleletterr(;kwargs...)

An IconCircleLetterR component.
...
"""
function dti_iconcircleletterr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterr", "IconCircleLetterR", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
