...
export dti_icontruckdelivery

"""
    dti_icontruckdelivery(;kwargs...)

An IconTruckDelivery component.
...
"""
function dti_icontruckdelivery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontruckdelivery", "IconTruckDelivery", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
