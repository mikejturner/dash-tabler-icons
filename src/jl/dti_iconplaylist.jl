...
export dti_iconplaylist

"""
    dti_iconplaylist(;kwargs...)

An IconPlaylist component.
...
"""
function dti_iconplaylist(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaylist", "IconPlaylist", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
