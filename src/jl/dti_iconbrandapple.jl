...
export dti_iconbrandapple

"""
    dti_iconbrandapple(;kwargs...)

An IconBrandApple component.
...
"""
function dti_iconbrandapple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandapple", "IconBrandApple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
