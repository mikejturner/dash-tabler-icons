...
export dti_icondevicegamepad2

"""
    dti_icondevicegamepad2(;kwargs...)

An IconDeviceGamepad2 component.
...
"""
function dti_icondevicegamepad2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicegamepad2", "IconDeviceGamepad2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
