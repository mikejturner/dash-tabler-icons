...
export dti_iconworldoff

"""
    dti_iconworldoff(;kwargs...)

An IconWorldOff component.
...
"""
function dti_iconworldoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworldoff", "IconWorldOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
