...
export dti_iconlasso

"""
    dti_iconlasso(;kwargs...)

An IconLasso component.
...
"""
function dti_iconlasso(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlasso", "IconLasso", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
