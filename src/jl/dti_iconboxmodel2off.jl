...
export dti_iconboxmodel2off

"""
    dti_iconboxmodel2off(;kwargs...)

An IconBoxModel2Off component.
...
"""
function dti_iconboxmodel2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmodel2off", "IconBoxModel2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
