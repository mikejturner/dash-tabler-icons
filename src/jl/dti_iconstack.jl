...
export dti_iconstack

"""
    dti_iconstack(;kwargs...)

An IconStack component.
...
"""
function dti_iconstack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstack", "IconStack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
