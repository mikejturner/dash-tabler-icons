...
export dti_iconrotatedot

"""
    dti_iconrotatedot(;kwargs...)

An IconRotateDot component.
...
"""
function dti_iconrotatedot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrotatedot", "IconRotateDot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
