...
export dti_iconcheckbox

"""
    dti_iconcheckbox(;kwargs...)

An IconCheckbox component.
...
"""
function dti_iconcheckbox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcheckbox", "IconCheckbox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
