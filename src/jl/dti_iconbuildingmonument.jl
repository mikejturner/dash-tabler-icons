...
export dti_iconbuildingmonument

"""
    dti_iconbuildingmonument(;kwargs...)

An IconBuildingMonument component.
...
"""
function dti_iconbuildingmonument(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingmonument", "IconBuildingMonument", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
