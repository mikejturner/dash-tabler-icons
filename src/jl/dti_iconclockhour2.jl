...
export dti_iconclockhour2

"""
    dti_iconclockhour2(;kwargs...)

An IconClockHour2 component.
...
"""
function dti_iconclockhour2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour2", "IconClockHour2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
