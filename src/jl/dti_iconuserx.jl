...
export dti_iconuserx

"""
    dti_iconuserx(;kwargs...)

An IconUserX component.
...
"""
function dti_iconuserx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuserx", "IconUserX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
