...
export dti_iconschemaoff

"""
    dti_iconschemaoff(;kwargs...)

An IconSchemaOff component.
...
"""
function dti_iconschemaoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconschemaoff", "IconSchemaOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
