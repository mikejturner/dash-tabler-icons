...
export dti_iconconeoff

"""
    dti_iconconeoff(;kwargs...)

An IconConeOff component.
...
"""
function dti_iconconeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconconeoff", "IconConeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
