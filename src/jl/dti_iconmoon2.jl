...
export dti_iconmoon2

"""
    dti_iconmoon2(;kwargs...)

An IconMoon2 component.
...
"""
function dti_iconmoon2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoon2", "IconMoon2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
