...
export dti_iconbrandbootstrap

"""
    dti_iconbrandbootstrap(;kwargs...)

An IconBrandBootstrap component.
...
"""
function dti_iconbrandbootstrap(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbootstrap", "IconBrandBootstrap", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
