...
export dti_icontextdirectionltr

"""
    dti_icontextdirectionltr(;kwargs...)

An IconTextDirectionLtr component.
...
"""
function dti_icontextdirectionltr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextdirectionltr", "IconTextDirectionLtr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
