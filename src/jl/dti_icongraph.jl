...
export dti_icongraph

"""
    dti_icongraph(;kwargs...)

An IconGraph component.
...
"""
function dti_icongraph(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongraph", "IconGraph", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
