...
export dti_icondeviceaudiotape

"""
    dti_icondeviceaudiotape(;kwargs...)

An IconDeviceAudioTape component.
...
"""
function dti_icondeviceaudiotape(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondeviceaudiotape", "IconDeviceAudioTape", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
