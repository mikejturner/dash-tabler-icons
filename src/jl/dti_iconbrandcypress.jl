...
export dti_iconbrandcypress

"""
    dti_iconbrandcypress(;kwargs...)

An IconBrandCypress component.
...
"""
function dti_iconbrandcypress(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcypress", "IconBrandCypress", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
