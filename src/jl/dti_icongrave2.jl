...
export dti_icongrave2

"""
    dti_icongrave2(;kwargs...)

An IconGrave2 component.
...
"""
function dti_icongrave2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrave2", "IconGrave2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
