...
export dti_iconarrowdownleftcircle

"""
    dti_iconarrowdownleftcircle(;kwargs...)

An IconArrowDownLeftCircle component.
...
"""
function dti_iconarrowdownleftcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdownleftcircle", "IconArrowDownLeftCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
