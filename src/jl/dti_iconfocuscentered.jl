...
export dti_iconfocuscentered

"""
    dti_iconfocuscentered(;kwargs...)

An IconFocusCentered component.
...
"""
function dti_iconfocuscentered(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfocuscentered", "IconFocusCentered", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
