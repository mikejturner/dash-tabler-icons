...
export dti_iconphotocheck

"""
    dti_iconphotocheck(;kwargs...)

An IconPhotoCheck component.
...
"""
function dti_iconphotocheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotocheck", "IconPhotoCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
