...
export dti_iconcloudrain

"""
    dti_iconcloudrain(;kwargs...)

An IconCloudRain component.
...
"""
function dti_iconcloudrain(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudrain", "IconCloudRain", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
