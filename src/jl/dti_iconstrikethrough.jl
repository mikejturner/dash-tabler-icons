...
export dti_iconstrikethrough

"""
    dti_iconstrikethrough(;kwargs...)

An IconStrikethrough component.
...
"""
function dti_iconstrikethrough(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstrikethrough", "IconStrikethrough", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
