...
export dti_iconplant2off

"""
    dti_iconplant2off(;kwargs...)

An IconPlant2Off component.
...
"""
function dti_iconplant2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplant2off", "IconPlant2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
