...
export dti_icondice6

"""
    dti_icondice6(;kwargs...)

An IconDice6 component.
...
"""
function dti_icondice6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondice6", "IconDice6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
