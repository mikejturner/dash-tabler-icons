...
export dti_icondevicegamepad

"""
    dti_icondevicegamepad(;kwargs...)

An IconDeviceGamepad component.
...
"""
function dti_icondevicegamepad(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicegamepad", "IconDeviceGamepad", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
