...
export dti_iconpokeball

"""
    dti_iconpokeball(;kwargs...)

An IconPokeball component.
...
"""
function dti_iconpokeball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpokeball", "IconPokeball", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
