...
export dti_iconhanger

"""
    dti_iconhanger(;kwargs...)

An IconHanger component.
...
"""
function dti_iconhanger(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhanger", "IconHanger", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
