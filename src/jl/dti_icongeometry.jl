...
export dti_icongeometry

"""
    dti_icongeometry(;kwargs...)

An IconGeometry component.
...
"""
function dti_icongeometry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongeometry", "IconGeometry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
