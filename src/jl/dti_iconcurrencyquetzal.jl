...
export dti_iconcurrencyquetzal

"""
    dti_iconcurrencyquetzal(;kwargs...)

An IconCurrencyQuetzal component.
...
"""
function dti_iconcurrencyquetzal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyquetzal", "IconCurrencyQuetzal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
