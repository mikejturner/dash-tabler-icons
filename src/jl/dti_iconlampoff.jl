...
export dti_iconlampoff

"""
    dti_iconlampoff(;kwargs...)

An IconLampOff component.
...
"""
function dti_iconlampoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlampoff", "IconLampOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
