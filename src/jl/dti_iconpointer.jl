...
export dti_iconpointer

"""
    dti_iconpointer(;kwargs...)

An IconPointer component.
...
"""
function dti_iconpointer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpointer", "IconPointer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
