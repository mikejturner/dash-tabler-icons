...
export dti_iconkeyframes

"""
    dti_iconkeyframes(;kwargs...)

An IconKeyframes component.
...
"""
function dti_iconkeyframes(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyframes", "IconKeyframes", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
