...
export dti_iconcarrot

"""
    dti_iconcarrot(;kwargs...)

An IconCarrot component.
...
"""
function dti_iconcarrot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcarrot", "IconCarrot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
