...
export dti_iconruler3

"""
    dti_iconruler3(;kwargs...)

An IconRuler3 component.
...
"""
function dti_iconruler3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconruler3", "IconRuler3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
