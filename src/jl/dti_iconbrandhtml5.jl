...
export dti_iconbrandhtml5

"""
    dti_iconbrandhtml5(;kwargs...)

An IconBrandHtml5 component.
...
"""
function dti_iconbrandhtml5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandhtml5", "IconBrandHtml5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
