...
export dti_icongitbranch

"""
    dti_icongitbranch(;kwargs...)

An IconGitBranch component.
...
"""
function dti_icongitbranch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitbranch", "IconGitBranch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
