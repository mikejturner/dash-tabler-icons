...
export dti_iconbrandframer

"""
    dti_iconbrandframer(;kwargs...)

An IconBrandFramer component.
...
"""
function dti_iconbrandframer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandframer", "IconBrandFramer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
