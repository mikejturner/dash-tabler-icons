...
export dti_icontemperaturecelsius

"""
    dti_icontemperaturecelsius(;kwargs...)

An IconTemperatureCelsius component.
...
"""
function dti_icontemperaturecelsius(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemperaturecelsius", "IconTemperatureCelsius", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
