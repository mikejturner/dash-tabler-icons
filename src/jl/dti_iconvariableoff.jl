...
export dti_iconvariableoff

"""
    dti_iconvariableoff(;kwargs...)

An IconVariableOff component.
...
"""
function dti_iconvariableoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvariableoff", "IconVariableOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
