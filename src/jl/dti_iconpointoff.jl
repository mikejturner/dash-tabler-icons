...
export dti_iconpointoff

"""
    dti_iconpointoff(;kwargs...)

An IconPointOff component.
...
"""
function dti_iconpointoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpointoff", "IconPointOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
