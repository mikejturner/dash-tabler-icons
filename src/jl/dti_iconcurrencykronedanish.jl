...
export dti_iconcurrencykronedanish

"""
    dti_iconcurrencykronedanish(;kwargs...)

An IconCurrencyKroneDanish component.
...
"""
function dti_iconcurrencykronedanish(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencykronedanish", "IconCurrencyKroneDanish", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
