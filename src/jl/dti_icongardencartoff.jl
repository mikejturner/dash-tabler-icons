...
export dti_icongardencartoff

"""
    dti_icongardencartoff(;kwargs...)

An IconGardenCartOff component.
...
"""
function dti_icongardencartoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongardencartoff", "IconGardenCartOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
