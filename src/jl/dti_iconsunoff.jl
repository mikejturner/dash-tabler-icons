...
export dti_iconsunoff

"""
    dti_iconsunoff(;kwargs...)

An IconSunOff component.
...
"""
function dti_iconsunoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunoff", "IconSunOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
