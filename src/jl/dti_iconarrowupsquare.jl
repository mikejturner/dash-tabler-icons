...
export dti_iconarrowupsquare

"""
    dti_iconarrowupsquare(;kwargs...)

An IconArrowUpSquare component.
...
"""
function dti_iconarrowupsquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowupsquare", "IconArrowUpSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
