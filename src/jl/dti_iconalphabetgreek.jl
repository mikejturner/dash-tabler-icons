...
export dti_iconalphabetgreek

"""
    dti_iconalphabetgreek(;kwargs...)

An IconAlphabetGreek component.
...
"""
function dti_iconalphabetgreek(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalphabetgreek", "IconAlphabetGreek", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
