...
export dti_icongenderbigender

"""
    dti_icongenderbigender(;kwargs...)

An IconGenderBigender component.
...
"""
function dti_icongenderbigender(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderbigender", "IconGenderBigender", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
