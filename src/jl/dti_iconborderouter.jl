...
export dti_iconborderouter

"""
    dti_iconborderouter(;kwargs...)

An IconBorderOuter component.
...
"""
function dti_iconborderouter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderouter", "IconBorderOuter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
