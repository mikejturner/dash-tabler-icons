...
export dti_iconbrandairbnb

"""
    dti_iconbrandairbnb(;kwargs...)

An IconBrandAirbnb component.
...
"""
function dti_iconbrandairbnb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandairbnb", "IconBrandAirbnb", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
