...
export dti_iconletterj

"""
    dti_iconletterj(;kwargs...)

An IconLetterJ component.
...
"""
function dti_iconletterj(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterj", "IconLetterJ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
