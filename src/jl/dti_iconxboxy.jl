...
export dti_iconxboxy

"""
    dti_iconxboxy(;kwargs...)

An IconXboxY component.
...
"""
function dti_iconxboxy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconxboxy", "IconXboxY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
