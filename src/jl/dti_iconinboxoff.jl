...
export dti_iconinboxoff

"""
    dti_iconinboxoff(;kwargs...)

An IconInboxOff component.
...
"""
function dti_iconinboxoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinboxoff", "IconInboxOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
