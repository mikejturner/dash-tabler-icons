...
export dti_iconreload

"""
    dti_iconreload(;kwargs...)

An IconReload component.
...
"""
function dti_iconreload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreload", "IconReload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
