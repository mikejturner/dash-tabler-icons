...
export dti_iconradaroff

"""
    dti_iconradaroff(;kwargs...)

An IconRadarOff component.
...
"""
function dti_iconradaroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradaroff", "IconRadarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
