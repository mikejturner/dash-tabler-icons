...
export dti_iconsquaref1

"""
    dti_iconsquaref1(;kwargs...)

An IconSquareF1 component.
...
"""
function dti_iconsquaref1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref1", "IconSquareF1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
