...
export dti_iconmathoff

"""
    dti_iconmathoff(;kwargs...)

An IconMathOff component.
...
"""
function dti_iconmathoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathoff", "IconMathOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
