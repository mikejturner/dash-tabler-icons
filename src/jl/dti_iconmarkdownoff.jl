...
export dti_iconmarkdownoff

"""
    dti_iconmarkdownoff(;kwargs...)

An IconMarkdownOff component.
...
"""
function dti_iconmarkdownoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmarkdownoff", "IconMarkdownOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
