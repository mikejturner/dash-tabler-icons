...
export dti_icondiscount2off

"""
    dti_icondiscount2off(;kwargs...)

An IconDiscount2Off component.
...
"""
function dti_icondiscount2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscount2off", "IconDiscount2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
