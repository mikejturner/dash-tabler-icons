...
export dti_iconvenus

"""
    dti_iconvenus(;kwargs...)

An IconVenus component.
...
"""
function dti_iconvenus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvenus", "IconVenus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
