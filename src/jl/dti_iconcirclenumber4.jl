...
export dti_iconcirclenumber4

"""
    dti_iconcirclenumber4(;kwargs...)

An IconCircleNumber4 component.
...
"""
function dti_iconcirclenumber4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber4", "IconCircleNumber4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
