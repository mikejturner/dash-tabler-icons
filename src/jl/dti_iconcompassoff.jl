...
export dti_iconcompassoff

"""
    dti_iconcompassoff(;kwargs...)

An IconCompassOff component.
...
"""
function dti_iconcompassoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcompassoff", "IconCompassOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
