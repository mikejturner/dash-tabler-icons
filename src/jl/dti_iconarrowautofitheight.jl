...
export dti_iconarrowautofitheight

"""
    dti_iconarrowautofitheight(;kwargs...)

An IconArrowAutofitHeight component.
...
"""
function dti_iconarrowautofitheight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitheight", "IconArrowAutofitHeight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
