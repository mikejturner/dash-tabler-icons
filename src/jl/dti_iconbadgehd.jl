...
export dti_iconbadgehd

"""
    dti_iconbadgehd(;kwargs...)

An IconBadgeHd component.
...
"""
function dti_iconbadgehd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgehd", "IconBadgeHd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
