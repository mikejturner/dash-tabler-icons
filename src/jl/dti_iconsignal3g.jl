...
export dti_iconsignal3g

"""
    dti_iconsignal3g(;kwargs...)

An IconSignal3g component.
...
"""
function dti_iconsignal3g(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignal3g", "IconSignal3g", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
