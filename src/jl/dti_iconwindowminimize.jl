...
export dti_iconwindowminimize

"""
    dti_iconwindowminimize(;kwargs...)

An IconWindowMinimize component.
...
"""
function dti_iconwindowminimize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindowminimize", "IconWindowMinimize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
