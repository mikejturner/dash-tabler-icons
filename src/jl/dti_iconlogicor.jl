...
export dti_iconlogicor

"""
    dti_iconlogicor(;kwargs...)

An IconLogicOr component.
...
"""
function dti_iconlogicor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicor", "IconLogicOr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
