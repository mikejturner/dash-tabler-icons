...
export dti_iconpackage

"""
    dti_iconpackage(;kwargs...)

An IconPackage component.
...
"""
function dti_iconpackage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpackage", "IconPackage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
