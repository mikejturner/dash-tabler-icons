...
export dti_iconironing1

"""
    dti_iconironing1(;kwargs...)

An IconIroning1 component.
...
"""
function dti_iconironing1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconironing1", "IconIroning1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
