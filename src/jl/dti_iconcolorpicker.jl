...
export dti_iconcolorpicker

"""
    dti_iconcolorpicker(;kwargs...)

An IconColorPicker component.
...
"""
function dti_iconcolorpicker(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolorpicker", "IconColorPicker", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
