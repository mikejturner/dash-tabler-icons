...
export dti_icondevices2

"""
    dti_icondevices2(;kwargs...)

An IconDevices2 component.
...
"""
function dti_icondevices2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevices2", "IconDevices2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
