...
export dti_iconminusvertical

"""
    dti_iconminusvertical(;kwargs...)

An IconMinusVertical component.
...
"""
function dti_iconminusvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconminusvertical", "IconMinusVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
