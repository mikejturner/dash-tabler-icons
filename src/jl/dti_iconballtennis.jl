...
export dti_iconballtennis

"""
    dti_iconballtennis(;kwargs...)

An IconBallTennis component.
...
"""
function dti_iconballtennis(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballtennis", "IconBallTennis", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
