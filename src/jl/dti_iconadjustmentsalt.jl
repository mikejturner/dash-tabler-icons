...
export dti_iconadjustmentsalt

"""
    dti_iconadjustmentsalt(;kwargs...)

An IconAdjustmentsAlt component.
...
"""
function dti_iconadjustmentsalt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconadjustmentsalt", "IconAdjustmentsAlt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
