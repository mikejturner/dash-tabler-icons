...
export dti_iconborderleft

"""
    dti_iconborderleft(;kwargs...)

An IconBorderLeft component.
...
"""
function dti_iconborderleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderleft", "IconBorderLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
