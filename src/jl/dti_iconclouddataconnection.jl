...
export dti_iconclouddataconnection

"""
    dti_iconclouddataconnection(;kwargs...)

An IconCloudDataConnection component.
...
"""
function dti_iconclouddataconnection(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclouddataconnection", "IconCloudDataConnection", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
