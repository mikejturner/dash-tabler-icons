...
export dti_iconbrandlinktree

"""
    dti_iconbrandlinktree(;kwargs...)

An IconBrandLinktree component.
...
"""
function dti_iconbrandlinktree(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandlinktree", "IconBrandLinktree", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
