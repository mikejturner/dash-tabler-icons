...
export dti_iconwebhookoff

"""
    dti_iconwebhookoff(;kwargs...)

An IconWebhookOff component.
...
"""
function dti_iconwebhookoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwebhookoff", "IconWebhookOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
