...
export dti_iconfirehydrantoff

"""
    dti_iconfirehydrantoff(;kwargs...)

An IconFireHydrantOff component.
...
"""
function dti_iconfirehydrantoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfirehydrantoff", "IconFireHydrantOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
