...
export dti_iconrouter

"""
    dti_iconrouter(;kwargs...)

An IconRouter component.
...
"""
function dti_iconrouter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrouter", "IconRouter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
