...
export dti_iconbadges

"""
    dti_iconbadges(;kwargs...)

An IconBadges component.
...
"""
function dti_iconbadges(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadges", "IconBadges", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
