...
export dti_icondevicedesktopoff

"""
    dti_icondevicedesktopoff(;kwargs...)

An IconDeviceDesktopOff component.
...
"""
function dti_icondevicedesktopoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicedesktopoff", "IconDeviceDesktopOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
