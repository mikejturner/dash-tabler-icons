...
export dti_iconsquaref2

"""
    dti_iconsquaref2(;kwargs...)

An IconSquareF2 component.
...
"""
function dti_iconsquaref2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref2", "IconSquareF2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
