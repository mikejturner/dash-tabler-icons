...
export dti_iconclockplay

"""
    dti_iconclockplay(;kwargs...)

An IconClockPlay component.
...
"""
function dti_iconclockplay(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockplay", "IconClockPlay", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
