...
export dti_iconeaseout

"""
    dti_iconeaseout(;kwargs...)

An IconEaseOut component.
...
"""
function dti_iconeaseout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeaseout", "IconEaseOut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
