...
export dti_iconambulance

"""
    dti_iconambulance(;kwargs...)

An IconAmbulance component.
...
"""
function dti_iconambulance(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconambulance", "IconAmbulance", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
