...
export dti_iconbrandairtable

"""
    dti_iconbrandairtable(;kwargs...)

An IconBrandAirtable component.
...
"""
function dti_iconbrandairtable(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandairtable", "IconBrandAirtable", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
