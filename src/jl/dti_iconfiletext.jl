...
export dti_iconfiletext

"""
    dti_iconfiletext(;kwargs...)

An IconFileText component.
...
"""
function dti_iconfiletext(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiletext", "IconFileText", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
