...
export dti_iconstethoscope

"""
    dti_iconstethoscope(;kwargs...)

An IconStethoscope component.
...
"""
function dti_iconstethoscope(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstethoscope", "IconStethoscope", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
