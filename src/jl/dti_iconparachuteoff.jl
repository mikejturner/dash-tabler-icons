...
export dti_iconparachuteoff

"""
    dti_iconparachuteoff(;kwargs...)

An IconParachuteOff component.
...
"""
function dti_iconparachuteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconparachuteoff", "IconParachuteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
