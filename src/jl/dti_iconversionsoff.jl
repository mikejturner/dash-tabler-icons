...
export dti_iconversionsoff

"""
    dti_iconversionsoff(;kwargs...)

An IconVersionsOff component.
...
"""
function dti_iconversionsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconversionsoff", "IconVersionsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
