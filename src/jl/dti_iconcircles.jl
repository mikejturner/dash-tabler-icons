...
export dti_iconcircles

"""
    dti_iconcircles(;kwargs...)

An IconCircles component.
...
"""
function dti_iconcircles(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircles", "IconCircles", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
