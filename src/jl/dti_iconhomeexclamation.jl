...
export dti_iconhomeexclamation

"""
    dti_iconhomeexclamation(;kwargs...)

An IconHomeExclamation component.
...
"""
function dti_iconhomeexclamation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeexclamation", "IconHomeExclamation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
