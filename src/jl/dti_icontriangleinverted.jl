...
export dti_icontriangleinverted

"""
    dti_icontriangleinverted(;kwargs...)

An IconTriangleInverted component.
...
"""
function dti_icontriangleinverted(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontriangleinverted", "IconTriangleInverted", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
