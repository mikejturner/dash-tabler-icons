...
export dti_iconfloatright

"""
    dti_iconfloatright(;kwargs...)

An IconFloatRight component.
...
"""
function dti_iconfloatright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfloatright", "IconFloatRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
