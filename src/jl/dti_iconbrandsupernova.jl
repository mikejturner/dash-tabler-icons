...
export dti_iconbrandsupernova

"""
    dti_iconbrandsupernova(;kwargs...)

An IconBrandSupernova component.
...
"""
function dti_iconbrandsupernova(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsupernova", "IconBrandSupernova", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
