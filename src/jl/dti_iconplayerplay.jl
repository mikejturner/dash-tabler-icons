...
export dti_iconplayerplay

"""
    dti_iconplayerplay(;kwargs...)

An IconPlayerPlay component.
...
"""
function dti_iconplayerplay(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayerplay", "IconPlayerPlay", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
