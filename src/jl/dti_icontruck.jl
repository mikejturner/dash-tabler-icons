...
export dti_icontruck

"""
    dti_icontruck(;kwargs...)

An IconTruck component.
...
"""
function dti_icontruck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontruck", "IconTruck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
