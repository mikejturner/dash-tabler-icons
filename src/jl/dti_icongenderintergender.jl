...
export dti_icongenderintergender

"""
    dti_icongenderintergender(;kwargs...)

An IconGenderIntergender component.
...
"""
function dti_icongenderintergender(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderintergender", "IconGenderIntergender", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
