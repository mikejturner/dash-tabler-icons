...
export dti_iconcodecircle

"""
    dti_iconcodecircle(;kwargs...)

An IconCodeCircle component.
...
"""
function dti_iconcodecircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcodecircle", "IconCodeCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
