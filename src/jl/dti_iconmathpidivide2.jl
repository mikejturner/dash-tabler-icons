...
export dti_iconmathpidivide2

"""
    dti_iconmathpidivide2(;kwargs...)

An IconMathPiDivide2 component.
...
"""
function dti_iconmathpidivide2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathpidivide2", "IconMathPiDivide2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
