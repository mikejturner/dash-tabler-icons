...
export dti_iconcamerarotate

"""
    dti_iconcamerarotate(;kwargs...)

An IconCameraRotate component.
...
"""
function dti_iconcamerarotate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcamerarotate", "IconCameraRotate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
