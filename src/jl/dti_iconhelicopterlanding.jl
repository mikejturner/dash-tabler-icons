...
export dti_iconhelicopterlanding

"""
    dti_iconhelicopterlanding(;kwargs...)

An IconHelicopterLanding component.
...
"""
function dti_iconhelicopterlanding(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhelicopterlanding", "IconHelicopterLanding", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
