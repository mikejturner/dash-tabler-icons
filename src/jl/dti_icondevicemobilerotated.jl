...
export dti_icondevicemobilerotated

"""
    dti_icondevicemobilerotated(;kwargs...)

An IconDeviceMobileRotated component.
...
"""
function dti_icondevicemobilerotated(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicemobilerotated", "IconDeviceMobileRotated", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
