...
export dti_iconarrowupright

"""
    dti_iconarrowupright(;kwargs...)

An IconArrowUpRight component.
...
"""
function dti_iconarrowupright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowupright", "IconArrowUpRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
