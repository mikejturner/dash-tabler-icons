...
export dti_icontestpipeoff

"""
    dti_icontestpipeoff(;kwargs...)

An IconTestPipeOff component.
...
"""
function dti_icontestpipeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontestpipeoff", "IconTestPipeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
