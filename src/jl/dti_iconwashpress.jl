...
export dti_iconwashpress

"""
    dti_iconwashpress(;kwargs...)

An IconWashPress component.
...
"""
function dti_iconwashpress(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashpress", "IconWashPress", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
