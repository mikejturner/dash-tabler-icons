...
export dti_iconmedicinesyrup

"""
    dti_iconmedicinesyrup(;kwargs...)

An IconMedicineSyrup component.
...
"""
function dti_iconmedicinesyrup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmedicinesyrup", "IconMedicineSyrup", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
