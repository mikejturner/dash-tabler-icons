...
export dti_iconstackpush

"""
    dti_iconstackpush(;kwargs...)

An IconStackPush component.
...
"""
function dti_iconstackpush(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstackpush", "IconStackPush", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
