...
export dti_iconassembly

"""
    dti_iconassembly(;kwargs...)

An IconAssembly component.
...
"""
function dti_iconassembly(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconassembly", "IconAssembly", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
