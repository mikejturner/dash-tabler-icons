...
export dti_iconreplaceoff

"""
    dti_iconreplaceoff(;kwargs...)

An IconReplaceOff component.
...
"""
function dti_iconreplaceoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreplaceoff", "IconReplaceOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
