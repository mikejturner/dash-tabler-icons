...
export dti_iconbrandreactnative

"""
    dti_iconbrandreactnative(;kwargs...)

An IconBrandReactNative component.
...
"""
function dti_iconbrandreactnative(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandreactnative", "IconBrandReactNative", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
