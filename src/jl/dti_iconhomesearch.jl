...
export dti_iconhomesearch

"""
    dti_iconhomesearch(;kwargs...)

An IconHomeSearch component.
...
"""
function dti_iconhomesearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomesearch", "IconHomeSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
