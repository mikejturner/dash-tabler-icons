...
export dti_iconnumber2

"""
    dti_iconnumber2(;kwargs...)

An IconNumber2 component.
...
"""
function dti_iconnumber2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber2", "IconNumber2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
