...
export dti_iconbookoff

"""
    dti_iconbookoff(;kwargs...)

An IconBookOff component.
...
"""
function dti_iconbookoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbookoff", "IconBookOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
