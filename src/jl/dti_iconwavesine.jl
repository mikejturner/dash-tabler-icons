...
export dti_iconwavesine

"""
    dti_iconwavesine(;kwargs...)

An IconWaveSine component.
...
"""
function dti_iconwavesine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwavesine", "IconWaveSine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
