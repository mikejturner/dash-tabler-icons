...
export dti_iconbrightnessdown

"""
    dti_iconbrightnessdown(;kwargs...)

An IconBrightnessDown component.
...
"""
function dti_iconbrightnessdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrightnessdown", "IconBrightnessDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
