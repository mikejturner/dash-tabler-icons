...
export dti_icondiscount2

"""
    dti_icondiscount2(;kwargs...)

An IconDiscount2 component.
...
"""
function dti_icondiscount2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscount2", "IconDiscount2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
