...
export dti_iconjewishstar

"""
    dti_iconjewishstar(;kwargs...)

An IconJewishStar component.
...
"""
function dti_iconjewishstar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconjewishstar", "IconJewishStar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
