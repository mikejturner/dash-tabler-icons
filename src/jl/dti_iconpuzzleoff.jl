...
export dti_iconpuzzleoff

"""
    dti_iconpuzzleoff(;kwargs...)

An IconPuzzleOff component.
...
"""
function dti_iconpuzzleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpuzzleoff", "IconPuzzleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
