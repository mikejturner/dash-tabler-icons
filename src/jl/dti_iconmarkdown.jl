...
export dti_iconmarkdown

"""
    dti_iconmarkdown(;kwargs...)

An IconMarkdown component.
...
"""
function dti_iconmarkdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmarkdown", "IconMarkdown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
