...
export dti_iconswitch2

"""
    dti_iconswitch2(;kwargs...)

An IconSwitch2 component.
...
"""
function dti_iconswitch2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswitch2", "IconSwitch2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
