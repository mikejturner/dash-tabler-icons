...
export dti_iconexposureminus1

"""
    dti_iconexposureminus1(;kwargs...)

An IconExposureMinus1 component.
...
"""
function dti_iconexposureminus1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposureminus1", "IconExposureMinus1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
