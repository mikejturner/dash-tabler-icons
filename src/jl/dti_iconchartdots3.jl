...
export dti_iconchartdots3

"""
    dti_iconchartdots3(;kwargs...)

An IconChartDots3 component.
...
"""
function dti_iconchartdots3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdots3", "IconChartDots3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
