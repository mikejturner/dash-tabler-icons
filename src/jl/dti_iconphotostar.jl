...
export dti_iconphotostar

"""
    dti_iconphotostar(;kwargs...)

An IconPhotoStar component.
...
"""
function dti_iconphotostar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotostar", "IconPhotoStar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
