...
export dti_iconarrowbigdownlines

"""
    dti_iconarrowbigdownlines(;kwargs...)

An IconArrowBigDownLines component.
...
"""
function dti_iconarrowbigdownlines(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigdownlines", "IconArrowBigDownLines", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
