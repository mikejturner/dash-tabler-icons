...
export dti_iconapioff

"""
    dti_iconapioff(;kwargs...)

An IconApiOff component.
...
"""
function dti_iconapioff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconapioff", "IconApiOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
