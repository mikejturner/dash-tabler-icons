...
export dti_iconshape3

"""
    dti_iconshape3(;kwargs...)

An IconShape3 component.
...
"""
function dti_iconshape3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshape3", "IconShape3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
