...
export dti_iconcurrencydollarguyanese

"""
    dti_iconcurrencydollarguyanese(;kwargs...)

An IconCurrencyDollarGuyanese component.
...
"""
function dti_iconcurrencydollarguyanese(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollarguyanese", "IconCurrencyDollarGuyanese", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
