...
export dti_iconsword

"""
    dti_iconsword(;kwargs...)

An IconSword component.
...
"""
function dti_iconsword(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsword", "IconSword", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
