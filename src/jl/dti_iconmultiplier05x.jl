...
export dti_iconmultiplier05x

"""
    dti_iconmultiplier05x(;kwargs...)

An IconMultiplier05x component.
...
"""
function dti_iconmultiplier05x(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmultiplier05x", "IconMultiplier05x", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
