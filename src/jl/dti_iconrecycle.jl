...
export dti_iconrecycle

"""
    dti_iconrecycle(;kwargs...)

An IconRecycle component.
...
"""
function dti_iconrecycle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrecycle", "IconRecycle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
