...
export dti_iconhomeshield

"""
    dti_iconhomeshield(;kwargs...)

An IconHomeShield component.
...
"""
function dti_iconhomeshield(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeshield", "IconHomeShield", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
