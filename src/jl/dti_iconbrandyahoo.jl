...
export dti_iconbrandyahoo

"""
    dti_iconbrandyahoo(;kwargs...)

An IconBrandYahoo component.
...
"""
function dti_iconbrandyahoo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandyahoo", "IconBrandYahoo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
