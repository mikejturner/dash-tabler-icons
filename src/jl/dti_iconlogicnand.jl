...
export dti_iconlogicnand

"""
    dti_iconlogicnand(;kwargs...)

An IconLogicNand component.
...
"""
function dti_iconlogicnand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicnand", "IconLogicNand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
