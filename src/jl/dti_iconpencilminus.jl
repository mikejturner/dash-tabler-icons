...
export dti_iconpencilminus

"""
    dti_iconpencilminus(;kwargs...)

An IconPencilMinus component.
...
"""
function dti_iconpencilminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpencilminus", "IconPencilMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
