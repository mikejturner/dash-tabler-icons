...
export dti_icontemperaturefahrenheit

"""
    dti_icontemperaturefahrenheit(;kwargs...)

An IconTemperatureFahrenheit component.
...
"""
function dti_icontemperaturefahrenheit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemperaturefahrenheit", "IconTemperatureFahrenheit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
