...
export dti_iconeraseroff

"""
    dti_iconeraseroff(;kwargs...)

An IconEraserOff component.
...
"""
function dti_iconeraseroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeraseroff", "IconEraserOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
