...
export dti_iconsquareplus

"""
    dti_iconsquareplus(;kwargs...)

An IconSquarePlus component.
...
"""
function dti_iconsquareplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareplus", "IconSquarePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
