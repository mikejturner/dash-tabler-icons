...
export dti_iconneedle

"""
    dti_iconneedle(;kwargs...)

An IconNeedle component.
...
"""
function dti_iconneedle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconneedle", "IconNeedle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
