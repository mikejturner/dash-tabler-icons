...
export dti_iconzodiacaries

"""
    dti_iconzodiacaries(;kwargs...)

An IconZodiacAries component.
...
"""
function dti_iconzodiacaries(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacaries", "IconZodiacAries", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
