...
export dti_iconborderinner

"""
    dti_iconborderinner(;kwargs...)

An IconBorderInner component.
...
"""
function dti_iconborderinner(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderinner", "IconBorderInner", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
