...
export dti_iconcircleletterb

"""
    dti_iconcircleletterb(;kwargs...)

An IconCircleLetterB component.
...
"""
function dti_iconcircleletterb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterb", "IconCircleLetterB", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
