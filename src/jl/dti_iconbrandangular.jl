...
export dti_iconbrandangular

"""
    dti_iconbrandangular(;kwargs...)

An IconBrandAngular component.
...
"""
function dti_iconbrandangular(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandangular", "IconBrandAngular", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
