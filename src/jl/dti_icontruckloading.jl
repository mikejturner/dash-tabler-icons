...
export dti_icontruckloading

"""
    dti_icontruckloading(;kwargs...)

An IconTruckLoading component.
...
"""
function dti_icontruckloading(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontruckloading", "IconTruckLoading", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
