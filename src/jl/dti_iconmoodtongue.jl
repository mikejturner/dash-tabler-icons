...
export dti_iconmoodtongue

"""
    dti_iconmoodtongue(;kwargs...)

An IconMoodTongue component.
...
"""
function dti_iconmoodtongue(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodtongue", "IconMoodTongue", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
