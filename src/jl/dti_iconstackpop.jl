...
export dti_iconstackpop

"""
    dti_iconstackpop(;kwargs...)

An IconStackPop component.
...
"""
function dti_iconstackpop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstackpop", "IconStackPop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
