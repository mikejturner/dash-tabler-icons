...
export dti_iconsquarerotated

"""
    dti_iconsquarerotated(;kwargs...)

An IconSquareRotated component.
...
"""
function dti_iconsquarerotated(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarerotated", "IconSquareRotated", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
