...
export dti_iconarrowbartodown

"""
    dti_iconarrowbartodown(;kwargs...)

An IconArrowBarToDown component.
...
"""
function dti_iconarrowbartodown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbartodown", "IconArrowBarToDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
