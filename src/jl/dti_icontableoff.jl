...
export dti_icontableoff

"""
    dti_icontableoff(;kwargs...)

An IconTableOff component.
...
"""
function dti_icontableoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontableoff", "IconTableOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
