...
export dti_iconmoodsaddizzy

"""
    dti_iconmoodsaddizzy(;kwargs...)

An IconMoodSadDizzy component.
...
"""
function dti_iconmoodsaddizzy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsaddizzy", "IconMoodSadDizzy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
