...
export dti_iconidbadge2

"""
    dti_iconidbadge2(;kwargs...)

An IconIdBadge2 component.
...
"""
function dti_iconidbadge2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconidbadge2", "IconIdBadge2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
