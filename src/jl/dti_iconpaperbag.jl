...
export dti_iconpaperbag

"""
    dti_iconpaperbag(;kwargs...)

An IconPaperBag component.
...
"""
function dti_iconpaperbag(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpaperbag", "IconPaperBag", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
