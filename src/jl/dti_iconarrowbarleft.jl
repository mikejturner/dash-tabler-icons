...
export dti_iconarrowbarleft

"""
    dti_iconarrowbarleft(;kwargs...)

An IconArrowBarLeft component.
...
"""
function dti_iconarrowbarleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbarleft", "IconArrowBarLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
