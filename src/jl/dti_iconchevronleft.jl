...
export dti_iconchevronleft

"""
    dti_iconchevronleft(;kwargs...)

An IconChevronLeft component.
...
"""
function dti_iconchevronleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronleft", "IconChevronLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
