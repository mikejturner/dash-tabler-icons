...
export dti_iconbrandsnapchat

"""
    dti_iconbrandsnapchat(;kwargs...)

An IconBrandSnapchat component.
...
"""
function dti_iconbrandsnapchat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsnapchat", "IconBrandSnapchat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
