...
export dti_iconbrandfinder

"""
    dti_iconbrandfinder(;kwargs...)

An IconBrandFinder component.
...
"""
function dti_iconbrandfinder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfinder", "IconBrandFinder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
