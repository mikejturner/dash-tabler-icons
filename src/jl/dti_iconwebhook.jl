...
export dti_iconwebhook

"""
    dti_iconwebhook(;kwargs...)

An IconWebhook component.
...
"""
function dti_iconwebhook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwebhook", "IconWebhook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
