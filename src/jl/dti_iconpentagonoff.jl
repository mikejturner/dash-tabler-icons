...
export dti_iconpentagonoff

"""
    dti_iconpentagonoff(;kwargs...)

An IconPentagonOff component.
...
"""
function dti_iconpentagonoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpentagonoff", "IconPentagonOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
