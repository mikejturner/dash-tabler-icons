...
export dti_iconswords

"""
    dti_iconswords(;kwargs...)

An IconSwords component.
...
"""
function dti_iconswords(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswords", "IconSwords", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
