...
export dti_icondevicesim3

"""
    dti_icondevicesim3(;kwargs...)

An IconDeviceSim3 component.
...
"""
function dti_icondevicesim3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicesim3", "IconDeviceSim3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
