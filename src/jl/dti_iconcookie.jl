...
export dti_iconcookie

"""
    dti_iconcookie(;kwargs...)

An IconCookie component.
...
"""
function dti_iconcookie(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcookie", "IconCookie", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
