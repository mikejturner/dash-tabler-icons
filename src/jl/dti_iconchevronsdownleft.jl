...
export dti_iconchevronsdownleft

"""
    dti_iconchevronsdownleft(;kwargs...)

An IconChevronsDownLeft component.
...
"""
function dti_iconchevronsdownleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsdownleft", "IconChevronsDownLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
