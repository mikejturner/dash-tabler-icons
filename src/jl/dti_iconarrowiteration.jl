...
export dti_iconarrowiteration

"""
    dti_iconarrowiteration(;kwargs...)

An IconArrowIteration component.
...
"""
function dti_iconarrowiteration(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowiteration", "IconArrowIteration", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
