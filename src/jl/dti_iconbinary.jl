...
export dti_iconbinary

"""
    dti_iconbinary(;kwargs...)

An IconBinary component.
...
"""
function dti_iconbinary(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbinary", "IconBinary", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
