...
export dti_iconletterz

"""
    dti_iconletterz(;kwargs...)

An IconLetterZ component.
...
"""
function dti_iconletterz(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterz", "IconLetterZ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
