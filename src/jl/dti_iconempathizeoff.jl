...
export dti_iconempathizeoff

"""
    dti_iconempathizeoff(;kwargs...)

An IconEmpathizeOff component.
...
"""
function dti_iconempathizeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconempathizeoff", "IconEmpathizeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
