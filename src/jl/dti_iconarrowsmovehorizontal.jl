...
export dti_iconarrowsmovehorizontal

"""
    dti_iconarrowsmovehorizontal(;kwargs...)

An IconArrowsMoveHorizontal component.
...
"""
function dti_iconarrowsmovehorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsmovehorizontal", "IconArrowsMoveHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
