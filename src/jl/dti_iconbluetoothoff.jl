...
export dti_iconbluetoothoff

"""
    dti_iconbluetoothoff(;kwargs...)

An IconBluetoothOff component.
...
"""
function dti_iconbluetoothoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbluetoothoff", "IconBluetoothOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
