...
export dti_iconphotoheart

"""
    dti_iconphotoheart(;kwargs...)

An IconPhotoHeart component.
...
"""
function dti_iconphotoheart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotoheart", "IconPhotoHeart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
