...
export dti_iconumbrellaoff

"""
    dti_iconumbrellaoff(;kwargs...)

An IconUmbrellaOff component.
...
"""
function dti_iconumbrellaoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconumbrellaoff", "IconUmbrellaOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
