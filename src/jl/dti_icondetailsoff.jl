...
export dti_icondetailsoff

"""
    dti_icondetailsoff(;kwargs...)

An IconDetailsOff component.
...
"""
function dti_icondetailsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondetailsoff", "IconDetailsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
