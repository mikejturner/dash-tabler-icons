...
export dti_iconbrandvisa

"""
    dti_iconbrandvisa(;kwargs...)

An IconBrandVisa component.
...
"""
function dti_iconbrandvisa(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvisa", "IconBrandVisa", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
