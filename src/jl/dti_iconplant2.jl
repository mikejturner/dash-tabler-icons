...
export dti_iconplant2

"""
    dti_iconplant2(;kwargs...)

An IconPlant2 component.
...
"""
function dti_iconplant2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplant2", "IconPlant2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
