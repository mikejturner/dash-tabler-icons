...
export dti_iconfiledownload

"""
    dti_iconfiledownload(;kwargs...)

An IconFileDownload component.
...
"""
function dti_iconfiledownload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledownload", "IconFileDownload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
