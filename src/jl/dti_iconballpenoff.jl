...
export dti_iconballpenoff

"""
    dti_iconballpenoff(;kwargs...)

An IconBallpenOff component.
...
"""
function dti_iconballpenoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballpenoff", "IconBallpenOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
