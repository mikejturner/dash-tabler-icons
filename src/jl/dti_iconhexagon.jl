...
export dti_iconhexagon

"""
    dti_iconhexagon(;kwargs...)

An IconHexagon component.
...
"""
function dti_iconhexagon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagon", "IconHexagon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
