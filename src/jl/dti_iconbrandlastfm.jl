...
export dti_iconbrandlastfm

"""
    dti_iconbrandlastfm(;kwargs...)

An IconBrandLastfm component.
...
"""
function dti_iconbrandlastfm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandlastfm", "IconBrandLastfm", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
