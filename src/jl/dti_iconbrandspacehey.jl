...
export dti_iconbrandspacehey

"""
    dti_iconbrandspacehey(;kwargs...)

An IconBrandSpacehey component.
...
"""
function dti_iconbrandspacehey(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandspacehey", "IconBrandSpacehey", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
