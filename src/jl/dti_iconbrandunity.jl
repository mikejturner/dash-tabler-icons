...
export dti_iconbrandunity

"""
    dti_iconbrandunity(;kwargs...)

An IconBrandUnity component.
...
"""
function dti_iconbrandunity(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandunity", "IconBrandUnity", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
