...
export dti_iconarrowsexchange2

"""
    dti_iconarrowsexchange2(;kwargs...)

An IconArrowsExchange2 component.
...
"""
function dti_iconarrowsexchange2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsexchange2", "IconArrowsExchange2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
