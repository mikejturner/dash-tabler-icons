...
export dti_iconscaneye

"""
    dti_iconscaneye(;kwargs...)

An IconScanEye component.
...
"""
function dti_iconscaneye(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscaneye", "IconScanEye", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
