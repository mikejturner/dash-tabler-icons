...
export dti_iconstethoscopeoff

"""
    dti_iconstethoscopeoff(;kwargs...)

An IconStethoscopeOff component.
...
"""
function dti_iconstethoscopeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstethoscopeoff", "IconStethoscopeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
