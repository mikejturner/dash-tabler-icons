...
export dti_iconarrowbigupline

"""
    dti_iconarrowbigupline(;kwargs...)

An IconArrowBigUpLine component.
...
"""
function dti_iconarrowbigupline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigupline", "IconArrowBigUpLine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
