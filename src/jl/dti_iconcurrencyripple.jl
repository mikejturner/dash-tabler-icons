...
export dti_iconcurrencyripple

"""
    dti_iconcurrencyripple(;kwargs...)

An IconCurrencyRipple component.
...
"""
function dti_iconcurrencyripple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyripple", "IconCurrencyRipple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
