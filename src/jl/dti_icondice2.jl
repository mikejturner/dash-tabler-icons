...
export dti_icondice2

"""
    dti_icondice2(;kwargs...)

An IconDice2 component.
...
"""
function dti_icondice2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondice2", "IconDice2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
