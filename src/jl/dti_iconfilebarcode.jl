...
export dti_iconfilebarcode

"""
    dti_iconfilebarcode(;kwargs...)

An IconFileBarcode component.
...
"""
function dti_iconfilebarcode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilebarcode", "IconFileBarcode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
