...
export dti_iconlayoutdistributehorizontal

"""
    dti_iconlayoutdistributehorizontal(;kwargs...)

An IconLayoutDistributeHorizontal component.
...
"""
function dti_iconlayoutdistributehorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutdistributehorizontal", "IconLayoutDistributeHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
