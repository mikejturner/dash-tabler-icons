...
export dti_iconarrowsmovevertical

"""
    dti_iconarrowsmovevertical(;kwargs...)

An IconArrowsMoveVertical component.
...
"""
function dti_iconarrowsmovevertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsmovevertical", "IconArrowsMoveVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
