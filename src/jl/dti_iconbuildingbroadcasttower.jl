...
export dti_iconbuildingbroadcasttower

"""
    dti_iconbuildingbroadcasttower(;kwargs...)

An IconBuildingBroadcastTower component.
...
"""
function dti_iconbuildingbroadcasttower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingbroadcasttower", "IconBuildingBroadcastTower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
