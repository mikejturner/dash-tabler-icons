...
export dti_icondevicewatch

"""
    dti_icondevicewatch(;kwargs...)

An IconDeviceWatch component.
...
"""
function dti_icondevicewatch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicewatch", "IconDeviceWatch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
