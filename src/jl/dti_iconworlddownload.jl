...
export dti_iconworlddownload

"""
    dti_iconworlddownload(;kwargs...)

An IconWorldDownload component.
...
"""
function dti_iconworlddownload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworlddownload", "IconWorldDownload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
