...
export dti_iconlockoff

"""
    dti_iconlockoff(;kwargs...)

An IconLockOff component.
...
"""
function dti_iconlockoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlockoff", "IconLockOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
