...
export dti_iconbrandmailgun

"""
    dti_iconbrandmailgun(;kwargs...)

An IconBrandMailgun component.
...
"""
function dti_iconbrandmailgun(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmailgun", "IconBrandMailgun", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
