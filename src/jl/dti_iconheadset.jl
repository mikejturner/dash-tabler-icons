...
export dti_iconheadset

"""
    dti_iconheadset(;kwargs...)

An IconHeadset component.
...
"""
function dti_iconheadset(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheadset", "IconHeadset", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
