...
export dti_iconheadphonesoff

"""
    dti_iconheadphonesoff(;kwargs...)

An IconHeadphonesOff component.
...
"""
function dti_iconheadphonesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheadphonesoff", "IconHeadphonesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
