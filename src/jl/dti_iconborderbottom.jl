...
export dti_iconborderbottom

"""
    dti_iconborderbottom(;kwargs...)

An IconBorderBottom component.
...
"""
function dti_iconborderbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderbottom", "IconBorderBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
