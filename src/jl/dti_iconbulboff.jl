...
export dti_iconbulboff

"""
    dti_iconbulboff(;kwargs...)

An IconBulbOff component.
...
"""
function dti_iconbulboff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbulboff", "IconBulbOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
