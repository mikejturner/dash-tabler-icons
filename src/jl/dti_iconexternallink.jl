...
export dti_iconexternallink

"""
    dti_iconexternallink(;kwargs...)

An IconExternalLink component.
...
"""
function dti_iconexternallink(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexternallink", "IconExternalLink", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
