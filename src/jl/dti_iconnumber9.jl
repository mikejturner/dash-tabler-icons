...
export dti_iconnumber9

"""
    dti_iconnumber9(;kwargs...)

An IconNumber9 component.
...
"""
function dti_iconnumber9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber9", "IconNumber9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
