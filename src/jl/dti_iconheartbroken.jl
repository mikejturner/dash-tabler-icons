...
export dti_iconheartbroken

"""
    dti_iconheartbroken(;kwargs...)

An IconHeartBroken component.
...
"""
function dti_iconheartbroken(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartbroken", "IconHeartBroken", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
