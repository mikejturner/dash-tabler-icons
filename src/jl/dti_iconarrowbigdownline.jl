...
export dti_iconarrowbigdownline

"""
    dti_iconarrowbigdownline(;kwargs...)

An IconArrowBigDownLine component.
...
"""
function dti_iconarrowbigdownline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigdownline", "IconArrowBigDownLine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
