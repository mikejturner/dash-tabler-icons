...
export dti_iconmoodangry

"""
    dti_iconmoodangry(;kwargs...)

An IconMoodAngry component.
...
"""
function dti_iconmoodangry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodangry", "IconMoodAngry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
