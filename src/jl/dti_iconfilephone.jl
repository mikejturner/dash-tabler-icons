...
export dti_iconfilephone

"""
    dti_iconfilephone(;kwargs...)

An IconFilePhone component.
...
"""
function dti_iconfilephone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilephone", "IconFilePhone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
