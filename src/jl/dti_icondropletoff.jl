...
export dti_icondropletoff

"""
    dti_icondropletoff(;kwargs...)

An IconDropletOff component.
...
"""
function dti_icondropletoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondropletoff", "IconDropletOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
