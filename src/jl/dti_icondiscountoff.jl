...
export dti_icondiscountoff

"""
    dti_icondiscountoff(;kwargs...)

An IconDiscountOff component.
...
"""
function dti_icondiscountoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscountoff", "IconDiscountOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
