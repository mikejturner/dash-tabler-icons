...
export dti_iconballamericanfootballoff

"""
    dti_iconballamericanfootballoff(;kwargs...)

An IconBallAmericanFootballOff component.
...
"""
function dti_iconballamericanfootballoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballamericanfootballoff", "IconBallAmericanFootballOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
