...
export dti_iconaugmentedreality2

"""
    dti_iconaugmentedreality2(;kwargs...)

An IconAugmentedReality2 component.
...
"""
function dti_iconaugmentedreality2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaugmentedreality2", "IconAugmentedReality2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
