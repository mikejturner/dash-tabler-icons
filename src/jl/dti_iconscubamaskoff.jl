...
export dti_iconscubamaskoff

"""
    dti_iconscubamaskoff(;kwargs...)

An IconScubaMaskOff component.
...
"""
function dti_iconscubamaskoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscubamaskoff", "IconScubaMaskOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
