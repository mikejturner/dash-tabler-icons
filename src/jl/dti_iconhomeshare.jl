...
export dti_iconhomeshare

"""
    dti_iconhomeshare(;kwargs...)

An IconHomeShare component.
...
"""
function dti_iconhomeshare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeshare", "IconHomeShare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
