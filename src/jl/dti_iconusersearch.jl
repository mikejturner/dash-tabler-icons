...
export dti_iconusersearch

"""
    dti_iconusersearch(;kwargs...)

An IconUserSearch component.
...
"""
function dti_iconusersearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconusersearch", "IconUserSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
