...
export dti_iconcodeasterix

"""
    dti_iconcodeasterix(;kwargs...)

An IconCodeAsterix component.
...
"""
function dti_iconcodeasterix(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcodeasterix", "IconCodeAsterix", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
