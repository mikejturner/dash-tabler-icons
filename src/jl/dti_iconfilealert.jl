...
export dti_iconfilealert

"""
    dti_iconfilealert(;kwargs...)

An IconFileAlert component.
...
"""
function dti_iconfilealert(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilealert", "IconFileAlert", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
