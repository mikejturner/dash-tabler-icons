...
export dti_iconfilechart

"""
    dti_iconfilechart(;kwargs...)

An IconFileChart component.
...
"""
function dti_iconfilechart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilechart", "IconFileChart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
