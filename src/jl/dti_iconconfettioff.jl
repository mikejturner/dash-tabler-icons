...
export dti_iconconfettioff

"""
    dti_iconconfettioff(;kwargs...)

An IconConfettiOff component.
...
"""
function dti_iconconfettioff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconconfettioff", "IconConfettiOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
