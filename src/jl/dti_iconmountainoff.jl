...
export dti_iconmountainoff

"""
    dti_iconmountainoff(;kwargs...)

An IconMountainOff component.
...
"""
function dti_iconmountainoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmountainoff", "IconMountainOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
