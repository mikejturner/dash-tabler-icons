...
export dti_iconmappins

"""
    dti_iconmappins(;kwargs...)

An IconMapPins component.
...
"""
function dti_iconmappins(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmappins", "IconMapPins", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
