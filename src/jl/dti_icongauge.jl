...
export dti_icongauge

"""
    dti_icongauge(;kwargs...)

An IconGauge component.
...
"""
function dti_icongauge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongauge", "IconGauge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
