...
export dti_iconcrane

"""
    dti_iconcrane(;kwargs...)

An IconCrane component.
...
"""
function dti_iconcrane(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrane", "IconCrane", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
