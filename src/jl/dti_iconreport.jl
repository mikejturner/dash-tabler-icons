...
export dti_iconreport

"""
    dti_iconreport(;kwargs...)

An IconReport component.
...
"""
function dti_iconreport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreport", "IconReport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
