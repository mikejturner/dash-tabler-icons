...
export dti_iconarrowdownrightcircle

"""
    dti_iconarrowdownrightcircle(;kwargs...)

An IconArrowDownRightCircle component.
...
"""
function dti_iconarrowdownrightcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdownrightcircle", "IconArrowDownRightCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
