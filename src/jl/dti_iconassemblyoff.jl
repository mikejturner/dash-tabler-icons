...
export dti_iconassemblyoff

"""
    dti_iconassemblyoff(;kwargs...)

An IconAssemblyOff component.
...
"""
function dti_iconassemblyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconassemblyoff", "IconAssemblyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
