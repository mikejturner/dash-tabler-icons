...
export dti_iconbrandadonisjs

"""
    dti_iconbrandadonisjs(;kwargs...)

An IconBrandAdonisJs component.
...
"""
function dti_iconbrandadonisjs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandadonisjs", "IconBrandAdonisJs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
