...
export dti_iconwallpaperoff

"""
    dti_iconwallpaperoff(;kwargs...)

An IconWallpaperOff component.
...
"""
function dti_iconwallpaperoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwallpaperoff", "IconWallpaperOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
