...
export dti_iconinnershadowtopright

"""
    dti_iconinnershadowtopright(;kwargs...)

An IconInnerShadowTopRight component.
...
"""
function dti_iconinnershadowtopright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowtopright", "IconInnerShadowTopRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
