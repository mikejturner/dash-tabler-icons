...
export dti_iconbrandgmail

"""
    dti_iconbrandgmail(;kwargs...)

An IconBrandGmail component.
...
"""
function dti_iconbrandgmail(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgmail", "IconBrandGmail", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
