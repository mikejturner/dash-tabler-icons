...
export dti_iconvectortriangleoff

"""
    dti_iconvectortriangleoff(;kwargs...)

An IconVectorTriangleOff component.
...
"""
function dti_iconvectortriangleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectortriangleoff", "IconVectorTriangleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
