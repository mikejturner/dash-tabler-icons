...
export dti_icontimelineevent

"""
    dti_icontimelineevent(;kwargs...)

An IconTimelineEvent component.
...
"""
function dti_icontimelineevent(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontimelineevent", "IconTimelineEvent", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
