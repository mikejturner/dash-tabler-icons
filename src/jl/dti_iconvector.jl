...
export dti_iconvector

"""
    dti_iconvector(;kwargs...)

An IconVector component.
...
"""
function dti_iconvector(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvector", "IconVector", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
