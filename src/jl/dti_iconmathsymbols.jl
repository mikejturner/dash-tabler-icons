...
export dti_iconmathsymbols

"""
    dti_iconmathsymbols(;kwargs...)

An IconMathSymbols component.
...
"""
function dti_iconmathsymbols(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathsymbols", "IconMathSymbols", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
