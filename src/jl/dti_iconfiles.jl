...
export dti_iconfiles

"""
    dti_iconfiles(;kwargs...)

An IconFiles component.
...
"""
function dti_iconfiles(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiles", "IconFiles", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
