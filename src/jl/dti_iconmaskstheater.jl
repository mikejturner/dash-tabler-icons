...
export dti_iconmaskstheater

"""
    dti_iconmaskstheater(;kwargs...)

An IconMasksTheater component.
...
"""
function dti_iconmaskstheater(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmaskstheater", "IconMasksTheater", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
