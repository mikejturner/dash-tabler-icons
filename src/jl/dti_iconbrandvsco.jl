...
export dti_iconbrandvsco

"""
    dti_iconbrandvsco(;kwargs...)

An IconBrandVsco component.
...
"""
function dti_iconbrandvsco(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvsco", "IconBrandVsco", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
