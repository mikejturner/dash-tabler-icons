...
export dti_iconpenciloff

"""
    dti_iconpenciloff(;kwargs...)

An IconPencilOff component.
...
"""
function dti_iconpenciloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpenciloff", "IconPencilOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
