...
export dti_iconsquarecheck

"""
    dti_iconsquarecheck(;kwargs...)

An IconSquareCheck component.
...
"""
function dti_iconsquarecheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarecheck", "IconSquareCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
