...
export dti_iconcircleletterc

"""
    dti_iconcircleletterc(;kwargs...)

An IconCircleLetterC component.
...
"""
function dti_iconcircleletterc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterc", "IconCircleLetterC", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
