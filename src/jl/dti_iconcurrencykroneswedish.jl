...
export dti_iconcurrencykroneswedish

"""
    dti_iconcurrencykroneswedish(;kwargs...)

An IconCurrencyKroneSwedish component.
...
"""
function dti_iconcurrencykroneswedish(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencykroneswedish", "IconCurrencyKroneSwedish", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
