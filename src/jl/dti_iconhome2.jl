...
export dti_iconhome2

"""
    dti_iconhome2(;kwargs...)

An IconHome2 component.
...
"""
function dti_iconhome2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhome2", "IconHome2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
