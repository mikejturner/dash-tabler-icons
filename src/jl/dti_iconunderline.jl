...
export dti_iconunderline

"""
    dti_iconunderline(;kwargs...)

An IconUnderline component.
...
"""
function dti_iconunderline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconunderline", "IconUnderline", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
