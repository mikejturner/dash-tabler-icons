...
export dti_iconradar2

"""
    dti_iconradar2(;kwargs...)

An IconRadar2 component.
...
"""
function dti_iconradar2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradar2", "IconRadar2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
