...
export dti_iconchevrondown

"""
    dti_iconchevrondown(;kwargs...)

An IconChevronDown component.
...
"""
function dti_iconchevrondown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevrondown", "IconChevronDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
