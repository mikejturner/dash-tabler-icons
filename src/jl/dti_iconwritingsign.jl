...
export dti_iconwritingsign

"""
    dti_iconwritingsign(;kwargs...)

An IconWritingSign component.
...
"""
function dti_iconwritingsign(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwritingsign", "IconWritingSign", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
