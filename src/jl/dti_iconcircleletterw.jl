...
export dti_iconcircleletterw

"""
    dti_iconcircleletterw(;kwargs...)

An IconCircleLetterW component.
...
"""
function dti_iconcircleletterw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterw", "IconCircleLetterW", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
