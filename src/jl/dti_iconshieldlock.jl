...
export dti_iconshieldlock

"""
    dti_iconshieldlock(;kwargs...)

An IconShieldLock component.
...
"""
function dti_iconshieldlock(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldlock", "IconShieldLock", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
