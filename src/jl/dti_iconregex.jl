...
export dti_iconregex

"""
    dti_iconregex(;kwargs...)

An IconRegex component.
...
"""
function dti_iconregex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconregex", "IconRegex", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
