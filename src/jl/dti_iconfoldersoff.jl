...
export dti_iconfoldersoff

"""
    dti_iconfoldersoff(;kwargs...)

An IconFoldersOff component.
...
"""
function dti_iconfoldersoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfoldersoff", "IconFoldersOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
