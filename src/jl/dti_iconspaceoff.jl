...
export dti_iconspaceoff

"""
    dti_iconspaceoff(;kwargs...)

An IconSpaceOff component.
...
"""
function dti_iconspaceoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspaceoff", "IconSpaceOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
