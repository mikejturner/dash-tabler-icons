...
export dti_iconphotosearch

"""
    dti_iconphotosearch(;kwargs...)

An IconPhotoSearch component.
...
"""
function dti_iconphotosearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotosearch", "IconPhotoSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
