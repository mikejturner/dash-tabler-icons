...
export dti_iconshoppingcartdiscount

"""
    dti_iconshoppingcartdiscount(;kwargs...)

An IconShoppingCartDiscount component.
...
"""
function dti_iconshoppingcartdiscount(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshoppingcartdiscount", "IconShoppingCartDiscount", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
