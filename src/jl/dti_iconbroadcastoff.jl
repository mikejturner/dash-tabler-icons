...
export dti_iconbroadcastoff

"""
    dti_iconbroadcastoff(;kwargs...)

An IconBroadcastOff component.
...
"""
function dti_iconbroadcastoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbroadcastoff", "IconBroadcastOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
