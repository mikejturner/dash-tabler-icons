...
export dti_iconcircuitbulb

"""
    dti_iconcircuitbulb(;kwargs...)

An IconCircuitBulb component.
...
"""
function dti_iconcircuitbulb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitbulb", "IconCircuitBulb", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
