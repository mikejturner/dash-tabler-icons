...
export dti_icondisabled2

"""
    dti_icondisabled2(;kwargs...)

An IconDisabled2 component.
...
"""
function dti_icondisabled2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondisabled2", "IconDisabled2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
