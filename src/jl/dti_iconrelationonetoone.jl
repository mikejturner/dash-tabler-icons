...
export dti_iconrelationonetoone

"""
    dti_iconrelationonetoone(;kwargs...)

An IconRelationOneToOne component.
...
"""
function dti_iconrelationonetoone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrelationonetoone", "IconRelationOneToOne", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
