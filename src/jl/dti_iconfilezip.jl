...
export dti_iconfilezip

"""
    dti_iconfilezip(;kwargs...)

An IconFileZip component.
...
"""
function dti_iconfilezip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilezip", "IconFileZip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
