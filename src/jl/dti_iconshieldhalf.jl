...
export dti_iconshieldhalf

"""
    dti_iconshieldhalf(;kwargs...)

An IconShieldHalf component.
...
"""
function dti_iconshieldhalf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldhalf", "IconShieldHalf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
