...
export dti_iconlistnumbers

"""
    dti_iconlistnumbers(;kwargs...)

An IconListNumbers component.
...
"""
function dti_iconlistnumbers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlistnumbers", "IconListNumbers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
