...
export dti_icongrill

"""
    dti_icongrill(;kwargs...)

An IconGrill component.
...
"""
function dti_icongrill(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrill", "IconGrill", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
