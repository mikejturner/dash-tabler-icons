...
export dti_iconerror404off

"""
    dti_iconerror404off(;kwargs...)

An IconError404Off component.
...
"""
function dti_iconerror404off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconerror404off", "IconError404Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
