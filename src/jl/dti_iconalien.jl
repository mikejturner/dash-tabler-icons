...
export dti_iconalien

"""
    dti_iconalien(;kwargs...)

An IconAlien component.
...
"""
function dti_iconalien(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalien", "IconAlien", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
