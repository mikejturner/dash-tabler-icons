...
export dti_iconcreditcard

"""
    dti_iconcreditcard(;kwargs...)

An IconCreditCard component.
...
"""
function dti_iconcreditcard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreditcard", "IconCreditCard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
