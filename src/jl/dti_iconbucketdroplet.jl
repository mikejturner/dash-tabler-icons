...
export dti_iconbucketdroplet

"""
    dti_iconbucketdroplet(;kwargs...)

An IconBucketDroplet component.
...
"""
function dti_iconbucketdroplet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbucketdroplet", "IconBucketDroplet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
