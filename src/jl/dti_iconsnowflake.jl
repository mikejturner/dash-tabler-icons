...
export dti_iconsnowflake

"""
    dti_iconsnowflake(;kwargs...)

An IconSnowflake component.
...
"""
function dti_iconsnowflake(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsnowflake", "IconSnowflake", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
