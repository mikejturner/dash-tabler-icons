...
export dti_iconcircleletteri

"""
    dti_iconcircleletteri(;kwargs...)

An IconCircleLetterI component.
...
"""
function dti_iconcircleletteri(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletteri", "IconCircleLetterI", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
