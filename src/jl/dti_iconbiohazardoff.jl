...
export dti_iconbiohazardoff

"""
    dti_iconbiohazardoff(;kwargs...)

An IconBiohazardOff component.
...
"""
function dti_iconbiohazardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbiohazardoff", "IconBiohazardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
