...
export dti_iconboneoff

"""
    dti_iconboneoff(;kwargs...)

An IconBoneOff component.
...
"""
function dti_iconboneoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboneoff", "IconBoneOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
