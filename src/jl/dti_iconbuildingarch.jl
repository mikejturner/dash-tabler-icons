...
export dti_iconbuildingarch

"""
    dti_iconbuildingarch(;kwargs...)

An IconBuildingArch component.
...
"""
function dti_iconbuildingarch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingarch", "IconBuildingArch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
