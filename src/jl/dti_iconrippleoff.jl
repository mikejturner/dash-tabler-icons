...
export dti_iconrippleoff

"""
    dti_iconrippleoff(;kwargs...)

An IconRippleOff component.
...
"""
function dti_iconrippleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrippleoff", "IconRippleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
