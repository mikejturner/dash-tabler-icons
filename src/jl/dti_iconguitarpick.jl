...
export dti_iconguitarpick

"""
    dti_iconguitarpick(;kwargs...)

An IconGuitarPick component.
...
"""
function dti_iconguitarpick(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconguitarpick", "IconGuitarPick", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
