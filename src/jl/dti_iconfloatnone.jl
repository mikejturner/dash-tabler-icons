...
export dti_iconfloatnone

"""
    dti_iconfloatnone(;kwargs...)

An IconFloatNone component.
...
"""
function dti_iconfloatnone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfloatnone", "IconFloatNone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
