...
export dti_iconcellsignal5

"""
    dti_iconcellsignal5(;kwargs...)

An IconCellSignal5 component.
...
"""
function dti_iconcellsignal5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcellsignal5", "IconCellSignal5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
