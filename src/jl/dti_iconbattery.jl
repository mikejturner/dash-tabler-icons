...
export dti_iconbattery

"""
    dti_iconbattery(;kwargs...)

An IconBattery component.
...
"""
function dti_iconbattery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbattery", "IconBattery", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
