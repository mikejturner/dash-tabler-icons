...
export dti_iconiceskating

"""
    dti_iconiceskating(;kwargs...)

An IconIceSkating component.
...
"""
function dti_iconiceskating(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconiceskating", "IconIceSkating", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
