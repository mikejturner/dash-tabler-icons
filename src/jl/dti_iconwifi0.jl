...
export dti_iconwifi0

"""
    dti_iconwifi0(;kwargs...)

An IconWifi0 component.
...
"""
function dti_iconwifi0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwifi0", "IconWifi0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
