...
export dti_iconbuildingcastle

"""
    dti_iconbuildingcastle(;kwargs...)

An IconBuildingCastle component.
...
"""
function dti_iconbuildingcastle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingcastle", "IconBuildingCastle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
