...
export dti_iconsettingsoff

"""
    dti_iconsettingsoff(;kwargs...)

An IconSettingsOff component.
...
"""
function dti_iconsettingsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsettingsoff", "IconSettingsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
