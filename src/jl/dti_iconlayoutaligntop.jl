...
export dti_iconlayoutaligntop

"""
    dti_iconlayoutaligntop(;kwargs...)

An IconLayoutAlignTop component.
...
"""
function dti_iconlayoutaligntop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutaligntop", "IconLayoutAlignTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
