...
export dti_iconarrownarrowright

"""
    dti_iconarrownarrowright(;kwargs...)

An IconArrowNarrowRight component.
...
"""
function dti_iconarrownarrowright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrownarrowright", "IconArrowNarrowRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
