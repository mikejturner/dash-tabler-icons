...
export dti_iconvideoplus

"""
    dti_iconvideoplus(;kwargs...)

An IconVideoPlus component.
...
"""
function dti_iconvideoplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvideoplus", "IconVideoPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
