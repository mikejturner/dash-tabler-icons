...
export dti_iconbrandnytimes

"""
    dti_iconbrandnytimes(;kwargs...)

An IconBrandNytimes component.
...
"""
function dti_iconbrandnytimes(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnytimes", "IconBrandNytimes", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
