...
export dti_iconhexagonletterv

"""
    dti_iconhexagonletterv(;kwargs...)

An IconHexagonLetterV component.
...
"""
function dti_iconhexagonletterv(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterv", "IconHexagonLetterV", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
