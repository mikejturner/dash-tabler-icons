...
export dti_iconarrowsleft

"""
    dti_iconarrowsleft(;kwargs...)

An IconArrowsLeft component.
...
"""
function dti_iconarrowsleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsleft", "IconArrowsLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
