...
export dti_iconclockcancel

"""
    dti_iconclockcancel(;kwargs...)

An IconClockCancel component.
...
"""
function dti_iconclockcancel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockcancel", "IconClockCancel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
