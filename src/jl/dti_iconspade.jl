...
export dti_iconspade

"""
    dti_iconspade(;kwargs...)

An IconSpade component.
...
"""
function dti_iconspade(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspade", "IconSpade", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
