...
export dti_iconexplicitoff

"""
    dti_iconexplicitoff(;kwargs...)

An IconExplicitOff component.
...
"""
function dti_iconexplicitoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexplicitoff", "IconExplicitOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
