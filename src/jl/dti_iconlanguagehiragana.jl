...
export dti_iconlanguagehiragana

"""
    dti_iconlanguagehiragana(;kwargs...)

An IconLanguageHiragana component.
...
"""
function dti_iconlanguagehiragana(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlanguagehiragana", "IconLanguageHiragana", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
