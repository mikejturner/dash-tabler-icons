...
export dti_icondatabase

"""
    dti_icondatabase(;kwargs...)

An IconDatabase component.
...
"""
function dti_icondatabase(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondatabase", "IconDatabase", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
