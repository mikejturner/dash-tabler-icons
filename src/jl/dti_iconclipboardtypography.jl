...
export dti_iconclipboardtypography

"""
    dti_iconclipboardtypography(;kwargs...)

An IconClipboardTypography component.
...
"""
function dti_iconclipboardtypography(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardtypography", "IconClipboardTypography", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
