...
export dti_iconslideshow

"""
    dti_iconslideshow(;kwargs...)

An IconSlideshow component.
...
"""
function dti_iconslideshow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconslideshow", "IconSlideshow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
