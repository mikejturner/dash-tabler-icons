...
export dti_icondragdrop

"""
    dti_icondragdrop(;kwargs...)

An IconDragDrop component.
...
"""
function dti_icondragdrop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondragdrop", "IconDragDrop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
