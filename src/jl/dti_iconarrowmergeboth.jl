...
export dti_iconarrowmergeboth

"""
    dti_iconarrowmergeboth(;kwargs...)

An IconArrowMergeBoth component.
...
"""
function dti_iconarrowmergeboth(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmergeboth", "IconArrowMergeBoth", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
