...
export dti_iconsteeringwheel

"""
    dti_iconsteeringwheel(;kwargs...)

An IconSteeringWheel component.
...
"""
function dti_iconsteeringwheel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsteeringwheel", "IconSteeringWheel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
