...
export dti_icontrolley

"""
    dti_icontrolley(;kwargs...)

An IconTrolley component.
...
"""
function dti_icontrolley(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrolley", "IconTrolley", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
