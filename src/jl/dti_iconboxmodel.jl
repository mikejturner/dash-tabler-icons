...
export dti_iconboxmodel

"""
    dti_iconboxmodel(;kwargs...)

An IconBoxModel component.
...
"""
function dti_iconboxmodel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmodel", "IconBoxModel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
