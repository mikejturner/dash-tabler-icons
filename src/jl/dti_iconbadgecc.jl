...
export dti_iconbadgecc

"""
    dti_iconbadgecc(;kwargs...)

An IconBadgeCc component.
...
"""
function dti_iconbadgecc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgecc", "IconBadgeCc", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
