...
export dti_iconnurse

"""
    dti_iconnurse(;kwargs...)

An IconNurse component.
...
"""
function dti_iconnurse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnurse", "IconNurse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
