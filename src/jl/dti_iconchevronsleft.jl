...
export dti_iconchevronsleft

"""
    dti_iconchevronsleft(;kwargs...)

An IconChevronsLeft component.
...
"""
function dti_iconchevronsleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsleft", "IconChevronsLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
