...
export dti_iconhexagonletterq

"""
    dti_iconhexagonletterq(;kwargs...)

An IconHexagonLetterQ component.
...
"""
function dti_iconhexagonletterq(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterq", "IconHexagonLetterQ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
