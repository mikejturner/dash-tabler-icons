...
export dti_iconalpha

"""
    dti_iconalpha(;kwargs...)

An IconAlpha component.
...
"""
function dti_iconalpha(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalpha", "IconAlpha", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
