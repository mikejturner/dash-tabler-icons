...
export dti_iconzoomexclamation

"""
    dti_iconzoomexclamation(;kwargs...)

An IconZoomExclamation component.
...
"""
function dti_iconzoomexclamation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomexclamation", "IconZoomExclamation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
