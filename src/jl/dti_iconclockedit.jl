...
export dti_iconclockedit

"""
    dti_iconclockedit(;kwargs...)

An IconClockEdit component.
...
"""
function dti_iconclockedit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockedit", "IconClockEdit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
