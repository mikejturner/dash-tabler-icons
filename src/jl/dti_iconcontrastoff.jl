...
export dti_iconcontrastoff

"""
    dti_iconcontrastoff(;kwargs...)

An IconContrastOff component.
...
"""
function dti_iconcontrastoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcontrastoff", "IconContrastOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
