...
export dti_iconmenu2

"""
    dti_iconmenu2(;kwargs...)

An IconMenu2 component.
...
"""
function dti_iconmenu2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmenu2", "IconMenu2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
