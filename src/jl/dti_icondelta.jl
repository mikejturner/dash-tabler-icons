...
export dti_icondelta

"""
    dti_icondelta(;kwargs...)

An IconDelta component.
...
"""
function dti_icondelta(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondelta", "IconDelta", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
