...
export dti_iconcornerdownright

"""
    dti_iconcornerdownright(;kwargs...)

An IconCornerDownRight component.
...
"""
function dti_iconcornerdownright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerdownright", "IconCornerDownRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
