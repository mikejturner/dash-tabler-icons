...
export dti_iconbrandhipchat

"""
    dti_iconbrandhipchat(;kwargs...)

An IconBrandHipchat component.
...
"""
function dti_iconbrandhipchat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandhipchat", "IconBrandHipchat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
