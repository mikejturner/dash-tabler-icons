...
export dti_iconrating12plus

"""
    dti_iconrating12plus(;kwargs...)

An IconRating12Plus component.
...
"""
function dti_iconrating12plus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrating12plus", "IconRating12Plus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
