...
export dti_iconbabycarriage

"""
    dti_iconbabycarriage(;kwargs...)

An IconBabyCarriage component.
...
"""
function dti_iconbabycarriage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbabycarriage", "IconBabyCarriage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
