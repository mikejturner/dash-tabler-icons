...
export dti_iconzoomcode

"""
    dti_iconzoomcode(;kwargs...)

An IconZoomCode component.
...
"""
function dti_iconzoomcode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomcode", "IconZoomCode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
