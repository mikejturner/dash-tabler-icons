...
export dti_iconaeriallift

"""
    dti_iconaeriallift(;kwargs...)

An IconAerialLift component.
...
"""
function dti_iconaeriallift(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaeriallift", "IconAerialLift", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
