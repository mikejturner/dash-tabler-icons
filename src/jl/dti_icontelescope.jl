...
export dti_icontelescope

"""
    dti_icontelescope(;kwargs...)

An IconTelescope component.
...
"""
function dti_icontelescope(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontelescope", "IconTelescope", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
