...
export dti_iconshoppingcartplus

"""
    dti_iconshoppingcartplus(;kwargs...)

An IconShoppingCartPlus component.
...
"""
function dti_iconshoppingcartplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshoppingcartplus", "IconShoppingCartPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
