...
export dti_iconarrowsdiagonalminimize2

"""
    dti_iconarrowsdiagonalminimize2(;kwargs...)

An IconArrowsDiagonalMinimize2 component.
...
"""
function dti_iconarrowsdiagonalminimize2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdiagonalminimize2", "IconArrowsDiagonalMinimize2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
