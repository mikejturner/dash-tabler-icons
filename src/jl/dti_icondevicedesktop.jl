...
export dti_icondevicedesktop

"""
    dti_icondevicedesktop(;kwargs...)

An IconDeviceDesktop component.
...
"""
function dti_icondevicedesktop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicedesktop", "IconDeviceDesktop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
