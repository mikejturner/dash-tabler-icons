...
export dti_iconmoodoff

"""
    dti_iconmoodoff(;kwargs...)

An IconMoodOff component.
...
"""
function dti_iconmoodoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodoff", "IconMoodOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
