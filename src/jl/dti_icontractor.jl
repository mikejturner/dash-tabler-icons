...
export dti_icontractor

"""
    dti_icontractor(;kwargs...)

An IconTractor component.
...
"""
function dti_icontractor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontractor", "IconTractor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
