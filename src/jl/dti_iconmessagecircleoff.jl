...
export dti_iconmessagecircleoff

"""
    dti_iconmessagecircleoff(;kwargs...)

An IconMessageCircleOff component.
...
"""
function dti_iconmessagecircleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagecircleoff", "IconMessageCircleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
