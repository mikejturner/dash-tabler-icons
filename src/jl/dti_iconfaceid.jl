...
export dti_iconfaceid

"""
    dti_iconfaceid(;kwargs...)

An IconFaceId component.
...
"""
function dti_iconfaceid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfaceid", "IconFaceId", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
