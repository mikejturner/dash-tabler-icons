...
export dti_iconapiapp

"""
    dti_iconapiapp(;kwargs...)

An IconApiApp component.
...
"""
function dti_iconapiapp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconapiapp", "IconApiApp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
