...
export dti_iconbattery4

"""
    dti_iconbattery4(;kwargs...)

An IconBattery4 component.
...
"""
function dti_iconbattery4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbattery4", "IconBattery4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
