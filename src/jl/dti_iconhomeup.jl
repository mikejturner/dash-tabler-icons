...
export dti_iconhomeup

"""
    dti_iconhomeup(;kwargs...)

An IconHomeUp component.
...
"""
function dti_iconhomeup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeup", "IconHomeUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
