...
export dti_iconarrowloopleft2

"""
    dti_iconarrowloopleft2(;kwargs...)

An IconArrowLoopLeft2 component.
...
"""
function dti_iconarrowloopleft2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowloopleft2", "IconArrowLoopLeft2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
