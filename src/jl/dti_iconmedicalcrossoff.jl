...
export dti_iconmedicalcrossoff

"""
    dti_iconmedicalcrossoff(;kwargs...)

An IconMedicalCrossOff component.
...
"""
function dti_iconmedicalcrossoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmedicalcrossoff", "IconMedicalCrossOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
