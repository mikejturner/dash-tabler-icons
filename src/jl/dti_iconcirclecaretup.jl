...
export dti_iconcirclecaretup

"""
    dti_iconcirclecaretup(;kwargs...)

An IconCircleCaretUp component.
...
"""
function dti_iconcirclecaretup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclecaretup", "IconCircleCaretUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
