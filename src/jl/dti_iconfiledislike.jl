...
export dti_iconfiledislike

"""
    dti_iconfiledislike(;kwargs...)

An IconFileDislike component.
...
"""
function dti_iconfiledislike(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledislike", "IconFileDislike", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
