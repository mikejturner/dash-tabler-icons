...
export dti_iconsofaoff

"""
    dti_iconsofaoff(;kwargs...)

An IconSofaOff component.
...
"""
function dti_iconsofaoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsofaoff", "IconSofaOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
