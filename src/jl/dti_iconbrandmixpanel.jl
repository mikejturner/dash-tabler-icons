...
export dti_iconbrandmixpanel

"""
    dti_iconbrandmixpanel(;kwargs...)

An IconBrandMixpanel component.
...
"""
function dti_iconbrandmixpanel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmixpanel", "IconBrandMixpanel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
