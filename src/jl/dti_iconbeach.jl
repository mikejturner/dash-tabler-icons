...
export dti_iconbeach

"""
    dti_iconbeach(;kwargs...)

An IconBeach component.
...
"""
function dti_iconbeach(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbeach", "IconBeach", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
