...
export dti_iconbrandloom

"""
    dti_iconbrandloom(;kwargs...)

An IconBrandLoom component.
...
"""
function dti_iconbrandloom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandloom", "IconBrandLoom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
