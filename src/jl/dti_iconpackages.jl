...
export dti_iconpackages

"""
    dti_iconpackages(;kwargs...)

An IconPackages component.
...
"""
function dti_iconpackages(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpackages", "IconPackages", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
