...
export dti_iconcircuitgrounddigital

"""
    dti_iconcircuitgrounddigital(;kwargs...)

An IconCircuitGroundDigital component.
...
"""
function dti_iconcircuitgrounddigital(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitgrounddigital", "IconCircuitGroundDigital", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
