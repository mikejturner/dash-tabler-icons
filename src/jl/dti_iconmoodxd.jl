...
export dti_iconmoodxd

"""
    dti_iconmoodxd(;kwargs...)

An IconMoodXd component.
...
"""
function dti_iconmoodxd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodxd", "IconMoodXd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
