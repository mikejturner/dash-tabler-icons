...
export dti_icondice3

"""
    dti_icondice3(;kwargs...)

An IconDice3 component.
...
"""
function dti_icondice3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondice3", "IconDice3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
