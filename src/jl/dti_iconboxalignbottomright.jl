...
export dti_iconboxalignbottomright

"""
    dti_iconboxalignbottomright(;kwargs...)

An IconBoxAlignBottomRight component.
...
"""
function dti_iconboxalignbottomright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxalignbottomright", "IconBoxAlignBottomRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
