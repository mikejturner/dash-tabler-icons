...
export dti_icondiamondoff

"""
    dti_icondiamondoff(;kwargs...)

An IconDiamondOff component.
...
"""
function dti_icondiamondoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiamondoff", "IconDiamondOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
