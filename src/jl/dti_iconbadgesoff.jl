...
export dti_iconbadgesoff

"""
    dti_iconbadgesoff(;kwargs...)

An IconBadgesOff component.
...
"""
function dti_iconbadgesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgesoff", "IconBadgesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
