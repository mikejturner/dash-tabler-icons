...
export dti_iconbaguette

"""
    dti_iconbaguette(;kwargs...)

An IconBaguette component.
...
"""
function dti_iconbaguette(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbaguette", "IconBaguette", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
