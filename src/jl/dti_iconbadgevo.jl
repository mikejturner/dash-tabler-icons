...
export dti_iconbadgevo

"""
    dti_iconbadgevo(;kwargs...)

An IconBadgeVo component.
...
"""
function dti_iconbadgevo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgevo", "IconBadgeVo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
