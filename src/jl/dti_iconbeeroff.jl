...
export dti_iconbeeroff

"""
    dti_iconbeeroff(;kwargs...)

An IconBeerOff component.
...
"""
function dti_iconbeeroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbeeroff", "IconBeerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
