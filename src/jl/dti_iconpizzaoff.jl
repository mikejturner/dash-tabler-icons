...
export dti_iconpizzaoff

"""
    dti_iconpizzaoff(;kwargs...)

An IconPizzaOff component.
...
"""
function dti_iconpizzaoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpizzaoff", "IconPizzaOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
