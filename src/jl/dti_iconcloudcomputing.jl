...
export dti_iconcloudcomputing

"""
    dti_iconcloudcomputing(;kwargs...)

An IconCloudComputing component.
...
"""
function dti_iconcloudcomputing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudcomputing", "IconCloudComputing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
