...
export dti_iconpolygonoff

"""
    dti_iconpolygonoff(;kwargs...)

An IconPolygonOff component.
...
"""
function dti_iconpolygonoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpolygonoff", "IconPolygonOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
