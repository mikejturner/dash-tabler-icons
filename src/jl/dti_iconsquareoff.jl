...
export dti_iconsquareoff

"""
    dti_iconsquareoff(;kwargs...)

An IconSquareOff component.
...
"""
function dti_iconsquareoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareoff", "IconSquareOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
