...
export dti_iconmathequallower

"""
    dti_iconmathequallower(;kwargs...)

An IconMathEqualLower component.
...
"""
function dti_iconmathequallower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathequallower", "IconMathEqualLower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
