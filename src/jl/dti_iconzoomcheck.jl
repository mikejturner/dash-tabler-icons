...
export dti_iconzoomcheck

"""
    dti_iconzoomcheck(;kwargs...)

An IconZoomCheck component.
...
"""
function dti_iconzoomcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomcheck", "IconZoomCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
