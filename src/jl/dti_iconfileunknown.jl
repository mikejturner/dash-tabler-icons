...
export dti_iconfileunknown

"""
    dti_iconfileunknown(;kwargs...)

An IconFileUnknown component.
...
"""
function dti_iconfileunknown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileunknown", "IconFileUnknown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
