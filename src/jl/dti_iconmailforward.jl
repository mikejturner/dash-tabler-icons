...
export dti_iconmailforward

"""
    dti_iconmailforward(;kwargs...)

An IconMailForward component.
...
"""
function dti_iconmailforward(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmailforward", "IconMailForward", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
