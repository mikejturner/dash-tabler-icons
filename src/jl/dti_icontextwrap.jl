...
export dti_icontextwrap

"""
    dti_icontextwrap(;kwargs...)

An IconTextWrap component.
...
"""
function dti_icontextwrap(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextwrap", "IconTextWrap", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
