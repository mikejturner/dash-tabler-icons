...
export dti_iconkayak

"""
    dti_iconkayak(;kwargs...)

An IconKayak component.
...
"""
function dti_iconkayak(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkayak", "IconKayak", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
