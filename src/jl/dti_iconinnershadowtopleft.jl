...
export dti_iconinnershadowtopleft

"""
    dti_iconinnershadowtopleft(;kwargs...)

An IconInnerShadowTopLeft component.
...
"""
function dti_iconinnershadowtopleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowtopleft", "IconInnerShadowTopLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
