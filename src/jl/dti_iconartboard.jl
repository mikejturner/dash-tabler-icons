...
export dti_iconartboard

"""
    dti_iconartboard(;kwargs...)

An IconArtboard component.
...
"""
function dti_iconartboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconartboard", "IconArtboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
