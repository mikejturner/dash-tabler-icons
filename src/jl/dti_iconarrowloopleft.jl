...
export dti_iconarrowloopleft

"""
    dti_iconarrowloopleft(;kwargs...)

An IconArrowLoopLeft component.
...
"""
function dti_iconarrowloopleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowloopleft", "IconArrowLoopLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
