...
export dti_iconequal

"""
    dti_iconequal(;kwargs...)

An IconEqual component.
...
"""
function dti_iconequal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconequal", "IconEqual", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
