...
export dti_iconbrandstrava

"""
    dti_iconbrandstrava(;kwargs...)

An IconBrandStrava component.
...
"""
function dti_iconbrandstrava(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandstrava", "IconBrandStrava", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
