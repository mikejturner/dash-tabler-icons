...
export dti_iconserverbolt

"""
    dti_iconserverbolt(;kwargs...)

An IconServerBolt component.
...
"""
function dti_iconserverbolt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconserverbolt", "IconServerBolt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
