...
export dti_iconbrandsurfshark

"""
    dti_iconbrandsurfshark(;kwargs...)

An IconBrandSurfshark component.
...
"""
function dti_iconbrandsurfshark(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsurfshark", "IconBrandSurfshark", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
