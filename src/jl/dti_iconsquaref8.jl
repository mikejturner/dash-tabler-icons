...
export dti_iconsquaref8

"""
    dti_iconsquaref8(;kwargs...)

An IconSquareF8 component.
...
"""
function dti_iconsquaref8(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref8", "IconSquareF8", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
