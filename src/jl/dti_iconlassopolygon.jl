...
export dti_iconlassopolygon

"""
    dti_iconlassopolygon(;kwargs...)

An IconLassoPolygon component.
...
"""
function dti_iconlassopolygon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlassopolygon", "IconLassoPolygon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
