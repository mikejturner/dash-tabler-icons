...
export dti_iconfileshredder

"""
    dti_iconfileshredder(;kwargs...)

An IconFileShredder component.
...
"""
function dti_iconfileshredder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileshredder", "IconFileShredder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
