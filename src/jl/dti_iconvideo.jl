...
export dti_iconvideo

"""
    dti_iconvideo(;kwargs...)

An IconVideo component.
...
"""
function dti_iconvideo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvideo", "IconVideo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
