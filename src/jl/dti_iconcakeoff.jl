...
export dti_iconcakeoff

"""
    dti_iconcakeoff(;kwargs...)

An IconCakeOff component.
...
"""
function dti_iconcakeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcakeoff", "IconCakeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
