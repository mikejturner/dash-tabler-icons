...
export dti_iconcirclehalfvertical

"""
    dti_iconcirclehalfvertical(;kwargs...)

An IconCircleHalfVertical component.
...
"""
function dti_iconcirclehalfvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclehalfvertical", "IconCircleHalfVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
