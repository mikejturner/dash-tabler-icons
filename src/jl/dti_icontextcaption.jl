...
export dti_icontextcaption

"""
    dti_icontextcaption(;kwargs...)

An IconTextCaption component.
...
"""
function dti_icontextcaption(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextcaption", "IconTextCaption", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
