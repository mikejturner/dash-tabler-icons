...
export dti_iconchartarcs

"""
    dti_iconchartarcs(;kwargs...)

An IconChartArcs component.
...
"""
function dti_iconchartarcs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartarcs", "IconChartArcs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
