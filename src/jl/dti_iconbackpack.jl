...
export dti_iconbackpack

"""
    dti_iconbackpack(;kwargs...)

An IconBackpack component.
...
"""
function dti_iconbackpack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbackpack", "IconBackpack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
