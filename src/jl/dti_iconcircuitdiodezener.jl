...
export dti_iconcircuitdiodezener

"""
    dti_iconcircuitdiodezener(;kwargs...)

An IconCircuitDiodeZener component.
...
"""
function dti_iconcircuitdiodezener(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitdiodezener", "IconCircuitDiodeZener", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
