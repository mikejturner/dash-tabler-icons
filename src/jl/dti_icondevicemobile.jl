...
export dti_icondevicemobile

"""
    dti_icondevicemobile(;kwargs...)

An IconDeviceMobile component.
...
"""
function dti_icondevicemobile(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicemobile", "IconDeviceMobile", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
