...
export dti_iconboxmargin

"""
    dti_iconboxmargin(;kwargs...)

An IconBoxMargin component.
...
"""
function dti_iconboxmargin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmargin", "IconBoxMargin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
