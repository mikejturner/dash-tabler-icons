...
export dti_iconcurrencyoff

"""
    dti_iconcurrencyoff(;kwargs...)

An IconCurrencyOff component.
...
"""
function dti_iconcurrencyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyoff", "IconCurrencyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
