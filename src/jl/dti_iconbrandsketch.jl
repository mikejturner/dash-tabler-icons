...
export dti_iconbrandsketch

"""
    dti_iconbrandsketch(;kwargs...)

An IconBrandSketch component.
...
"""
function dti_iconbrandsketch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsketch", "IconBrandSketch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
