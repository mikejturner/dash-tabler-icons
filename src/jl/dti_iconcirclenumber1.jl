...
export dti_iconcirclenumber1

"""
    dti_iconcirclenumber1(;kwargs...)

An IconCircleNumber1 component.
...
"""
function dti_iconcirclenumber1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber1", "IconCircleNumber1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
