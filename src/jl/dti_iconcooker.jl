...
export dti_iconcooker

"""
    dti_iconcooker(;kwargs...)

An IconCooker component.
...
"""
function dti_iconcooker(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcooker", "IconCooker", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
