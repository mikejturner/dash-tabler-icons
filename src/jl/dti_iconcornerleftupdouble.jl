...
export dti_iconcornerleftupdouble

"""
    dti_iconcornerleftupdouble(;kwargs...)

An IconCornerLeftUpDouble component.
...
"""
function dti_iconcornerleftupdouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerleftupdouble", "IconCornerLeftUpDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
