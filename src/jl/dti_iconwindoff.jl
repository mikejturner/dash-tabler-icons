...
export dti_iconwindoff

"""
    dti_iconwindoff(;kwargs...)

An IconWindOff component.
...
"""
function dti_iconwindoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindoff", "IconWindOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
