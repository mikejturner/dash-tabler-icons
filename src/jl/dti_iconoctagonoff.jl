...
export dti_iconoctagonoff

"""
    dti_iconoctagonoff(;kwargs...)

An IconOctagonOff component.
...
"""
function dti_iconoctagonoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconoctagonoff", "IconOctagonOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
