...
export dti_iconphotodown

"""
    dti_iconphotodown(;kwargs...)

An IconPhotoDown component.
...
"""
function dti_iconphotodown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotodown", "IconPhotoDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
