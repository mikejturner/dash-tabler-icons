...
export dti_iconbrandtinder

"""
    dti_iconbrandtinder(;kwargs...)

An IconBrandTinder component.
...
"""
function dti_iconbrandtinder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtinder", "IconBrandTinder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
