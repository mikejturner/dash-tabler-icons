...
export dti_iconwalloff

"""
    dti_iconwalloff(;kwargs...)

An IconWallOff component.
...
"""
function dti_iconwalloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwalloff", "IconWallOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
