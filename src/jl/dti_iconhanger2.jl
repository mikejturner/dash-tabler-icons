...
export dti_iconhanger2

"""
    dti_iconhanger2(;kwargs...)

An IconHanger2 component.
...
"""
function dti_iconhanger2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhanger2", "IconHanger2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
