...
export dti_iconshadow

"""
    dti_iconshadow(;kwargs...)

An IconShadow component.
...
"""
function dti_iconshadow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshadow", "IconShadow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
