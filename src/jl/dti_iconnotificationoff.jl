...
export dti_iconnotificationoff

"""
    dti_iconnotificationoff(;kwargs...)

An IconNotificationOff component.
...
"""
function dti_iconnotificationoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnotificationoff", "IconNotificationOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
