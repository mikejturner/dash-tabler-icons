...
export dti_iconscreenshot

"""
    dti_iconscreenshot(;kwargs...)

An IconScreenshot component.
...
"""
function dti_iconscreenshot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscreenshot", "IconScreenshot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
