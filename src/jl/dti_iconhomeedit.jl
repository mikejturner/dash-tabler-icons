...
export dti_iconhomeedit

"""
    dti_iconhomeedit(;kwargs...)

An IconHomeEdit component.
...
"""
function dti_iconhomeedit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeedit", "IconHomeEdit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
