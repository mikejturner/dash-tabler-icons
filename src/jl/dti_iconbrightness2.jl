...
export dti_iconbrightness2

"""
    dti_iconbrightness2(;kwargs...)

An IconBrightness2 component.
...
"""
function dti_iconbrightness2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrightness2", "IconBrightness2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
