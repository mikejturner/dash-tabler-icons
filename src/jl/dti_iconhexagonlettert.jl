...
export dti_iconhexagonlettert

"""
    dti_iconhexagonlettert(;kwargs...)

An IconHexagonLetterT component.
...
"""
function dti_iconhexagonlettert(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonlettert", "IconHexagonLetterT", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
