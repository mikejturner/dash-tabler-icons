...
export dti_iconmathxdivide2

"""
    dti_iconmathxdivide2(;kwargs...)

An IconMathXDivide2 component.
...
"""
function dti_iconmathxdivide2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxdivide2", "IconMathXDivide2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
