...
export dti_iconplayerskipback

"""
    dti_iconplayerskipback(;kwargs...)

An IconPlayerSkipBack component.
...
"""
function dti_iconplayerskipback(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayerskipback", "IconPlayerSkipBack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
