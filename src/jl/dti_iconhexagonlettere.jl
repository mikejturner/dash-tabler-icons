...
export dti_iconhexagonlettere

"""
    dti_iconhexagonlettere(;kwargs...)

An IconHexagonLetterE component.
...
"""
function dti_iconhexagonlettere(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonlettere", "IconHexagonLetterE", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
