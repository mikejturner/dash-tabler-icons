...
export dti_icontallymarks

"""
    dti_icontallymarks(;kwargs...)

An IconTallymarks component.
...
"""
function dti_icontallymarks(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontallymarks", "IconTallymarks", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
