...
export dti_iconarrowssplit

"""
    dti_iconarrowssplit(;kwargs...)

An IconArrowsSplit component.
...
"""
function dti_iconarrowssplit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowssplit", "IconArrowsSplit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
