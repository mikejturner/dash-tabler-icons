...
export dti_icontableimport

"""
    dti_icontableimport(;kwargs...)

An IconTableImport component.
...
"""
function dti_icontableimport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontableimport", "IconTableImport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
