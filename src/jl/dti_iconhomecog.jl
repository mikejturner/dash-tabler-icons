...
export dti_iconhomecog

"""
    dti_iconhomecog(;kwargs...)

An IconHomeCog component.
...
"""
function dti_iconhomecog(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomecog", "IconHomeCog", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
