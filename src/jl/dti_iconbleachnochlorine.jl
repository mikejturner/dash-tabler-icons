...
export dti_iconbleachnochlorine

"""
    dti_iconbleachnochlorine(;kwargs...)

An IconBleachNoChlorine component.
...
"""
function dti_iconbleachnochlorine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbleachnochlorine", "IconBleachNoChlorine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
