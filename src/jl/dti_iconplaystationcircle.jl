...
export dti_iconplaystationcircle

"""
    dti_iconplaystationcircle(;kwargs...)

An IconPlaystationCircle component.
...
"""
function dti_iconplaystationcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaystationcircle", "IconPlaystationCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
