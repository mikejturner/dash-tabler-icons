...
export dti_iconarrowrotaryfirstleft

"""
    dti_iconarrowrotaryfirstleft(;kwargs...)

An IconArrowRotaryFirstLeft component.
...
"""
function dti_iconarrowrotaryfirstleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotaryfirstleft", "IconArrowRotaryFirstLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
