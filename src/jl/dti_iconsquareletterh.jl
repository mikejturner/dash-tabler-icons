...
export dti_iconsquareletterh

"""
    dti_iconsquareletterh(;kwargs...)

An IconSquareLetterH component.
...
"""
function dti_iconsquareletterh(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterh", "IconSquareLetterH", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
