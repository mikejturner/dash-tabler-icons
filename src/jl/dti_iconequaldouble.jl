...
export dti_iconequaldouble

"""
    dti_iconequaldouble(;kwargs...)

An IconEqualDouble component.
...
"""
function dti_iconequaldouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconequaldouble", "IconEqualDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
