...
export dti_iconlettercaselower

"""
    dti_iconlettercaselower(;kwargs...)

An IconLetterCaseLower component.
...
"""
function dti_iconlettercaselower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettercaselower", "IconLetterCaseLower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
