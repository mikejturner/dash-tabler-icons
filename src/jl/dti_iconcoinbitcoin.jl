...
export dti_iconcoinbitcoin

"""
    dti_iconcoinbitcoin(;kwargs...)

An IconCoinBitcoin component.
...
"""
function dti_iconcoinbitcoin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinbitcoin", "IconCoinBitcoin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
