...
export dti_iconchartpieoff

"""
    dti_iconchartpieoff(;kwargs...)

An IconChartPieOff component.
...
"""
function dti_iconchartpieoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartpieoff", "IconChartPieOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
