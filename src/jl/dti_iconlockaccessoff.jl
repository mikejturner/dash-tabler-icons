...
export dti_iconlockaccessoff

"""
    dti_iconlockaccessoff(;kwargs...)

An IconLockAccessOff component.
...
"""
function dti_iconlockaccessoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlockaccessoff", "IconLockAccessOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
