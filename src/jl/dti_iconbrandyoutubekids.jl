...
export dti_iconbrandyoutubekids

"""
    dti_iconbrandyoutubekids(;kwargs...)

An IconBrandYoutubeKids component.
...
"""
function dti_iconbrandyoutubekids(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandyoutubekids", "IconBrandYoutubeKids", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
