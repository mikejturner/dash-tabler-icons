...
export dti_iconscaleoutlineoff

"""
    dti_iconscaleoutlineoff(;kwargs...)

An IconScaleOutlineOff component.
...
"""
function dti_iconscaleoutlineoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscaleoutlineoff", "IconScaleOutlineOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
