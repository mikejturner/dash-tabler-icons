...
export dti_iconcircuitcapacitorpolarized

"""
    dti_iconcircuitcapacitorpolarized(;kwargs...)

An IconCircuitCapacitorPolarized component.
...
"""
function dti_iconcircuitcapacitorpolarized(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitcapacitorpolarized", "IconCircuitCapacitorPolarized", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
