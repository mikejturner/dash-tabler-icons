...
export dti_iconarmchairoff

"""
    dti_iconarmchairoff(;kwargs...)

An IconArmchairOff component.
...
"""
function dti_iconarmchairoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarmchairoff", "IconArmchairOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
