...
export dti_iconrepeatoff

"""
    dti_iconrepeatoff(;kwargs...)

An IconRepeatOff component.
...
"""
function dti_iconrepeatoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrepeatoff", "IconRepeatOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
