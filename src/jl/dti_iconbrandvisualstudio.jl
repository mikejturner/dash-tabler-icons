...
export dti_iconbrandvisualstudio

"""
    dti_iconbrandvisualstudio(;kwargs...)

An IconBrandVisualStudio component.
...
"""
function dti_iconbrandvisualstudio(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvisualstudio", "IconBrandVisualStudio", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
