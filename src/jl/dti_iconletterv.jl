...
export dti_iconletterv

"""
    dti_iconletterv(;kwargs...)

An IconLetterV component.
...
"""
function dti_iconletterv(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterv", "IconLetterV", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
