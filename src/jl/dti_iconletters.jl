...
export dti_iconletters

"""
    dti_iconletters(;kwargs...)

An IconLetterS component.
...
"""
function dti_iconletters(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletters", "IconLetterS", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
