...
export dti_iconclockhour1

"""
    dti_iconclockhour1(;kwargs...)

An IconClockHour1 component.
...
"""
function dti_iconclockhour1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour1", "IconClockHour1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
