...
export dti_iconalphabetcyrillic

"""
    dti_iconalphabetcyrillic(;kwargs...)

An IconAlphabetCyrillic component.
...
"""
function dti_iconalphabetcyrillic(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalphabetcyrillic", "IconAlphabetCyrillic", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
