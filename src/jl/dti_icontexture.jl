...
export dti_icontexture

"""
    dti_icontexture(;kwargs...)

An IconTexture component.
...
"""
function dti_icontexture(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontexture", "IconTexture", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
