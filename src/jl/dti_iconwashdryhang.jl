...
export dti_iconwashdryhang

"""
    dti_iconwashdryhang(;kwargs...)

An IconWashDryHang component.
...
"""
function dti_iconwashdryhang(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryhang", "IconWashDryHang", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
