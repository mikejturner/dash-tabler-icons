...
export dti_iconarrownarrowdown

"""
    dti_iconarrownarrowdown(;kwargs...)

An IconArrowNarrowDown component.
...
"""
function dti_iconarrownarrowdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrownarrowdown", "IconArrowNarrowDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
