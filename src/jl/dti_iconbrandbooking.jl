...
export dti_iconbrandbooking

"""
    dti_iconbrandbooking(;kwargs...)

An IconBrandBooking component.
...
"""
function dti_iconbrandbooking(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbooking", "IconBrandBooking", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
