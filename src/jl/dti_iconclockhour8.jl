...
export dti_iconclockhour8

"""
    dti_iconclockhour8(;kwargs...)

An IconClockHour8 component.
...
"""
function dti_iconclockhour8(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour8", "IconClockHour8", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
