...
export dti_icondevicedesktopanalytics

"""
    dti_icondevicedesktopanalytics(;kwargs...)

An IconDeviceDesktopAnalytics component.
...
"""
function dti_icondevicedesktopanalytics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicedesktopanalytics", "IconDeviceDesktopAnalytics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
