...
export dti_iconlogicbuffer

"""
    dti_iconlogicbuffer(;kwargs...)

An IconLogicBuffer component.
...
"""
function dti_iconlogicbuffer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicbuffer", "IconLogicBuffer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
