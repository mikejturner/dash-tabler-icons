...
export dti_iconchevronsdownright

"""
    dti_iconchevronsdownright(;kwargs...)

An IconChevronsDownRight component.
...
"""
function dti_iconchevronsdownright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsdownright", "IconChevronsDownRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
