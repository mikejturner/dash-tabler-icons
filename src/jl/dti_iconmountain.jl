...
export dti_iconmountain

"""
    dti_iconmountain(;kwargs...)

An IconMountain component.
...
"""
function dti_iconmountain(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmountain", "IconMountain", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
