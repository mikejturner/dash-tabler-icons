...
export dti_iconwashtemperature4

"""
    dti_iconwashtemperature4(;kwargs...)

An IconWashTemperature4 component.
...
"""
function dti_iconwashtemperature4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtemperature4", "IconWashTemperature4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
