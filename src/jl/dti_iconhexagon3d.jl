...
export dti_iconhexagon3d

"""
    dti_iconhexagon3d(;kwargs...)

An IconHexagon3d component.
...
"""
function dti_iconhexagon3d(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagon3d", "IconHexagon3d", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
