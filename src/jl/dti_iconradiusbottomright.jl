...
export dti_iconradiusbottomright

"""
    dti_iconradiusbottomright(;kwargs...)

An IconRadiusBottomRight component.
...
"""
function dti_iconradiusbottomright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradiusbottomright", "IconRadiusBottomRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
