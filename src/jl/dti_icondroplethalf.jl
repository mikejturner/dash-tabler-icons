...
export dti_icondroplethalf

"""
    dti_icondroplethalf(;kwargs...)

An IconDropletHalf component.
...
"""
function dti_icondroplethalf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondroplethalf", "IconDropletHalf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
