...
export dti_iconcaravan

"""
    dti_iconcaravan(;kwargs...)

An IconCaravan component.
...
"""
function dti_iconcaravan(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaravan", "IconCaravan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
