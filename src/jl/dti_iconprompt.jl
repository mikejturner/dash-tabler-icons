...
export dti_iconprompt

"""
    dti_iconprompt(;kwargs...)

An IconPrompt component.
...
"""
function dti_iconprompt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconprompt", "IconPrompt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
