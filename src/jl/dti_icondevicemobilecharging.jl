...
export dti_icondevicemobilecharging

"""
    dti_icondevicemobilecharging(;kwargs...)

An IconDeviceMobileCharging component.
...
"""
function dti_icondevicemobilecharging(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicemobilecharging", "IconDeviceMobileCharging", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
