...
export dti_iconbrandtrello

"""
    dti_iconbrandtrello(;kwargs...)

An IconBrandTrello component.
...
"""
function dti_iconbrandtrello(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtrello", "IconBrandTrello", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
