...
export dti_iconhexagonletterf

"""
    dti_iconhexagonletterf(;kwargs...)

An IconHexagonLetterF component.
...
"""
function dti_iconhexagonletterf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterf", "IconHexagonLetterF", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
