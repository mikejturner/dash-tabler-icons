...
export dti_iconlayoutdashboard

"""
    dti_iconlayoutdashboard(;kwargs...)

An IconLayoutDashboard component.
...
"""
function dti_iconlayoutdashboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutdashboard", "IconLayoutDashboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
