...
export dti_iconhandfingeroff

"""
    dti_iconhandfingeroff(;kwargs...)

An IconHandFingerOff component.
...
"""
function dti_iconhandfingeroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandfingeroff", "IconHandFingerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
