...
export dti_icontransferin

"""
    dti_icontransferin(;kwargs...)

An IconTransferIn component.
...
"""
function dti_icontransferin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontransferin", "IconTransferIn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
