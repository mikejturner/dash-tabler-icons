...
export dti_iconbrandtumblr

"""
    dti_iconbrandtumblr(;kwargs...)

An IconBrandTumblr component.
...
"""
function dti_iconbrandtumblr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtumblr", "IconBrandTumblr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
