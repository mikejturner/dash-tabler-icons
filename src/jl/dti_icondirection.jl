...
export dti_icondirection

"""
    dti_icondirection(;kwargs...)

An IconDirection component.
...
"""
function dti_icondirection(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondirection", "IconDirection", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
