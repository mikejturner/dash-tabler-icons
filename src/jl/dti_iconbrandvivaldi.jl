...
export dti_iconbrandvivaldi

"""
    dti_iconbrandvivaldi(;kwargs...)

An IconBrandVivaldi component.
...
"""
function dti_iconbrandvivaldi(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvivaldi", "IconBrandVivaldi", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
