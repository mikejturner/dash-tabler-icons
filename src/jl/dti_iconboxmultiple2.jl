...
export dti_iconboxmultiple2

"""
    dti_iconboxmultiple2(;kwargs...)

An IconBoxMultiple2 component.
...
"""
function dti_iconboxmultiple2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple2", "IconBoxMultiple2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
