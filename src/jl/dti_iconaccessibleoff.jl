...
export dti_iconaccessibleoff

"""
    dti_iconaccessibleoff(;kwargs...)

An IconAccessibleOff component.
...
"""
function dti_iconaccessibleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaccessibleoff", "IconAccessibleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
