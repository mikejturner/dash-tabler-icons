...
export dti_iconzeppelinoff

"""
    dti_iconzeppelinoff(;kwargs...)

An IconZeppelinOff component.
...
"""
function dti_iconzeppelinoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzeppelinoff", "IconZeppelinOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
