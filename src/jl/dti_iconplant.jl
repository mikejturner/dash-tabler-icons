...
export dti_iconplant

"""
    dti_iconplant(;kwargs...)

An IconPlant component.
...
"""
function dti_iconplant(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplant", "IconPlant", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
