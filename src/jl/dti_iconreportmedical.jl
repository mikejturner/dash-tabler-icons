...
export dti_iconreportmedical

"""
    dti_iconreportmedical(;kwargs...)

An IconReportMedical component.
...
"""
function dti_iconreportmedical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreportmedical", "IconReportMedical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
