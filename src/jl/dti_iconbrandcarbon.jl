...
export dti_iconbrandcarbon

"""
    dti_iconbrandcarbon(;kwargs...)

An IconBrandCarbon component.
...
"""
function dti_iconbrandcarbon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcarbon", "IconBrandCarbon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
