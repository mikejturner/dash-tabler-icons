...
export dti_iconcurrencyshekel

"""
    dti_iconcurrencyshekel(;kwargs...)

An IconCurrencyShekel component.
...
"""
function dti_iconcurrencyshekel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyshekel", "IconCurrencyShekel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
