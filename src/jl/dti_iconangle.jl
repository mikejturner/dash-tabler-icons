...
export dti_iconangle

"""
    dti_iconangle(;kwargs...)

An IconAngle component.
...
"""
function dti_iconangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconangle", "IconAngle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
