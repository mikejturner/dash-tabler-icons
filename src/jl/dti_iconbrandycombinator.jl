...
export dti_iconbrandycombinator

"""
    dti_iconbrandycombinator(;kwargs...)

An IconBrandYcombinator component.
...
"""
function dti_iconbrandycombinator(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandycombinator", "IconBrandYcombinator", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
