...
export dti_iconbottle

"""
    dti_iconbottle(;kwargs...)

An IconBottle component.
...
"""
function dti_iconbottle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbottle", "IconBottle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
