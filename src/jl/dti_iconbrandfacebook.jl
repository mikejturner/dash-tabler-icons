...
export dti_iconbrandfacebook

"""
    dti_iconbrandfacebook(;kwargs...)

An IconBrandFacebook component.
...
"""
function dti_iconbrandfacebook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfacebook", "IconBrandFacebook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
