...
export dti_iconfilesettings

"""
    dti_iconfilesettings(;kwargs...)

An IconFileSettings component.
...
"""
function dti_iconfilesettings(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilesettings", "IconFileSettings", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
