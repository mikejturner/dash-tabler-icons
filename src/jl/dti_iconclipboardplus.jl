...
export dti_iconclipboardplus

"""
    dti_iconclipboardplus(;kwargs...)

An IconClipboardPlus component.
...
"""
function dti_iconclipboardplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardplus", "IconClipboardPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
