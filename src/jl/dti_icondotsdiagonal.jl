...
export dti_icondotsdiagonal

"""
    dti_icondotsdiagonal(;kwargs...)

An IconDotsDiagonal component.
...
"""
function dti_icondotsdiagonal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondotsdiagonal", "IconDotsDiagonal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
