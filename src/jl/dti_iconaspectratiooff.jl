...
export dti_iconaspectratiooff

"""
    dti_iconaspectratiooff(;kwargs...)

An IconAspectRatioOff component.
...
"""
function dti_iconaspectratiooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaspectratiooff", "IconAspectRatioOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
