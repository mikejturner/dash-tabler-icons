...
export dti_iconmoodhappy

"""
    dti_iconmoodhappy(;kwargs...)

An IconMoodHappy component.
...
"""
function dti_iconmoodhappy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodhappy", "IconMoodHappy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
