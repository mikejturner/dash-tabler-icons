...
export dti_iconbrandmyoppo

"""
    dti_iconbrandmyoppo(;kwargs...)

An IconBrandMyOppo component.
...
"""
function dti_iconbrandmyoppo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmyoppo", "IconBrandMyOppo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
