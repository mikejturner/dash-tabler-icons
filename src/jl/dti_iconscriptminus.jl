...
export dti_iconscriptminus

"""
    dti_iconscriptminus(;kwargs...)

An IconScriptMinus component.
...
"""
function dti_iconscriptminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscriptminus", "IconScriptMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
