...
export dti_icontallymark2

"""
    dti_icontallymark2(;kwargs...)

An IconTallymark2 component.
...
"""
function dti_icontallymark2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontallymark2", "IconTallymark2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
