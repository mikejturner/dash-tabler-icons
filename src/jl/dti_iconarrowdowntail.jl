...
export dti_iconarrowdowntail

"""
    dti_iconarrowdowntail(;kwargs...)

An IconArrowDownTail component.
...
"""
function dti_iconarrowdowntail(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdowntail", "IconArrowDownTail", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
