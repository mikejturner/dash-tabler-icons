...
export dti_iconmoodtonguewink2

"""
    dti_iconmoodtonguewink2(;kwargs...)

An IconMoodTongueWink2 component.
...
"""
function dti_iconmoodtonguewink2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodtonguewink2", "IconMoodTongueWink2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
