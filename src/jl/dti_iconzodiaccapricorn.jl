...
export dti_iconzodiaccapricorn

"""
    dti_iconzodiaccapricorn(;kwargs...)

An IconZodiacCapricorn component.
...
"""
function dti_iconzodiaccapricorn(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiaccapricorn", "IconZodiacCapricorn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
