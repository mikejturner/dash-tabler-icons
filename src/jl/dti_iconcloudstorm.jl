...
export dti_iconcloudstorm

"""
    dti_iconcloudstorm(;kwargs...)

An IconCloudStorm component.
...
"""
function dti_iconcloudstorm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudstorm", "IconCloudStorm", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
