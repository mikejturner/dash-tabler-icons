...
export dti_iconphoneoff

"""
    dti_iconphoneoff(;kwargs...)

An IconPhoneOff component.
...
"""
function dti_iconphoneoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphoneoff", "IconPhoneOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
