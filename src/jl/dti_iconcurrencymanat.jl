...
export dti_iconcurrencymanat

"""
    dti_iconcurrencymanat(;kwargs...)

An IconCurrencyManat component.
...
"""
function dti_iconcurrencymanat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencymanat", "IconCurrencyManat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
