...
export dti_iconcurrencyyenoff

"""
    dti_iconcurrencyyenoff(;kwargs...)

An IconCurrencyYenOff component.
...
"""
function dti_iconcurrencyyenoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyyenoff", "IconCurrencyYenOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
