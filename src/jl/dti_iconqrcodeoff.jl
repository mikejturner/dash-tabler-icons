...
export dti_iconqrcodeoff

"""
    dti_iconqrcodeoff(;kwargs...)

An IconQrcodeOff component.
...
"""
function dti_iconqrcodeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconqrcodeoff", "IconQrcodeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
