...
export dti_iconbrandkickstarter

"""
    dti_iconbrandkickstarter(;kwargs...)

An IconBrandKickstarter component.
...
"""
function dti_iconbrandkickstarter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandkickstarter", "IconBrandKickstarter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
