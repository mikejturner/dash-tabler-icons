...
export dti_iconwifi1

"""
    dti_iconwifi1(;kwargs...)

An IconWifi1 component.
...
"""
function dti_iconwifi1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwifi1", "IconWifi1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
