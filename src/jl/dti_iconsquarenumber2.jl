...
export dti_iconsquarenumber2

"""
    dti_iconsquarenumber2(;kwargs...)

An IconSquareNumber2 component.
...
"""
function dti_iconsquarenumber2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber2", "IconSquareNumber2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
