...
export dti_iconcirclenumber5

"""
    dti_iconcirclenumber5(;kwargs...)

An IconCircleNumber5 component.
...
"""
function dti_iconcirclenumber5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber5", "IconCircleNumber5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
