...
export dti_iconpawoff

"""
    dti_iconpawoff(;kwargs...)

An IconPawOff component.
...
"""
function dti_iconpawoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpawoff", "IconPawOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
