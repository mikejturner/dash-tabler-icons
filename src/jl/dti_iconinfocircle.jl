...
export dti_iconinfocircle

"""
    dti_iconinfocircle(;kwargs...)

An IconInfoCircle component.
...
"""
function dti_iconinfocircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinfocircle", "IconInfoCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
