...
export dti_iconcrosshair

"""
    dti_iconcrosshair(;kwargs...)

An IconCrosshair component.
...
"""
function dti_iconcrosshair(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrosshair", "IconCrosshair", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
