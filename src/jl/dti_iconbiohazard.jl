...
export dti_iconbiohazard

"""
    dti_iconbiohazard(;kwargs...)

An IconBiohazard component.
...
"""
function dti_iconbiohazard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbiohazard", "IconBiohazard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
