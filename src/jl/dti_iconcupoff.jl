...
export dti_iconcupoff

"""
    dti_iconcupoff(;kwargs...)

An IconCupOff component.
...
"""
function dti_iconcupoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcupoff", "IconCupOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
