...
export dti_iconconfetti

"""
    dti_iconconfetti(;kwargs...)

An IconConfetti component.
...
"""
function dti_iconconfetti(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconconfetti", "IconConfetti", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
