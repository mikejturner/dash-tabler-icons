...
export dti_iconballfootball

"""
    dti_iconballfootball(;kwargs...)

An IconBallFootball component.
...
"""
function dti_iconballfootball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballfootball", "IconBallFootball", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
