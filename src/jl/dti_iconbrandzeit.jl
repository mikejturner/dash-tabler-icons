...
export dti_iconbrandzeit

"""
    dti_iconbrandzeit(;kwargs...)

An IconBrandZeit component.
...
"""
function dti_iconbrandzeit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandzeit", "IconBrandZeit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
