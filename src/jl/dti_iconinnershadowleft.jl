...
export dti_iconinnershadowleft

"""
    dti_iconinnershadowleft(;kwargs...)

An IconInnerShadowLeft component.
...
"""
function dti_iconinnershadowleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowleft", "IconInnerShadowLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
