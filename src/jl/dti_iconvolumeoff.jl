...
export dti_iconvolumeoff

"""
    dti_iconvolumeoff(;kwargs...)

An IconVolumeOff component.
...
"""
function dti_iconvolumeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvolumeoff", "IconVolumeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
