...
export dti_iconbrandtoyota

"""
    dti_iconbrandtoyota(;kwargs...)

An IconBrandToyota component.
...
"""
function dti_iconbrandtoyota(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtoyota", "IconBrandToyota", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
