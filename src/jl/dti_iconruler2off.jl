...
export dti_iconruler2off

"""
    dti_iconruler2off(;kwargs...)

An IconRuler2Off component.
...
"""
function dti_iconruler2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconruler2off", "IconRuler2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
