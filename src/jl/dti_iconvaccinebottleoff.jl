...
export dti_iconvaccinebottleoff

"""
    dti_iconvaccinebottleoff(;kwargs...)

An IconVaccineBottleOff component.
...
"""
function dti_iconvaccinebottleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvaccinebottleoff", "IconVaccineBottleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
