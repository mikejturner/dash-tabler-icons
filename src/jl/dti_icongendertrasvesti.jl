...
export dti_icongendertrasvesti

"""
    dti_icongendertrasvesti(;kwargs...)

An IconGenderTrasvesti component.
...
"""
function dti_icongendertrasvesti(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongendertrasvesti", "IconGenderTrasvesti", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
