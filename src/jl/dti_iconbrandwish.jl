...
export dti_iconbrandwish

"""
    dti_iconbrandwish(;kwargs...)

An IconBrandWish component.
...
"""
function dti_iconbrandwish(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwish", "IconBrandWish", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
