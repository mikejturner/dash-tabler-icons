...
export dti_iconarrowsrightleft

"""
    dti_iconarrowsrightleft(;kwargs...)

An IconArrowsRightLeft component.
...
"""
function dti_iconarrowsrightleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsrightleft", "IconArrowsRightLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
