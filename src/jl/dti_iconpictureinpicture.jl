...
export dti_iconpictureinpicture

"""
    dti_iconpictureinpicture(;kwargs...)

An IconPictureInPicture component.
...
"""
function dti_iconpictureinpicture(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpictureinpicture", "IconPictureInPicture", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
