...
export dti_iconcurrencydollarzimbabwean

"""
    dti_iconcurrencydollarzimbabwean(;kwargs...)

An IconCurrencyDollarZimbabwean component.
...
"""
function dti_iconcurrencydollarzimbabwean(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollarzimbabwean", "IconCurrencyDollarZimbabwean", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
