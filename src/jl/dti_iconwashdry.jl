...
export dti_iconwashdry

"""
    dti_iconwashdry(;kwargs...)

An IconWashDry component.
...
"""
function dti_iconwashdry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdry", "IconWashDry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
