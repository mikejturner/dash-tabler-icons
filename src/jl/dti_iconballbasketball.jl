...
export dti_iconballbasketball

"""
    dti_iconballbasketball(;kwargs...)

An IconBallBasketball component.
...
"""
function dti_iconballbasketball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballbasketball", "IconBallBasketball", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
