...
export dti_iconreportmoney

"""
    dti_iconreportmoney(;kwargs...)

An IconReportMoney component.
...
"""
function dti_iconreportmoney(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreportmoney", "IconReportMoney", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
