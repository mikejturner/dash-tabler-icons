...
export dti_icontransferout

"""
    dti_icontransferout(;kwargs...)

An IconTransferOut component.
...
"""
function dti_icontransferout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontransferout", "IconTransferOut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
