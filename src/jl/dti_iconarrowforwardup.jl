...
export dti_iconarrowforwardup

"""
    dti_iconarrowforwardup(;kwargs...)

An IconArrowForwardUp component.
...
"""
function dti_iconarrowforwardup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowforwardup", "IconArrowForwardUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
