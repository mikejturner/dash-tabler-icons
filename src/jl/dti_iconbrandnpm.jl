...
export dti_iconbrandnpm

"""
    dti_iconbrandnpm(;kwargs...)

An IconBrandNpm component.
...
"""
function dti_iconbrandnpm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnpm", "IconBrandNpm", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
