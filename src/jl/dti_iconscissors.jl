...
export dti_iconscissors

"""
    dti_iconscissors(;kwargs...)

An IconScissors component.
...
"""
function dti_iconscissors(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscissors", "IconScissors", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
