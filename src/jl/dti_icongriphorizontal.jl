...
export dti_icongriphorizontal

"""
    dti_icongriphorizontal(;kwargs...)

An IconGripHorizontal component.
...
"""
function dti_icongriphorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongriphorizontal", "IconGripHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
