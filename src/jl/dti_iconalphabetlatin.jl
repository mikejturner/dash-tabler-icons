...
export dti_iconalphabetlatin

"""
    dti_iconalphabetlatin(;kwargs...)

An IconAlphabetLatin component.
...
"""
function dti_iconalphabetlatin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalphabetlatin", "IconAlphabetLatin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
