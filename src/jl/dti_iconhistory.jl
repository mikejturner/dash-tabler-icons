...
export dti_iconhistory

"""
    dti_iconhistory(;kwargs...)

An IconHistory component.
...
"""
function dti_iconhistory(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhistory", "IconHistory", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
