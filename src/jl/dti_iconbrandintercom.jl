...
export dti_iconbrandintercom

"""
    dti_iconbrandintercom(;kwargs...)

An IconBrandIntercom component.
...
"""
function dti_iconbrandintercom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandintercom", "IconBrandIntercom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
