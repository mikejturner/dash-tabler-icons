...
export dti_iconaward

"""
    dti_iconaward(;kwargs...)

An IconAward component.
...
"""
function dti_iconaward(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaward", "IconAward", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
