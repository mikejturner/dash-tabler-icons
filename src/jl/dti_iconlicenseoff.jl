...
export dti_iconlicenseoff

"""
    dti_iconlicenseoff(;kwargs...)

An IconLicenseOff component.
...
"""
function dti_iconlicenseoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlicenseoff", "IconLicenseOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
