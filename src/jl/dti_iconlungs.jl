...
export dti_iconlungs

"""
    dti_iconlungs(;kwargs...)

An IconLungs component.
...
"""
function dti_iconlungs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlungs", "IconLungs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
