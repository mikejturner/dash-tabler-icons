...
export dti_iconarrowscross

"""
    dti_iconarrowscross(;kwargs...)

An IconArrowsCross component.
...
"""
function dti_iconarrowscross(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowscross", "IconArrowsCross", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
