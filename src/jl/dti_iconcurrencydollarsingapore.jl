...
export dti_iconcurrencydollarsingapore

"""
    dti_iconcurrencydollarsingapore(;kwargs...)

An IconCurrencyDollarSingapore component.
...
"""
function dti_iconcurrencydollarsingapore(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollarsingapore", "IconCurrencyDollarSingapore", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
