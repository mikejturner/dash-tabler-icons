...
export dti_iconchecklist

"""
    dti_iconchecklist(;kwargs...)

An IconChecklist component.
...
"""
function dti_iconchecklist(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchecklist", "IconChecklist", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
