...
export dti_icondropcircle

"""
    dti_icondropcircle(;kwargs...)

An IconDropCircle component.
...
"""
function dti_icondropcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondropcircle", "IconDropCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
