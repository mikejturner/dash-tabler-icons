...
export dti_iconarrowsrandom

"""
    dti_iconarrowsrandom(;kwargs...)

An IconArrowsRandom component.
...
"""
function dti_iconarrowsrandom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsrandom", "IconArrowsRandom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
