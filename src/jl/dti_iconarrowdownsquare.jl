...
export dti_iconarrowdownsquare

"""
    dti_iconarrowdownsquare(;kwargs...)

An IconArrowDownSquare component.
...
"""
function dti_iconarrowdownsquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdownsquare", "IconArrowDownSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
