...
export dti_icondirectionsign

"""
    dti_icondirectionsign(;kwargs...)

An IconDirectionSign component.
...
"""
function dti_icondirectionsign(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondirectionsign", "IconDirectionSign", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
