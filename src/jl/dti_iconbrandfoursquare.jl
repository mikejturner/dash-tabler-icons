...
export dti_iconbrandfoursquare

"""
    dti_iconbrandfoursquare(;kwargs...)

An IconBrandFoursquare component.
...
"""
function dti_iconbrandfoursquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfoursquare", "IconBrandFoursquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
