...
export dti_iconaddressbookoff

"""
    dti_iconaddressbookoff(;kwargs...)

An IconAddressBookOff component.
...
"""
function dti_iconaddressbookoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaddressbookoff", "IconAddressBookOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
