...
export dti_iconlayoutsidebarrightcollapse

"""
    dti_iconlayoutsidebarrightcollapse(;kwargs...)

An IconLayoutSidebarRightCollapse component.
...
"""
function dti_iconlayoutsidebarrightcollapse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutsidebarrightcollapse", "IconLayoutSidebarRightCollapse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
