...
export dti_iconbrandcomedycentral

"""
    dti_iconbrandcomedycentral(;kwargs...)

An IconBrandComedyCentral component.
...
"""
function dti_iconbrandcomedycentral(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcomedycentral", "IconBrandComedyCentral", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
