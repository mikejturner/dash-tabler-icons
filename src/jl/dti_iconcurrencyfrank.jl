...
export dti_iconcurrencyfrank

"""
    dti_iconcurrencyfrank(;kwargs...)

An IconCurrencyFrank component.
...
"""
function dti_iconcurrencyfrank(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyfrank", "IconCurrencyFrank", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
