...
export dti_iconnorthstar

"""
    dti_iconnorthstar(;kwargs...)

An IconNorthStar component.
...
"""
function dti_iconnorthstar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnorthstar", "IconNorthStar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
