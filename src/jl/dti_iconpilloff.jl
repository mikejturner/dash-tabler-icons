...
export dti_iconpilloff

"""
    dti_iconpilloff(;kwargs...)

An IconPillOff component.
...
"""
function dti_iconpilloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpilloff", "IconPillOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
