...
export dti_iconstretching

"""
    dti_iconstretching(;kwargs...)

An IconStretching component.
...
"""
function dti_iconstretching(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstretching", "IconStretching", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
