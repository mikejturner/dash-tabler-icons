...
export dti_iconceoff

"""
    dti_iconceoff(;kwargs...)

An IconCeOff component.
...
"""
function dti_iconceoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconceoff", "IconCeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
