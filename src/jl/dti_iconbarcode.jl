...
export dti_iconbarcode

"""
    dti_iconbarcode(;kwargs...)

An IconBarcode component.
...
"""
function dti_iconbarcode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarcode", "IconBarcode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
