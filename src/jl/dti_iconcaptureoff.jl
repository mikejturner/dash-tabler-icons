...
export dti_iconcaptureoff

"""
    dti_iconcaptureoff(;kwargs...)

An IconCaptureOff component.
...
"""
function dti_iconcaptureoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaptureoff", "IconCaptureOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
