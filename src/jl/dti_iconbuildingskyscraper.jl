...
export dti_iconbuildingskyscraper

"""
    dti_iconbuildingskyscraper(;kwargs...)

An IconBuildingSkyscraper component.
...
"""
function dti_iconbuildingskyscraper(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingskyscraper", "IconBuildingSkyscraper", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
