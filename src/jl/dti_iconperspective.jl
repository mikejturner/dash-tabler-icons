...
export dti_iconperspective

"""
    dti_iconperspective(;kwargs...)

An IconPerspective component.
...
"""
function dti_iconperspective(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconperspective", "IconPerspective", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
