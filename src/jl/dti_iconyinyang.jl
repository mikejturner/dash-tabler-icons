...
export dti_iconyinyang

"""
    dti_iconyinyang(;kwargs...)

An IconYinYang component.
...
"""
function dti_iconyinyang(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconyinyang", "IconYinYang", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
