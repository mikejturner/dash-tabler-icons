...
export dti_iconmoodsing

"""
    dti_iconmoodsing(;kwargs...)

An IconMoodSing component.
...
"""
function dti_iconmoodsing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsing", "IconMoodSing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
