...
export dti_iconscale

"""
    dti_iconscale(;kwargs...)

An IconScale component.
...
"""
function dti_iconscale(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscale", "IconScale", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
