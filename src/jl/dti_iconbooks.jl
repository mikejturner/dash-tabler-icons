...
export dti_iconbooks

"""
    dti_iconbooks(;kwargs...)

An IconBooks component.
...
"""
function dti_iconbooks(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbooks", "IconBooks", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
