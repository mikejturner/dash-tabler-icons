...
export dti_iconkeyboardhide

"""
    dti_iconkeyboardhide(;kwargs...)

An IconKeyboardHide component.
...
"""
function dti_iconkeyboardhide(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyboardhide", "IconKeyboardHide", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
