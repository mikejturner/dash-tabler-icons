...
export dti_iconcornerleftdowndouble

"""
    dti_iconcornerleftdowndouble(;kwargs...)

An IconCornerLeftDownDouble component.
...
"""
function dti_iconcornerleftdowndouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerleftdowndouble", "IconCornerLeftDownDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
