...
export dti_iconchevronright

"""
    dti_iconchevronright(;kwargs...)

An IconChevronRight component.
...
"""
function dti_iconchevronright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronright", "IconChevronRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
