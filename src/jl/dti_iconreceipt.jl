...
export dti_iconreceipt

"""
    dti_iconreceipt(;kwargs...)

An IconReceipt component.
...
"""
function dti_iconreceipt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreceipt", "IconReceipt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
