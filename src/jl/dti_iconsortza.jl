...
export dti_iconsortza

"""
    dti_iconsortza(;kwargs...)

An IconSortZA component.
...
"""
function dti_iconsortza(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortza", "IconSortZA", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
