...
export dti_iconcolorswatchoff

"""
    dti_iconcolorswatchoff(;kwargs...)

An IconColorSwatchOff component.
...
"""
function dti_iconcolorswatchoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolorswatchoff", "IconColorSwatchOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
