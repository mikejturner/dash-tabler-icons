...
export dti_iconbranddeviantart

"""
    dti_iconbranddeviantart(;kwargs...)

An IconBrandDeviantart component.
...
"""
function dti_iconbranddeviantart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddeviantart", "IconBrandDeviantart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
