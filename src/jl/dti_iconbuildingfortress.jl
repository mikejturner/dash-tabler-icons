...
export dti_iconbuildingfortress

"""
    dti_iconbuildingfortress(;kwargs...)

An IconBuildingFortress component.
...
"""
function dti_iconbuildingfortress(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingfortress", "IconBuildingFortress", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
