...
export dti_iconfilevector

"""
    dti_iconfilevector(;kwargs...)

An IconFileVector component.
...
"""
function dti_iconfilevector(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilevector", "IconFileVector", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
