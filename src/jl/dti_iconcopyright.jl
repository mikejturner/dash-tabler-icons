...
export dti_iconcopyright

"""
    dti_iconcopyright(;kwargs...)

An IconCopyright component.
...
"""
function dti_iconcopyright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcopyright", "IconCopyright", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
