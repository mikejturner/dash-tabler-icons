...
export dti_iconarrowrotaryleft

"""
    dti_iconarrowrotaryleft(;kwargs...)

An IconArrowRotaryLeft component.
...
"""
function dti_iconarrowrotaryleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotaryleft", "IconArrowRotaryLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
