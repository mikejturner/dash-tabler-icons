...
export dti_iconalignboxtopright

"""
    dti_iconalignboxtopright(;kwargs...)

An IconAlignBoxTopRight component.
...
"""
function dti_iconalignboxtopright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxtopright", "IconAlignBoxTopRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
