...
export dti_iconsignal4gplus

"""
    dti_iconsignal4gplus(;kwargs...)

An IconSignal4gPlus component.
...
"""
function dti_iconsignal4gplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignal4gplus", "IconSignal4gPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
