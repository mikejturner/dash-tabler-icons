...
export dti_iconironing2

"""
    dti_iconironing2(;kwargs...)

An IconIroning2 component.
...
"""
function dti_iconironing2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconironing2", "IconIroning2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
