...
export dti_iconcursoroff

"""
    dti_iconcursoroff(;kwargs...)

An IconCursorOff component.
...
"""
function dti_iconcursoroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcursoroff", "IconCursorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
