...
export dti_iconmultiplier1x

"""
    dti_iconmultiplier1x(;kwargs...)

An IconMultiplier1x component.
...
"""
function dti_iconmultiplier1x(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmultiplier1x", "IconMultiplier1x", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
