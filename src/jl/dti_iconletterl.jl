...
export dti_iconletterl

"""
    dti_iconletterl(;kwargs...)

An IconLetterL component.
...
"""
function dti_iconletterl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterl", "IconLetterL", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
