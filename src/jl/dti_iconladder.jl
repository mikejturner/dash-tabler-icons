...
export dti_iconladder

"""
    dti_iconladder(;kwargs...)

An IconLadder component.
...
"""
function dti_iconladder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconladder", "IconLadder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
