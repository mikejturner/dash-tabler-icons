...
export dti_iconeditcircle

"""
    dti_iconeditcircle(;kwargs...)

An IconEditCircle component.
...
"""
function dti_iconeditcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeditcircle", "IconEditCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
