...
export dti_iconcloudoff

"""
    dti_iconcloudoff(;kwargs...)

An IconCloudOff component.
...
"""
function dti_iconcloudoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudoff", "IconCloudOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
