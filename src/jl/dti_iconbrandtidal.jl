...
export dti_iconbrandtidal

"""
    dti_iconbrandtidal(;kwargs...)

An IconBrandTidal component.
...
"""
function dti_iconbrandtidal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtidal", "IconBrandTidal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
