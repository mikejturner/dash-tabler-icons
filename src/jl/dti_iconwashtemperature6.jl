...
export dti_iconwashtemperature6

"""
    dti_iconwashtemperature6(;kwargs...)

An IconWashTemperature6 component.
...
"""
function dti_iconwashtemperature6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtemperature6", "IconWashTemperature6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
