...
export dti_iconcirclenumber7

"""
    dti_iconcirclenumber7(;kwargs...)

An IconCircleNumber7 component.
...
"""
function dti_iconcirclenumber7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber7", "IconCircleNumber7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
