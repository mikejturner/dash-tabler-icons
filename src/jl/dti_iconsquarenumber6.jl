...
export dti_iconsquarenumber6

"""
    dti_iconsquarenumber6(;kwargs...)

An IconSquareNumber6 component.
...
"""
function dti_iconsquarenumber6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber6", "IconSquareNumber6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
