...
export dti_iconcopyleftoff

"""
    dti_iconcopyleftoff(;kwargs...)

An IconCopyleftOff component.
...
"""
function dti_iconcopyleftoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcopyleftoff", "IconCopyleftOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
