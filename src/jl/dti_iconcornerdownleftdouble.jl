...
export dti_iconcornerdownleftdouble

"""
    dti_iconcornerdownleftdouble(;kwargs...)

An IconCornerDownLeftDouble component.
...
"""
function dti_iconcornerdownleftdouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerdownleftdouble", "IconCornerDownLeftDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
