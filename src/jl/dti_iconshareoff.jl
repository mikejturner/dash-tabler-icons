...
export dti_iconshareoff

"""
    dti_iconshareoff(;kwargs...)

An IconShareOff component.
...
"""
function dti_iconshareoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshareoff", "IconShareOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
