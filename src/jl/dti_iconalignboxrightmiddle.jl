...
export dti_iconalignboxrightmiddle

"""
    dti_iconalignboxrightmiddle(;kwargs...)

An IconAlignBoxRightMiddle component.
...
"""
function dti_iconalignboxrightmiddle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxrightmiddle", "IconAlignBoxRightMiddle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
