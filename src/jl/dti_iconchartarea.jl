...
export dti_iconchartarea

"""
    dti_iconchartarea(;kwargs...)

An IconChartArea component.
...
"""
function dti_iconchartarea(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartarea", "IconChartArea", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
