...
export dti_iconbookdownload

"""
    dti_iconbookdownload(;kwargs...)

An IconBookDownload component.
...
"""
function dti_iconbookdownload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbookdownload", "IconBookDownload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
