...
export dti_iconuseroff

"""
    dti_iconuseroff(;kwargs...)

An IconUserOff component.
...
"""
function dti_iconuseroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuseroff", "IconUserOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
