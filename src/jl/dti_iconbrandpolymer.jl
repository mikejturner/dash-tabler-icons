...
export dti_iconbrandpolymer

"""
    dti_iconbrandpolymer(;kwargs...)

An IconBrandPolymer component.
...
"""
function dti_iconbrandpolymer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpolymer", "IconBrandPolymer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
