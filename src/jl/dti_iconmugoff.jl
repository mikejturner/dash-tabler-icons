...
export dti_iconmugoff

"""
    dti_iconmugoff(;kwargs...)

An IconMugOff component.
...
"""
function dti_iconmugoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmugoff", "IconMugOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
