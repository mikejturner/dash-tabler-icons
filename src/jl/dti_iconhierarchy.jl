...
export dti_iconhierarchy

"""
    dti_iconhierarchy(;kwargs...)

An IconHierarchy component.
...
"""
function dti_iconhierarchy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhierarchy", "IconHierarchy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
