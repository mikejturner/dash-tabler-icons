...
export dti_iconarrowrampright2

"""
    dti_iconarrowrampright2(;kwargs...)

An IconArrowRampRight2 component.
...
"""
function dti_iconarrowrampright2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrampright2", "IconArrowRampRight2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
