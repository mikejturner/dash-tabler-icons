...
export dti_iconcurrencylitecoin

"""
    dti_iconcurrencylitecoin(;kwargs...)

An IconCurrencyLitecoin component.
...
"""
function dti_iconcurrencylitecoin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencylitecoin", "IconCurrencyLitecoin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
