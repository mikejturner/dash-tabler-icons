...
export dti_iconalignboxleftmiddle

"""
    dti_iconalignboxleftmiddle(;kwargs...)

An IconAlignBoxLeftMiddle component.
...
"""
function dti_iconalignboxleftmiddle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxleftmiddle", "IconAlignBoxLeftMiddle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
