...
export dti_iconsquarearrowup

"""
    dti_iconsquarearrowup(;kwargs...)

An IconSquareArrowUp component.
...
"""
function dti_iconsquarearrowup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarearrowup", "IconSquareArrowUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
