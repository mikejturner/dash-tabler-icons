...
export dti_iconmathfunction

"""
    dti_iconmathfunction(;kwargs...)

An IconMathFunction component.
...
"""
function dti_iconmathfunction(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathfunction", "IconMathFunction", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
