...
export dti_iconarrowstransferdown

"""
    dti_iconarrowstransferdown(;kwargs...)

An IconArrowsTransferDown component.
...
"""
function dti_iconarrowstransferdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowstransferdown", "IconArrowsTransferDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
