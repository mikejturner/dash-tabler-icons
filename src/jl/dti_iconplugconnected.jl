...
export dti_iconplugconnected

"""
    dti_iconplugconnected(;kwargs...)

An IconPlugConnected component.
...
"""
function dti_iconplugconnected(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplugconnected", "IconPlugConnected", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
