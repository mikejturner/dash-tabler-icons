...
export dti_iconcurrencyyen

"""
    dti_iconcurrencyyen(;kwargs...)

An IconCurrencyYen component.
...
"""
function dti_iconcurrencyyen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyyen", "IconCurrencyYen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
