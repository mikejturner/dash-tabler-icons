...
export dti_icondoorexit

"""
    dti_icondoorexit(;kwargs...)

An IconDoorExit component.
...
"""
function dti_icondoorexit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondoorexit", "IconDoorExit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
