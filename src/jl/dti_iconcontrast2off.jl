...
export dti_iconcontrast2off

"""
    dti_iconcontrast2off(;kwargs...)

An IconContrast2Off component.
...
"""
function dti_iconcontrast2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcontrast2off", "IconContrast2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
