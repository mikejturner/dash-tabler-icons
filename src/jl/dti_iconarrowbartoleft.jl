...
export dti_iconarrowbartoleft

"""
    dti_iconarrowbartoleft(;kwargs...)

An IconArrowBarToLeft component.
...
"""
function dti_iconarrowbartoleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbartoleft", "IconArrowBarToLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
