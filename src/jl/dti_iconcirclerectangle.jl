...
export dti_iconcirclerectangle

"""
    dti_iconcirclerectangle(;kwargs...)

An IconCircleRectangle component.
...
"""
function dti_iconcirclerectangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclerectangle", "IconCircleRectangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
