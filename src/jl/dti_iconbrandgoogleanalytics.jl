...
export dti_iconbrandgoogleanalytics

"""
    dti_iconbrandgoogleanalytics(;kwargs...)

An IconBrandGoogleAnalytics component.
...
"""
function dti_iconbrandgoogleanalytics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgoogleanalytics", "IconBrandGoogleAnalytics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
