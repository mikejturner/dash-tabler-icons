...
export dti_iconarrowuprightcircle

"""
    dti_iconarrowuprightcircle(;kwargs...)

An IconArrowUpRightCircle component.
...
"""
function dti_iconarrowuprightcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowuprightcircle", "IconArrowUpRightCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
