...
export dti_iconbrandlinqpad

"""
    dti_iconbrandlinqpad(;kwargs...)

An IconBrandLinqpad component.
...
"""
function dti_iconbrandlinqpad(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandlinqpad", "IconBrandLinqpad", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
