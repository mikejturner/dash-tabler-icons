...
export dti_iconcornerupleft

"""
    dti_iconcornerupleft(;kwargs...)

An IconCornerUpLeft component.
...
"""
function dti_iconcornerupleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerupleft", "IconCornerUpLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
