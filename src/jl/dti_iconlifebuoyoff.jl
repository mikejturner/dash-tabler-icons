...
export dti_iconlifebuoyoff

"""
    dti_iconlifebuoyoff(;kwargs...)

An IconLifebuoyOff component.
...
"""
function dti_iconlifebuoyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlifebuoyoff", "IconLifebuoyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
