...
export dti_iconidbadgeoff

"""
    dti_iconidbadgeoff(;kwargs...)

An IconIdBadgeOff component.
...
"""
function dti_iconidbadgeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconidbadgeoff", "IconIdBadgeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
