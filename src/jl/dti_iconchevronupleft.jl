...
export dti_iconchevronupleft

"""
    dti_iconchevronupleft(;kwargs...)

An IconChevronUpLeft component.
...
"""
function dti_iconchevronupleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronupleft", "IconChevronUpLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
