...
export dti_iconchevronup

"""
    dti_iconchevronup(;kwargs...)

An IconChevronUp component.
...
"""
function dti_iconchevronup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronup", "IconChevronUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
