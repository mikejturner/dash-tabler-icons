...
export dti_iconparachute

"""
    dti_iconparachute(;kwargs...)

An IconParachute component.
...
"""
function dti_iconparachute(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconparachute", "IconParachute", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
