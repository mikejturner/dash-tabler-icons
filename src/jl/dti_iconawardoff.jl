...
export dti_iconawardoff

"""
    dti_iconawardoff(;kwargs...)

An IconAwardOff component.
...
"""
function dti_iconawardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconawardoff", "IconAwardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
