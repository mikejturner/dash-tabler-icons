...
export dti_iconhandstop

"""
    dti_iconhandstop(;kwargs...)

An IconHandStop component.
...
"""
function dti_iconhandstop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandstop", "IconHandStop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
