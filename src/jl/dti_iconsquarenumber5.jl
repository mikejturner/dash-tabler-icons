...
export dti_iconsquarenumber5

"""
    dti_iconsquarenumber5(;kwargs...)

An IconSquareNumber5 component.
...
"""
function dti_iconsquarenumber5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber5", "IconSquareNumber5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
