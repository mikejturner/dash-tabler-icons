...
export dti_iconfriendsoff

"""
    dti_iconfriendsoff(;kwargs...)

An IconFriendsOff component.
...
"""
function dti_iconfriendsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfriendsoff", "IconFriendsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
