...
export dti_iconolympicsoff

"""
    dti_iconolympicsoff(;kwargs...)

An IconOlympicsOff component.
...
"""
function dti_iconolympicsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconolympicsoff", "IconOlympicsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
