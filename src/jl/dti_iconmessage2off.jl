...
export dti_iconmessage2off

"""
    dti_iconmessage2off(;kwargs...)

An IconMessage2Off component.
...
"""
function dti_iconmessage2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessage2off", "IconMessage2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
