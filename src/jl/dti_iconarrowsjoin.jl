...
export dti_iconarrowsjoin

"""
    dti_iconarrowsjoin(;kwargs...)

An IconArrowsJoin component.
...
"""
function dti_iconarrowsjoin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsjoin", "IconArrowsJoin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
