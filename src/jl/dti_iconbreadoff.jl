...
export dti_iconbreadoff

"""
    dti_iconbreadoff(;kwargs...)

An IconBreadOff component.
...
"""
function dti_iconbreadoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbreadoff", "IconBreadOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
