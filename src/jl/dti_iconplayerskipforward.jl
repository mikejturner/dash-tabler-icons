...
export dti_iconplayerskipforward

"""
    dti_iconplayerskipforward(;kwargs...)

An IconPlayerSkipForward component.
...
"""
function dti_iconplayerskipforward(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayerskipforward", "IconPlayerSkipForward", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
