...
export dti_iconlayoutsidebarleftexpand

"""
    dti_iconlayoutsidebarleftexpand(;kwargs...)

An IconLayoutSidebarLeftExpand component.
...
"""
function dti_iconlayoutsidebarleftexpand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutsidebarleftexpand", "IconLayoutSidebarLeftExpand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
