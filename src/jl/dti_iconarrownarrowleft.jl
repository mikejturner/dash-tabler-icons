...
export dti_iconarrownarrowleft

"""
    dti_iconarrownarrowleft(;kwargs...)

An IconArrowNarrowLeft component.
...
"""
function dti_iconarrownarrowleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrownarrowleft", "IconArrowNarrowLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
