...
export dti_iconmicrophone

"""
    dti_iconmicrophone(;kwargs...)

An IconMicrophone component.
...
"""
function dti_iconmicrophone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicrophone", "IconMicrophone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
