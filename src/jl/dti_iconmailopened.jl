...
export dti_iconmailopened

"""
    dti_iconmailopened(;kwargs...)

An IconMailOpened component.
...
"""
function dti_iconmailopened(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmailopened", "IconMailOpened", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
