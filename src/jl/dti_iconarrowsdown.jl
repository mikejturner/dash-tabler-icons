...
export dti_iconarrowsdown

"""
    dti_iconarrowsdown(;kwargs...)

An IconArrowsDown component.
...
"""
function dti_iconarrowsdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdown", "IconArrowsDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
