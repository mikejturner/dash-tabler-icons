...
export dti_iconbuildingcommunity

"""
    dti_iconbuildingcommunity(;kwargs...)

An IconBuildingCommunity component.
...
"""
function dti_iconbuildingcommunity(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingcommunity", "IconBuildingCommunity", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
