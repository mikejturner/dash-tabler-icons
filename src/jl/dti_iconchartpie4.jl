...
export dti_iconchartpie4

"""
    dti_iconchartpie4(;kwargs...)

An IconChartPie4 component.
...
"""
function dti_iconchartpie4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartpie4", "IconChartPie4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
