...
export dti_iconsturndown

"""
    dti_iconsturndown(;kwargs...)

An IconSTurnDown component.
...
"""
function dti_iconsturndown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsturndown", "IconSTurnDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
