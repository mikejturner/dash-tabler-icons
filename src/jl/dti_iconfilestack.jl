...
export dti_iconfilestack

"""
    dti_iconfilestack(;kwargs...)

An IconFileStack component.
...
"""
function dti_iconfilestack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilestack", "IconFileStack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
