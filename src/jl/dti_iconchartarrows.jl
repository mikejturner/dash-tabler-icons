...
export dti_iconchartarrows

"""
    dti_iconchartarrows(;kwargs...)

An IconChartArrows component.
...
"""
function dti_iconchartarrows(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartarrows", "IconChartArrows", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
