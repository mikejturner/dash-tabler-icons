...
export dti_icondotscirclehorizontal

"""
    dti_icondotscirclehorizontal(;kwargs...)

An IconDotsCircleHorizontal component.
...
"""
function dti_icondotscirclehorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondotscirclehorizontal", "IconDotsCircleHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
