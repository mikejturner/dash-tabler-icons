...
export dti_iconshoeoff

"""
    dti_iconshoeoff(;kwargs...)

An IconShoeOff component.
...
"""
function dti_iconshoeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshoeoff", "IconShoeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
