...
export dti_iconclubs

"""
    dti_iconclubs(;kwargs...)

An IconClubs component.
...
"""
function dti_iconclubs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclubs", "IconClubs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
