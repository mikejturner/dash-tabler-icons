...
export dti_iconcircleletterj

"""
    dti_iconcircleletterj(;kwargs...)

An IconCircleLetterJ component.
...
"""
function dti_iconcircleletterj(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterj", "IconCircleLetterJ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
