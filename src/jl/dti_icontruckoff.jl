...
export dti_icontruckoff

"""
    dti_icontruckoff(;kwargs...)

An IconTruckOff component.
...
"""
function dti_icontruckoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontruckoff", "IconTruckOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
