...
export dti_iconsoccerfield

"""
    dti_iconsoccerfield(;kwargs...)

An IconSoccerField component.
...
"""
function dti_iconsoccerfield(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsoccerfield", "IconSoccerField", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
