...
export dti_iconfidgetspinner

"""
    dti_iconfidgetspinner(;kwargs...)

An IconFidgetSpinner component.
...
"""
function dti_iconfidgetspinner(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfidgetspinner", "IconFidgetSpinner", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
