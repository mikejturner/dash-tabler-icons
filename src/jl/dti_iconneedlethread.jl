...
export dti_iconneedlethread

"""
    dti_iconneedlethread(;kwargs...)

An IconNeedleThread component.
...
"""
function dti_iconneedlethread(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconneedlethread", "IconNeedleThread", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
