...
export dti_iconeaseincontrolpoint

"""
    dti_iconeaseincontrolpoint(;kwargs...)

An IconEaseInControlPoint component.
...
"""
function dti_iconeaseincontrolpoint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeaseincontrolpoint", "IconEaseInControlPoint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
