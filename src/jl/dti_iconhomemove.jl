...
export dti_iconhomemove

"""
    dti_iconhomemove(;kwargs...)

An IconHomeMove component.
...
"""
function dti_iconhomemove(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomemove", "IconHomeMove", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
