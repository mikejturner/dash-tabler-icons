...
export dti_iconfilediff

"""
    dti_iconfilediff(;kwargs...)

An IconFileDiff component.
...
"""
function dti_iconfilediff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilediff", "IconFileDiff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
