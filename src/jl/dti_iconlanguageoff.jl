...
export dti_iconlanguageoff

"""
    dti_iconlanguageoff(;kwargs...)

An IconLanguageOff component.
...
"""
function dti_iconlanguageoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlanguageoff", "IconLanguageOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
