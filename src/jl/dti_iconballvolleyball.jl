...
export dti_iconballvolleyball

"""
    dti_iconballvolleyball(;kwargs...)

An IconBallVolleyball component.
...
"""
function dti_iconballvolleyball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballvolleyball", "IconBallVolleyball", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
