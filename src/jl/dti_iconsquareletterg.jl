...
export dti_iconsquareletterg

"""
    dti_iconsquareletterg(;kwargs...)

An IconSquareLetterG component.
...
"""
function dti_iconsquareletterg(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterg", "IconSquareLetterG", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
