...
export dti_iconclockhour3

"""
    dti_iconclockhour3(;kwargs...)

An IconClockHour3 component.
...
"""
function dti_iconclockhour3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour3", "IconClockHour3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
