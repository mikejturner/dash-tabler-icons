...
export dti_iconbrandcampaignmonitor

"""
    dti_iconbrandcampaignmonitor(;kwargs...)

An IconBrandCampaignmonitor component.
...
"""
function dti_iconbrandcampaignmonitor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcampaignmonitor", "IconBrandCampaignmonitor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
