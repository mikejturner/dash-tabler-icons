...
export dti_iconexposure

"""
    dti_iconexposure(;kwargs...)

An IconExposure component.
...
"""
function dti_iconexposure(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposure", "IconExposure", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
