...
export dti_icondevicenintendooff

"""
    dti_icondevicenintendooff(;kwargs...)

An IconDeviceNintendoOff component.
...
"""
function dti_icondevicenintendooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicenintendooff", "IconDeviceNintendoOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
