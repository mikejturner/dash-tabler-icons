...
export dti_iconstereoglasses

"""
    dti_iconstereoglasses(;kwargs...)

An IconStereoGlasses component.
...
"""
function dti_iconstereoglasses(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstereoglasses", "IconStereoGlasses", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
