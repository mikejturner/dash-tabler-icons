...
export dti_iconbadge8k

"""
    dti_iconbadge8k(;kwargs...)

An IconBadge8k component.
...
"""
function dti_iconbadge8k(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadge8k", "IconBadge8k", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
