...
export dti_iconbrandgoogleplay

"""
    dti_iconbrandgoogleplay(;kwargs...)

An IconBrandGooglePlay component.
...
"""
function dti_iconbrandgoogleplay(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgoogleplay", "IconBrandGooglePlay", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
