...
export dti_iconalbumoff

"""
    dti_iconalbumoff(;kwargs...)

An IconAlbumOff component.
...
"""
function dti_iconalbumoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalbumoff", "IconAlbumOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
