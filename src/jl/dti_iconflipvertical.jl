...
export dti_iconflipvertical

"""
    dti_iconflipvertical(;kwargs...)

An IconFlipVertical component.
...
"""
function dti_iconflipvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflipvertical", "IconFlipVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
