...
export dti_iconanalyzeoff

"""
    dti_iconanalyzeoff(;kwargs...)

An IconAnalyzeOff component.
...
"""
function dti_iconanalyzeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconanalyzeoff", "IconAnalyzeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
