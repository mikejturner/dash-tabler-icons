...
export dti_iconwashdryoff

"""
    dti_iconwashdryoff(;kwargs...)

An IconWashDryOff component.
...
"""
function dti_iconwashdryoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryoff", "IconWashDryOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
