...
export dti_iconbrandbeats

"""
    dti_iconbrandbeats(;kwargs...)

An IconBrandBeats component.
...
"""
function dti_iconbrandbeats(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbeats", "IconBrandBeats", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
