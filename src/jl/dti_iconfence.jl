...
export dti_iconfence

"""
    dti_iconfence(;kwargs...)

An IconFence component.
...
"""
function dti_iconfence(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfence", "IconFence", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
