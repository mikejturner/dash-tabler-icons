...
export dti_icongenderagender

"""
    dti_icongenderagender(;kwargs...)

An IconGenderAgender component.
...
"""
function dti_icongenderagender(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderagender", "IconGenderAgender", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
