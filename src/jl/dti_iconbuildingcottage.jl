...
export dti_iconbuildingcottage

"""
    dti_iconbuildingcottage(;kwargs...)

An IconBuildingCottage component.
...
"""
function dti_iconbuildingcottage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingcottage", "IconBuildingCottage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
