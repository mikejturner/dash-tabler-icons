...
export dti_iconarrowsvertical

"""
    dti_iconarrowsvertical(;kwargs...)

An IconArrowsVertical component.
...
"""
function dti_iconarrowsvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsvertical", "IconArrowsVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
