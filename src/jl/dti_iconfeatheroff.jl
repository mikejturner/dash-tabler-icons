...
export dti_iconfeatheroff

"""
    dti_iconfeatheroff(;kwargs...)

An IconFeatherOff component.
...
"""
function dti_iconfeatheroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfeatheroff", "IconFeatherOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
