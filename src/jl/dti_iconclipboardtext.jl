...
export dti_iconclipboardtext

"""
    dti_iconclipboardtext(;kwargs...)

An IconClipboardText component.
...
"""
function dti_iconclipboardtext(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardtext", "IconClipboardText", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
