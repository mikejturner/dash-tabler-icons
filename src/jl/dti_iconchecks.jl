...
export dti_iconchecks

"""
    dti_iconchecks(;kwargs...)

An IconChecks component.
...
"""
function dti_iconchecks(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchecks", "IconChecks", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
