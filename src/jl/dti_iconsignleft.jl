...
export dti_iconsignleft

"""
    dti_iconsignleft(;kwargs...)

An IconSignLeft component.
...
"""
function dti_iconsignleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignleft", "IconSignLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
