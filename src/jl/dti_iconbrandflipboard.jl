...
export dti_iconbrandflipboard

"""
    dti_iconbrandflipboard(;kwargs...)

An IconBrandFlipboard component.
...
"""
function dti_iconbrandflipboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandflipboard", "IconBrandFlipboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
