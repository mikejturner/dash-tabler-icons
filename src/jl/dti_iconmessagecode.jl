...
export dti_iconmessagecode

"""
    dti_iconmessagecode(;kwargs...)

An IconMessageCode component.
...
"""
function dti_iconmessagecode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagecode", "IconMessageCode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
