...
export dti_iconarrowbearleft2

"""
    dti_iconarrowbearleft2(;kwargs...)

An IconArrowBearLeft2 component.
...
"""
function dti_iconarrowbearleft2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbearleft2", "IconArrowBearLeft2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
