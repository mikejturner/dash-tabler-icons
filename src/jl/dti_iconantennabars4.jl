...
export dti_iconantennabars4

"""
    dti_iconantennabars4(;kwargs...)

An IconAntennaBars4 component.
...
"""
function dti_iconantennabars4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennabars4", "IconAntennaBars4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
