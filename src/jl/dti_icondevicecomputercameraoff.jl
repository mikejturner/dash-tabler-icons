...
export dti_icondevicecomputercameraoff

"""
    dti_icondevicecomputercameraoff(;kwargs...)

An IconDeviceComputerCameraOff component.
...
"""
function dti_icondevicecomputercameraoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicecomputercameraoff", "IconDeviceComputerCameraOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
