...
export dti_iconsteam

"""
    dti_iconsteam(;kwargs...)

An IconSteam component.
...
"""
function dti_iconsteam(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsteam", "IconSteam", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
