...
export dti_iconaffiliate

"""
    dti_iconaffiliate(;kwargs...)

An IconAffiliate component.
...
"""
function dti_iconaffiliate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaffiliate", "IconAffiliate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
