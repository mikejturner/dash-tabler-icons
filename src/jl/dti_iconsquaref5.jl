...
export dti_iconsquaref5

"""
    dti_iconsquaref5(;kwargs...)

An IconSquareF5 component.
...
"""
function dti_iconsquaref5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref5", "IconSquareF5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
