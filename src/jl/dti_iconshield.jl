...
export dti_iconshield

"""
    dti_iconshield(;kwargs...)

An IconShield component.
...
"""
function dti_iconshield(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshield", "IconShield", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
