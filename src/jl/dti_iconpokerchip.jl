...
export dti_iconpokerchip

"""
    dti_iconpokerchip(;kwargs...)

An IconPokerChip component.
...
"""
function dti_iconpokerchip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpokerchip", "IconPokerChip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
