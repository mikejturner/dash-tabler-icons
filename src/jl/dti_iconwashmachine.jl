...
export dti_iconwashmachine

"""
    dti_iconwashmachine(;kwargs...)

An IconWashMachine component.
...
"""
function dti_iconwashmachine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashmachine", "IconWashMachine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
