...
export dti_iconsquareletterr

"""
    dti_iconsquareletterr(;kwargs...)

An IconSquareLetterR component.
...
"""
function dti_iconsquareletterr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterr", "IconSquareLetterR", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
