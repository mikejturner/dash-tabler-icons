...
export dti_iconghost

"""
    dti_iconghost(;kwargs...)

An IconGhost component.
...
"""
function dti_iconghost(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconghost", "IconGhost", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
