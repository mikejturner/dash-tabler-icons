...
export dti_iconhexagons

"""
    dti_iconhexagons(;kwargs...)

An IconHexagons component.
...
"""
function dti_iconhexagons(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagons", "IconHexagons", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
