...
export dti_iconbriefcase

"""
    dti_iconbriefcase(;kwargs...)

An IconBriefcase component.
...
"""
function dti_iconbriefcase(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbriefcase", "IconBriefcase", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
