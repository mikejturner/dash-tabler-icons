...
export dti_iconplanedeparture

"""
    dti_iconplanedeparture(;kwargs...)

An IconPlaneDeparture component.
...
"""
function dti_iconplanedeparture(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplanedeparture", "IconPlaneDeparture", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
