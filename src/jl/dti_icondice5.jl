...
export dti_icondice5

"""
    dti_icondice5(;kwargs...)

An IconDice5 component.
...
"""
function dti_icondice5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondice5", "IconDice5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
