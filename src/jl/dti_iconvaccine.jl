...
export dti_iconvaccine

"""
    dti_iconvaccine(;kwargs...)

An IconVaccine component.
...
"""
function dti_iconvaccine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvaccine", "IconVaccine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
