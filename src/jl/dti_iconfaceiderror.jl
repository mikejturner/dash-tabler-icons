...
export dti_iconfaceiderror

"""
    dti_iconfaceiderror(;kwargs...)

An IconFaceIdError component.
...
"""
function dti_iconfaceiderror(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfaceiderror", "IconFaceIdError", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
