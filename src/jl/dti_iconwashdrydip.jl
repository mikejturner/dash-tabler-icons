...
export dti_iconwashdrydip

"""
    dti_iconwashdrydip(;kwargs...)

An IconWashDryDip component.
...
"""
function dti_iconwashdrydip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdrydip", "IconWashDryDip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
