...
export dti_iconlayoutdistributevertical

"""
    dti_iconlayoutdistributevertical(;kwargs...)

An IconLayoutDistributeVertical component.
...
"""
function dti_iconlayoutdistributevertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutdistributevertical", "IconLayoutDistributeVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
