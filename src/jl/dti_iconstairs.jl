...
export dti_iconstairs

"""
    dti_iconstairs(;kwargs...)

An IconStairs component.
...
"""
function dti_iconstairs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstairs", "IconStairs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
