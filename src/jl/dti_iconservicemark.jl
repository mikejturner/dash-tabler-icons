...
export dti_iconservicemark

"""
    dti_iconservicemark(;kwargs...)

An IconServicemark component.
...
"""
function dti_iconservicemark(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconservicemark", "IconServicemark", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
