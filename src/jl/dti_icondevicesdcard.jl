...
export dti_icondevicesdcard

"""
    dti_icondevicesdcard(;kwargs...)

An IconDeviceSdCard component.
...
"""
function dti_icondevicesdcard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicesdcard", "IconDeviceSdCard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
