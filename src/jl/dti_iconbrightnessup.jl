...
export dti_iconbrightnessup

"""
    dti_iconbrightnessup(;kwargs...)

An IconBrightnessUp component.
...
"""
function dti_iconbrightnessup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrightnessup", "IconBrightnessUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
