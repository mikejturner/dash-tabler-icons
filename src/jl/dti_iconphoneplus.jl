...
export dti_iconphoneplus

"""
    dti_iconphoneplus(;kwargs...)

An IconPhonePlus component.
...
"""
function dti_iconphoneplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphoneplus", "IconPhonePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
