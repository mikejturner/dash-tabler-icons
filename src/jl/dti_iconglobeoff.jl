...
export dti_iconglobeoff

"""
    dti_iconglobeoff(;kwargs...)

An IconGlobeOff component.
...
"""
function dti_iconglobeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconglobeoff", "IconGlobeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
