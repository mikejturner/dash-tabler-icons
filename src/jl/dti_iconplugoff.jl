...
export dti_iconplugoff

"""
    dti_iconplugoff(;kwargs...)

An IconPlugOff component.
...
"""
function dti_iconplugoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplugoff", "IconPlugOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
