...
export dti_iconchartbaroff

"""
    dti_iconchartbaroff(;kwargs...)

An IconChartBarOff component.
...
"""
function dti_iconchartbaroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartbaroff", "IconChartBarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
