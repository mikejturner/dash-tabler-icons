...
export dti_iconnotes

"""
    dti_iconnotes(;kwargs...)

An IconNotes component.
...
"""
function dti_iconnotes(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnotes", "IconNotes", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
