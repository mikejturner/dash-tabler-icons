...
export dti_icondevicetv

"""
    dti_icondevicetv(;kwargs...)

An IconDeviceTv component.
...
"""
function dti_icondevicetv(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicetv", "IconDeviceTv", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
