...
export dti_iconhomex

"""
    dti_iconhomex(;kwargs...)

An IconHomeX component.
...
"""
function dti_iconhomex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomex", "IconHomeX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
