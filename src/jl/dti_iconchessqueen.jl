...
export dti_iconchessqueen

"""
    dti_iconchessqueen(;kwargs...)

An IconChessQueen component.
...
"""
function dti_iconchessqueen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchessqueen", "IconChessQueen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
