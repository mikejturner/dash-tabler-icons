...
export dti_iconglassfull

"""
    dti_iconglassfull(;kwargs...)

An IconGlassFull component.
...
"""
function dti_iconglassfull(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconglassfull", "IconGlassFull", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
