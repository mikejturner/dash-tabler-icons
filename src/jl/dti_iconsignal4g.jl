...
export dti_iconsignal4g

"""
    dti_iconsignal4g(;kwargs...)

An IconSignal4g component.
...
"""
function dti_iconsignal4g(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignal4g", "IconSignal4g", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
