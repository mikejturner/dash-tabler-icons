...
export dti_iconclockhour5

"""
    dti_iconclockhour5(;kwargs...)

An IconClockHour5 component.
...
"""
function dti_iconclockhour5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour5", "IconClockHour5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
