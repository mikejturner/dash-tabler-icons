...
export dti_iconcircuitvoltmeter

"""
    dti_iconcircuitvoltmeter(;kwargs...)

An IconCircuitVoltmeter component.
...
"""
function dti_iconcircuitvoltmeter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitvoltmeter", "IconCircuitVoltmeter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
