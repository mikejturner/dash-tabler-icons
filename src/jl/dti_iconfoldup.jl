...
export dti_iconfoldup

"""
    dti_iconfoldup(;kwargs...)

An IconFoldUp component.
...
"""
function dti_iconfoldup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfoldup", "IconFoldUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
