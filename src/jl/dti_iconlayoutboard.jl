...
export dti_iconlayoutboard

"""
    dti_iconlayoutboard(;kwargs...)

An IconLayoutBoard component.
...
"""
function dti_iconlayoutboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutboard", "IconLayoutBoard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
