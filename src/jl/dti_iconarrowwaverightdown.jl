...
export dti_iconarrowwaverightdown

"""
    dti_iconarrowwaverightdown(;kwargs...)

An IconArrowWaveRightDown component.
...
"""
function dti_iconarrowwaverightdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowwaverightdown", "IconArrowWaveRightDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
