...
export dti_iconcookieman

"""
    dti_iconcookieman(;kwargs...)

An IconCookieMan component.
...
"""
function dti_iconcookieman(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcookieman", "IconCookieMan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
