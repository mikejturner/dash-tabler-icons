...
export dti_iconarrowbearleft

"""
    dti_iconarrowbearleft(;kwargs...)

An IconArrowBearLeft component.
...
"""
function dti_iconarrowbearleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbearleft", "IconArrowBearLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
