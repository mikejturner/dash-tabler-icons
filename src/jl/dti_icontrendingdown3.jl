...
export dti_icontrendingdown3

"""
    dti_icontrendingdown3(;kwargs...)

An IconTrendingDown3 component.
...
"""
function dti_icontrendingdown3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrendingdown3", "IconTrendingDown3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
