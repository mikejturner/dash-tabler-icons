...
export dti_iconarrowbarright

"""
    dti_iconarrowbarright(;kwargs...)

An IconArrowBarRight component.
...
"""
function dti_iconarrowbarright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbarright", "IconArrowBarRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
