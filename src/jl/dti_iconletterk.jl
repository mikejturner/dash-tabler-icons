...
export dti_iconletterk

"""
    dti_iconletterk(;kwargs...)

An IconLetterK component.
...
"""
function dti_iconletterk(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterk", "IconLetterK", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
