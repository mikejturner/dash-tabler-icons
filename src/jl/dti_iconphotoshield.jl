...
export dti_iconphotoshield

"""
    dti_iconphotoshield(;kwargs...)

An IconPhotoShield component.
...
"""
function dti_iconphotoshield(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotoshield", "IconPhotoShield", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
