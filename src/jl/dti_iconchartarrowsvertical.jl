...
export dti_iconchartarrowsvertical

"""
    dti_iconchartarrowsvertical(;kwargs...)

An IconChartArrowsVertical component.
...
"""
function dti_iconchartarrowsvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartarrowsvertical", "IconChartArrowsVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
