...
export dti_iconcrystalball

"""
    dti_iconcrystalball(;kwargs...)

An IconCrystalBall component.
...
"""
function dti_iconcrystalball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrystalball", "IconCrystalBall", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
