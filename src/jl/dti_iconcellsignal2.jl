...
export dti_iconcellsignal2

"""
    dti_iconcellsignal2(;kwargs...)

An IconCellSignal2 component.
...
"""
function dti_iconcellsignal2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcellsignal2", "IconCellSignal2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
