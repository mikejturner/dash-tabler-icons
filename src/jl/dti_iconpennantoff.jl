...
export dti_iconpennantoff

"""
    dti_iconpennantoff(;kwargs...)

An IconPennantOff component.
...
"""
function dti_iconpennantoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpennantoff", "IconPennantOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
