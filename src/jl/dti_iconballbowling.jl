...
export dti_iconballbowling

"""
    dti_iconballbowling(;kwargs...)

An IconBallBowling component.
...
"""
function dti_iconballbowling(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballbowling", "IconBallBowling", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
