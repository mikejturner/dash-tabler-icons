...
export dti_iconcheckuplist

"""
    dti_iconcheckuplist(;kwargs...)

An IconCheckupList component.
...
"""
function dti_iconcheckuplist(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcheckuplist", "IconCheckupList", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
