...
export dti_icontoolskitchen2

"""
    dti_icontoolskitchen2(;kwargs...)

An IconToolsKitchen2 component.
...
"""
function dti_icontoolskitchen2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoolskitchen2", "IconToolsKitchen2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
