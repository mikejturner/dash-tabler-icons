...
export dti_iconhomedollar

"""
    dti_iconhomedollar(;kwargs...)

An IconHomeDollar component.
...
"""
function dti_iconhomedollar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomedollar", "IconHomeDollar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
