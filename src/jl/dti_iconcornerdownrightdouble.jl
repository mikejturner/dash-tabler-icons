...
export dti_iconcornerdownrightdouble

"""
    dti_iconcornerdownrightdouble(;kwargs...)

An IconCornerDownRightDouble component.
...
"""
function dti_iconcornerdownrightdouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerdownrightdouble", "IconCornerDownRightDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
