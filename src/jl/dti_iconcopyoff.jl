...
export dti_iconcopyoff

"""
    dti_iconcopyoff(;kwargs...)

An IconCopyOff component.
...
"""
function dti_iconcopyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcopyoff", "IconCopyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
