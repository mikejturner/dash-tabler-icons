...
export dti_icondevicesim2

"""
    dti_icondevicesim2(;kwargs...)

An IconDeviceSim2 component.
...
"""
function dti_icondevicesim2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicesim2", "IconDeviceSim2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
