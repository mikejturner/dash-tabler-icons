...
export dti_iconmoodwink2

"""
    dti_iconmoodwink2(;kwargs...)

An IconMoodWink2 component.
...
"""
function dti_iconmoodwink2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodwink2", "IconMoodWink2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
