...
export dti_iconeasein

"""
    dti_iconeasein(;kwargs...)

An IconEaseIn component.
...
"""
function dti_iconeasein(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeasein", "IconEaseIn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
