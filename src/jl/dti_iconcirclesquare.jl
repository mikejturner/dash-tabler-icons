...
export dti_iconcirclesquare

"""
    dti_iconcirclesquare(;kwargs...)

An IconCircleSquare component.
...
"""
function dti_iconcirclesquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclesquare", "IconCircleSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
