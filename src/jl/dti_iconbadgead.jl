...
export dti_iconbadgead

"""
    dti_iconbadgead(;kwargs...)

An IconBadgeAd component.
...
"""
function dti_iconbadgead(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgead", "IconBadgeAd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
