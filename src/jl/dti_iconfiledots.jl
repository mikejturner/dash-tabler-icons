...
export dti_iconfiledots

"""
    dti_iconfiledots(;kwargs...)

An IconFileDots component.
...
"""
function dti_iconfiledots(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledots", "IconFileDots", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
