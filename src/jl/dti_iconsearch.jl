...
export dti_iconsearch

"""
    dti_iconsearch(;kwargs...)

An IconSearch component.
...
"""
function dti_iconsearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsearch", "IconSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
