...
export dti_iconuxcircle

"""
    dti_iconuxcircle(;kwargs...)

An IconUxCircle component.
...
"""
function dti_iconuxcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuxcircle", "IconUxCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
