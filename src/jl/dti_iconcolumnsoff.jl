...
export dti_iconcolumnsoff

"""
    dti_iconcolumnsoff(;kwargs...)

An IconColumnsOff component.
...
"""
function dti_iconcolumnsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolumnsoff", "IconColumnsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
