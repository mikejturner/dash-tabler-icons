...
export dti_iconfeather

"""
    dti_iconfeather(;kwargs...)

An IconFeather component.
...
"""
function dti_iconfeather(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfeather", "IconFeather", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
