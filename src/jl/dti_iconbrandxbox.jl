...
export dti_iconbrandxbox

"""
    dti_iconbrandxbox(;kwargs...)

An IconBrandXbox component.
...
"""
function dti_iconbrandxbox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandxbox", "IconBrandXbox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
