...
export dti_iconcaroff

"""
    dti_iconcaroff(;kwargs...)

An IconCarOff component.
...
"""
function dti_iconcaroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaroff", "IconCarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
