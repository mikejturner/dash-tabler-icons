...
export dti_iconcalendarevent

"""
    dti_iconcalendarevent(;kwargs...)

An IconCalendarEvent component.
...
"""
function dti_iconcalendarevent(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendarevent", "IconCalendarEvent", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
