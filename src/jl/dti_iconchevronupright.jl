...
export dti_iconchevronupright

"""
    dti_iconchevronupright(;kwargs...)

An IconChevronUpRight component.
...
"""
function dti_iconchevronupright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronupright", "IconChevronUpRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
