...
export dti_iconadjustmentsoff

"""
    dti_iconadjustmentsoff(;kwargs...)

An IconAdjustmentsOff component.
...
"""
function dti_iconadjustmentsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconadjustmentsoff", "IconAdjustmentsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
