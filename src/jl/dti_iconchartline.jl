...
export dti_iconchartline

"""
    dti_iconchartline(;kwargs...)

An IconChartLine component.
...
"""
function dti_iconchartline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartline", "IconChartLine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
