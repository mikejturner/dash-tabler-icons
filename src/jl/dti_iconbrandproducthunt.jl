...
export dti_iconbrandproducthunt

"""
    dti_iconbrandproducthunt(;kwargs...)

An IconBrandProducthunt component.
...
"""
function dti_iconbrandproducthunt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandproducthunt", "IconBrandProducthunt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
