...
export dti_iconalarmoff

"""
    dti_iconalarmoff(;kwargs...)

An IconAlarmOff component.
...
"""
function dti_iconalarmoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalarmoff", "IconAlarmOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
