...
export dti_iconbrandjavascript

"""
    dti_iconbrandjavascript(;kwargs...)

An IconBrandJavascript component.
...
"""
function dti_iconbrandjavascript(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandjavascript", "IconBrandJavascript", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
