...
export dti_iconlayoutbottombar

"""
    dti_iconlayoutbottombar(;kwargs...)

An IconLayoutBottombar component.
...
"""
function dti_iconlayoutbottombar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutbottombar", "IconLayoutBottombar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
