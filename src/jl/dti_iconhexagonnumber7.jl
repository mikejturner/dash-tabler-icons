...
export dti_iconhexagonnumber7

"""
    dti_iconhexagonnumber7(;kwargs...)

An IconHexagonNumber7 component.
...
"""
function dti_iconhexagonnumber7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber7", "IconHexagonNumber7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
