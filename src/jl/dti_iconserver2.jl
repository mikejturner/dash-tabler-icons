...
export dti_iconserver2

"""
    dti_iconserver2(;kwargs...)

An IconServer2 component.
...
"""
function dti_iconserver2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconserver2", "IconServer2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
