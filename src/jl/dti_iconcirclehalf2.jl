...
export dti_iconcirclehalf2

"""
    dti_iconcirclehalf2(;kwargs...)

An IconCircleHalf2 component.
...
"""
function dti_iconcirclehalf2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclehalf2", "IconCircleHalf2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
