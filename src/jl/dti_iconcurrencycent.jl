...
export dti_iconcurrencycent

"""
    dti_iconcurrencycent(;kwargs...)

An IconCurrencyCent component.
...
"""
function dti_iconcurrencycent(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencycent", "IconCurrencyCent", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
