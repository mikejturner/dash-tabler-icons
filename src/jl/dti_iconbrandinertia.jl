...
export dti_iconbrandinertia

"""
    dti_iconbrandinertia(;kwargs...)

An IconBrandInertia component.
...
"""
function dti_iconbrandinertia(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandinertia", "IconBrandInertia", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
