...
export dti_iconmacro

"""
    dti_iconmacro(;kwargs...)

An IconMacro component.
...
"""
function dti_iconmacro(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmacro", "IconMacro", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
