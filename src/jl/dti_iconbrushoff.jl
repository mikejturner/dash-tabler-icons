...
export dti_iconbrushoff

"""
    dti_iconbrushoff(;kwargs...)

An IconBrushOff component.
...
"""
function dti_iconbrushoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrushoff", "IconBrushOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
