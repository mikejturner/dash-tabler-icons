...
export dti_iconcurrencypaanga

"""
    dti_iconcurrencypaanga(;kwargs...)

An IconCurrencyPaanga component.
...
"""
function dti_iconcurrencypaanga(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencypaanga", "IconCurrencyPaanga", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
