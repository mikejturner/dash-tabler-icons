...
export dti_iconworldlongitude

"""
    dti_iconworldlongitude(;kwargs...)

An IconWorldLongitude component.
...
"""
function dti_iconworldlongitude(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworldlongitude", "IconWorldLongitude", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
