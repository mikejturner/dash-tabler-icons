...
export dti_icondental

"""
    dti_icondental(;kwargs...)

An IconDental component.
...
"""
function dti_icondental(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondental", "IconDental", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
