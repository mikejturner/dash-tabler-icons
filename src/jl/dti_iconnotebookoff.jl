...
export dti_iconnotebookoff

"""
    dti_iconnotebookoff(;kwargs...)

An IconNotebookOff component.
...
"""
function dti_iconnotebookoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnotebookoff", "IconNotebookOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
