...
export dti_iconantennabarsoff

"""
    dti_iconantennabarsoff(;kwargs...)

An IconAntennaBarsOff component.
...
"""
function dti_iconantennabarsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennabarsoff", "IconAntennaBarsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
