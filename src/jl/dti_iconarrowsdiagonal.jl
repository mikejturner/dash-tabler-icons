...
export dti_iconarrowsdiagonal

"""
    dti_iconarrowsdiagonal(;kwargs...)

An IconArrowsDiagonal component.
...
"""
function dti_iconarrowsdiagonal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdiagonal", "IconArrowsDiagonal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
