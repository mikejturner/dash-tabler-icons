...
export dti_icontrashx

"""
    dti_icontrashx(;kwargs...)

An IconTrashX component.
...
"""
function dti_icontrashx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrashx", "IconTrashX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
