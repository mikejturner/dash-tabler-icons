...
export dti_icondragdrop2

"""
    dti_icondragdrop2(;kwargs...)

An IconDragDrop2 component.
...
"""
function dti_icondragdrop2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondragdrop2", "IconDragDrop2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
