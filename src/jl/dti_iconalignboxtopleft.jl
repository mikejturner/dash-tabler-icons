...
export dti_iconalignboxtopleft

"""
    dti_iconalignboxtopleft(;kwargs...)

An IconAlignBoxTopLeft component.
...
"""
function dti_iconalignboxtopleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxtopleft", "IconAlignBoxTopLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
