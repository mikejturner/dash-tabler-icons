...
export dti_iconzoomoutarea

"""
    dti_iconzoomoutarea(;kwargs...)

An IconZoomOutArea component.
...
"""
function dti_iconzoomoutarea(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomoutarea", "IconZoomOutArea", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
