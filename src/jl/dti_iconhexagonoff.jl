...
export dti_iconhexagonoff

"""
    dti_iconhexagonoff(;kwargs...)

An IconHexagonOff component.
...
"""
function dti_iconhexagonoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonoff", "IconHexagonOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
