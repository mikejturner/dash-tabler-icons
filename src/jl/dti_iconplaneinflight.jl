...
export dti_iconplaneinflight

"""
    dti_iconplaneinflight(;kwargs...)

An IconPlaneInflight component.
...
"""
function dti_iconplaneinflight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaneinflight", "IconPlaneInflight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
