...
export dti_iconfishhookoff

"""
    dti_iconfishhookoff(;kwargs...)

An IconFishHookOff component.
...
"""
function dti_iconfishhookoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfishhookoff", "IconFishHookOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
