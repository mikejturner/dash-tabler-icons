...
export dti_iconmouseoff

"""
    dti_iconmouseoff(;kwargs...)

An IconMouseOff component.
...
"""
function dti_iconmouseoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmouseoff", "IconMouseOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
