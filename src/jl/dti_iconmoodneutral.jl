...
export dti_iconmoodneutral

"""
    dti_iconmoodneutral(;kwargs...)

An IconMoodNeutral component.
...
"""
function dti_iconmoodneutral(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodneutral", "IconMoodNeutral", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
