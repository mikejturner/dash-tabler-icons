...
export dti_iconbrandshazam

"""
    dti_iconbrandshazam(;kwargs...)

An IconBrandShazam component.
...
"""
function dti_iconbrandshazam(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandshazam", "IconBrandShazam", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
