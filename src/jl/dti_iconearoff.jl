...
export dti_iconearoff

"""
    dti_iconearoff(;kwargs...)

An IconEarOff component.
...
"""
function dti_iconearoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconearoff", "IconEarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
