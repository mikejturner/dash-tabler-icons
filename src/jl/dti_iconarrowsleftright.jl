...
export dti_iconarrowsleftright

"""
    dti_iconarrowsleftright(;kwargs...)

An IconArrowsLeftRight component.
...
"""
function dti_iconarrowsleftright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsleftright", "IconArrowsLeftRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
