...
export dti_iconvectorbeziercircle

"""
    dti_iconvectorbeziercircle(;kwargs...)

An IconVectorBezierCircle component.
...
"""
function dti_iconvectorbeziercircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectorbeziercircle", "IconVectorBezierCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
