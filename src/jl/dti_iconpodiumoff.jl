...
export dti_iconpodiumoff

"""
    dti_iconpodiumoff(;kwargs...)

An IconPodiumOff component.
...
"""
function dti_iconpodiumoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpodiumoff", "IconPodiumOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
