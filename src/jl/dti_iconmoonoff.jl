...
export dti_iconmoonoff

"""
    dti_iconmoonoff(;kwargs...)

An IconMoonOff component.
...
"""
function dti_iconmoonoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoonoff", "IconMoonOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
