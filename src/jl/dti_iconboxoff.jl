...
export dti_iconboxoff

"""
    dti_iconboxoff(;kwargs...)

An IconBoxOff component.
...
"""
function dti_iconboxoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxoff", "IconBoxOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
