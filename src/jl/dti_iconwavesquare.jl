...
export dti_iconwavesquare

"""
    dti_iconwavesquare(;kwargs...)

An IconWaveSquare component.
...
"""
function dti_iconwavesquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwavesquare", "IconWaveSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
