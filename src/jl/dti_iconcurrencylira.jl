...
export dti_iconcurrencylira

"""
    dti_iconcurrencylira(;kwargs...)

An IconCurrencyLira component.
...
"""
function dti_iconcurrencylira(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencylira", "IconCurrencyLira", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
