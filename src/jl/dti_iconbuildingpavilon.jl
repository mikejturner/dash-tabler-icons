...
export dti_iconbuildingpavilon

"""
    dti_iconbuildingpavilon(;kwargs...)

An IconBuildingPavilon component.
...
"""
function dti_iconbuildingpavilon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingpavilon", "IconBuildingPavilon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
