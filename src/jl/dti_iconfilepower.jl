...
export dti_iconfilepower

"""
    dti_iconfilepower(;kwargs...)

An IconFilePower component.
...
"""
function dti_iconfilepower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilepower", "IconFilePower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
