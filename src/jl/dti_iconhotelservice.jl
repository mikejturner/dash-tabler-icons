...
export dti_iconhotelservice

"""
    dti_iconhotelservice(;kwargs...)

An IconHotelService component.
...
"""
function dti_iconhotelservice(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhotelservice", "IconHotelService", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
