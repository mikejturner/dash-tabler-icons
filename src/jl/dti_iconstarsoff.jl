...
export dti_iconstarsoff

"""
    dti_iconstarsoff(;kwargs...)

An IconStarsOff component.
...
"""
function dti_iconstarsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstarsoff", "IconStarsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
