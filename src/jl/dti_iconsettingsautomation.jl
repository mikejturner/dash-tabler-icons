...
export dti_iconsettingsautomation

"""
    dti_iconsettingsautomation(;kwargs...)

An IconSettingsAutomation component.
...
"""
function dti_iconsettingsautomation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsettingsautomation", "IconSettingsAutomation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
