...
export dti_iconswimming

"""
    dti_iconswimming(;kwargs...)

An IconSwimming component.
...
"""
function dti_iconswimming(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswimming", "IconSwimming", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
