...
export dti_icondevicewatchoff

"""
    dti_icondevicewatchoff(;kwargs...)

An IconDeviceWatchOff component.
...
"""
function dti_icondevicewatchoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicewatchoff", "IconDeviceWatchOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
