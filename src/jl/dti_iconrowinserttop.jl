...
export dti_iconrowinserttop

"""
    dti_iconrowinserttop(;kwargs...)

An IconRowInsertTop component.
...
"""
function dti_iconrowinserttop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrowinserttop", "IconRowInsertTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
