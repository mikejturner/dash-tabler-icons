...
export dti_iconzodiactaurus

"""
    dti_iconzodiactaurus(;kwargs...)

An IconZodiacTaurus component.
...
"""
function dti_iconzodiactaurus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiactaurus", "IconZodiacTaurus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
