...
export dti_iconmathfunctiony

"""
    dti_iconmathfunctiony(;kwargs...)

An IconMathFunctionY component.
...
"""
function dti_iconmathfunctiony(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathfunctiony", "IconMathFunctionY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
