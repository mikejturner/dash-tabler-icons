...
export dti_iconarrowbigleftlines

"""
    dti_iconarrowbigleftlines(;kwargs...)

An IconArrowBigLeftLines component.
...
"""
function dti_iconarrowbigleftlines(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigleftlines", "IconArrowBigLeftLines", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
