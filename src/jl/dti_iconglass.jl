...
export dti_iconglass

"""
    dti_iconglass(;kwargs...)

An IconGlass component.
...
"""
function dti_iconglass(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconglass", "IconGlass", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
