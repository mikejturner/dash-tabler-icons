...
export dti_icondiscoff

"""
    dti_icondiscoff(;kwargs...)

An IconDiscOff component.
...
"""
function dti_icondiscoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscoff", "IconDiscOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
