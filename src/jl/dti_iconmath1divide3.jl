...
export dti_iconmath1divide3

"""
    dti_iconmath1divide3(;kwargs...)

An IconMath1Divide3 component.
...
"""
function dti_iconmath1divide3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmath1divide3", "IconMath1Divide3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
