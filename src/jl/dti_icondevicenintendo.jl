...
export dti_icondevicenintendo

"""
    dti_icondevicenintendo(;kwargs...)

An IconDeviceNintendo component.
...
"""
function dti_icondevicenintendo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicenintendo", "IconDeviceNintendo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
