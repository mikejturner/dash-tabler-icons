...
export dti_iconarrowrampright3

"""
    dti_iconarrowrampright3(;kwargs...)

An IconArrowRampRight3 component.
...
"""
function dti_iconarrowrampright3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrampright3", "IconArrowRampRight3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
