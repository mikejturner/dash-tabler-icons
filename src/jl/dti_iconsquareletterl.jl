...
export dti_iconsquareletterl

"""
    dti_iconsquareletterl(;kwargs...)

An IconSquareLetterL component.
...
"""
function dti_iconsquareletterl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterl", "IconSquareLetterL", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
