...
export dti_iconmultiplier15x

"""
    dti_iconmultiplier15x(;kwargs...)

An IconMultiplier15x component.
...
"""
function dti_iconmultiplier15x(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmultiplier15x", "IconMultiplier15x", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
