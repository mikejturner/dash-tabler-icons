...
export dti_iconbrandctemplar

"""
    dti_iconbrandctemplar(;kwargs...)

An IconBrandCtemplar component.
...
"""
function dti_iconbrandctemplar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandctemplar", "IconBrandCtemplar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
