...
export dti_iconcricket

"""
    dti_iconcricket(;kwargs...)

An IconCricket component.
...
"""
function dti_iconcricket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcricket", "IconCricket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
