...
export dti_iconcalculator

"""
    dti_iconcalculator(;kwargs...)

An IconCalculator component.
...
"""
function dti_iconcalculator(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalculator", "IconCalculator", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
