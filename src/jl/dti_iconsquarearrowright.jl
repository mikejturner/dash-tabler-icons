...
export dti_iconsquarearrowright

"""
    dti_iconsquarearrowright(;kwargs...)

An IconSquareArrowRight component.
...
"""
function dti_iconsquarearrowright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarearrowright", "IconSquareArrowRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
