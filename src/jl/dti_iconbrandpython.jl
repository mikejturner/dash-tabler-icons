...
export dti_iconbrandpython

"""
    dti_iconbrandpython(;kwargs...)

An IconBrandPython component.
...
"""
function dti_iconbrandpython(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpython", "IconBrandPython", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
