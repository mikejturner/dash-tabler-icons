...
export dti_iconarrowbartoup

"""
    dti_iconarrowbartoup(;kwargs...)

An IconArrowBarToUp component.
...
"""
function dti_iconarrowbartoup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbartoup", "IconArrowBarToUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
