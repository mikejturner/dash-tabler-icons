...
export dti_iconcirclehalf

"""
    dti_iconcirclehalf(;kwargs...)

An IconCircleHalf component.
...
"""
function dti_iconcirclehalf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclehalf", "IconCircleHalf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
