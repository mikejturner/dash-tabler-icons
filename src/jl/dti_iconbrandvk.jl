...
export dti_iconbrandvk

"""
    dti_iconbrandvk(;kwargs...)

An IconBrandVk component.
...
"""
function dti_iconbrandvk(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvk", "IconBrandVk", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
