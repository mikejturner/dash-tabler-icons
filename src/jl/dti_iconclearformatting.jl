...
export dti_iconclearformatting

"""
    dti_iconclearformatting(;kwargs...)

An IconClearFormatting component.
...
"""
function dti_iconclearformatting(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclearformatting", "IconClearFormatting", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
