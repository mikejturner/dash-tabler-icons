...
export dti_iconfilecertificate

"""
    dti_iconfilecertificate(;kwargs...)

An IconFileCertificate component.
...
"""
function dti_iconfilecertificate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilecertificate", "IconFileCertificate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
