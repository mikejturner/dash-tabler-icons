...
export dti_iconcircledot

"""
    dti_iconcircledot(;kwargs...)

An IconCircleDot component.
...
"""
function dti_iconcircledot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircledot", "IconCircleDot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
