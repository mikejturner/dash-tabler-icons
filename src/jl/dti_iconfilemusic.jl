...
export dti_iconfilemusic

"""
    dti_iconfilemusic(;kwargs...)

An IconFileMusic component.
...
"""
function dti_iconfilemusic(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilemusic", "IconFileMusic", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
