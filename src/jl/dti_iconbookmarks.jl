...
export dti_iconbookmarks

"""
    dti_iconbookmarks(;kwargs...)

An IconBookmarks component.
...
"""
function dti_iconbookmarks(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbookmarks", "IconBookmarks", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
