...
export dti_iconlayersintersect2

"""
    dti_iconlayersintersect2(;kwargs...)

An IconLayersIntersect2 component.
...
"""
function dti_iconlayersintersect2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayersintersect2", "IconLayersIntersect2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
