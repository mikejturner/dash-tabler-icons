...
export dti_iconslashes

"""
    dti_iconslashes(;kwargs...)

An IconSlashes component.
...
"""
function dti_iconslashes(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconslashes", "IconSlashes", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
