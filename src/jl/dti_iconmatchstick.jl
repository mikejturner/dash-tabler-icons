...
export dti_iconmatchstick

"""
    dti_iconmatchstick(;kwargs...)

An IconMatchstick component.
...
"""
function dti_iconmatchstick(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmatchstick", "IconMatchstick", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
