...
export dti_iconradioactiveoff

"""
    dti_iconradioactiveoff(;kwargs...)

An IconRadioactiveOff component.
...
"""
function dti_iconradioactiveoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradioactiveoff", "IconRadioactiveOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
