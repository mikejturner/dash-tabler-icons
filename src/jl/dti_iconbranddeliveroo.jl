...
export dti_iconbranddeliveroo

"""
    dti_iconbranddeliveroo(;kwargs...)

An IconBrandDeliveroo component.
...
"""
function dti_iconbranddeliveroo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddeliveroo", "IconBrandDeliveroo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
