...
export dti_iconbranddocker

"""
    dti_iconbranddocker(;kwargs...)

An IconBrandDocker component.
...
"""
function dti_iconbranddocker(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddocker", "IconBrandDocker", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
