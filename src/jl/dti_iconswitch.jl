...
export dti_iconswitch

"""
    dti_iconswitch(;kwargs...)
...
"""
function dti_iconswitch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswitch", "IconSwitch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
