...
export dti_iconruleroff

"""
    dti_iconruleroff(;kwargs...)

An IconRulerOff component.
...
"""
function dti_iconruleroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconruleroff", "IconRulerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
