...
export dti_iconarrowbiguplines

"""
    dti_iconarrowbiguplines(;kwargs...)

An IconArrowBigUpLines component.
...
"""
function dti_iconarrowbiguplines(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbiguplines", "IconArrowBigUpLines", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
