...
export dti_icontextorientation

"""
    dti_icontextorientation(;kwargs...)

An IconTextOrientation component.
...
"""
function dti_icontextorientation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextorientation", "IconTextOrientation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
