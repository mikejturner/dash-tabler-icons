...
export dti_iconrobot

"""
    dti_iconrobot(;kwargs...)

An IconRobot component.
...
"""
function dti_iconrobot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrobot", "IconRobot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
