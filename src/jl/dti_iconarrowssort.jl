...
export dti_iconarrowssort

"""
    dti_iconarrowssort(;kwargs...)

An IconArrowsSort component.
...
"""
function dti_iconarrowssort(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowssort", "IconArrowsSort", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
