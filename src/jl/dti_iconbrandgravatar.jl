...
export dti_iconbrandgravatar

"""
    dti_iconbrandgravatar(;kwargs...)

An IconBrandGravatar component.
...
"""
function dti_iconbrandgravatar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgravatar", "IconBrandGravatar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
