...
export dti_iconlollipopoff

"""
    dti_iconlollipopoff(;kwargs...)

An IconLollipopOff component.
...
"""
function dti_iconlollipopoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlollipopoff", "IconLollipopOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
