...
export dti_iconbeachoff

"""
    dti_iconbeachoff(;kwargs...)

An IconBeachOff component.
...
"""
function dti_iconbeachoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbeachoff", "IconBeachOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
