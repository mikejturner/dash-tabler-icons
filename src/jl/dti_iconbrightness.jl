...
export dti_iconbrightness

"""
    dti_iconbrightness(;kwargs...)

An IconBrightness component.
...
"""
function dti_iconbrightness(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrightness", "IconBrightness", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
