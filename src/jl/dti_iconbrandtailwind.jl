...
export dti_iconbrandtailwind

"""
    dti_iconbrandtailwind(;kwargs...)

An IconBrandTailwind component.
...
"""
function dti_iconbrandtailwind(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtailwind", "IconBrandTailwind", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
