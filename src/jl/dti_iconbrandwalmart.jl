...
export dti_iconbrandwalmart

"""
    dti_iconbrandwalmart(;kwargs...)

An IconBrandWalmart component.
...
"""
function dti_iconbrandwalmart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwalmart", "IconBrandWalmart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
