...
export dti_iconbrandfortnite

"""
    dti_iconbrandfortnite(;kwargs...)

An IconBrandFortnite component.
...
"""
function dti_iconbrandfortnite(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfortnite", "IconBrandFortnite", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
