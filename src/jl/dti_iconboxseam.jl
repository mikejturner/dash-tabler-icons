...
export dti_iconboxseam

"""
    dti_iconboxseam(;kwargs...)

An IconBoxSeam component.
...
"""
function dti_iconboxseam(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxseam", "IconBoxSeam", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
