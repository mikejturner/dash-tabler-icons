...
export dti_iconaddressbook

"""
    dti_iconaddressbook(;kwargs...)

An IconAddressBook component.
...
"""
function dti_iconaddressbook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaddressbook", "IconAddressBook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
