...
export dti_iconthumbdownoff

"""
    dti_iconthumbdownoff(;kwargs...)

An IconThumbDownOff component.
...
"""
function dti_iconthumbdownoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconthumbdownoff", "IconThumbDownOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
