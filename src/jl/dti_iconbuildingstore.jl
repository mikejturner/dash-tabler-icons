...
export dti_iconbuildingstore

"""
    dti_iconbuildingstore(;kwargs...)

An IconBuildingStore component.
...
"""
function dti_iconbuildingstore(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingstore", "IconBuildingStore", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
