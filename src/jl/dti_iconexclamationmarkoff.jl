...
export dti_iconexclamationmarkoff

"""
    dti_iconexclamationmarkoff(;kwargs...)

An IconExclamationMarkOff component.
...
"""
function dti_iconexclamationmarkoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexclamationmarkoff", "IconExclamationMarkOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
