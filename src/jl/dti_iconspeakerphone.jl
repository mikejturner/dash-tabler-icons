...
export dti_iconspeakerphone

"""
    dti_iconspeakerphone(;kwargs...)

An IconSpeakerphone component.
...
"""
function dti_iconspeakerphone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspeakerphone", "IconSpeakerphone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
