...
export dti_iconsquaref6

"""
    dti_iconsquaref6(;kwargs...)

An IconSquareF6 component.
...
"""
function dti_iconsquaref6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref6", "IconSquareF6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
