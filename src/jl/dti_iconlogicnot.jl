...
export dti_iconlogicnot

"""
    dti_iconlogicnot(;kwargs...)

An IconLogicNot component.
...
"""
function dti_iconlogicnot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicnot", "IconLogicNot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
