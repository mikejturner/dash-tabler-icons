...
export dti_iconwashdry1

"""
    dti_iconwashdry1(;kwargs...)

An IconWashDry1 component.
...
"""
function dti_iconwashdry1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdry1", "IconWashDry1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
