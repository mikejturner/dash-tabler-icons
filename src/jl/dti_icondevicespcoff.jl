...
export dti_icondevicespcoff

"""
    dti_icondevicespcoff(;kwargs...)

An IconDevicesPcOff component.
...
"""
function dti_icondevicespcoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicespcoff", "IconDevicesPcOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
