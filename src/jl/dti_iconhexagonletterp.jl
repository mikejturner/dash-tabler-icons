...
export dti_iconhexagonletterp

"""
    dti_iconhexagonletterp(;kwargs...)

An IconHexagonLetterP component.
...
"""
function dti_iconhexagonletterp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterp", "IconHexagonLetterP", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
