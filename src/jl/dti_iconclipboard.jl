...
export dti_iconclipboard

"""
    dti_iconclipboard(;kwargs...)

An IconClipboard component.
...
"""
function dti_iconclipboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboard", "IconClipboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
