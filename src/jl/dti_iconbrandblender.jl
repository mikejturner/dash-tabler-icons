...
export dti_iconbrandblender

"""
    dti_iconbrandblender(;kwargs...)

An IconBrandBlender component.
...
"""
function dti_iconbrandblender(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandblender", "IconBrandBlender", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
