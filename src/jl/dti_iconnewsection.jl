...
export dti_iconnewsection

"""
    dti_iconnewsection(;kwargs...)

An IconNewSection component.
...
"""
function dti_iconnewsection(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnewsection", "IconNewSection", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
