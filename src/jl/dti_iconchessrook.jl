...
export dti_iconchessrook

"""
    dti_iconchessrook(;kwargs...)

An IconChessRook component.
...
"""
function dti_iconchessrook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchessrook", "IconChessRook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
