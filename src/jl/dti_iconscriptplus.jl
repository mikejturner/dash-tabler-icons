...
export dti_iconscriptplus

"""
    dti_iconscriptplus(;kwargs...)

An IconScriptPlus component.
...
"""
function dti_iconscriptplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscriptplus", "IconScriptPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
