...
export dti_iconxboxx

"""
    dti_iconxboxx(;kwargs...)

An IconXboxX component.
...
"""
function dti_iconxboxx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconxboxx", "IconXboxX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
