...
export dti_iconsquare

"""
    dti_iconsquare(;kwargs...)

An IconSquare component.
...
"""
function dti_iconsquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquare", "IconSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
