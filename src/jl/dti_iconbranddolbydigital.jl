...
export dti_iconbranddolbydigital

"""
    dti_iconbranddolbydigital(;kwargs...)

An IconBrandDolbyDigital component.
...
"""
function dti_iconbranddolbydigital(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddolbydigital", "IconBrandDolbyDigital", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
