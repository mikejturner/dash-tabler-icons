...
export dti_iconbrandtopbuzz

"""
    dti_iconbrandtopbuzz(;kwargs...)

An IconBrandTopbuzz component.
...
"""
function dti_iconbrandtopbuzz(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtopbuzz", "IconBrandTopbuzz", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
