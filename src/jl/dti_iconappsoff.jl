...
export dti_iconappsoff

"""
    dti_iconappsoff(;kwargs...)

An IconAppsOff component.
...
"""
function dti_iconappsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconappsoff", "IconAppsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
