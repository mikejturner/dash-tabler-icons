...
export dti_iconlogicand

"""
    dti_iconlogicand(;kwargs...)

An IconLogicAnd component.
...
"""
function dti_iconlogicand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicand", "IconLogicAnd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
