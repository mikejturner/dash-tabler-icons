...
export dti_icondevicemobilemessage

"""
    dti_icondevicemobilemessage(;kwargs...)

An IconDeviceMobileMessage component.
...
"""
function dti_icondevicemobilemessage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicemobilemessage", "IconDeviceMobileMessage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
