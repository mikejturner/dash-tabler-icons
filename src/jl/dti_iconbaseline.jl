...
export dti_iconbaseline

"""
    dti_iconbaseline(;kwargs...)

An IconBaseline component.
...
"""
function dti_iconbaseline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbaseline", "IconBaseline", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
