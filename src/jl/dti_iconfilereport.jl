...
export dti_iconfilereport

"""
    dti_iconfilereport(;kwargs...)

An IconFileReport component.
...
"""
function dti_iconfilereport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilereport", "IconFileReport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
