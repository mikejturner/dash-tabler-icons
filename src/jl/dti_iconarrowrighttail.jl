...
export dti_iconarrowrighttail

"""
    dti_iconarrowrighttail(;kwargs...)

An IconArrowRightTail component.
...
"""
function dti_iconarrowrighttail(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrighttail", "IconArrowRightTail", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
