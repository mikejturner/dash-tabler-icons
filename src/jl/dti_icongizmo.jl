...
export dti_icongizmo

"""
    dti_icongizmo(;kwargs...)

An IconGizmo component.
...
"""
function dti_icongizmo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongizmo", "IconGizmo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
