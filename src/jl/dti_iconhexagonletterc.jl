...
export dti_iconhexagonletterc

"""
    dti_iconhexagonletterc(;kwargs...)

An IconHexagonLetterC component.
...
"""
function dti_iconhexagonletterc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterc", "IconHexagonLetterC", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
