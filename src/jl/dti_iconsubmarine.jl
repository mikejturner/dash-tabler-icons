...
export dti_iconsubmarine

"""
    dti_iconsubmarine(;kwargs...)

An IconSubmarine component.
...
"""
function dti_iconsubmarine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsubmarine", "IconSubmarine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
