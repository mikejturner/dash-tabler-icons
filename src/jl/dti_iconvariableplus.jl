...
export dti_iconvariableplus

"""
    dti_iconvariableplus(;kwargs...)

An IconVariablePlus component.
...
"""
function dti_iconvariableplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvariableplus", "IconVariablePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
