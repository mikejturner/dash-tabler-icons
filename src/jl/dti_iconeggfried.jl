...
export dti_iconeggfried

"""
    dti_iconeggfried(;kwargs...)

An IconEggFried component.
...
"""
function dti_iconeggfried(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeggfried", "IconEggFried", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
