...
export dti_iconzoomquestion

"""
    dti_iconzoomquestion(;kwargs...)

An IconZoomQuestion component.
...
"""
function dti_iconzoomquestion(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomquestion", "IconZoomQuestion", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
