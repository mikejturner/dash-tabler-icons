...
export dti_iconcurrencypound

"""
    dti_iconcurrencypound(;kwargs...)

An IconCurrencyPound component.
...
"""
function dti_iconcurrencypound(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencypound", "IconCurrencyPound", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
