...
export dti_iconwindmill

"""
    dti_iconwindmill(;kwargs...)

An IconWindmill component.
...
"""
function dti_iconwindmill(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindmill", "IconWindmill", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
