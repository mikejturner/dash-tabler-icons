...
export dti_iconhomeeco

"""
    dti_iconhomeeco(;kwargs...)

An IconHomeEco component.
...
"""
function dti_iconhomeeco(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeeco", "IconHomeEco", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
