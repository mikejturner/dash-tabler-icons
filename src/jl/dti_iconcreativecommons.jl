...
export dti_iconcreativecommons

"""
    dti_iconcreativecommons(;kwargs...)

An IconCreativeCommons component.
...
"""
function dti_iconcreativecommons(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommons", "IconCreativeCommons", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
