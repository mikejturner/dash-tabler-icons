...
export dti_iconcirclecaretright

"""
    dti_iconcirclecaretright(;kwargs...)

An IconCircleCaretRight component.
...
"""
function dti_iconcirclecaretright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclecaretright", "IconCircleCaretRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
