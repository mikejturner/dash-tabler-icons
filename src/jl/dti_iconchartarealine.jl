...
export dti_iconchartarealine

"""
    dti_iconchartarealine(;kwargs...)

An IconChartAreaLine component.
...
"""
function dti_iconchartarealine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartarealine", "IconChartAreaLine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
