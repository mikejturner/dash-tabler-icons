...
export dti_iconforbid2

"""
    dti_iconforbid2(;kwargs...)

An IconForbid2 component.
...
"""
function dti_iconforbid2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconforbid2", "IconForbid2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
