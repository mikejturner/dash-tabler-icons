...
export dti_iconframeoff

"""
    dti_iconframeoff(;kwargs...)

An IconFrameOff component.
...
"""
function dti_iconframeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconframeoff", "IconFrameOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
