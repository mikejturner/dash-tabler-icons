...
export dti_iconclockhour6

"""
    dti_iconclockhour6(;kwargs...)

An IconClockHour6 component.
...
"""
function dti_iconclockhour6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour6", "IconClockHour6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
