...
export dti_iconclipboardheart

"""
    dti_iconclipboardheart(;kwargs...)

An IconClipboardHeart component.
...
"""
function dti_iconclipboardheart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardheart", "IconClipboardHeart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
