...
export dti_iconflag2

"""
    dti_iconflag2(;kwargs...)

An IconFlag2 component.
...
"""
function dti_iconflag2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflag2", "IconFlag2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
