...
export dti_iconmotorbike

"""
    dti_iconmotorbike(;kwargs...)

An IconMotorbike component.
...
"""
function dti_iconmotorbike(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmotorbike", "IconMotorbike", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
