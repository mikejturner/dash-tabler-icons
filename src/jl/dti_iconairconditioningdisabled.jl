...
export dti_iconairconditioningdisabled

"""
    dti_iconairconditioningdisabled(;kwargs...)

An IconAirConditioningDisabled component.
...
"""
function dti_iconairconditioningdisabled(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconairconditioningdisabled", "IconAirConditioningDisabled", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
