...
export dti_iconlettercaseupper

"""
    dti_iconlettercaseupper(;kwargs...)

An IconLetterCaseUpper component.
...
"""
function dti_iconlettercaseupper(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettercaseupper", "IconLetterCaseUpper", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
