...
export dti_iconweight

"""
    dti_iconweight(;kwargs...)

An IconWeight component.
...
"""
function dti_iconweight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconweight", "IconWeight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
