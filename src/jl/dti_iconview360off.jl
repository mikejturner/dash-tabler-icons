...
export dti_iconview360off

"""
    dti_iconview360off(;kwargs...)

An IconView360Off component.
...
"""
function dti_iconview360off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconview360off", "IconView360Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
