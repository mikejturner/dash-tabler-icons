...
export dti_iconscissorsoff

"""
    dti_iconscissorsoff(;kwargs...)

An IconScissorsOff component.
...
"""
function dti_iconscissorsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscissorsoff", "IconScissorsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
