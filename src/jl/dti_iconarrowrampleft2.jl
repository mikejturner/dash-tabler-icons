...
export dti_iconarrowrampleft2

"""
    dti_iconarrowrampleft2(;kwargs...)

An IconArrowRampLeft2 component.
...
"""
function dti_iconarrowrampleft2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrampleft2", "IconArrowRampLeft2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
