...
export dti_iconcamera

"""
    dti_iconcamera(;kwargs...)

An IconCamera component.
...
"""
function dti_iconcamera(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcamera", "IconCamera", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
