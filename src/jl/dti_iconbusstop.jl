...
export dti_iconbusstop

"""
    dti_iconbusstop(;kwargs...)

An IconBusStop component.
...
"""
function dti_iconbusstop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbusstop", "IconBusStop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
