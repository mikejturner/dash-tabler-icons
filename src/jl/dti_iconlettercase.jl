...
export dti_iconlettercase

"""
    dti_iconlettercase(;kwargs...)

An IconLetterCase component.
...
"""
function dti_iconlettercase(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettercase", "IconLetterCase", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
