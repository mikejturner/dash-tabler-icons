...
export dti_iconwashdryf

"""
    dti_iconwashdryf(;kwargs...)

An IconWashDryF component.
...
"""
function dti_iconwashdryf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryf", "IconWashDryF", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
