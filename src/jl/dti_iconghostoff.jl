...
export dti_iconghostoff

"""
    dti_iconghostoff(;kwargs...)

An IconGhostOff component.
...
"""
function dti_iconghostoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconghostoff", "IconGhostOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
