...
export dti_iconarrowrampright

"""
    dti_iconarrowrampright(;kwargs...)

An IconArrowRampRight component.
...
"""
function dti_iconarrowrampright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrampright", "IconArrowRampRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
