...
export dti_iconschooloff

"""
    dti_iconschooloff(;kwargs...)

An IconSchoolOff component.
...
"""
function dti_iconschooloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconschooloff", "IconSchoolOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
