...
export dti_iconcpuoff

"""
    dti_iconcpuoff(;kwargs...)

An IconCpuOff component.
...
"""
function dti_iconcpuoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcpuoff", "IconCpuOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
