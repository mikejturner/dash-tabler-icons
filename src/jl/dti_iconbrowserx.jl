...
export dti_iconbrowserx

"""
    dti_iconbrowserx(;kwargs...)

An IconBrowserX component.
...
"""
function dti_iconbrowserx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrowserx", "IconBrowserX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
