...
export dti_iconheadphones

"""
    dti_iconheadphones(;kwargs...)

An IconHeadphones component.
...
"""
function dti_iconheadphones(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheadphones", "IconHeadphones", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
