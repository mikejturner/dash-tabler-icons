...
export dti_iconarrowsshuffle

"""
    dti_iconarrowsshuffle(;kwargs...)

An IconArrowsShuffle component.
...
"""
function dti_iconarrowsshuffle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsshuffle", "IconArrowsShuffle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
