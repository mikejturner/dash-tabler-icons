...
export dti_iconchevrondownright

"""
    dti_iconchevrondownright(;kwargs...)

An IconChevronDownRight component.
...
"""
function dti_iconchevrondownright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevrondownright", "IconChevronDownRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
