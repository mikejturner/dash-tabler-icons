...
export dti_iconsquarenumber8

"""
    dti_iconsquarenumber8(;kwargs...)

An IconSquareNumber8 component.
...
"""
function dti_iconsquarenumber8(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber8", "IconSquareNumber8", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
