...
export dti_iconhierarchy3

"""
    dti_iconhierarchy3(;kwargs...)

An IconHierarchy3 component.
...
"""
function dti_iconhierarchy3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhierarchy3", "IconHierarchy3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
