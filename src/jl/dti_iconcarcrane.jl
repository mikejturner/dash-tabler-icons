...
export dti_iconcarcrane

"""
    dti_iconcarcrane(;kwargs...)

An IconCarCrane component.
...
"""
function dti_iconcarcrane(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcarcrane", "IconCarCrane", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
