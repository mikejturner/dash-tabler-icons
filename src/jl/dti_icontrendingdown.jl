...
export dti_icontrendingdown

"""
    dti_icontrendingdown(;kwargs...)

An IconTrendingDown component.
...
"""
function dti_icontrendingdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrendingdown", "IconTrendingDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
