...
export dti_iconlettery

"""
    dti_iconlettery(;kwargs...)

An IconLetterY component.
...
"""
function dti_iconlettery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettery", "IconLetterY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
