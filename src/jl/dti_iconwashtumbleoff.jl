...
export dti_iconwashtumbleoff

"""
    dti_iconwashtumbleoff(;kwargs...)

An IconWashTumbleOff component.
...
"""
function dti_iconwashtumbleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtumbleoff", "IconWashTumbleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
