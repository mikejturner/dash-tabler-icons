...
export dti_iconarrowautofitdown

"""
    dti_iconarrowautofitdown(;kwargs...)

An IconArrowAutofitDown component.
...
"""
function dti_iconarrowautofitdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitdown", "IconArrowAutofitDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
