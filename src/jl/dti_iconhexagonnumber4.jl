...
export dti_iconhexagonnumber4

"""
    dti_iconhexagonnumber4(;kwargs...)

An IconHexagonNumber4 component.
...
"""
function dti_iconhexagonnumber4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber4", "IconHexagonNumber4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
