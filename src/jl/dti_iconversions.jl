...
export dti_iconversions

"""
    dti_iconversions(;kwargs...)

An IconVersions component.
...
"""
function dti_iconversions(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconversions", "IconVersions", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
