...
export dti_iconforklift

"""
    dti_iconforklift(;kwargs...)

An IconForklift component.
...
"""
function dti_iconforklift(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconforklift", "IconForklift", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
