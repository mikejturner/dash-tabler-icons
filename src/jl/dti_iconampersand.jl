...
export dti_iconampersand

"""
    dti_iconampersand(;kwargs...)

An IconAmpersand component.
...
"""
function dti_iconampersand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconampersand", "IconAmpersand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
