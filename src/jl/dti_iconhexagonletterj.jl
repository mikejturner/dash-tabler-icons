...
export dti_iconhexagonletterj

"""
    dti_iconhexagonletterj(;kwargs...)

An IconHexagonLetterJ component.
...
"""
function dti_iconhexagonletterj(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterj", "IconHexagonLetterJ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
