...
export dti_iconborderradius

"""
    dti_iconborderradius(;kwargs...)

An IconBorderRadius component.
...
"""
function dti_iconborderradius(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderradius", "IconBorderRadius", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
