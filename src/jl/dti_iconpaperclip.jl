...
export dti_iconpaperclip

"""
    dti_iconpaperclip(;kwargs...)

An IconPaperclip component.
...
"""
function dti_iconpaperclip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpaperclip", "IconPaperclip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
