...
export dti_icondropletfilled

"""
    dti_icondropletfilled(;kwargs...)

An IconDropletFilled component.
...
"""
function dti_icondropletfilled(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondropletfilled", "IconDropletFilled", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
