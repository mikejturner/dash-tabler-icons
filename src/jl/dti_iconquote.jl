...
export dti_iconquote

"""
    dti_iconquote(;kwargs...)

An IconQuote component.
...
"""
function dti_iconquote(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconquote", "IconQuote", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
