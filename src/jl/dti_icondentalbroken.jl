...
export dti_icondentalbroken

"""
    dti_icondentalbroken(;kwargs...)

An IconDentalBroken component.
...
"""
function dti_icondentalbroken(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondentalbroken", "IconDentalBroken", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
