...
export dti_iconterminal2

"""
    dti_iconterminal2(;kwargs...)

An IconTerminal2 component.
...
"""
function dti_iconterminal2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconterminal2", "IconTerminal2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
