...
export dti_iconrating14plus

"""
    dti_iconrating14plus(;kwargs...)

An IconRating14Plus component.
...
"""
function dti_iconrating14plus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrating14plus", "IconRating14Plus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
