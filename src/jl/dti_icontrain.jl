...
export dti_icontrain

"""
    dti_icontrain(;kwargs...)

An IconTrain component.
...
"""
function dti_icontrain(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrain", "IconTrain", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
