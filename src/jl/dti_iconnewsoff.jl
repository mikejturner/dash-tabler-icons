...
export dti_iconnewsoff

"""
    dti_iconnewsoff(;kwargs...)

An IconNewsOff component.
...
"""
function dti_iconnewsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnewsoff", "IconNewsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
