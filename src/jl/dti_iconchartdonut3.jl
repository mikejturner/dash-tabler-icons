...
export dti_iconchartdonut3

"""
    dti_iconchartdonut3(;kwargs...)

An IconChartDonut3 component.
...
"""
function dti_iconchartdonut3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdonut3", "IconChartDonut3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
