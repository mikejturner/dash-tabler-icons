...
export dti_iconnumber0

"""
    dti_iconnumber0(;kwargs...)

An IconNumber0 component.
...
"""
function dti_iconnumber0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber0", "IconNumber0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
