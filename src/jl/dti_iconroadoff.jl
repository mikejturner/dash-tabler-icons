...
export dti_iconroadoff

"""
    dti_iconroadoff(;kwargs...)

An IconRoadOff component.
...
"""
function dti_iconroadoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconroadoff", "IconRoadOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
