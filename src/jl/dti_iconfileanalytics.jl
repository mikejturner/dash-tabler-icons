...
export dti_iconfileanalytics

"""
    dti_iconfileanalytics(;kwargs...)

An IconFileAnalytics component.
...
"""
function dti_iconfileanalytics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileanalytics", "IconFileAnalytics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
