...
export dti_iconrotateclockwise

"""
    dti_iconrotateclockwise(;kwargs...)

An IconRotateClockwise component.
...
"""
function dti_iconrotateclockwise(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrotateclockwise", "IconRotateClockwise", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
