...
export dti_icondevicelaptopoff

"""
    dti_icondevicelaptopoff(;kwargs...)

An IconDeviceLaptopOff component.
...
"""
function dti_icondevicelaptopoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicelaptopoff", "IconDeviceLaptopOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
