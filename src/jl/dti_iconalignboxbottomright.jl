...
export dti_iconalignboxbottomright

"""
    dti_iconalignboxbottomright(;kwargs...)

An IconAlignBoxBottomRight component.
...
"""
function dti_iconalignboxbottomright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxbottomright", "IconAlignBoxBottomRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
