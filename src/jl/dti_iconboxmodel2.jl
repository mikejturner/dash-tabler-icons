...
export dti_iconboxmodel2

"""
    dti_iconboxmodel2(;kwargs...)

An IconBoxModel2 component.
...
"""
function dti_iconboxmodel2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmodel2", "IconBoxModel2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
