...
export dti_iconphotoedit

"""
    dti_iconphotoedit(;kwargs...)

An IconPhotoEdit component.
...
"""
function dti_iconphotoedit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotoedit", "IconPhotoEdit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
