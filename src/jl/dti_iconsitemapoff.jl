...
export dti_iconsitemapoff

"""
    dti_iconsitemapoff(;kwargs...)

An IconSitemapOff component.
...
"""
function dti_iconsitemapoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsitemapoff", "IconSitemapOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
