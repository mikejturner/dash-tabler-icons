...
export dti_iconuserplus

"""
    dti_iconuserplus(;kwargs...)

An IconUserPlus component.
...
"""
function dti_iconuserplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuserplus", "IconUserPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
