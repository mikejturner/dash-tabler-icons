...
export dti_iconzoompan

"""
    dti_iconzoompan(;kwargs...)

An IconZoomPan component.
...
"""
function dti_iconzoompan(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoompan", "IconZoomPan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
