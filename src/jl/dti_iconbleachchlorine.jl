...
export dti_iconbleachchlorine

"""
    dti_iconbleachchlorine(;kwargs...)

An IconBleachChlorine component.
...
"""
function dti_iconbleachchlorine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbleachchlorine", "IconBleachChlorine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
