...
export dti_iconfiledatabase

"""
    dti_iconfiledatabase(;kwargs...)

An IconFileDatabase component.
...
"""
function dti_iconfiledatabase(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledatabase", "IconFileDatabase", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
