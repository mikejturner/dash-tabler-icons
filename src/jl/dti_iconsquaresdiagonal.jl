...
export dti_iconsquaresdiagonal

"""
    dti_iconsquaresdiagonal(;kwargs...)

An IconSquaresDiagonal component.
...
"""
function dti_iconsquaresdiagonal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaresdiagonal", "IconSquaresDiagonal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
