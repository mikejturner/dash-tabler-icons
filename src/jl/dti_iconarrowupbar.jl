...
export dti_iconarrowupbar

"""
    dti_iconarrowupbar(;kwargs...)

An IconArrowUpBar component.
...
"""
function dti_iconarrowupbar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowupbar", "IconArrowUpBar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
