...
export dti_iconarrowleft

"""
    dti_iconarrowleft(;kwargs...)

An IconArrowLeft component.
...
"""
function dti_iconarrowleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowleft", "IconArrowLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
