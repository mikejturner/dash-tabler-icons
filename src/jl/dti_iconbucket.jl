...
export dti_iconbucket

"""
    dti_iconbucket(;kwargs...)

An IconBucket component.
...
"""
function dti_iconbucket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbucket", "IconBucket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
