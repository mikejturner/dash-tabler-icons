...
export dti_iconsortdescendingletters

"""
    dti_iconsortdescendingletters(;kwargs...)

An IconSortDescendingLetters component.
...
"""
function dti_iconsortdescendingletters(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortdescendingletters", "IconSortDescendingLetters", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
