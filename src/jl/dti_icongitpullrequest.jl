...
export dti_icongitpullrequest

"""
    dti_icongitpullrequest(;kwargs...)

An IconGitPullRequest component.
...
"""
function dti_icongitpullrequest(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitpullrequest", "IconGitPullRequest", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
