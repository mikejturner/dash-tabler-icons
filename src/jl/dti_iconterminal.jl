...
export dti_iconterminal

"""
    dti_iconterminal(;kwargs...)

An IconTerminal component.
...
"""
function dti_iconterminal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconterminal", "IconTerminal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
