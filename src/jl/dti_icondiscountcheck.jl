...
export dti_icondiscountcheck

"""
    dti_icondiscountcheck(;kwargs...)

An IconDiscountCheck component.
...
"""
function dti_icondiscountcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscountcheck", "IconDiscountCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
