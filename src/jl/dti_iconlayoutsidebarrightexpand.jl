...
export dti_iconlayoutsidebarrightexpand

"""
    dti_iconlayoutsidebarrightexpand(;kwargs...)

An IconLayoutSidebarRightExpand component.
...
"""
function dti_iconlayoutsidebarrightexpand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutsidebarrightexpand", "IconLayoutSidebarRightExpand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
