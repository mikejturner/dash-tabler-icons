...
export dti_iconchartinfographic

"""
    dti_iconchartinfographic(;kwargs...)

An IconChartInfographic component.
...
"""
function dti_iconchartinfographic(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartinfographic", "IconChartInfographic", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
