...
export dti_iconcylinder

"""
    dti_iconcylinder(;kwargs...)

An IconCylinder component.
...
"""
function dti_iconcylinder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcylinder", "IconCylinder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
