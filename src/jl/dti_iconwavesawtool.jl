...
export dti_iconwavesawtool

"""
    dti_iconwavesawtool(;kwargs...)

An IconWaveSawTool component.
...
"""
function dti_iconwavesawtool(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwavesawtool", "IconWaveSawTool", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
