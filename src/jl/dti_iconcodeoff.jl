...
export dti_iconcodeoff

"""
    dti_iconcodeoff(;kwargs...)

An IconCodeOff component.
...
"""
function dti_iconcodeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcodeoff", "IconCodeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
