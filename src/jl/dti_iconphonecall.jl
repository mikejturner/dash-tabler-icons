...
export dti_iconphonecall

"""
    dti_iconphonecall(;kwargs...)

An IconPhoneCall component.
...
"""
function dti_iconphonecall(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphonecall", "IconPhoneCall", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
