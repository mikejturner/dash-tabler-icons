...
export dti_iconcirclenumber8

"""
    dti_iconcirclenumber8(;kwargs...)

An IconCircleNumber8 component.
...
"""
function dti_iconcirclenumber8(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber8", "IconCircleNumber8", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
