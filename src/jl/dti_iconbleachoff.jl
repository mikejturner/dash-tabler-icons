...
export dti_iconbleachoff

"""
    dti_iconbleachoff(;kwargs...)

An IconBleachOff component.
...
"""
function dti_iconbleachoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbleachoff", "IconBleachOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
