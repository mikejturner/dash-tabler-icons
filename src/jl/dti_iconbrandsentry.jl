...
export dti_iconbrandsentry

"""
    dti_iconbrandsentry(;kwargs...)

An IconBrandSentry component.
...
"""
function dti_iconbrandsentry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsentry", "IconBrandSentry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
