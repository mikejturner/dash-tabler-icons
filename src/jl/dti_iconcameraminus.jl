...
export dti_iconcameraminus

"""
    dti_iconcameraminus(;kwargs...)

An IconCameraMinus component.
...
"""
function dti_iconcameraminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcameraminus", "IconCameraMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
