...
export dti_iconlayerssubtract

"""
    dti_iconlayerssubtract(;kwargs...)

An IconLayersSubtract component.
...
"""
function dti_iconlayerssubtract(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayerssubtract", "IconLayersSubtract", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
