...
export dti_iconbrandubuntu

"""
    dti_iconbrandubuntu(;kwargs...)

An IconBrandUbuntu component.
...
"""
function dti_iconbrandubuntu(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandubuntu", "IconBrandUbuntu", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
