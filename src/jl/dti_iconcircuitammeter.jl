...
export dti_iconcircuitammeter

"""
    dti_iconcircuitammeter(;kwargs...)

An IconCircuitAmmeter component.
...
"""
function dti_iconcircuitammeter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitammeter", "IconCircuitAmmeter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
