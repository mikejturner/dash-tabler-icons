...
export dti_iconcircleminus

"""
    dti_iconcircleminus(;kwargs...)

An IconCircleMinus component.
...
"""
function dti_iconcircleminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleminus", "IconCircleMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
