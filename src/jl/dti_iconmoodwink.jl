...
export dti_iconmoodwink

"""
    dti_iconmoodwink(;kwargs...)

An IconMoodWink component.
...
"""
function dti_iconmoodwink(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodwink", "IconMoodWink", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
