...
export dti_iconpaperbagoff

"""
    dti_iconpaperbagoff(;kwargs...)

An IconPaperBagOff component.
...
"""
function dti_iconpaperbagoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpaperbagoff", "IconPaperBagOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
