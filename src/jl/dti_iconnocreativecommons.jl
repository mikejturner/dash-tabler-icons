...
export dti_iconnocreativecommons

"""
    dti_iconnocreativecommons(;kwargs...)

An IconNoCreativeCommons component.
...
"""
function dti_iconnocreativecommons(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnocreativecommons", "IconNoCreativeCommons", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
