...
export dti_iconfileoff

"""
    dti_iconfileoff(;kwargs...)

An IconFileOff component.
...
"""
function dti_iconfileoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileoff", "IconFileOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
