...
export dti_icongrilloff

"""
    dti_icongrilloff(;kwargs...)

An IconGrillOff component.
...
"""
function dti_icongrilloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrilloff", "IconGrillOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
