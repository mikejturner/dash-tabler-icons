...
export dti_icontransitionright

"""
    dti_icontransitionright(;kwargs...)

An IconTransitionRight component.
...
"""
function dti_icontransitionright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontransitionright", "IconTransitionRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
