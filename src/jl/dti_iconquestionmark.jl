...
export dti_iconquestionmark

"""
    dti_iconquestionmark(;kwargs...)

An IconQuestionMark component.
...
"""
function dti_iconquestionmark(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconquestionmark", "IconQuestionMark", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
