...
export dti_iconbinaryoff

"""
    dti_iconbinaryoff(;kwargs...)

An IconBinaryOff component.
...
"""
function dti_iconbinaryoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbinaryoff", "IconBinaryOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
