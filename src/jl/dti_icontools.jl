...
export dti_icontools

"""
    dti_icontools(;kwargs...)

An IconTools component.
...
"""
function dti_icontools(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontools", "IconTools", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
