...
export dti_iconbrandgrindr

"""
    dti_iconbrandgrindr(;kwargs...)

An IconBrandGrindr component.
...
"""
function dti_iconbrandgrindr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgrindr", "IconBrandGrindr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
