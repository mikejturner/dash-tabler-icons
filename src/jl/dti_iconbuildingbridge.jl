...
export dti_iconbuildingbridge

"""
    dti_iconbuildingbridge(;kwargs...)

An IconBuildingBridge component.
...
"""
function dti_iconbuildingbridge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingbridge", "IconBuildingBridge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
