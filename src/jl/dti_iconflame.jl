...
export dti_iconflame

"""
    dti_iconflame(;kwargs...)

An IconFlame component.
...
"""
function dti_iconflame(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflame", "IconFlame", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
