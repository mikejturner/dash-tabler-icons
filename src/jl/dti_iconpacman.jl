...
export dti_iconpacman

"""
    dti_iconpacman(;kwargs...)

An IconPacman component.
...
"""
function dti_iconpacman(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpacman", "IconPacman", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
