...
export dti_iconpackageoff

"""
    dti_iconpackageoff(;kwargs...)

An IconPackageOff component.
...
"""
function dti_iconpackageoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpackageoff", "IconPackageOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
