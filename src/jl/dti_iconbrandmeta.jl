...
export dti_iconbrandmeta

"""
    dti_iconbrandmeta(;kwargs...)

An IconBrandMeta component.
...
"""
function dti_iconbrandmeta(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmeta", "IconBrandMeta", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
