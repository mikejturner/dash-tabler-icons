...
export dti_iconcirclenumber0

"""
    dti_iconcirclenumber0(;kwargs...)

An IconCircleNumber0 component.
...
"""
function dti_iconcirclenumber0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber0", "IconCircleNumber0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
