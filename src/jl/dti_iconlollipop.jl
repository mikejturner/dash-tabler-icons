...
export dti_iconlollipop

"""
    dti_iconlollipop(;kwargs...)

An IconLollipop component.
...
"""
function dti_iconlollipop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlollipop", "IconLollipop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
