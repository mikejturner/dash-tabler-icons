...
export dti_iconfishhook

"""
    dti_iconfishhook(;kwargs...)

An IconFishHook component.
...
"""
function dti_iconfishhook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfishhook", "IconFishHook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
