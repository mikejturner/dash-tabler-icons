...
export dti_iconballamericanfootball

"""
    dti_iconballamericanfootball(;kwargs...)

An IconBallAmericanFootball component.
...
"""
function dti_iconballamericanfootball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballamericanfootball", "IconBallAmericanFootball", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
