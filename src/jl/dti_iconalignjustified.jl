...
export dti_iconalignjustified

"""
    dti_iconalignjustified(;kwargs...)

An IconAlignJustified component.
...
"""
function dti_iconalignjustified(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignjustified", "IconAlignJustified", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
