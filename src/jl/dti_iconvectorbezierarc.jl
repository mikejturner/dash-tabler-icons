...
export dti_iconvectorbezierarc

"""
    dti_iconvectorbezierarc(;kwargs...)

An IconVectorBezierArc component.
...
"""
function dti_iconvectorbezierarc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectorbezierarc", "IconVectorBezierArc", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
