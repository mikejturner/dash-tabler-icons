...
export dti_iconwritingsignoff

"""
    dti_iconwritingsignoff(;kwargs...)

An IconWritingSignOff component.
...
"""
function dti_iconwritingsignoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwritingsignoff", "IconWritingSignOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
