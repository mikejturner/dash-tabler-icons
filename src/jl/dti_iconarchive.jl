...
export dti_iconarchive

"""
    dti_iconarchive(;kwargs...)

An IconArchive component.
...
"""
function dti_iconarchive(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarchive", "IconArchive", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
