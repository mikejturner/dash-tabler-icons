...
export dti_iconfiledelta

"""
    dti_iconfiledelta(;kwargs...)

An IconFileDelta component.
...
"""
function dti_iconfiledelta(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledelta", "IconFileDelta", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
