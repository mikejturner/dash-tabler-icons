...
export dti_iconclockpause

"""
    dti_iconclockpause(;kwargs...)

An IconClockPause component.
...
"""
function dti_iconclockpause(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockpause", "IconClockPause", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
