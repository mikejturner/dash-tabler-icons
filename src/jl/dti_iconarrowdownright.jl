...
export dti_iconarrowdownright

"""
    dti_iconarrowdownright(;kwargs...)

An IconArrowDownRight component.
...
"""
function dti_iconarrowdownright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdownright", "IconArrowDownRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
