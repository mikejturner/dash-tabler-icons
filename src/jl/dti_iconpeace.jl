...
export dti_iconpeace

"""
    dti_iconpeace(;kwargs...)

An IconPeace component.
...
"""
function dti_iconpeace(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpeace", "IconPeace", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
