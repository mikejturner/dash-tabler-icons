...
export dti_iconvolume3

"""
    dti_iconvolume3(;kwargs...)

An IconVolume3 component.
...
"""
function dti_iconvolume3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvolume3", "IconVolume3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
