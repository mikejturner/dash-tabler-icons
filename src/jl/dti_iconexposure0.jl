...
export dti_iconexposure0

"""
    dti_iconexposure0(;kwargs...)

An IconExposure0 component.
...
"""
function dti_iconexposure0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposure0", "IconExposure0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
