...
export dti_icontransform

"""
    dti_icontransform(;kwargs...)

An IconTransform component.
...
"""
function dti_icontransform(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontransform", "IconTransform", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
