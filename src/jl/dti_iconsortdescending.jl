...
export dti_iconsortdescending

"""
    dti_iconsortdescending(;kwargs...)

An IconSortDescending component.
...
"""
function dti_iconsortdescending(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortdescending", "IconSortDescending", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
