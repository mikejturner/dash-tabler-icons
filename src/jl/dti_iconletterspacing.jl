...
export dti_iconletterspacing

"""
    dti_iconletterspacing(;kwargs...)

An IconLetterSpacing component.
...
"""
function dti_iconletterspacing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterspacing", "IconLetterSpacing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
