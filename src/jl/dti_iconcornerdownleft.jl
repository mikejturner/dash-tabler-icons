...
export dti_iconcornerdownleft

"""
    dti_iconcornerdownleft(;kwargs...)

An IconCornerDownLeft component.
...
"""
function dti_iconcornerdownleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerdownleft", "IconCornerDownLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
