...
export dti_iconseparator

"""
    dti_iconseparator(;kwargs...)

An IconSeparator component.
...
"""
function dti_iconseparator(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconseparator", "IconSeparator", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
