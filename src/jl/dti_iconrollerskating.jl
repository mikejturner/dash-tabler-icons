...
export dti_iconrollerskating

"""
    dti_iconrollerskating(;kwargs...)

An IconRollerSkating component.
...
"""
function dti_iconrollerskating(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrollerskating", "IconRollerSkating", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
