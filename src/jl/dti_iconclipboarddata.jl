...
export dti_iconclipboarddata

"""
    dti_iconclipboarddata(;kwargs...)

An IconClipboardData component.
...
"""
function dti_iconclipboarddata(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboarddata", "IconClipboardData", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
