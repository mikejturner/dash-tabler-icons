...
export dti_iconbooksoff

"""
    dti_iconbooksoff(;kwargs...)

An IconBooksOff component.
...
"""
function dti_iconbooksoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbooksoff", "IconBooksOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
