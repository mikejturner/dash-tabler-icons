...
export dti_iconcircuitswitchopen

"""
    dti_iconcircuitswitchopen(;kwargs...)

An IconCircuitSwitchOpen component.
...
"""
function dti_iconcircuitswitchopen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitswitchopen", "IconCircuitSwitchOpen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
