...
export dti_iconflower

"""
    dti_iconflower(;kwargs...)

An IconFlower component.
...
"""
function dti_iconflower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflower", "IconFlower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
