...
export dti_iconbrandslack

"""
    dti_iconbrandslack(;kwargs...)

An IconBrandSlack component.
...
"""
function dti_iconbrandslack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandslack", "IconBrandSlack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
