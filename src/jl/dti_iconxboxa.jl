...
export dti_iconxboxa

"""
    dti_iconxboxa(;kwargs...)

An IconXboxA component.
...
"""
function dti_iconxboxa(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconxboxa", "IconXboxA", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
