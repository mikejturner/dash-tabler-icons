...
export dti_icontransitionleft

"""
    dti_icontransitionleft(;kwargs...)

An IconTransitionLeft component.
...
"""
function dti_icontransitionleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontransitionleft", "IconTransitionLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
