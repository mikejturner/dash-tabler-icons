...
export dti_iconmessagecircle2

"""
    dti_iconmessagecircle2(;kwargs...)

An IconMessageCircle2 component.
...
"""
function dti_iconmessagecircle2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagecircle2", "IconMessageCircle2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
