...
export dti_iconcirclelettery

"""
    dti_iconcirclelettery(;kwargs...)

An IconCircleLetterY component.
...
"""
function dti_iconcirclelettery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclelettery", "IconCircleLetterY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
