...
export dti_iconironingsteamoff

"""
    dti_iconironingsteamoff(;kwargs...)

An IconIroningSteamOff component.
...
"""
function dti_iconironingsteamoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconironingsteamoff", "IconIroningSteamOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
