...
export dti_iconsquarehalf

"""
    dti_iconsquarehalf(;kwargs...)

An IconSquareHalf component.
...
"""
function dti_iconsquarehalf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarehalf", "IconSquareHalf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
