...
export dti_iconmicrophone2

"""
    dti_iconmicrophone2(;kwargs...)

An IconMicrophone2 component.
...
"""
function dti_iconmicrophone2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicrophone2", "IconMicrophone2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
