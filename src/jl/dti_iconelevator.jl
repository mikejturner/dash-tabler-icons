...
export dti_iconelevator

"""
    dti_iconelevator(;kwargs...)

An IconElevator component.
...
"""
function dti_iconelevator(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconelevator", "IconElevator", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
