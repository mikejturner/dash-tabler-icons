...
export dti_iconindentincrease

"""
    dti_iconindentincrease(;kwargs...)

An IconIndentIncrease component.
...
"""
function dti_iconindentincrease(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconindentincrease", "IconIndentIncrease", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
