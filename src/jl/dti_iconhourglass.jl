...
export dti_iconhourglass

"""
    dti_iconhourglass(;kwargs...)

An IconHourglass component.
...
"""
function dti_iconhourglass(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhourglass", "IconHourglass", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
