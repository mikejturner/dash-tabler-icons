...
export dti_iconcurrency

"""
    dti_iconcurrency(;kwargs...)

An IconCurrency component.
...
"""
function dti_iconcurrency(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrency", "IconCurrency", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
