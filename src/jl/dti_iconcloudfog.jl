...
export dti_iconcloudfog

"""
    dti_iconcloudfog(;kwargs...)

An IconCloudFog component.
...
"""
function dti_iconcloudfog(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudfog", "IconCloudFog", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
