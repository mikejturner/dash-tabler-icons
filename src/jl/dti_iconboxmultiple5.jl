...
export dti_iconboxmultiple5

"""
    dti_iconboxmultiple5(;kwargs...)

An IconBoxMultiple5 component.
...
"""
function dti_iconboxmultiple5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple5", "IconBoxMultiple5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
