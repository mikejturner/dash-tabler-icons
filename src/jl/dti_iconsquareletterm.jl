...
export dti_iconsquareletterm

"""
    dti_iconsquareletterm(;kwargs...)

An IconSquareLetterM component.
...
"""
function dti_iconsquareletterm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterm", "IconSquareLetterM", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
