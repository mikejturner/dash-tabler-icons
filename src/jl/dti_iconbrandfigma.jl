...
export dti_iconbrandfigma

"""
    dti_iconbrandfigma(;kwargs...)

An IconBrandFigma component.
...
"""
function dti_iconbrandfigma(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfigma", "IconBrandFigma", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
