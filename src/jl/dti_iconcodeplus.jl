...
export dti_iconcodeplus

"""
    dti_iconcodeplus(;kwargs...)

An IconCodePlus component.
...
"""
function dti_iconcodeplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcodeplus", "IconCodePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
