...
export dti_iconbrand4chan

"""
    dti_iconbrand4chan(;kwargs...)

An IconBrand4chan component.
...
"""
function dti_iconbrand4chan(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrand4chan", "IconBrand4chan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
