...
export dti_iconflagoff

"""
    dti_iconflagoff(;kwargs...)

An IconFlagOff component.
...
"""
function dti_iconflagoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflagoff", "IconFlagOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
