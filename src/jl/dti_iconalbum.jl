...
export dti_iconalbum

"""
    dti_iconalbum(;kwargs...)

An IconAlbum component.
...
"""
function dti_iconalbum(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalbum", "IconAlbum", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
