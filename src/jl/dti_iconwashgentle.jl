...
export dti_iconwashgentle

"""
    dti_iconwashgentle(;kwargs...)

An IconWashGentle component.
...
"""
function dti_iconwashgentle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashgentle", "IconWashGentle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
