...
export dti_iconsquareletterx

"""
    dti_iconsquareletterx(;kwargs...)

An IconSquareLetterX component.
...
"""
function dti_iconsquareletterx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterx", "IconSquareLetterX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
