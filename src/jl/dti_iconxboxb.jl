...
export dti_iconxboxb

"""
    dti_iconxboxb(;kwargs...)

An IconXboxB component.
...
"""
function dti_iconxboxb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconxboxb", "IconXboxB", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
