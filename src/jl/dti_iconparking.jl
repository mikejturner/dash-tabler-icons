...
export dti_iconparking

"""
    dti_iconparking(;kwargs...)

An IconParking component.
...
"""
function dti_iconparking(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconparking", "IconParking", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
