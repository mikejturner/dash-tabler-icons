...
export dti_iconbatteryautomotive

"""
    dti_iconbatteryautomotive(;kwargs...)

An IconBatteryAutomotive component.
...
"""
function dti_iconbatteryautomotive(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbatteryautomotive", "IconBatteryAutomotive", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
