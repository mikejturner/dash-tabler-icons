...
export dti_iconcornerrightdown

"""
    dti_iconcornerrightdown(;kwargs...)

An IconCornerRightDown component.
...
"""
function dti_iconcornerrightdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerrightdown", "IconCornerRightDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
