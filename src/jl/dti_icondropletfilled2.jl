...
export dti_icondropletfilled2

"""
    dti_icondropletfilled2(;kwargs...)

An IconDropletFilled2 component.
...
"""
function dti_icondropletfilled2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondropletfilled2", "IconDropletFilled2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
