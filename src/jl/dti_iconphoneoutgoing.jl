...
export dti_iconphoneoutgoing

"""
    dti_iconphoneoutgoing(;kwargs...)

An IconPhoneOutgoing component.
...
"""
function dti_iconphoneoutgoing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphoneoutgoing", "IconPhoneOutgoing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
