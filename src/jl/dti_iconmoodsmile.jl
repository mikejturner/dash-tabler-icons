...
export dti_iconmoodsmile

"""
    dti_iconmoodsmile(;kwargs...)

An IconMoodSmile component.
...
"""
function dti_iconmoodsmile(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsmile", "IconMoodSmile", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
