...
export dti_icontable

"""
    dti_icontable(;kwargs...)

An IconTable component.
...
"""
function dti_icontable(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontable", "IconTable", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
