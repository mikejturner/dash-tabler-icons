...
export dti_iconlayoutoff

"""
    dti_iconlayoutoff(;kwargs...)

An IconLayoutOff component.
...
"""
function dti_iconlayoutoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutoff", "IconLayoutOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
