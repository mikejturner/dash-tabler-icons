...
export dti_iconsquareasterisk

"""
    dti_iconsquareasterisk(;kwargs...)

An IconSquareAsterisk component.
...
"""
function dti_iconsquareasterisk(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareasterisk", "IconSquareAsterisk", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
