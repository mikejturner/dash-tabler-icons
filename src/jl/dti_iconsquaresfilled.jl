...
export dti_iconsquaresfilled

"""
    dti_iconsquaresfilled(;kwargs...)

An IconSquaresFilled component.
...
"""
function dti_iconsquaresfilled(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaresfilled", "IconSquaresFilled", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
