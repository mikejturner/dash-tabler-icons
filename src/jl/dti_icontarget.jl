...
export dti_icontarget

"""
    dti_icontarget(;kwargs...)

An IconTarget component.
...
"""
function dti_icontarget(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontarget", "IconTarget", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
