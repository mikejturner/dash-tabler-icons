...
export dti_iconarrowsjoin2

"""
    dti_iconarrowsjoin2(;kwargs...)

An IconArrowsJoin2 component.
...
"""
function dti_iconarrowsjoin2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsjoin2", "IconArrowsJoin2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
