...
export dti_iconbrandnotion

"""
    dti_iconbrandnotion(;kwargs...)

An IconBrandNotion component.
...
"""
function dti_iconbrandnotion(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnotion", "IconBrandNotion", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
