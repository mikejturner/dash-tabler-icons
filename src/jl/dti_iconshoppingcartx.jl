...
export dti_iconshoppingcartx

"""
    dti_iconshoppingcartx(;kwargs...)

An IconShoppingCartX component.
...
"""
function dti_iconshoppingcartx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshoppingcartx", "IconShoppingCartX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
