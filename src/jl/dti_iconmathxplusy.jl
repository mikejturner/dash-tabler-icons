...
export dti_iconmathxplusy

"""
    dti_iconmathxplusy(;kwargs...)

An IconMathXPlusY component.
...
"""
function dti_iconmathxplusy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxplusy", "IconMathXPlusY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
