...
export dti_iconrelationonetomany

"""
    dti_iconrelationonetomany(;kwargs...)

An IconRelationOneToMany component.
...
"""
function dti_iconrelationonetomany(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrelationonetomany", "IconRelationOneToMany", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
