...
export dti_iconcurrencyeuro

"""
    dti_iconcurrencyeuro(;kwargs...)

An IconCurrencyEuro component.
...
"""
function dti_iconcurrencyeuro(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyeuro", "IconCurrencyEuro", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
