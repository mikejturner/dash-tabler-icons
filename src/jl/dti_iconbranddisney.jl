...
export dti_iconbranddisney

"""
    dti_iconbranddisney(;kwargs...)

An IconBrandDisney component.
...
"""
function dti_iconbranddisney(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddisney", "IconBrandDisney", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
