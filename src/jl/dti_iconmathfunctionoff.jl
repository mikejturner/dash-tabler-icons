...
export dti_iconmathfunctionoff

"""
    dti_iconmathfunctionoff(;kwargs...)

An IconMathFunctionOff component.
...
"""
function dti_iconmathfunctionoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathfunctionoff", "IconMathFunctionOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
