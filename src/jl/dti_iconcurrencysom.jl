...
export dti_iconcurrencysom

"""
    dti_iconcurrencysom(;kwargs...)

An IconCurrencySom component.
...
"""
function dti_iconcurrencysom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencysom", "IconCurrencySom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
