...
export dti_iconlayoutlist

"""
    dti_iconlayoutlist(;kwargs...)

An IconLayoutList component.
...
"""
function dti_iconlayoutlist(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutlist", "IconLayoutList", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
