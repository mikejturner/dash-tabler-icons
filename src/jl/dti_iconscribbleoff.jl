...
export dti_iconscribbleoff

"""
    dti_iconscribbleoff(;kwargs...)

An IconScribbleOff component.
...
"""
function dti_iconscribbleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscribbleoff", "IconScribbleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
