...
export dti_iconlocksquare

"""
    dti_iconlocksquare(;kwargs...)

An IconLockSquare component.
...
"""
function dti_iconlocksquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlocksquare", "IconLockSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
