...
export dti_iconpanoramahorizontaloff

"""
    dti_iconpanoramahorizontaloff(;kwargs...)

An IconPanoramaHorizontalOff component.
...
"""
function dti_iconpanoramahorizontaloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpanoramahorizontaloff", "IconPanoramaHorizontalOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
