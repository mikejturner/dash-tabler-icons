...
export dti_iconbusoff

"""
    dti_iconbusoff(;kwargs...)

An IconBusOff component.
...
"""
function dti_iconbusoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbusoff", "IconBusOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
