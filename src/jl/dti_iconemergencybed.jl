...
export dti_iconemergencybed

"""
    dti_iconemergencybed(;kwargs...)

An IconEmergencyBed component.
...
"""
function dti_iconemergencybed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconemergencybed", "IconEmergencyBed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
