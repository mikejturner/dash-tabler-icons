...
export dti_iconfiledigit

"""
    dti_iconfiledigit(;kwargs...)

An IconFileDigit component.
...
"""
function dti_iconfiledigit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledigit", "IconFileDigit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
