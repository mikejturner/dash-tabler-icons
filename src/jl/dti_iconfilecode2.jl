...
export dti_iconfilecode2

"""
    dti_iconfilecode2(;kwargs...)

An IconFileCode2 component.
...
"""
function dti_iconfilecode2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilecode2", "IconFileCode2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
