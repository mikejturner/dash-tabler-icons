...
export dti_iconbrandwindy

"""
    dti_iconbrandwindy(;kwargs...)

An IconBrandWindy component.
...
"""
function dti_iconbrandwindy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwindy", "IconBrandWindy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
