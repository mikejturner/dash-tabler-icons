...
export dti_iconladderoff

"""
    dti_iconladderoff(;kwargs...)

An IconLadderOff component.
...
"""
function dti_iconladderoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconladderoff", "IconLadderOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
