...
export dti_iconfiletypography

"""
    dti_iconfiletypography(;kwargs...)

An IconFileTypography component.
...
"""
function dti_iconfiletypography(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiletypography", "IconFileTypography", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
