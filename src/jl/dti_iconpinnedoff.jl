...
export dti_iconpinnedoff

"""
    dti_iconpinnedoff(;kwargs...)

An IconPinnedOff component.
...
"""
function dti_iconpinnedoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpinnedoff", "IconPinnedOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
