...
export dti_iconselector

"""
    dti_iconselector(;kwargs...)

An IconSelector component.
...
"""
function dti_iconselector(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconselector", "IconSelector", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
