...
export dti_iconhomesignal

"""
    dti_iconhomesignal(;kwargs...)

An IconHomeSignal component.
...
"""
function dti_iconhomesignal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomesignal", "IconHomeSignal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
