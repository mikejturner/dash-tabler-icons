...
export dti_iconaugmentedrealityoff

"""
    dti_iconaugmentedrealityoff(;kwargs...)

An IconAugmentedRealityOff component.
...
"""
function dti_iconaugmentedrealityoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaugmentedrealityoff", "IconAugmentedRealityOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
