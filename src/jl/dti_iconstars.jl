...
export dti_iconstars

"""
    dti_iconstars(;kwargs...)

An IconStars component.
...
"""
function dti_iconstars(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstars", "IconStars", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
