...
export dti_iconbrandgooglefit

"""
    dti_iconbrandgooglefit(;kwargs...)

An IconBrandGoogleFit component.
...
"""
function dti_iconbrandgooglefit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgooglefit", "IconBrandGoogleFit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
