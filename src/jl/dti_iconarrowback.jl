...
export dti_iconarrowback

"""
    dti_iconarrowback(;kwargs...)

An IconArrowBack component.
...
"""
function dti_iconarrowback(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowback", "IconArrowBack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
