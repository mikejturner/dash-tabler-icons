...
export dti_iconcrown

"""
    dti_iconcrown(;kwargs...)

An IconCrown component.
...
"""
function dti_iconcrown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrown", "IconCrown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
