...
export dti_iconphonecalling

"""
    dti_iconphonecalling(;kwargs...)

An IconPhoneCalling component.
...
"""
function dti_iconphonecalling(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphonecalling", "IconPhoneCalling", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
