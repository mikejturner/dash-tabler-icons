...
export dti_iconrulermeasure

"""
    dti_iconrulermeasure(;kwargs...)

An IconRulerMeasure component.
...
"""
function dti_iconrulermeasure(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrulermeasure", "IconRulerMeasure", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
