...
export dti_iconarrowright

"""
    dti_iconarrowright(;kwargs...)

An IconArrowRight component.
...
"""
function dti_iconarrowright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowright", "IconArrowRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
