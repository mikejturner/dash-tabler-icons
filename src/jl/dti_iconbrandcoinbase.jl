...
export dti_iconbrandcoinbase

"""
    dti_iconbrandcoinbase(;kwargs...)

An IconBrandCoinbase component.
...
"""
function dti_iconbrandcoinbase(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcoinbase", "IconBrandCoinbase", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
