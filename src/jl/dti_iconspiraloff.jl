...
export dti_iconspiraloff

"""
    dti_iconspiraloff(;kwargs...)

An IconSpiralOff component.
...
"""
function dti_iconspiraloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspiraloff", "IconSpiralOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
