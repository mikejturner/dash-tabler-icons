...
export dti_iconbrandgit

"""
    dti_iconbrandgit(;kwargs...)

An IconBrandGit component.
...
"""
function dti_iconbrandgit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgit", "IconBrandGit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
