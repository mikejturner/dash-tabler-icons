...
export dti_iconeyecheck

"""
    dti_iconeyecheck(;kwargs...)

An IconEyeCheck component.
...
"""
function dti_iconeyecheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeyecheck", "IconEyeCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
