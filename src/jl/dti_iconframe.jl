...
export dti_iconframe

"""
    dti_iconframe(;kwargs...)

An IconFrame component.
...
"""
function dti_iconframe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconframe", "IconFrame", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
