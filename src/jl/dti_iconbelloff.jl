...
export dti_iconbelloff

"""
    dti_iconbelloff(;kwargs...)

An IconBellOff component.
...
"""
function dti_iconbelloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbelloff", "IconBellOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
