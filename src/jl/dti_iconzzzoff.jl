...
export dti_iconzzzoff

"""
    dti_iconzzzoff(;kwargs...)

An IconZzzOff component.
...
"""
function dti_iconzzzoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzzzoff", "IconZzzOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
