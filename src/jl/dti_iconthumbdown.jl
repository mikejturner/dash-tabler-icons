...
export dti_iconthumbdown

"""
    dti_iconthumbdown(;kwargs...)

An IconThumbDown component.
...
"""
function dti_iconthumbdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconthumbdown", "IconThumbDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
