...
export dti_iconcandle

"""
    dti_iconcandle(;kwargs...)

An IconCandle component.
...
"""
function dti_iconcandle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcandle", "IconCandle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
