...
export dti_iconkeyboardoff

"""
    dti_iconkeyboardoff(;kwargs...)

An IconKeyboardOff component.
...
"""
function dti_iconkeyboardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyboardoff", "IconKeyboardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
