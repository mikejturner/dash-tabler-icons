...
export dti_iconbrandwindows

"""
    dti_iconbrandwindows(;kwargs...)

An IconBrandWindows component.
...
"""
function dti_iconbrandwindows(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwindows", "IconBrandWindows", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
