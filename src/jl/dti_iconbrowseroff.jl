...
export dti_iconbrowseroff

"""
    dti_iconbrowseroff(;kwargs...)

An IconBrowserOff component.
...
"""
function dti_iconbrowseroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrowseroff", "IconBrowserOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
