...
export dti_iconcurrencynaira

"""
    dti_iconcurrencynaira(;kwargs...)

An IconCurrencyNaira component.
...
"""
function dti_iconcurrencynaira(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencynaira", "IconCurrencyNaira", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
