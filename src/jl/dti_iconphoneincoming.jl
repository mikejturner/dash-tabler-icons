...
export dti_iconphoneincoming

"""
    dti_iconphoneincoming(;kwargs...)

An IconPhoneIncoming component.
...
"""
function dti_iconphoneincoming(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphoneincoming", "IconPhoneIncoming", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
