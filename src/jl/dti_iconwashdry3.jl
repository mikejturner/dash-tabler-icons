...
export dti_iconwashdry3

"""
    dti_iconwashdry3(;kwargs...)

An IconWashDry3 component.
...
"""
function dti_iconwashdry3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdry3", "IconWashDry3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
