...
export dti_iconempathize

"""
    dti_iconempathize(;kwargs...)

An IconEmpathize component.
...
"""
function dti_iconempathize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconempathize", "IconEmpathize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
