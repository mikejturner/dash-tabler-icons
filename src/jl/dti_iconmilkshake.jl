...
export dti_iconmilkshake

"""
    dti_iconmilkshake(;kwargs...)

An IconMilkshake component.
...
"""
function dti_iconmilkshake(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmilkshake", "IconMilkshake", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
