...
export dti_iconfilex

"""
    dti_iconfilex(;kwargs...)

An IconFileX component.
...
"""
function dti_iconfilex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilex", "IconFileX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
