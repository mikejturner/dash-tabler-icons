...
export dti_iconfreerights

"""
    dti_iconfreerights(;kwargs...)

An IconFreeRights component.
...
"""
function dti_iconfreerights(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfreerights", "IconFreeRights", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
