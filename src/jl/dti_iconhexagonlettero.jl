...
export dti_iconhexagonlettero

"""
    dti_iconhexagonlettero(;kwargs...)

An IconHexagonLetterO component.
...
"""
function dti_iconhexagonlettero(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonlettero", "IconHexagonLetterO", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
