...
export dti_iconcircletriangle

"""
    dti_iconcircletriangle(;kwargs...)

An IconCircleTriangle component.
...
"""
function dti_iconcircletriangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircletriangle", "IconCircleTriangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
