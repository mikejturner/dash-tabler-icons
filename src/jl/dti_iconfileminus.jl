...
export dti_iconfileminus

"""
    dti_iconfileminus(;kwargs...)

An IconFileMinus component.
...
"""
function dti_iconfileminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileminus", "IconFileMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
