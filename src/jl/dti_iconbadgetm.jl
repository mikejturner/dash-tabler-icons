...
export dti_iconbadgetm

"""
    dti_iconbadgetm(;kwargs...)

An IconBadgeTm component.
...
"""
function dti_iconbadgetm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgetm", "IconBadgeTm", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
