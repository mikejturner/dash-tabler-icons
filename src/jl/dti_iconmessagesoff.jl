...
export dti_iconmessagesoff

"""
    dti_iconmessagesoff(;kwargs...)

An IconMessagesOff component.
...
"""
function dti_iconmessagesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagesoff", "IconMessagesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
