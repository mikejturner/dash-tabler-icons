...
export dti_icondatabaseoff

"""
    dti_icondatabaseoff(;kwargs...)

An IconDatabaseOff component.
...
"""
function dti_icondatabaseoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondatabaseoff", "IconDatabaseOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
