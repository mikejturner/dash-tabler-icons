...
export dti_iconfliphorizontal

"""
    dti_iconfliphorizontal(;kwargs...)

An IconFlipHorizontal component.
...
"""
function dti_iconfliphorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfliphorizontal", "IconFlipHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
