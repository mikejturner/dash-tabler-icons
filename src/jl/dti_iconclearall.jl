...
export dti_iconclearall

"""
    dti_iconclearall(;kwargs...)

An IconClearAll component.
...
"""
function dti_iconclearall(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclearall", "IconClearAll", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
