...
export dti_iconfirstaidkitoff

"""
    dti_iconfirstaidkitoff(;kwargs...)

An IconFirstAidKitOff component.
...
"""
function dti_iconfirstaidkitoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfirstaidkitoff", "IconFirstAidKitOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
