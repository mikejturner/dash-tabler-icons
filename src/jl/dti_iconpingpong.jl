...
export dti_iconpingpong

"""
    dti_iconpingpong(;kwargs...)

An IconPingPong component.
...
"""
function dti_iconpingpong(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpingpong", "IconPingPong", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
