...
export dti_iconpyramid

"""
    dti_iconpyramid(;kwargs...)

An IconPyramid component.
...
"""
function dti_iconpyramid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpyramid", "IconPyramid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
