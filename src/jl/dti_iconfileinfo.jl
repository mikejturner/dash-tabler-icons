...
export dti_iconfileinfo

"""
    dti_iconfileinfo(;kwargs...)

An IconFileInfo component.
...
"""
function dti_iconfileinfo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileinfo", "IconFileInfo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
