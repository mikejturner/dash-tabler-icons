...
export dti_iconboltoff

"""
    dti_iconboltoff(;kwargs...)

An IconBoltOff component.
...
"""
function dti_iconboltoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboltoff", "IconBoltOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
