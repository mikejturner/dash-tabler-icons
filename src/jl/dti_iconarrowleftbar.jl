...
export dti_iconarrowleftbar

"""
    dti_iconarrowleftbar(;kwargs...)

An IconArrowLeftBar component.
...
"""
function dti_iconarrowleftbar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowleftbar", "IconArrowLeftBar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
