...
export dti_iconarrowsdiagonal2

"""
    dti_iconarrowsdiagonal2(;kwargs...)

An IconArrowsDiagonal2 component.
...
"""
function dti_iconarrowsdiagonal2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdiagonal2", "IconArrowsDiagonal2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
