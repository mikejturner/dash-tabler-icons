...
export dti_iconsmokingno

"""
    dti_iconsmokingno(;kwargs...)

An IconSmokingNo component.
...
"""
function dti_iconsmokingno(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsmokingno", "IconSmokingNo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
