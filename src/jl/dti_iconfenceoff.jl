...
export dti_iconfenceoff

"""
    dti_iconfenceoff(;kwargs...)

An IconFenceOff component.
...
"""
function dti_iconfenceoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfenceoff", "IconFenceOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
