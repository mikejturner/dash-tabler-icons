...
export dti_iconcomponents

"""
    dti_iconcomponents(;kwargs...)

An IconComponents component.
...
"""
function dti_iconcomponents(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcomponents", "IconComponents", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
