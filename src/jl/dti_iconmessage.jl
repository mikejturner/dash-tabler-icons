...
export dti_iconmessage

"""
    dti_iconmessage(;kwargs...)

An IconMessage component.
...
"""
function dti_iconmessage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessage", "IconMessage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
