...
export dti_iconsortascendingnumbers

"""
    dti_iconsortascendingnumbers(;kwargs...)

An IconSortAscendingNumbers component.
...
"""
function dti_iconsortascendingnumbers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortascendingnumbers", "IconSortAscendingNumbers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
