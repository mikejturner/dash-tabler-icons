...
export dti_iconhexagonletterz

"""
    dti_iconhexagonletterz(;kwargs...)

An IconHexagonLetterZ component.
...
"""
function dti_iconhexagonletterz(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterz", "IconHexagonLetterZ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
