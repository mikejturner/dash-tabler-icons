...
export dti_iconnumber1

"""
    dti_iconnumber1(;kwargs...)

An IconNumber1 component.
...
"""
function dti_iconnumber1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber1", "IconNumber1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
