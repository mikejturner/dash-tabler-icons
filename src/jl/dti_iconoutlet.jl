...
export dti_iconoutlet

"""
    dti_iconoutlet(;kwargs...)

An IconOutlet component.
...
"""
function dti_iconoutlet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconoutlet", "IconOutlet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
