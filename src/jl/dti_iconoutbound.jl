...
export dti_iconoutbound

"""
    dti_iconoutbound(;kwargs...)

An IconOutbound component.
...
"""
function dti_iconoutbound(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconoutbound", "IconOutbound", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
