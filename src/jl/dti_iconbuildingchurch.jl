...
export dti_iconbuildingchurch

"""
    dti_iconbuildingchurch(;kwargs...)

An IconBuildingChurch component.
...
"""
function dti_iconbuildingchurch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingchurch", "IconBuildingChurch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
