...
export dti_iconreportanalytics

"""
    dti_iconreportanalytics(;kwargs...)

An IconReportAnalytics component.
...
"""
function dti_iconreportanalytics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreportanalytics", "IconReportAnalytics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
