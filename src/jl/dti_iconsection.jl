...
export dti_iconsection

"""
    dti_iconsection(;kwargs...)

An IconSection component.
...
"""
function dti_iconsection(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsection", "IconSection", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
