...
export dti_iconcandy

"""
    dti_iconcandy(;kwargs...)

An IconCandy component.
...
"""
function dti_iconcandy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcandy", "IconCandy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
