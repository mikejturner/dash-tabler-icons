...
export dti_iconcorneruprightdouble

"""
    dti_iconcorneruprightdouble(;kwargs...)

An IconCornerUpRightDouble component.
...
"""
function dti_iconcorneruprightdouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcorneruprightdouble", "IconCornerUpRightDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
