...
export dti_iconbrandvalorant

"""
    dti_iconbrandvalorant(;kwargs...)

An IconBrandValorant component.
...
"""
function dti_iconbrandvalorant(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvalorant", "IconBrandValorant", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
