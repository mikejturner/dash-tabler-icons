...
export dti_iconbrush

"""
    dti_iconbrush(;kwargs...)

An IconBrush component.
...
"""
function dti_iconbrush(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrush", "IconBrush", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
