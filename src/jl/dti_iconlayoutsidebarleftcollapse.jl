...
export dti_iconlayoutsidebarleftcollapse

"""
    dti_iconlayoutsidebarleftcollapse(;kwargs...)

An IconLayoutSidebarLeftCollapse component.
...
"""
function dti_iconlayoutsidebarleftcollapse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutsidebarleftcollapse", "IconLayoutSidebarLeftCollapse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
