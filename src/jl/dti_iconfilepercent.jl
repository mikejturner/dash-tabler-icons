...
export dti_iconfilepercent

"""
    dti_iconfilepercent(;kwargs...)

An IconFilePercent component.
...
"""
function dti_iconfilepercent(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilepercent", "IconFilePercent", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
