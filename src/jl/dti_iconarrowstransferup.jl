...
export dti_iconarrowstransferup

"""
    dti_iconarrowstransferup(;kwargs...)

An IconArrowsTransferUp component.
...
"""
function dti_iconarrowstransferup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowstransferup", "IconArrowsTransferUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
