...
export dti_iconbrandlaravel

"""
    dti_iconbrandlaravel(;kwargs...)

An IconBrandLaravel component.
...
"""
function dti_iconbrandlaravel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandlaravel", "IconBrandLaravel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
