...
export dti_icontextsize

"""
    dti_icontextsize(;kwargs...)

An IconTextSize component.
...
"""
function dti_icontextsize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextsize", "IconTextSize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
