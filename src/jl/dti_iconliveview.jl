...
export dti_iconliveview

"""
    dti_iconliveview(;kwargs...)

An IconLiveView component.
...
"""
function dti_iconliveview(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconliveview", "IconLiveView", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
