...
export dti_iconfilter

"""
    dti_iconfilter(;kwargs...)

An IconFilter component.
...
"""
function dti_iconfilter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilter", "IconFilter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
