...
export dti_iconeaseoutcontrolpoint

"""
    dti_iconeaseoutcontrolpoint(;kwargs...)

An IconEaseOutControlPoint component.
...
"""
function dti_iconeaseoutcontrolpoint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeaseoutcontrolpoint", "IconEaseOutControlPoint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
