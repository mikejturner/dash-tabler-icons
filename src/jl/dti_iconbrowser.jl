...
export dti_iconbrowser

"""
    dti_iconbrowser(;kwargs...)

An IconBrowser component.
...
"""
function dti_iconbrowser(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrowser", "IconBrowser", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
