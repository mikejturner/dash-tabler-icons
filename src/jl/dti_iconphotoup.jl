...
export dti_iconphotoup

"""
    dti_iconphotoup(;kwargs...)

An IconPhotoUp component.
...
"""
function dti_iconphotoup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotoup", "IconPhotoUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
