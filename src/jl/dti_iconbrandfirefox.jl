...
export dti_iconbrandfirefox

"""
    dti_iconbrandfirefox(;kwargs...)

An IconBrandFirefox component.
...
"""
function dti_iconbrandfirefox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandfirefox", "IconBrandFirefox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
