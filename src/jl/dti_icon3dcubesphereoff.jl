...
export dti_icon3dcubesphereoff

"""
    dti_icon3dcubesphereoff(;kwargs...)

An Icon3dCubeSphereOff component.
...
"""
function dti_icon3dcubesphereoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icon3dcubesphereoff", "Icon3dCubeSphereOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
