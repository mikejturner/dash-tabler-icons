...
export dti_iconbrandnextjs

"""
    dti_iconbrandnextjs(;kwargs...)

An IconBrandNextjs component.
...
"""
function dti_iconbrandnextjs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnextjs", "IconBrandNextjs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
