...
export dti_iconfirehydrant

"""
    dti_iconfirehydrant(;kwargs...)

An IconFireHydrant component.
...
"""
function dti_iconfirehydrant(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfirehydrant", "IconFireHydrant", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
