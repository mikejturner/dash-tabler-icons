...
export dti_iconreplace

"""
    dti_iconreplace(;kwargs...)

An IconReplace component.
...
"""
function dti_iconreplace(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreplace", "IconReplace", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
