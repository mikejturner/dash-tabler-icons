...
export dti_iconmoodnervous

"""
    dti_iconmoodnervous(;kwargs...)

An IconMoodNervous component.
...
"""
function dti_iconmoodnervous(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodnervous", "IconMoodNervous", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
