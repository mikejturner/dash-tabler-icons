...
export dti_iconfileplus

"""
    dti_iconfileplus(;kwargs...)

An IconFilePlus component.
...
"""
function dti_iconfileplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileplus", "IconFilePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
