...
export dti_icongitbranchdeleted

"""
    dti_icongitbranchdeleted(;kwargs...)

An IconGitBranchDeleted component.
...
"""
function dti_icongitbranchdeleted(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitbranchdeleted", "IconGitBranchDeleted", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
