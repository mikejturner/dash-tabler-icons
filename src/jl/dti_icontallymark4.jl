...
export dti_icontallymark4

"""
    dti_icontallymark4(;kwargs...)

An IconTallymark4 component.
...
"""
function dti_icontallymark4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontallymark4", "IconTallymark4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
