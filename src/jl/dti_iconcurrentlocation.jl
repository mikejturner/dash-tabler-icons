...
export dti_iconcurrentlocation

"""
    dti_iconcurrentlocation(;kwargs...)

An IconCurrentLocation component.
...
"""
function dti_iconcurrentlocation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrentlocation", "IconCurrentLocation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
