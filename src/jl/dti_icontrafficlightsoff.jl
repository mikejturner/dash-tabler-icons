...
export dti_icontrafficlightsoff

"""
    dti_icontrafficlightsoff(;kwargs...)

An IconTrafficLightsOff component.
...
"""
function dti_icontrafficlightsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrafficlightsoff", "IconTrafficLightsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
