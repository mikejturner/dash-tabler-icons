...
export dti_iconlettern

"""
    dti_iconlettern(;kwargs...)

An IconLetterN component.
...
"""
function dti_iconlettern(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettern", "IconLetterN", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
