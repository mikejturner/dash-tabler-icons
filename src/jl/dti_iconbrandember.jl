...
export dti_iconbrandember

"""
    dti_iconbrandember(;kwargs...)

An IconBrandEmber component.
...
"""
function dti_iconbrandember(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandember", "IconBrandEmber", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
