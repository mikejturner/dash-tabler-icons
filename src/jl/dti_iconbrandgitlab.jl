...
export dti_iconbrandgitlab

"""
    dti_iconbrandgitlab(;kwargs...)

An IconBrandGitlab component.
...
"""
function dti_iconbrandgitlab(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgitlab", "IconBrandGitlab", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
