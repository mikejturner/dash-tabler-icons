...
export dti_iconmessageforward

"""
    dti_iconmessageforward(;kwargs...)

An IconMessageForward component.
...
"""
function dti_iconmessageforward(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessageforward", "IconMessageForward", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
