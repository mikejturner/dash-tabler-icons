...
export dti_iconcreditcardoff

"""
    dti_iconcreditcardoff(;kwargs...)

An IconCreditCardOff component.
...
"""
function dti_iconcreditcardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreditcardoff", "IconCreditCardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
