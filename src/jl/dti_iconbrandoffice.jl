...
export dti_iconbrandoffice

"""
    dti_iconbrandoffice(;kwargs...)

An IconBrandOffice component.
...
"""
function dti_iconbrandoffice(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandoffice", "IconBrandOffice", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
