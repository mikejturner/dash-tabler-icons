...
export dti_iconchess

"""
    dti_iconchess(;kwargs...)

An IconChess component.
...
"""
function dti_iconchess(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchess", "IconChess", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
