...
export dti_iconbrandcucumber

"""
    dti_iconbrandcucumber(;kwargs...)

An IconBrandCucumber component.
...
"""
function dti_iconbrandcucumber(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcucumber", "IconBrandCucumber", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
