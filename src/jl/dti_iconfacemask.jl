...
export dti_iconfacemask

"""
    dti_iconfacemask(;kwargs...)

An IconFaceMask component.
...
"""
function dti_iconfacemask(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfacemask", "IconFaceMask", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
