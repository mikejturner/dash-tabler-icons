...
export dti_iconflipflops

"""
    dti_iconflipflops(;kwargs...)

An IconFlipFlops component.
...
"""
function dti_iconflipflops(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflipflops", "IconFlipFlops", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
