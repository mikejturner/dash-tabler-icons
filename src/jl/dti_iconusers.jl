...
export dti_iconusers

"""
    dti_iconusers(;kwargs...)

An IconUsers component.
...
"""
function dti_iconusers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconusers", "IconUsers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
