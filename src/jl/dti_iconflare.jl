...
export dti_iconflare

"""
    dti_iconflare(;kwargs...)

An IconFlare component.
...
"""
function dti_iconflare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflare", "IconFlare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
