...
export dti_icondirectionsoff

"""
    dti_icondirectionsoff(;kwargs...)

An IconDirectionsOff component.
...
"""
function dti_icondirectionsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondirectionsoff", "IconDirectionsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
