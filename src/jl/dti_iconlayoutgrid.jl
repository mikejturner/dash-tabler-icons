...
export dti_iconlayoutgrid

"""
    dti_iconlayoutgrid(;kwargs...)

An IconLayoutGrid component.
...
"""
function dti_iconlayoutgrid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutgrid", "IconLayoutGrid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
