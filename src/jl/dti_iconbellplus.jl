...
export dti_iconbellplus

"""
    dti_iconbellplus(;kwargs...)

An IconBellPlus component.
...
"""
function dti_iconbellplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellplus", "IconBellPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
