...
export dti_iconlockopenoff

"""
    dti_iconlockopenoff(;kwargs...)

An IconLockOpenOff component.
...
"""
function dti_iconlockopenoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlockopenoff", "IconLockOpenOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
