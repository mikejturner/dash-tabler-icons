...
export dti_iconwashdryw

"""
    dti_iconwashdryw(;kwargs...)

An IconWashDryW component.
...
"""
function dti_iconwashdryw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryw", "IconWashDryW", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
