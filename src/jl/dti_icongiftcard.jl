...
export dti_icongiftcard

"""
    dti_icongiftcard(;kwargs...)

An IconGiftCard component.
...
"""
function dti_icongiftcard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongiftcard", "IconGiftCard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
