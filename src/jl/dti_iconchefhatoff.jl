...
export dti_iconchefhatoff

"""
    dti_iconchefhatoff(;kwargs...)

An IconChefHatOff component.
...
"""
function dti_iconchefhatoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchefhatoff", "IconChefHatOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
