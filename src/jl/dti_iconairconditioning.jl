...
export dti_iconairconditioning

"""
    dti_iconairconditioning(;kwargs...)

An IconAirConditioning component.
...
"""
function dti_iconairconditioning(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconairconditioning", "IconAirConditioning", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
