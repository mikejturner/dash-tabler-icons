...
export dti_icontemperatureoff

"""
    dti_icontemperatureoff(;kwargs...)

An IconTemperatureOff component.
...
"""
function dti_icontemperatureoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemperatureoff", "IconTemperatureOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
