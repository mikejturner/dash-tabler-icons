...
export dti_iconletterm

"""
    dti_iconletterm(;kwargs...)

An IconLetterM component.
...
"""
function dti_iconletterm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterm", "IconLetterM", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
