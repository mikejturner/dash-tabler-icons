...
export dti_iconlifebuoy

"""
    dti_iconlifebuoy(;kwargs...)

An IconLifebuoy component.
...
"""
function dti_iconlifebuoy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlifebuoy", "IconLifebuoy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
