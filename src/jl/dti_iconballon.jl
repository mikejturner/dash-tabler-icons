...
export dti_iconballon

"""
    dti_iconballon(;kwargs...)

An IconBallon component.
...
"""
function dti_iconballon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballon", "IconBallon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
