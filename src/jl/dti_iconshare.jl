...
export dti_iconshare

"""
    dti_iconshare(;kwargs...)

An IconShare component.
...
"""
function dti_iconshare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshare", "IconShare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
