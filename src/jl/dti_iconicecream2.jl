...
export dti_iconicecream2

"""
    dti_iconicecream2(;kwargs...)

An IconIceCream2 component.
...
"""
function dti_iconicecream2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconicecream2", "IconIceCream2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
