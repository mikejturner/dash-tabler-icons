...
export dti_iconbrandsvelte

"""
    dti_iconbrandsvelte(;kwargs...)

An IconBrandSvelte component.
...
"""
function dti_iconbrandsvelte(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsvelte", "IconBrandSvelte", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
