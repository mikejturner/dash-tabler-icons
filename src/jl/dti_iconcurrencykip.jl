...
export dti_iconcurrencykip

"""
    dti_iconcurrencykip(;kwargs...)

An IconCurrencyKip component.
...
"""
function dti_iconcurrencykip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencykip", "IconCurrencyKip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
