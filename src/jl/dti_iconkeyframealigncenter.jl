...
export dti_iconkeyframealigncenter

"""
    dti_iconkeyframealigncenter(;kwargs...)

An IconKeyframeAlignCenter component.
...
"""
function dti_iconkeyframealigncenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyframealigncenter", "IconKeyframeAlignCenter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
