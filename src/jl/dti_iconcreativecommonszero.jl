...
export dti_iconcreativecommonszero

"""
    dti_iconcreativecommonszero(;kwargs...)

An IconCreativeCommonsZero component.
...
"""
function dti_iconcreativecommonszero(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommonszero", "IconCreativeCommonsZero", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
