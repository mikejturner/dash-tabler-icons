...
export dti_iconchalkboard

"""
    dti_iconchalkboard(;kwargs...)

An IconChalkboard component.
...
"""
function dti_iconchalkboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchalkboard", "IconChalkboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
