...
export dti_iconwiper

"""
    dti_iconwiper(;kwargs...)

An IconWiper component.
...
"""
function dti_iconwiper(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwiper", "IconWiper", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
