...
export dti_iconarrowshorizontal

"""
    dti_iconarrowshorizontal(;kwargs...)

An IconArrowsHorizontal component.
...
"""
function dti_iconarrowshorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowshorizontal", "IconArrowsHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
