...
export dti_icongardencart

"""
    dti_icongardencart(;kwargs...)

An IconGardenCart component.
...
"""
function dti_icongardencart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongardencart", "IconGardenCart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
