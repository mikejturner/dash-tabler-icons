...
export dti_iconbadge

"""
    dti_iconbadge(;kwargs...)

An IconBadge component.
...
"""
function dti_iconbadge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadge", "IconBadge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
