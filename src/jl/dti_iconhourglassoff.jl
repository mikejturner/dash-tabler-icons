...
export dti_iconhourglassoff

"""
    dti_iconhourglassoff(;kwargs...)

An IconHourglassOff component.
...
"""
function dti_iconhourglassoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhourglassoff", "IconHourglassOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
