...
export dti_iconcornerrightup

"""
    dti_iconcornerrightup(;kwargs...)

An IconCornerRightUp component.
...
"""
function dti_iconcornerrightup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerrightup", "IconCornerRightUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
