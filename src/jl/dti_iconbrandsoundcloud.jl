...
export dti_iconbrandsoundcloud

"""
    dti_iconbrandsoundcloud(;kwargs...)

An IconBrandSoundcloud component.
...
"""
function dti_iconbrandsoundcloud(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsoundcloud", "IconBrandSoundcloud", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
