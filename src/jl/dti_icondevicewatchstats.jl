...
export dti_icondevicewatchstats

"""
    dti_icondevicewatchstats(;kwargs...)

An IconDeviceWatchStats component.
...
"""
function dti_icondevicewatchstats(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicewatchstats", "IconDeviceWatchStats", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
