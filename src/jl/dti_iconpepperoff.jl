...
export dti_iconpepperoff

"""
    dti_iconpepperoff(;kwargs...)

An IconPepperOff component.
...
"""
function dti_iconpepperoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpepperoff", "IconPepperOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
