...
export dti_iconrating18plus

"""
    dti_iconrating18plus(;kwargs...)

An IconRating18Plus component.
...
"""
function dti_iconrating18plus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrating18plus", "IconRating18Plus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
