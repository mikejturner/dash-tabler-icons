...
export dti_iconslice

"""
    dti_iconslice(;kwargs...)

An IconSlice component.
...
"""
function dti_iconslice(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconslice", "IconSlice", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
