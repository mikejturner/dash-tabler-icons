...
export dti_iconcurrencydirham

"""
    dti_iconcurrencydirham(;kwargs...)

An IconCurrencyDirham component.
...
"""
function dti_iconcurrencydirham(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydirham", "IconCurrencyDirham", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
