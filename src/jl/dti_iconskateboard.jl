...
export dti_iconskateboard

"""
    dti_iconskateboard(;kwargs...)

An IconSkateboard component.
...
"""
function dti_iconskateboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconskateboard", "IconSkateboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
