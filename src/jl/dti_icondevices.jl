...
export dti_icondevices

"""
    dti_icondevices(;kwargs...)

An IconDevices component.
...
"""
function dti_icondevices(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevices", "IconDevices", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
