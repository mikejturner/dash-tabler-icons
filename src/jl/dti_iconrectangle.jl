...
export dti_iconrectangle

"""
    dti_iconrectangle(;kwargs...)

An IconRectangle component.
...
"""
function dti_iconrectangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrectangle", "IconRectangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
