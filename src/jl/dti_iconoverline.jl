...
export dti_iconoverline

"""
    dti_iconoverline(;kwargs...)

An IconOverline component.
...
"""
function dti_iconoverline(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconoverline", "IconOverline", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
