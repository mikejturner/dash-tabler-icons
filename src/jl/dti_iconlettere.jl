...
export dti_iconlettere

"""
    dti_iconlettere(;kwargs...)

An IconLetterE component.
...
"""
function dti_iconlettere(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettere", "IconLetterE", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
