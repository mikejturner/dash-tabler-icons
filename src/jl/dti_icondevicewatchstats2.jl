...
export dti_icondevicewatchstats2

"""
    dti_icondevicewatchstats2(;kwargs...)

An IconDeviceWatchStats2 component.
...
"""
function dti_icondevicewatchstats2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicewatchstats2", "IconDeviceWatchStats2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
