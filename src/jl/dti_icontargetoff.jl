...
export dti_icontargetoff

"""
    dti_icontargetoff(;kwargs...)

An IconTargetOff component.
...
"""
function dti_icontargetoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontargetoff", "IconTargetOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
