...
export dti_iconnotebook

"""
    dti_iconnotebook(;kwargs...)

An IconNotebook component.
...
"""
function dti_iconnotebook(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnotebook", "IconNotebook", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
