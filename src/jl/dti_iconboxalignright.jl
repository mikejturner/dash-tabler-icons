...
export dti_iconboxalignright

"""
    dti_iconboxalignright(;kwargs...)

An IconBoxAlignRight component.
...
"""
function dti_iconboxalignright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxalignright", "IconBoxAlignRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
