...
export dti_iconrainbowoff

"""
    dti_iconrainbowoff(;kwargs...)

An IconRainbowOff component.
...
"""
function dti_iconrainbowoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrainbowoff", "IconRainbowOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
