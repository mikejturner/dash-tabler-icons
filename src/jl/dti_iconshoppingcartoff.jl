...
export dti_iconshoppingcartoff

"""
    dti_iconshoppingcartoff(;kwargs...)

An IconShoppingCartOff component.
...
"""
function dti_iconshoppingcartoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshoppingcartoff", "IconShoppingCartOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
