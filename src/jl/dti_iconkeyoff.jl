...
export dti_iconkeyoff

"""
    dti_iconkeyoff(;kwargs...)

An IconKeyOff component.
...
"""
function dti_iconkeyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkeyoff", "IconKeyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
