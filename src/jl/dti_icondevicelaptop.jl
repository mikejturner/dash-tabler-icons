...
export dti_icondevicelaptop

"""
    dti_icondevicelaptop(;kwargs...)

An IconDeviceLaptop component.
...
"""
function dti_icondevicelaptop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicelaptop", "IconDeviceLaptop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
