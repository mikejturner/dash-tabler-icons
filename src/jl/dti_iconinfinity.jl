...
export dti_iconinfinity

"""
    dti_iconinfinity(;kwargs...)

An IconInfinity component.
...
"""
function dti_iconinfinity(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinfinity", "IconInfinity", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
