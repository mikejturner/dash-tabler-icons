...
export dti_iconboxaligntopright

"""
    dti_iconboxaligntopright(;kwargs...)

An IconBoxAlignTopRight component.
...
"""
function dti_iconboxaligntopright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxaligntopright", "IconBoxAlignTopRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
