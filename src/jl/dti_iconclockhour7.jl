...
export dti_iconclockhour7

"""
    dti_iconclockhour7(;kwargs...)

An IconClockHour7 component.
...
"""
function dti_iconclockhour7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour7", "IconClockHour7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
