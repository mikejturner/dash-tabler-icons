...
export dti_iconeaseinoutcontrolpoints

"""
    dti_iconeaseinoutcontrolpoints(;kwargs...)

An IconEaseInOutControlPoints component.
...
"""
function dti_iconeaseinoutcontrolpoints(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeaseinoutcontrolpoints", "IconEaseInOutControlPoints", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
