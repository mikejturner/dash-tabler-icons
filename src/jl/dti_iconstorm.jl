...
export dti_iconstorm

"""
    dti_iconstorm(;kwargs...)

An IconStorm component.
...
"""
function dti_iconstorm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstorm", "IconStorm", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
