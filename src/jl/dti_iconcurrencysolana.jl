...
export dti_iconcurrencysolana

"""
    dti_iconcurrencysolana(;kwargs...)

An IconCurrencySolana component.
...
"""
function dti_iconcurrencysolana(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencysolana", "IconCurrencySolana", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
