...
export dti_iconarrowrightcircle

"""
    dti_iconarrowrightcircle(;kwargs...)

An IconArrowRightCircle component.
...
"""
function dti_iconarrowrightcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrightcircle", "IconArrowRightCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
