...
export dti_iconradiooff

"""
    dti_iconradiooff(;kwargs...)

An IconRadioOff component.
...
"""
function dti_iconradiooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradiooff", "IconRadioOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
