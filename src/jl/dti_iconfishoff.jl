...
export dti_iconfishoff

"""
    dti_iconfishoff(;kwargs...)

An IconFishOff component.
...
"""
function dti_iconfishoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfishoff", "IconFishOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
