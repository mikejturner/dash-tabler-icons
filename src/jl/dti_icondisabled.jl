...
export dti_icondisabled

"""
    dti_icondisabled(;kwargs...)

An IconDisabled component.
...
"""
function dti_icondisabled(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondisabled", "IconDisabled", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
