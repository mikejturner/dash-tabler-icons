...
export dti_iconlettert

"""
    dti_iconlettert(;kwargs...)

An IconLetterT component.
...
"""
function dti_iconlettert(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettert", "IconLetterT", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
