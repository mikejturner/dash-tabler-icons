...
export dti_iconcircleoff

"""
    dti_iconcircleoff(;kwargs...)

An IconCircleOff component.
...
"""
function dti_iconcircleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleoff", "IconCircleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
