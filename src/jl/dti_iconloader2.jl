...
export dti_iconloader2

"""
    dti_iconloader2(;kwargs...)

An IconLoader2 component.
...
"""
function dti_iconloader2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconloader2", "IconLoader2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
