...
export dti_iconstack2

"""
    dti_iconstack2(;kwargs...)

An IconStack2 component.
...
"""
function dti_iconstack2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstack2", "IconStack2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
