...
export dti_iconhomeoff

"""
    dti_iconhomeoff(;kwargs...)

An IconHomeOff component.
...
"""
function dti_iconhomeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeoff", "IconHomeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
