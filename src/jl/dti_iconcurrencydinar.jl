...
export dti_iconcurrencydinar

"""
    dti_iconcurrencydinar(;kwargs...)

An IconCurrencyDinar component.
...
"""
function dti_iconcurrencydinar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydinar", "IconCurrencyDinar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
