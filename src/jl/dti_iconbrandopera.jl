...
export dti_iconbrandopera

"""
    dti_iconbrandopera(;kwargs...)

An IconBrandOpera component.
...
"""
function dti_iconbrandopera(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandopera", "IconBrandOpera", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
