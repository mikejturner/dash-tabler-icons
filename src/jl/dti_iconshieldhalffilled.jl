...
export dti_iconshieldhalffilled

"""
    dti_iconshieldhalffilled(;kwargs...)

An IconShieldHalfFilled component.
...
"""
function dti_iconshieldhalffilled(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldhalffilled", "IconShieldHalfFilled", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
