...
export dti_iconclockhour11

"""
    dti_iconclockhour11(;kwargs...)

An IconClockHour11 component.
...
"""
function dti_iconclockhour11(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour11", "IconClockHour11", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
