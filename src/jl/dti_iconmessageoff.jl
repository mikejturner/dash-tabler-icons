...
export dti_iconmessageoff

"""
    dti_iconmessageoff(;kwargs...)

An IconMessageOff component.
...
"""
function dti_iconmessageoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessageoff", "IconMessageOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
