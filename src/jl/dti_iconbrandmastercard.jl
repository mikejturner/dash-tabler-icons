...
export dti_iconbrandmastercard

"""
    dti_iconbrandmastercard(;kwargs...)

An IconBrandMastercard component.
...
"""
function dti_iconbrandmastercard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmastercard", "IconBrandMastercard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
