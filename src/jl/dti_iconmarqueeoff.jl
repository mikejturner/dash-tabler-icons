...
export dti_iconmarqueeoff

"""
    dti_iconmarqueeoff(;kwargs...)

An IconMarqueeOff component.
...
"""
function dti_iconmarqueeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmarqueeoff", "IconMarqueeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
