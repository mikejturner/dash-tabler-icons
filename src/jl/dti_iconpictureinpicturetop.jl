...
export dti_iconpictureinpicturetop

"""
    dti_iconpictureinpicturetop(;kwargs...)

An IconPictureInPictureTop component.
...
"""
function dti_iconpictureinpicturetop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpictureinpicturetop", "IconPictureInPictureTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
