...
export dti_iconsquaref3

"""
    dti_iconsquaref3(;kwargs...)

An IconSquareF3 component.
...
"""
function dti_iconsquaref3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref3", "IconSquareF3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
