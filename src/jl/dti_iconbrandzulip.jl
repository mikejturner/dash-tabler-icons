...
export dti_iconbrandzulip

"""
    dti_iconbrandzulip(;kwargs...)

An IconBrandZulip component.
...
"""
function dti_iconbrandzulip(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandzulip", "IconBrandZulip", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
