...
export dti_iconbraile

"""
    dti_iconbraile(;kwargs...)

An IconBraile component.
...
"""
function dti_iconbraile(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbraile", "IconBraile", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
