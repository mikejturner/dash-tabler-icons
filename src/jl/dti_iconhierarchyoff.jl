...
export dti_iconhierarchyoff

"""
    dti_iconhierarchyoff(;kwargs...)

An IconHierarchyOff component.
...
"""
function dti_iconhierarchyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhierarchyoff", "IconHierarchyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
