...
export dti_iconsmarthome

"""
    dti_iconsmarthome(;kwargs...)

An IconSmartHome component.
...
"""
function dti_iconsmarthome(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsmarthome", "IconSmartHome", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
