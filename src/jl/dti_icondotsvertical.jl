...
export dti_icondotsvertical

"""
    dti_icondotsvertical(;kwargs...)

An IconDotsVertical component.
...
"""
function dti_icondotsvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondotsvertical", "IconDotsVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
