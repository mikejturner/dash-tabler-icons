...
export dti_iconfilerss

"""
    dti_iconfilerss(;kwargs...)

An IconFileRss component.
...
"""
function dti_iconfilerss(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilerss", "IconFileRss", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
