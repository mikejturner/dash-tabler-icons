...
export dti_iconkering

"""
    dti_iconkering(;kwargs...)

An IconKering component.
...
"""
function dti_iconkering(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkering", "IconKering", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
