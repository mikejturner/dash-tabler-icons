...
export dti_iconcoffeeoff

"""
    dti_iconcoffeeoff(;kwargs...)

An IconCoffeeOff component.
...
"""
function dti_iconcoffeeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoffeeoff", "IconCoffeeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
