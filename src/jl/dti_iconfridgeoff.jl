...
export dti_iconfridgeoff

"""
    dti_iconfridgeoff(;kwargs...)

An IconFridgeOff component.
...
"""
function dti_iconfridgeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfridgeoff", "IconFridgeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
