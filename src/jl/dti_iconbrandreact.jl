...
export dti_iconbrandreact

"""
    dti_iconbrandreact(;kwargs...)

An IconBrandReact component.
...
"""
function dti_iconbrandreact(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandreact", "IconBrandReact", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
