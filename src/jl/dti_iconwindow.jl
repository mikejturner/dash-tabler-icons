...
export dti_iconwindow

"""
    dti_iconwindow(;kwargs...)

An IconWindow component.
...
"""
function dti_iconwindow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwindow", "IconWindow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
