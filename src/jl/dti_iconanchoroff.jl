...
export dti_iconanchoroff

"""
    dti_iconanchoroff(;kwargs...)

An IconAnchorOff component.
...
"""
function dti_iconanchoroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconanchoroff", "IconAnchorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
