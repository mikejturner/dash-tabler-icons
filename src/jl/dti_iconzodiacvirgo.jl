...
export dti_iconzodiacvirgo

"""
    dti_iconzodiacvirgo(;kwargs...)

An IconZodiacVirgo component.
...
"""
function dti_iconzodiacvirgo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacvirgo", "IconZodiacVirgo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
