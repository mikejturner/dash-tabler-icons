...
export dti_iconbrandnetbeans

"""
    dti_iconbrandnetbeans(;kwargs...)

An IconBrandNetbeans component.
...
"""
function dti_iconbrandnetbeans(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnetbeans", "IconBrandNetbeans", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
