...
export dti_iconbrandgatsby

"""
    dti_iconbrandgatsby(;kwargs...)

An IconBrandGatsby component.
...
"""
function dti_iconbrandgatsby(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgatsby", "IconBrandGatsby", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
