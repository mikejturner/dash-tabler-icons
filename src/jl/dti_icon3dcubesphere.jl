...
export dti_icon3dcubesphere

"""
    dti_icon3dcubesphere(;kwargs...)

An Icon3dCubeSphere component.
...
"""
function dti_icon3dcubesphere(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icon3dcubesphere", "Icon3dCubeSphere", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
