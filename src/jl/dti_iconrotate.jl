...
export dti_iconrotate

"""
    dti_iconrotate(;kwargs...)

An IconRotate component.
...
"""
function dti_iconrotate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrotate", "IconRotate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
