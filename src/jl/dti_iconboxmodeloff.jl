...
export dti_iconboxmodeloff

"""
    dti_iconboxmodeloff(;kwargs...)

An IconBoxModelOff component.
...
"""
function dti_iconboxmodeloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmodeloff", "IconBoxModelOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
