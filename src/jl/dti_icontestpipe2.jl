...
export dti_icontestpipe2

"""
    dti_icontestpipe2(;kwargs...)

An IconTestPipe2 component.
...
"""
function dti_icontestpipe2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontestpipe2", "IconTestPipe2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
