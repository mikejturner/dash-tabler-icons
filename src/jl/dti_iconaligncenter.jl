...
export dti_iconaligncenter

"""
    dti_iconaligncenter(;kwargs...)

An IconAlignCenter component.
...
"""
function dti_iconaligncenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaligncenter", "IconAlignCenter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
