...
export dti_iconscooterelectric

"""
    dti_iconscooterelectric(;kwargs...)

An IconScooterElectric component.
...
"""
function dti_iconscooterelectric(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscooterelectric", "IconScooterElectric", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
