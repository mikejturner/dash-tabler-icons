...
export dti_iconclover2

"""
    dti_iconclover2(;kwargs...)

An IconClover2 component.
...
"""
function dti_iconclover2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclover2", "IconClover2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
