...
export dti_icontablealias

"""
    dti_icontablealias(;kwargs...)

An IconTableAlias component.
...
"""
function dti_icontablealias(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontablealias", "IconTableAlias", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
