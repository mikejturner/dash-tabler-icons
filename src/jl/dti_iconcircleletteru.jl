...
export dti_iconcircleletteru

"""
    dti_iconcircleletteru(;kwargs...)

An IconCircleLetterU component.
...
"""
function dti_iconcircleletteru(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletteru", "IconCircleLetterU", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
