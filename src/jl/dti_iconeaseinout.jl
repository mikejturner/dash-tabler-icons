...
export dti_iconeaseinout

"""
    dti_iconeaseinout(;kwargs...)

An IconEaseInOut component.
...
"""
function dti_iconeaseinout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeaseinout", "IconEaseInOut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
