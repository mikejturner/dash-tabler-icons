...
export dti_iconfolddown

"""
    dti_iconfolddown(;kwargs...)

An IconFoldDown component.
...
"""
function dti_iconfolddown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolddown", "IconFoldDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
