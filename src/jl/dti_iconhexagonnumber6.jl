...
export dti_iconhexagonnumber6

"""
    dti_iconhexagonnumber6(;kwargs...)

An IconHexagonNumber6 component.
...
"""
function dti_iconhexagonnumber6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber6", "IconHexagonNumber6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
