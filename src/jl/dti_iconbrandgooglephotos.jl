...
export dti_iconbrandgooglephotos

"""
    dti_iconbrandgooglephotos(;kwargs...)

An IconBrandGooglePhotos component.
...
"""
function dti_iconbrandgooglephotos(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgooglephotos", "IconBrandGooglePhotos", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
