...
export dti_iconsquareletteri

"""
    dti_iconsquareletteri(;kwargs...)

An IconSquareLetterI component.
...
"""
function dti_iconsquareletteri(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletteri", "IconSquareLetterI", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
