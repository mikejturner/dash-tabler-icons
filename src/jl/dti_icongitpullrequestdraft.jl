...
export dti_icongitpullrequestdraft

"""
    dti_icongitpullrequestdraft(;kwargs...)

An IconGitPullRequestDraft component.
...
"""
function dti_icongitpullrequestdraft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitpullrequestdraft", "IconGitPullRequestDraft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
