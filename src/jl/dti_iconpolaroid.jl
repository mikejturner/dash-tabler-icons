...
export dti_iconpolaroid

"""
    dti_iconpolaroid(;kwargs...)

An IconPolaroid component.
...
"""
function dti_iconpolaroid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpolaroid", "IconPolaroid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
