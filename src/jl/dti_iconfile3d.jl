...
export dti_iconfile3d

"""
    dti_iconfile3d(;kwargs...)

An IconFile3d component.
...
"""
function dti_iconfile3d(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfile3d", "IconFile3d", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
