...
export dti_iconchisel

"""
    dti_iconchisel(;kwargs...)

An IconChisel component.
...
"""
function dti_iconchisel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchisel", "IconChisel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
