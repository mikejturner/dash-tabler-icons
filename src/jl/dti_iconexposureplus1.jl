...
export dti_iconexposureplus1

"""
    dti_iconexposureplus1(;kwargs...)

An IconExposurePlus1 component.
...
"""
function dti_iconexposureplus1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposureplus1", "IconExposurePlus1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
