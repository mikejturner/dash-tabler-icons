...
export dti_iconjetpack

"""
    dti_iconjetpack(;kwargs...)

An IconJetpack component.
...
"""
function dti_iconjetpack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconjetpack", "IconJetpack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
