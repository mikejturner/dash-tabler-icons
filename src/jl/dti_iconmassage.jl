...
export dti_iconmassage

"""
    dti_iconmassage(;kwargs...)

An IconMassage component.
...
"""
function dti_iconmassage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmassage", "IconMassage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
