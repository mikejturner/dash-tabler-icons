...
export dti_icongitcompare

"""
    dti_icongitcompare(;kwargs...)

An IconGitCompare component.
...
"""
function dti_icongitcompare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitcompare", "IconGitCompare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
