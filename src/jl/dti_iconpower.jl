...
export dti_iconpower

"""
    dti_iconpower(;kwargs...)

An IconPower component.
...
"""
function dti_iconpower(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpower", "IconPower", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
