...
export dti_iconchartbubble

"""
    dti_iconchartbubble(;kwargs...)

An IconChartBubble component.
...
"""
function dti_iconchartbubble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartbubble", "IconChartBubble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
