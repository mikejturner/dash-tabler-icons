...
export dti_icontentoff

"""
    dti_icontentoff(;kwargs...)

An IconTentOff component.
...
"""
function dti_icontentoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontentoff", "IconTentOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
