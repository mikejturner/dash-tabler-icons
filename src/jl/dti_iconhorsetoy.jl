...
export dti_iconhorsetoy

"""
    dti_iconhorsetoy(;kwargs...)

An IconHorseToy component.
...
"""
function dti_iconhorsetoy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhorsetoy", "IconHorseToy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
