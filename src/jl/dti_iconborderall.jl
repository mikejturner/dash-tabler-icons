...
export dti_iconborderall

"""
    dti_iconborderall(;kwargs...)

An IconBorderAll component.
...
"""
function dti_iconborderall(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderall", "IconBorderAll", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
