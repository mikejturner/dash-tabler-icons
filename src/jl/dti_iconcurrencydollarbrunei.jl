...
export dti_iconcurrencydollarbrunei

"""
    dti_iconcurrencydollarbrunei(;kwargs...)

An IconCurrencyDollarBrunei component.
...
"""
function dti_iconcurrencydollarbrunei(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollarbrunei", "IconCurrencyDollarBrunei", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
