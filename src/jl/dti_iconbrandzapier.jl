...
export dti_iconbrandzapier

"""
    dti_iconbrandzapier(;kwargs...)

An IconBrandZapier component.
...
"""
function dti_iconbrandzapier(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandzapier", "IconBrandZapier", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
