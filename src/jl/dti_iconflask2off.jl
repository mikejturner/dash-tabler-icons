...
export dti_iconflask2off

"""
    dti_iconflask2off(;kwargs...)

An IconFlask2Off component.
...
"""
function dti_iconflask2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflask2off", "IconFlask2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
