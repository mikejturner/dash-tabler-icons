...
export dti_iconcreativecommonsnd

"""
    dti_iconcreativecommonsnd(;kwargs...)

An IconCreativeCommonsNd component.
...
"""
function dti_iconcreativecommonsnd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommonsnd", "IconCreativeCommonsNd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
