...
export dti_icongenderneutrois

"""
    dti_icongenderneutrois(;kwargs...)

An IconGenderNeutrois component.
...
"""
function dti_icongenderneutrois(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderneutrois", "IconGenderNeutrois", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
