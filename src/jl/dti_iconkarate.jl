...
export dti_iconkarate

"""
    dti_iconkarate(;kwargs...)

An IconKarate component.
...
"""
function dti_iconkarate(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconkarate", "IconKarate", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
