...
export dti_iconinnershadowtop

"""
    dti_iconinnershadowtop(;kwargs...)

An IconInnerShadowTop component.
...
"""
function dti_iconinnershadowtop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowtop", "IconInnerShadowTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
