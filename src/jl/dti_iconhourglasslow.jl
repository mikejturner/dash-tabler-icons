...
export dti_iconhourglasslow

"""
    dti_iconhourglasslow(;kwargs...)

An IconHourglassLow component.
...
"""
function dti_iconhourglasslow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhourglasslow", "IconHourglassLow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
