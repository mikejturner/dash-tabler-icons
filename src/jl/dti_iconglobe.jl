...
export dti_iconglobe

"""
    dti_iconglobe(;kwargs...)

An IconGlobe component.
...
"""
function dti_iconglobe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconglobe", "IconGlobe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
