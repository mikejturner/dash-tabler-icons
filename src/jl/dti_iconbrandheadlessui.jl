...
export dti_iconbrandheadlessui

"""
    dti_iconbrandheadlessui(;kwargs...)

An IconBrandHeadlessui component.
...
"""
function dti_iconbrandheadlessui(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandheadlessui", "IconBrandHeadlessui", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
