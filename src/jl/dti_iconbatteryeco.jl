...
export dti_iconbatteryeco

"""
    dti_iconbatteryeco(;kwargs...)

An IconBatteryEco component.
...
"""
function dti_iconbatteryeco(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbatteryeco", "IconBatteryEco", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
