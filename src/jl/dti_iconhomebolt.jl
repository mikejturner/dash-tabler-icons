...
export dti_iconhomebolt

"""
    dti_iconhomebolt(;kwargs...)

An IconHomeBolt component.
...
"""
function dti_iconhomebolt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomebolt", "IconHomeBolt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
