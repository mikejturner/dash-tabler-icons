...
export dti_iconphone

"""
    dti_iconphone(;kwargs...)

An IconPhone component.
...
"""
function dti_iconphone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphone", "IconPhone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
