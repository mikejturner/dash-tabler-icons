...
export dti_iconscaleoff

"""
    dti_iconscaleoff(;kwargs...)

An IconScaleOff component.
...
"""
function dti_iconscaleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscaleoff", "IconScaleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
