...
export dti_iconnumber7

"""
    dti_iconnumber7(;kwargs...)

An IconNumber7 component.
...
"""
function dti_iconnumber7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber7", "IconNumber7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
