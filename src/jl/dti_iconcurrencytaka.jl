...
export dti_iconcurrencytaka

"""
    dti_iconcurrencytaka(;kwargs...)

An IconCurrencyTaka component.
...
"""
function dti_iconcurrencytaka(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencytaka", "IconCurrencyTaka", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
