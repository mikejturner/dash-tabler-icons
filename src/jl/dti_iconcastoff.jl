...
export dti_iconcastoff

"""
    dti_iconcastoff(;kwargs...)

An IconCastOff component.
...
"""
function dti_iconcastoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcastoff", "IconCastOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
