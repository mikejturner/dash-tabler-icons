...
export dti_iconboxmultiple1

"""
    dti_iconboxmultiple1(;kwargs...)

An IconBoxMultiple1 component.
...
"""
function dti_iconboxmultiple1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple1", "IconBoxMultiple1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
