...
export dti_iconpanoramaverticaloff

"""
    dti_iconpanoramaverticaloff(;kwargs...)

An IconPanoramaVerticalOff component.
...
"""
function dti_iconpanoramaverticaloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpanoramaverticaloff", "IconPanoramaVerticalOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
