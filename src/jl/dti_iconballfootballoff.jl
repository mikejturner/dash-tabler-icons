...
export dti_iconballfootballoff

"""
    dti_iconballfootballoff(;kwargs...)

An IconBallFootballOff component.
...
"""
function dti_iconballfootballoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballfootballoff", "IconBallFootballOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
