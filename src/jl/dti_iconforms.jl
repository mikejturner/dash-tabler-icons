...
export dti_iconforms

"""
    dti_iconforms(;kwargs...)

An IconForms component.
...
"""
function dti_iconforms(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconforms", "IconForms", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
