...
export dti_iconheartsoff

"""
    dti_iconheartsoff(;kwargs...)

An IconHeartsOff component.
...
"""
function dti_iconheartsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartsoff", "IconHeartsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
