...
export dti_iconbrandtwitter

"""
    dti_iconbrandtwitter(;kwargs...)

An IconBrandTwitter component.
...
"""
function dti_iconbrandtwitter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtwitter", "IconBrandTwitter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
