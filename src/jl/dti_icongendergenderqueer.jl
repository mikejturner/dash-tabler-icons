...
export dti_icongendergenderqueer

"""
    dti_icongendergenderqueer(;kwargs...)

An IconGenderGenderqueer component.
...
"""
function dti_icongendergenderqueer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongendergenderqueer", "IconGenderGenderqueer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
