...
export dti_iconbuildingfactory

"""
    dti_iconbuildingfactory(;kwargs...)

An IconBuildingFactory component.
...
"""
function dti_iconbuildingfactory(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingfactory", "IconBuildingFactory", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
