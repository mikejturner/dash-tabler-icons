...
export dti_iconteapot

"""
    dti_iconteapot(;kwargs...)

An IconTeapot component.
...
"""
function dti_iconteapot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconteapot", "IconTeapot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
