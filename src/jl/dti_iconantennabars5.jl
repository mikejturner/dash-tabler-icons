...
export dti_iconantennabars5

"""
    dti_iconantennabars5(;kwargs...)

An IconAntennaBars5 component.
...
"""
function dti_iconantennabars5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennabars5", "IconAntennaBars5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
