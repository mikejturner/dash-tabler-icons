...
export dti_iconcoineuro

"""
    dti_iconcoineuro(;kwargs...)

An IconCoinEuro component.
...
"""
function dti_iconcoineuro(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoineuro", "IconCoinEuro", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
