...
export dti_iconcirclecheck

"""
    dti_iconcirclecheck(;kwargs...)

An IconCircleCheck component.
...
"""
function dti_iconcirclecheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclecheck", "IconCircleCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
