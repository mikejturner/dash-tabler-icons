...
export dti_iconcolumninsertright

"""
    dti_iconcolumninsertright(;kwargs...)

An IconColumnInsertRight component.
...
"""
function dti_iconcolumninsertright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolumninsertright", "IconColumnInsertRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
