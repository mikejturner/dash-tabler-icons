...
export dti_iconfolders

"""
    dti_iconfolders(;kwargs...)

An IconFolders component.
...
"""
function dti_iconfolders(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolders", "IconFolders", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
