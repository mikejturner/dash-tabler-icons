...
export dti_iconvolume2

"""
    dti_iconvolume2(;kwargs...)

An IconVolume2 component.
...
"""
function dti_iconvolume2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvolume2", "IconVolume2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
