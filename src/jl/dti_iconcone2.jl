...
export dti_iconcone2

"""
    dti_iconcone2(;kwargs...)

An IconCone2 component.
...
"""
function dti_iconcone2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcone2", "IconCone2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
