...
export dti_iconswitchhorizontal

"""
    dti_iconswitchhorizontal(;kwargs...)

An IconSwitchHorizontal component.
...
"""
function dti_iconswitchhorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswitchhorizontal", "IconSwitchHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
