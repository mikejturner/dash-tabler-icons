...
export dti_iconsortascending

"""
    dti_iconsortascending(;kwargs...)

An IconSortAscending component.
...
"""
function dti_iconsortascending(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortascending", "IconSortAscending", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
