...
export dti_iconarrowsdiff

"""
    dti_iconarrowsdiff(;kwargs...)

An IconArrowsDiff component.
...
"""
function dti_iconarrowsdiff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdiff", "IconArrowsDiff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
