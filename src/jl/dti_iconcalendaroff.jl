...
export dti_iconcalendaroff

"""
    dti_iconcalendaroff(;kwargs...)

An IconCalendarOff component.
...
"""
function dti_iconcalendaroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendaroff", "IconCalendarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
