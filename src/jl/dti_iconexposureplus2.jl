...
export dti_iconexposureplus2

"""
    dti_iconexposureplus2(;kwargs...)

An IconExposurePlus2 component.
...
"""
function dti_iconexposureplus2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexposureplus2", "IconExposurePlus2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
