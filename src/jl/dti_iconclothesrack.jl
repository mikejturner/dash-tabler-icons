...
export dti_iconclothesrack

"""
    dti_iconclothesrack(;kwargs...)

An IconClothesRack component.
...
"""
function dti_iconclothesrack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclothesrack", "IconClothesRack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
