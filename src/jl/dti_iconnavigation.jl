...
export dti_iconnavigation

"""
    dti_iconnavigation(;kwargs...)

An IconNavigation component.
...
"""
function dti_iconnavigation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnavigation", "IconNavigation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
