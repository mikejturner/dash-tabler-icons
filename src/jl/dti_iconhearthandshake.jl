...
export dti_iconhearthandshake

"""
    dti_iconhearthandshake(;kwargs...)

An IconHeartHandshake component.
...
"""
function dti_iconhearthandshake(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhearthandshake", "IconHeartHandshake", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
