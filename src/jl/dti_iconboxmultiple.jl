...
export dti_iconboxmultiple

"""
    dti_iconboxmultiple(;kwargs...)

An IconBoxMultiple component.
...
"""
function dti_iconboxmultiple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple", "IconBoxMultiple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
