...
export dti_iconbrandvscode

"""
    dti_iconbrandvscode(;kwargs...)

An IconBrandVscode component.
...
"""
function dti_iconbrandvscode(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvscode", "IconBrandVscode", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
