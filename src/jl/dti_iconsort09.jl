...
export dti_iconsort09

"""
    dti_iconsort09(;kwargs...)

An IconSort09 component.
...
"""
function dti_iconsort09(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsort09", "IconSort09", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
