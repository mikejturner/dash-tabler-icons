...
export dti_iconplugconnectedx

"""
    dti_iconplugconnectedx(;kwargs...)

An IconPlugConnectedX component.
...
"""
function dti_iconplugconnectedx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplugconnectedx", "IconPlugConnectedX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
