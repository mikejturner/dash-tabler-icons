...
export dti_iconhealthrecognition

"""
    dti_iconhealthrecognition(;kwargs...)

An IconHealthRecognition component.
...
"""
function dti_iconhealthrecognition(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhealthrecognition", "IconHealthRecognition", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
