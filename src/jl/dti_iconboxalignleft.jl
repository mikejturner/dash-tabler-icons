...
export dti_iconboxalignleft

"""
    dti_iconboxalignleft(;kwargs...)

An IconBoxAlignLeft component.
...
"""
function dti_iconboxalignleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxalignleft", "IconBoxAlignLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
