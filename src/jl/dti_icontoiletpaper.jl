...
export dti_icontoiletpaper

"""
    dti_icontoiletpaper(;kwargs...)

An IconToiletPaper component.
...
"""
function dti_icontoiletpaper(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoiletpaper", "IconToiletPaper", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
