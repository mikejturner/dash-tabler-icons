...
export dti_iconfloatleft

"""
    dti_iconfloatleft(;kwargs...)

An IconFloatLeft component.
...
"""
function dti_iconfloatleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfloatleft", "IconFloatLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
