...
export dti_iconview360

"""
    dti_iconview360(;kwargs...)

An IconView360 component.
...
"""
function dti_iconview360(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconview360", "IconView360", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
