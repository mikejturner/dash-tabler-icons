...
export dti_iconphotox

"""
    dti_iconphotox(;kwargs...)

An IconPhotoX component.
...
"""
function dti_iconphotox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotox", "IconPhotoX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
