...
export dti_iconbikeoff

"""
    dti_iconbikeoff(;kwargs...)

An IconBikeOff component.
...
"""
function dti_iconbikeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbikeoff", "IconBikeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
