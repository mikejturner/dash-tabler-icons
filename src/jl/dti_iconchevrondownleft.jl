...
export dti_iconchevrondownleft

"""
    dti_iconchevrondownleft(;kwargs...)

An IconChevronDownLeft component.
...
"""
function dti_iconchevrondownleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevrondownleft", "IconChevronDownLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
