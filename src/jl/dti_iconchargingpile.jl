...
export dti_iconchargingpile

"""
    dti_iconchargingpile(;kwargs...)

An IconChargingPile component.
...
"""
function dti_iconchargingpile(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchargingpile", "IconChargingPile", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
