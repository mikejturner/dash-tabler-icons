...
export dti_iconsquareletterd

"""
    dti_iconsquareletterd(;kwargs...)

An IconSquareLetterD component.
...
"""
function dti_iconsquareletterd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterd", "IconSquareLetterD", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
