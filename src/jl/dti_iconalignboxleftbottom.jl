...
export dti_iconalignboxleftbottom

"""
    dti_iconalignboxleftbottom(;kwargs...)

An IconAlignBoxLeftBottom component.
...
"""
function dti_iconalignboxleftbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxleftbottom", "IconAlignBoxLeftBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
