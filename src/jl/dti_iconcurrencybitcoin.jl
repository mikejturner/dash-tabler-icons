...
export dti_iconcurrencybitcoin

"""
    dti_iconcurrencybitcoin(;kwargs...)

An IconCurrencyBitcoin component.
...
"""
function dti_iconcurrencybitcoin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencybitcoin", "IconCurrencyBitcoin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
