...
export dti_iconsquaref0

"""
    dti_iconsquaref0(;kwargs...)

An IconSquareF0 component.
...
"""
function dti_iconsquaref0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref0", "IconSquareF0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
