...
export dti_icondirections

"""
    dti_icondirections(;kwargs...)

An IconDirections component.
...
"""
function dti_icondirections(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondirections", "IconDirections", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
