...
export dti_iconcurrencyhryvnia

"""
    dti_iconcurrencyhryvnia(;kwargs...)

An IconCurrencyHryvnia component.
...
"""
function dti_iconcurrencyhryvnia(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyhryvnia", "IconCurrencyHryvnia", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
