...
export dti_iconarrowsup

"""
    dti_iconarrowsup(;kwargs...)

An IconArrowsUp component.
...
"""
function dti_iconarrowsup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsup", "IconArrowsUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
