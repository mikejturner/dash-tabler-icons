...
export dti_iconbadge4k

"""
    dti_iconbadge4k(;kwargs...)

An IconBadge4k component.
...
"""
function dti_iconbadge4k(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadge4k", "IconBadge4k", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
