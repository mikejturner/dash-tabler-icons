...
export dti_iconheart

"""
    dti_iconheart(;kwargs...)

An IconHeart component.
...
"""
function dti_iconheart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheart", "IconHeart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
