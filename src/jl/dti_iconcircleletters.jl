...
export dti_iconcircleletters

"""
    dti_iconcircleletters(;kwargs...)

An IconCircleLetterS component.
...
"""
function dti_iconcircleletters(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletters", "IconCircleLetterS", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
