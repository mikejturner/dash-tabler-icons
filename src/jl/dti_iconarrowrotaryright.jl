...
export dti_iconarrowrotaryright

"""
    dti_iconarrowrotaryright(;kwargs...)

An IconArrowRotaryRight component.
...
"""
function dti_iconarrowrotaryright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotaryright", "IconArrowRotaryRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
