...
export dti_iconcross

"""
    dti_iconcross(;kwargs...)

An IconCross component.
...
"""
function dti_iconcross(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcross", "IconCross", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
