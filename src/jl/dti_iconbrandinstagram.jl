...
export dti_iconbrandinstagram

"""
    dti_iconbrandinstagram(;kwargs...)

An IconBrandInstagram component.
...
"""
function dti_iconbrandinstagram(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandinstagram", "IconBrandInstagram", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
