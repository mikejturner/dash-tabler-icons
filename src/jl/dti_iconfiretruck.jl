...
export dti_iconfiretruck

"""
    dti_iconfiretruck(;kwargs...)

An IconFiretruck component.
...
"""
function dti_iconfiretruck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiretruck", "IconFiretruck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
