...
export dti_iconcurrencyrupee

"""
    dti_iconcurrencyrupee(;kwargs...)

An IconCurrencyRupee component.
...
"""
function dti_iconcurrencyrupee(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyrupee", "IconCurrencyRupee", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
