...
export dti_iconhexagonletterx

"""
    dti_iconhexagonletterx(;kwargs...)

An IconHexagonLetterX component.
...
"""
function dti_iconhexagonletterx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterx", "IconHexagonLetterX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
