...
export dti_icontrack

"""
    dti_icontrack(;kwargs...)

An IconTrack component.
...
"""
function dti_icontrack(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrack", "IconTrack", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
