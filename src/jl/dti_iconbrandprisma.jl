...
export dti_iconbrandprisma

"""
    dti_iconbrandprisma(;kwargs...)

An IconBrandPrisma component.
...
"""
function dti_iconbrandprisma(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandprisma", "IconBrandPrisma", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
