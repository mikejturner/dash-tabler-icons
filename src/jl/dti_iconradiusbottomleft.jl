...
export dti_iconradiusbottomleft

"""
    dti_iconradiusbottomleft(;kwargs...)

An IconRadiusBottomLeft component.
...
"""
function dti_iconradiusbottomleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradiusbottomleft", "IconRadiusBottomLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
