...
export dti_icondiscount

"""
    dti_icondiscount(;kwargs...)

An IconDiscount component.
...
"""
function dti_icondiscount(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiscount", "IconDiscount", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
