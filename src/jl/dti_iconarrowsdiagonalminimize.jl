...
export dti_iconarrowsdiagonalminimize

"""
    dti_iconarrowsdiagonalminimize(;kwargs...)

An IconArrowsDiagonalMinimize component.
...
"""
function dti_iconarrowsdiagonalminimize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdiagonalminimize", "IconArrowsDiagonalMinimize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
