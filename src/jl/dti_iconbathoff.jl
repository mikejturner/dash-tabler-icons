...
export dti_iconbathoff

"""
    dti_iconbathoff(;kwargs...)

An IconBathOff component.
...
"""
function dti_iconbathoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbathoff", "IconBathOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
