...
export dti_iconcharttreemap

"""
    dti_iconcharttreemap(;kwargs...)

An IconChartTreemap component.
...
"""
function dti_iconcharttreemap(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcharttreemap", "IconChartTreemap", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
