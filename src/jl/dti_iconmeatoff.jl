...
export dti_iconmeatoff

"""
    dti_iconmeatoff(;kwargs...)

An IconMeatOff component.
...
"""
function dti_iconmeatoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmeatoff", "IconMeatOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
