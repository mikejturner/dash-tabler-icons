...
export dti_iconbrandnuxt

"""
    dti_iconbrandnuxt(;kwargs...)

An IconBrandNuxt component.
...
"""
function dti_iconbrandnuxt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnuxt", "IconBrandNuxt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
