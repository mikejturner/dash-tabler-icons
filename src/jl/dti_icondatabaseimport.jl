...
export dti_icondatabaseimport

"""
    dti_icondatabaseimport(;kwargs...)

An IconDatabaseImport component.
...
"""
function dti_icondatabaseimport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondatabaseimport", "IconDatabaseImport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
