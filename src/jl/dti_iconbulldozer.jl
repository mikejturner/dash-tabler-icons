...
export dti_iconbulldozer

"""
    dti_iconbulldozer(;kwargs...)

An IconBulldozer component.
...
"""
function dti_iconbulldozer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbulldozer", "IconBulldozer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
