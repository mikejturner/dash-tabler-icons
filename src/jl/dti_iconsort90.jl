...
export dti_iconsort90

"""
    dti_iconsort90(;kwargs...)

An IconSort90 component.
...
"""
function dti_iconsort90(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsort90", "IconSort90", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
