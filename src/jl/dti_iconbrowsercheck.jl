...
export dti_iconbrowsercheck

"""
    dti_iconbrowsercheck(;kwargs...)

An IconBrowserCheck component.
...
"""
function dti_iconbrowsercheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrowsercheck", "IconBrowserCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
