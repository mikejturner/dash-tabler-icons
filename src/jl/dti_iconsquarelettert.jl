...
export dti_iconsquarelettert

"""
    dti_iconsquarelettert(;kwargs...)

An IconSquareLetterT component.
...
"""
function dti_iconsquarelettert(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarelettert", "IconSquareLetterT", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
