...
export dti_iconarrowsmove

"""
    dti_iconarrowsmove(;kwargs...)

An IconArrowsMove component.
...
"""
function dti_iconarrowsmove(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsmove", "IconArrowsMove", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
