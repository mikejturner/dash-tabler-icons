...
export dti_iconmoodlookleft

"""
    dti_iconmoodlookleft(;kwargs...)

An IconMoodLookLeft component.
...
"""
function dti_iconmoodlookleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodlookleft", "IconMoodLookLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
