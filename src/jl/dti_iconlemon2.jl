...
export dti_iconlemon2

"""
    dti_iconlemon2(;kwargs...)

An IconLemon2 component.
...
"""
function dti_iconlemon2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlemon2", "IconLemon2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
