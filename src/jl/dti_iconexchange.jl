...
export dti_iconexchange

"""
    dti_iconexchange(;kwargs...)

An IconExchange component.
...
"""
function dti_iconexchange(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexchange", "IconExchange", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
