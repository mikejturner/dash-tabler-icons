...
export dti_iconbadgevr

"""
    dti_iconbadgevr(;kwargs...)

An IconBadgeVr component.
...
"""
function dti_iconbadgevr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgevr", "IconBadgeVr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
