...
export dti_iconarrowsharpturnleft

"""
    dti_iconarrowsharpturnleft(;kwargs...)

An IconArrowSharpTurnLeft component.
...
"""
function dti_iconarrowsharpturnleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsharpturnleft", "IconArrowSharpTurnLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
