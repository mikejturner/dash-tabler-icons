...
export dti_iconplayertrackprev

"""
    dti_iconplayertrackprev(;kwargs...)

An IconPlayerTrackPrev component.
...
"""
function dti_iconplayertrackprev(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayertrackprev", "IconPlayerTrackPrev", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
