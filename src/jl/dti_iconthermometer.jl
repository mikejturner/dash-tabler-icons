...
export dti_iconthermometer

"""
    dti_iconthermometer(;kwargs...)

An IconThermometer component.
...
"""
function dti_iconthermometer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconthermometer", "IconThermometer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
