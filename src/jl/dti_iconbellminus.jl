...
export dti_iconbellminus

"""
    dti_iconbellminus(;kwargs...)

An IconBellMinus component.
...
"""
function dti_iconbellminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellminus", "IconBellMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
