...
export dti_iconregistered

"""
    dti_iconregistered(;kwargs...)

An IconRegistered component.
...
"""
function dti_iconregistered(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconregistered", "IconRegistered", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
