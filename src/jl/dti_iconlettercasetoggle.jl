...
export dti_iconlettercasetoggle

"""
    dti_iconlettercasetoggle(;kwargs...)

An IconLetterCaseToggle component.
...
"""
function dti_iconlettercasetoggle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlettercasetoggle", "IconLetterCaseToggle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
