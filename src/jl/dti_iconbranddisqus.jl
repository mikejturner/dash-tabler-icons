...
export dti_iconbranddisqus

"""
    dti_iconbranddisqus(;kwargs...)

An IconBrandDisqus component.
...
"""
function dti_iconbranddisqus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddisqus", "IconBrandDisqus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
