...
export dti_iconclockhour4

"""
    dti_iconclockhour4(;kwargs...)

An IconClockHour4 component.
...
"""
function dti_iconclockhour4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour4", "IconClockHour4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
