...
export dti_iconmath1divide2

"""
    dti_iconmath1divide2(;kwargs...)

An IconMath1Divide2 component.
...
"""
function dti_iconmath1divide2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmath1divide2", "IconMath1Divide2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
