...
export dti_iconcurrencyrubel

"""
    dti_iconcurrencyrubel(;kwargs...)

An IconCurrencyRubel component.
...
"""
function dti_iconcurrencyrubel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyrubel", "IconCurrencyRubel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
