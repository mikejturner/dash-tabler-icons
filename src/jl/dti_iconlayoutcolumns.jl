...
export dti_iconlayoutcolumns

"""
    dti_iconlayoutcolumns(;kwargs...)

An IconLayoutColumns component.
...
"""
function dti_iconlayoutcolumns(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutcolumns", "IconLayoutColumns", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
