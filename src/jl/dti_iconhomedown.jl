...
export dti_iconhomedown

"""
    dti_iconhomedown(;kwargs...)

An IconHomeDown component.
...
"""
function dti_iconhomedown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomedown", "IconHomeDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
