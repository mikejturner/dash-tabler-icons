...
export dti_iconlayersoff

"""
    dti_iconlayersoff(;kwargs...)

An IconLayersOff component.
...
"""
function dti_iconlayersoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayersoff", "IconLayersOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
