...
export dti_icondownload

"""
    dti_icondownload(;kwargs...)

An IconDownload component.
...
"""
function dti_icondownload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondownload", "IconDownload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
