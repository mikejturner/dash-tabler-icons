...
export dti_iconbugoff

"""
    dti_iconbugoff(;kwargs...)

An IconBugOff component.
...
"""
function dti_iconbugoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbugoff", "IconBugOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
