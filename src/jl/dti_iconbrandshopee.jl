...
export dti_iconbrandshopee

"""
    dti_iconbrandshopee(;kwargs...)

An IconBrandShopee component.
...
"""
function dti_iconbrandshopee(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandshopee", "IconBrandShopee", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
