...
export dti_iconmailboxoff

"""
    dti_iconmailboxoff(;kwargs...)

An IconMailboxOff component.
...
"""
function dti_iconmailboxoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmailboxoff", "IconMailboxOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
