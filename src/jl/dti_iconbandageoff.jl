...
export dti_iconbandageoff

"""
    dti_iconbandageoff(;kwargs...)

An IconBandageOff component.
...
"""
function dti_iconbandageoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbandageoff", "IconBandageOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
