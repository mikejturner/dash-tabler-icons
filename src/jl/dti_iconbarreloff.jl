...
export dti_iconbarreloff

"""
    dti_iconbarreloff(;kwargs...)

An IconBarrelOff component.
...
"""
function dti_iconbarreloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarreloff", "IconBarrelOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
