...
export dti_iconbrandokru

"""
    dti_iconbrandokru(;kwargs...)

An IconBrandOkRu component.
...
"""
function dti_iconbrandokru(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandokru", "IconBrandOkRu", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
