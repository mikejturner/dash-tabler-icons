...
export dti_iconvideooff

"""
    dti_iconvideooff(;kwargs...)

An IconVideoOff component.
...
"""
function dti_iconvideooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvideooff", "IconVideoOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
