...
export dti_iconmessageplus

"""
    dti_iconmessageplus(;kwargs...)

An IconMessagePlus component.
...
"""
function dti_iconmessageplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessageplus", "IconMessagePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
