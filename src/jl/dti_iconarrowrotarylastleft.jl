...
export dti_iconarrowrotarylastleft

"""
    dti_iconarrowrotarylastleft(;kwargs...)

An IconArrowRotaryLastLeft component.
...
"""
function dti_iconarrowrotarylastleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotarylastleft", "IconArrowRotaryLastLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
