...
export dti_iconsocialoff

"""
    dti_iconsocialoff(;kwargs...)

An IconSocialOff component.
...
"""
function dti_iconsocialoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsocialoff", "IconSocialOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
