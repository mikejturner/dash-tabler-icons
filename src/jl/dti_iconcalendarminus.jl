...
export dti_iconcalendarminus

"""
    dti_iconcalendarminus(;kwargs...)

An IconCalendarMinus component.
...
"""
function dti_iconcalendarminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendarminus", "IconCalendarMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
