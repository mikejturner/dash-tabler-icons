...
export dti_iconplayerrecord

"""
    dti_iconplayerrecord(;kwargs...)

An IconPlayerRecord component.
...
"""
function dti_iconplayerrecord(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayerrecord", "IconPlayerRecord", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
