...
export dti_iconmessage2

"""
    dti_iconmessage2(;kwargs...)

An IconMessage2 component.
...
"""
function dti_iconmessage2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessage2", "IconMessage2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
