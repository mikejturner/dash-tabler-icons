...
export dti_iconbrandcss3

"""
    dti_iconbrandcss3(;kwargs...)

An IconBrandCss3 component.
...
"""
function dti_iconbrandcss3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcss3", "IconBrandCss3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
