...
export dti_iconsquarelettero

"""
    dti_iconsquarelettero(;kwargs...)

An IconSquareLetterO component.
...
"""
function dti_iconsquarelettero(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarelettero", "IconSquareLetterO", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
