...
export dti_iconchefhat

"""
    dti_iconchefhat(;kwargs...)

An IconChefHat component.
...
"""
function dti_iconchefhat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchefhat", "IconChefHat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
