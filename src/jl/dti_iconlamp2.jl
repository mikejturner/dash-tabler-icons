...
export dti_iconlamp2

"""
    dti_iconlamp2(;kwargs...)

An IconLamp2 component.
...
"""
function dti_iconlamp2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlamp2", "IconLamp2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
