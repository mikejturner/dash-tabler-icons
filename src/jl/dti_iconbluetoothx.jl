...
export dti_iconbluetoothx

"""
    dti_iconbluetoothx(;kwargs...)

An IconBluetoothX component.
...
"""
function dti_iconbluetoothx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbluetoothx", "IconBluetoothX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
