...
export dti_iconcircuitcell

"""
    dti_iconcircuitcell(;kwargs...)

An IconCircuitCell component.
...
"""
function dti_iconcircuitcell(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitcell", "IconCircuitCell", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
