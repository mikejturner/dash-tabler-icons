...
export dti_iconcurrencyzloty

"""
    dti_iconcurrencyzloty(;kwargs...)

An IconCurrencyZloty component.
...
"""
function dti_iconcurrencyzloty(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyzloty", "IconCurrencyZloty", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
