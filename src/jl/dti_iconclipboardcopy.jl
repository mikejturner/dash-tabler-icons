...
export dti_iconclipboardcopy

"""
    dti_iconclipboardcopy(;kwargs...)

An IconClipboardCopy component.
...
"""
function dti_iconclipboardcopy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardcopy", "IconClipboardCopy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
