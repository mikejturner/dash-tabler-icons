...
export dti_iconschool

"""
    dti_iconschool(;kwargs...)

An IconSchool component.
...
"""
function dti_iconschool(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconschool", "IconSchool", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
