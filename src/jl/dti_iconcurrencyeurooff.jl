...
export dti_iconcurrencyeurooff

"""
    dti_iconcurrencyeurooff(;kwargs...)

An IconCurrencyEuroOff component.
...
"""
function dti_iconcurrencyeurooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyeurooff", "IconCurrencyEuroOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
