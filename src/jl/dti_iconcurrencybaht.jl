...
export dti_iconcurrencybaht

"""
    dti_iconcurrencybaht(;kwargs...)

An IconCurrencyBaht component.
...
"""
function dti_iconcurrencybaht(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencybaht", "IconCurrencyBaht", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
