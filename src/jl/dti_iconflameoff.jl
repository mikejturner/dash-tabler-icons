...
export dti_iconflameoff

"""
    dti_iconflameoff(;kwargs...)

An IconFlameOff component.
...
"""
function dti_iconflameoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflameoff", "IconFlameOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
