...
export dti_iconsturnup

"""
    dti_iconsturnup(;kwargs...)

An IconSTurnUp component.
...
"""
function dti_iconsturnup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsturnup", "IconSTurnUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
