...
export dti_iconvectorbezier2

"""
    dti_iconvectorbezier2(;kwargs...)

An IconVectorBezier2 component.
...
"""
function dti_iconvectorbezier2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectorbezier2", "IconVectorBezier2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
