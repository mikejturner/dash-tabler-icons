...
export dti_iconmoodsmiledizzy

"""
    dti_iconmoodsmiledizzy(;kwargs...)

An IconMoodSmileDizzy component.
...
"""
function dti_iconmoodsmiledizzy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsmiledizzy", "IconMoodSmileDizzy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
