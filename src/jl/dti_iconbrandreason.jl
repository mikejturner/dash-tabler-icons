...
export dti_iconbrandreason

"""
    dti_iconbrandreason(;kwargs...)

An IconBrandReason component.
...
"""
function dti_iconbrandreason(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandreason", "IconBrandReason", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
