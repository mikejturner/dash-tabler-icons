...
export dti_iconatoff

"""
    dti_iconatoff(;kwargs...)

An IconAtOff component.
...
"""
function dti_iconatoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconatoff", "IconAtOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
