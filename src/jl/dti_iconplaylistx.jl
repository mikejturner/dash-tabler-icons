...
export dti_iconplaylistx

"""
    dti_iconplaylistx(;kwargs...)

An IconPlaylistX component.
...
"""
function dti_iconplaylistx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaylistx", "IconPlaylistX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
