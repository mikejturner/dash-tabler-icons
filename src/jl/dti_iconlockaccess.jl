...
export dti_iconlockaccess

"""
    dti_iconlockaccess(;kwargs...)

An IconLockAccess component.
...
"""
function dti_iconlockaccess(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlockaccess", "IconLockAccess", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
