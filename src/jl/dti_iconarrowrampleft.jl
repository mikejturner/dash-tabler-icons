...
export dti_iconarrowrampleft

"""
    dti_iconarrowrampleft(;kwargs...)

An IconArrowRampLeft component.
...
"""
function dti_iconarrowrampleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrampleft", "IconArrowRampLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
