...
export dti_iconsubtask

"""
    dti_iconsubtask(;kwargs...)

An IconSubtask component.
...
"""
function dti_iconsubtask(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsubtask", "IconSubtask", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
