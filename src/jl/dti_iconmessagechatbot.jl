...
export dti_iconmessagechatbot

"""
    dti_iconmessagechatbot(;kwargs...)

An IconMessageChatbot component.
...
"""
function dti_iconmessagechatbot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagechatbot", "IconMessageChatbot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
