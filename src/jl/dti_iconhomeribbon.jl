...
export dti_iconhomeribbon

"""
    dti_iconhomeribbon(;kwargs...)

An IconHomeRibbon component.
...
"""
function dti_iconhomeribbon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeribbon", "IconHomeRibbon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
