...
export dti_iconbrandopenvpn

"""
    dti_iconbrandopenvpn(;kwargs...)

An IconBrandOpenvpn component.
...
"""
function dti_iconbrandopenvpn(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandopenvpn", "IconBrandOpenvpn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
