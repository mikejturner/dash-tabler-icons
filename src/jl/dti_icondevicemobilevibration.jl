...
export dti_icondevicemobilevibration

"""
    dti_icondevicemobilevibration(;kwargs...)

An IconDeviceMobileVibration component.
...
"""
function dti_icondevicemobilevibration(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicemobilevibration", "IconDeviceMobileVibration", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
