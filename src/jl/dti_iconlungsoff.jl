...
export dti_iconlungsoff

"""
    dti_iconlungsoff(;kwargs...)

An IconLungsOff component.
...
"""
function dti_iconlungsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlungsoff", "IconLungsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
