...
export dti_iconmathxminusx

"""
    dti_iconmathxminusx(;kwargs...)

An IconMathXMinusX component.
...
"""
function dti_iconmathxminusx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxminusx", "IconMathXMinusX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
