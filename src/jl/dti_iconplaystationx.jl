...
export dti_iconplaystationx

"""
    dti_iconplaystationx(;kwargs...)

An IconPlaystationX component.
...
"""
function dti_iconplaystationx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaystationx", "IconPlaystationX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
