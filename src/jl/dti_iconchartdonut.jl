...
export dti_iconchartdonut

"""
    dti_iconchartdonut(;kwargs...)

An IconChartDonut component.
...
"""
function dti_iconchartdonut(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdonut", "IconChartDonut", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
