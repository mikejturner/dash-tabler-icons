...
export dti_iconnetwork

"""
    dti_iconnetwork(;kwargs...)

An IconNetwork component.
...
"""
function dti_iconnetwork(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnetwork", "IconNetwork", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
