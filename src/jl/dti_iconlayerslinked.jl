...
export dti_iconlayerslinked

"""
    dti_iconlayerslinked(;kwargs...)

An IconLayersLinked component.
...
"""
function dti_iconlayerslinked(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayerslinked", "IconLayersLinked", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
