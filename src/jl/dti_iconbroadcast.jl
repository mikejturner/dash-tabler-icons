...
export dti_iconbroadcast

"""
    dti_iconbroadcast(;kwargs...)

An IconBroadcast component.
...
"""
function dti_iconbroadcast(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbroadcast", "IconBroadcast", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
