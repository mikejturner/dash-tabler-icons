...
export dti_icondentaloff

"""
    dti_icondentaloff(;kwargs...)

An IconDentalOff component.
...
"""
function dti_icondentaloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondentaloff", "IconDentalOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
