...
export dti_iconbrandbadoo

"""
    dti_iconbrandbadoo(;kwargs...)

An IconBrandBadoo component.
...
"""
function dti_iconbrandbadoo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbadoo", "IconBrandBadoo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
