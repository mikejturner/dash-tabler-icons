...
export dti_iconforbid

"""
    dti_iconforbid(;kwargs...)

An IconForbid component.
...
"""
function dti_iconforbid(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconforbid", "IconForbid", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
