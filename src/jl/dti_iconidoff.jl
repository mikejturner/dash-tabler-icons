...
export dti_iconidoff

"""
    dti_iconidoff(;kwargs...)

An IconIdOff component.
...
"""
function dti_iconidoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconidoff", "IconIdOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
