...
export dti_iconshoppingcart

"""
    dti_iconshoppingcart(;kwargs...)

An IconShoppingCart component.
...
"""
function dti_iconshoppingcart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshoppingcart", "IconShoppingCart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
