...
export dti_icontrashoff

"""
    dti_icontrashoff(;kwargs...)

An IconTrashOff component.
...
"""
function dti_icontrashoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrashoff", "IconTrashOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
