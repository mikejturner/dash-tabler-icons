...
export dti_iconironingoff

"""
    dti_iconironingoff(;kwargs...)

An IconIroningOff component.
...
"""
function dti_iconironingoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconironingoff", "IconIroningOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
