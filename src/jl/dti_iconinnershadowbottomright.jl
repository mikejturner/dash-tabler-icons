...
export dti_iconinnershadowbottomright

"""
    dti_iconinnershadowbottomright(;kwargs...)

An IconInnerShadowBottomRight component.
...
"""
function dti_iconinnershadowbottomright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowbottomright", "IconInnerShadowBottomRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
