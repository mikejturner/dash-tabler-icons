...
export dti_iconlanguage

"""
    dti_iconlanguage(;kwargs...)

An IconLanguage component.
...
"""
function dti_iconlanguage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlanguage", "IconLanguage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
