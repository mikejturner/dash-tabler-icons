...
export dti_iconcornerrightupdouble

"""
    dti_iconcornerrightupdouble(;kwargs...)

An IconCornerRightUpDouble component.
...
"""
function dti_iconcornerrightupdouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerrightupdouble", "IconCornerRightUpDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
