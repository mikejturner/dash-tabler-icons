...
export dti_iconpremiumrights

"""
    dti_iconpremiumrights(;kwargs...)

An IconPremiumRights component.
...
"""
function dti_iconpremiumrights(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpremiumrights", "IconPremiumRights", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
