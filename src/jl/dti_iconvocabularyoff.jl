...
export dti_iconvocabularyoff

"""
    dti_iconvocabularyoff(;kwargs...)

An IconVocabularyOff component.
...
"""
function dti_iconvocabularyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvocabularyoff", "IconVocabularyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
