...
export dti_iconarrowrotarylastright

"""
    dti_iconarrowrotarylastright(;kwargs...)

An IconArrowRotaryLastRight component.
...
"""
function dti_iconarrowrotarylastright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotarylastright", "IconArrowRotaryLastRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
