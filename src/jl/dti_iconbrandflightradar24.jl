...
export dti_iconbrandflightradar24

"""
    dti_iconbrandflightradar24(;kwargs...)

An IconBrandFlightradar24 component.
...
"""
function dti_iconbrandflightradar24(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandflightradar24", "IconBrandFlightradar24", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
