...
export dti_iconbutterfly

"""
    dti_iconbutterfly(;kwargs...)

An IconButterfly component.
...
"""
function dti_iconbutterfly(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbutterfly", "IconButterfly", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
