...
export dti_iconarmchair2

"""
    dti_iconarmchair2(;kwargs...)

An IconArmchair2 component.
...
"""
function dti_iconarmchair2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarmchair2", "IconArmchair2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
