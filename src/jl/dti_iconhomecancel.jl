...
export dti_iconhomecancel

"""
    dti_iconhomecancel(;kwargs...)

An IconHomeCancel component.
...
"""
function dti_iconhomecancel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomecancel", "IconHomeCancel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
