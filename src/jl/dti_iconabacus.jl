...
export dti_iconabacus

"""
    dti_iconabacus(;kwargs...)

An IconAbacus component.
...
"""
function dti_iconabacus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconabacus", "IconAbacus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
