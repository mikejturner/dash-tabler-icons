...
export dti_iconhomedot

"""
    dti_iconhomedot(;kwargs...)

An IconHomeDot component.
...
"""
function dti_iconhomedot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomedot", "IconHomeDot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
