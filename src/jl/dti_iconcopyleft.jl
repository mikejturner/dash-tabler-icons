...
export dti_iconcopyleft

"""
    dti_iconcopyleft(;kwargs...)

An IconCopyleft component.
...
"""
function dti_iconcopyleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcopyleft", "IconCopyleft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
