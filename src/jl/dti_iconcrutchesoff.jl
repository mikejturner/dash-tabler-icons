...
export dti_iconcrutchesoff

"""
    dti_iconcrutchesoff(;kwargs...)

An IconCrutchesOff component.
...
"""
function dti_iconcrutchesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrutchesoff", "IconCrutchesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
