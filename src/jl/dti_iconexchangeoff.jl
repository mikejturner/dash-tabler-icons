...
export dti_iconexchangeoff

"""
    dti_iconexchangeoff(;kwargs...)

An IconExchangeOff component.
...
"""
function dti_iconexchangeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexchangeoff", "IconExchangeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
