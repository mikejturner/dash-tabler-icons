...
export dti_iconbattery3

"""
    dti_iconbattery3(;kwargs...)

An IconBattery3 component.
...
"""
function dti_iconbattery3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbattery3", "IconBattery3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
