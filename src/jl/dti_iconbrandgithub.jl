...
export dti_iconbrandgithub

"""
    dti_iconbrandgithub(;kwargs...)

An IconBrandGithub component.
...
"""
function dti_iconbrandgithub(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgithub", "IconBrandGithub", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
