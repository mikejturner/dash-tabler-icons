...
export dti_iconhelmet

"""
    dti_iconhelmet(;kwargs...)

An IconHelmet component.
...
"""
function dti_iconhelmet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhelmet", "IconHelmet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
