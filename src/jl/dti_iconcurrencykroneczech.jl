...
export dti_iconcurrencykroneczech

"""
    dti_iconcurrencykroneczech(;kwargs...)

An IconCurrencyKroneCzech component.
...
"""
function dti_iconcurrencykroneczech(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencykroneczech", "IconCurrencyKroneCzech", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
