...
export dti_iconcircle

"""
    dti_iconcircle(;kwargs...)

An IconCircle component.
...
"""
function dti_iconcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircle", "IconCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
