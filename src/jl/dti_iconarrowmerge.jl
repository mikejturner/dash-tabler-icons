...
export dti_iconarrowmerge

"""
    dti_iconarrowmerge(;kwargs...)

An IconArrowMerge component.
...
"""
function dti_iconarrowmerge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmerge", "IconArrowMerge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
