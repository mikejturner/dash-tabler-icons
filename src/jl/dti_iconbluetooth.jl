...
export dti_iconbluetooth

"""
    dti_iconbluetooth(;kwargs...)

An IconBluetooth component.
...
"""
function dti_iconbluetooth(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbluetooth", "IconBluetooth", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
