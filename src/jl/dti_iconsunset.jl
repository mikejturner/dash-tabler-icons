...
export dti_iconsunset

"""
    dti_iconsunset(;kwargs...)

An IconSunset component.
...
"""
function dti_iconsunset(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunset", "IconSunset", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
