...
export dti_iconfilefunction

"""
    dti_iconfilefunction(;kwargs...)

An IconFileFunction component.
...
"""
function dti_iconfilefunction(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilefunction", "IconFileFunction", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
