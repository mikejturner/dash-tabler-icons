...
export dti_icongridpattern

"""
    dti_icongridpattern(;kwargs...)

An IconGridPattern component.
...
"""
function dti_icongridpattern(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongridpattern", "IconGridPattern", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
