...
export dti_iconclock

"""
    dti_iconclock(;kwargs...)

An IconClock component.
...
"""
function dti_iconclock(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclock", "IconClock", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
