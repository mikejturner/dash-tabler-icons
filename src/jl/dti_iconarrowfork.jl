...
export dti_iconarrowfork

"""
    dti_iconarrowfork(;kwargs...)

An IconArrowFork component.
...
"""
function dti_iconarrowfork(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowfork", "IconArrowFork", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
