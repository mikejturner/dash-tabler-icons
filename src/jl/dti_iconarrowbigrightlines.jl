...
export dti_iconarrowbigrightlines

"""
    dti_iconarrowbigrightlines(;kwargs...)

An IconArrowBigRightLines component.
...
"""
function dti_iconarrowbigrightlines(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigrightlines", "IconArrowBigRightLines", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
