...
export dti_iconarticle

"""
    dti_iconarticle(;kwargs...)

An IconArticle component.
...
"""
function dti_iconarticle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarticle", "IconArticle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
