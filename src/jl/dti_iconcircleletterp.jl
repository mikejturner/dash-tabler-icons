...
export dti_iconcircleletterp

"""
    dti_iconcircleletterp(;kwargs...)

An IconCircleLetterP component.
...
"""
function dti_iconcircleletterp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterp", "IconCircleLetterP", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
