...
export dti_icontrowel

"""
    dti_icontrowel(;kwargs...)

An IconTrowel component.
...
"""
function dti_icontrowel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrowel", "IconTrowel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
