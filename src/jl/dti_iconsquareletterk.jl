...
export dti_iconsquareletterk

"""
    dti_iconsquareletterk(;kwargs...)

An IconSquareLetterK component.
...
"""
function dti_iconsquareletterk(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterk", "IconSquareLetterK", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
