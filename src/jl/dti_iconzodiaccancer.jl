...
export dti_iconzodiaccancer

"""
    dti_iconzodiaccancer(;kwargs...)

An IconZodiacCancer component.
...
"""
function dti_iconzodiaccancer(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiaccancer", "IconZodiacCancer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
