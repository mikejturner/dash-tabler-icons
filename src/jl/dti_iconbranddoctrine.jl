...
export dti_iconbranddoctrine

"""
    dti_iconbranddoctrine(;kwargs...)

An IconBrandDoctrine component.
...
"""
function dti_iconbranddoctrine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddoctrine", "IconBrandDoctrine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
