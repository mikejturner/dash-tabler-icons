...
export dti_iconnumbers

"""
    dti_iconnumbers(;kwargs...)

An IconNumbers component.
...
"""
function dti_iconnumbers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumbers", "IconNumbers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
