...
export dti_icongenderandrogyne

"""
    dti_icongenderandrogyne(;kwargs...)

An IconGenderAndrogyne component.
...
"""
function dti_icongenderandrogyne(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderandrogyne", "IconGenderAndrogyne", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
