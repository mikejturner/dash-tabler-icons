...
export dti_iconreportoff

"""
    dti_iconreportoff(;kwargs...)

An IconReportOff component.
...
"""
function dti_iconreportoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreportoff", "IconReportOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
