...
export dti_iconfileorientation

"""
    dti_iconfileorientation(;kwargs...)

An IconFileOrientation component.
...
"""
function dti_iconfileorientation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileorientation", "IconFileOrientation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
