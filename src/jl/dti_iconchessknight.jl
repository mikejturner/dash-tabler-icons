...
export dti_iconchessknight

"""
    dti_iconchessknight(;kwargs...)

An IconChessKnight component.
...
"""
function dti_iconchessknight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchessknight", "IconChessKnight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
