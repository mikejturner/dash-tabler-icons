...
export dti_icontagsoff

"""
    dti_icontagsoff(;kwargs...)

An IconTagsOff component.
...
"""
function dti_icontagsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontagsoff", "IconTagsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
