...
export dti_iconsquaref9

"""
    dti_iconsquaref9(;kwargs...)

An IconSquareF9 component.
...
"""
function dti_iconsquaref9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref9", "IconSquareF9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
