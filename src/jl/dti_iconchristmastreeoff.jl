...
export dti_iconchristmastreeoff

"""
    dti_iconchristmastreeoff(;kwargs...)

An IconChristmasTreeOff component.
...
"""
function dti_iconchristmastreeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchristmastreeoff", "IconChristmasTreeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
