...
export dti_icontagoff

"""
    dti_icontagoff(;kwargs...)

An IconTagOff component.
...
"""
function dti_icontagoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontagoff", "IconTagOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
