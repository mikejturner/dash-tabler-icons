...
export dti_iconviewfinder

"""
    dti_iconviewfinder(;kwargs...)

An IconViewfinder component.
...
"""
function dti_iconviewfinder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconviewfinder", "IconViewfinder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
