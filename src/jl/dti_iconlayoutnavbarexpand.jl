...
export dti_iconlayoutnavbarexpand

"""
    dti_iconlayoutnavbarexpand(;kwargs...)

An IconLayoutNavbarExpand component.
...
"""
function dti_iconlayoutnavbarexpand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutnavbarexpand", "IconLayoutNavbarExpand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
