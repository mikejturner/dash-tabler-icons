...
export dti_iconicons

"""
    dti_iconicons(;kwargs...)

An IconIcons component.
...
"""
function dti_iconicons(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconicons", "IconIcons", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
