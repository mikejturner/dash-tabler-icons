...
export dti_iconarrowbigdown

"""
    dti_iconarrowbigdown(;kwargs...)

An IconArrowBigDown component.
...
"""
function dti_iconarrowbigdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigdown", "IconArrowBigDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
