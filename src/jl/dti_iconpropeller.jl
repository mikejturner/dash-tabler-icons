...
export dti_iconpropeller

"""
    dti_iconpropeller(;kwargs...)

An IconPropeller component.
...
"""
function dti_iconpropeller(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpropeller", "IconPropeller", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
