...
export dti_iconfilelike

"""
    dti_iconfilelike(;kwargs...)

An IconFileLike component.
...
"""
function dti_iconfilelike(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilelike", "IconFileLike", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
