...
export dti_iconmessagecircle

"""
    dti_iconmessagecircle(;kwargs...)

An IconMessageCircle component.
...
"""
function dti_iconmessagecircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagecircle", "IconMessageCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
