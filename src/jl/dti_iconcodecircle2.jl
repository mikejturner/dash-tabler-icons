...
export dti_iconcodecircle2

"""
    dti_iconcodecircle2(;kwargs...)

An IconCodeCircle2 component.
...
"""
function dti_iconcodecircle2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcodecircle2", "IconCodeCircle2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
