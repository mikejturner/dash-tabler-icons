...
export dti_icontrademark

"""
    dti_icontrademark(;kwargs...)

An IconTrademark component.
...
"""
function dti_icontrademark(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrademark", "IconTrademark", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
