...
export dti_iconroute

"""
    dti_iconroute(;kwargs...)

An IconRoute component.
...
"""
function dti_iconroute(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconroute", "IconRoute", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
