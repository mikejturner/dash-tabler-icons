...
export dti_iconthumbupoff

"""
    dti_iconthumbupoff(;kwargs...)

An IconThumbUpOff component.
...
"""
function dti_iconthumbupoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconthumbupoff", "IconThumbUpOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
