...
export dti_iconcarturbine

"""
    dti_iconcarturbine(;kwargs...)

An IconCarTurbine component.
...
"""
function dti_iconcarturbine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcarturbine", "IconCarTurbine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
