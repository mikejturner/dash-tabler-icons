...
export dti_iconfolderoff

"""
    dti_iconfolderoff(;kwargs...)

An IconFolderOff component.
...
"""
function dti_iconfolderoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolderoff", "IconFolderOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
