...
export dti_iconinputsearch

"""
    dti_iconinputsearch(;kwargs...)

An IconInputSearch component.
...
"""
function dti_iconinputsearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinputsearch", "IconInputSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
