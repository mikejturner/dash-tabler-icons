...
export dti_iconarrowloopright2

"""
    dti_iconarrowloopright2(;kwargs...)

An IconArrowLoopRight2 component.
...
"""
function dti_iconarrowloopright2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowloopright2", "IconArrowLoopRight2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
