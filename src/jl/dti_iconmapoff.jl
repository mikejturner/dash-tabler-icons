...
export dti_iconmapoff

"""
    dti_iconmapoff(;kwargs...)

An IconMapOff component.
...
"""
function dti_iconmapoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmapoff", "IconMapOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
