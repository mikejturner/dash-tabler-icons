...
export dti_iconarrowbigtop

"""
    dti_iconarrowbigtop(;kwargs...)

An IconArrowBigTop component.
...
"""
function dti_iconarrowbigtop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigtop", "IconArrowBigTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
