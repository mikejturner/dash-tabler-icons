...
export dti_iconmappin

"""
    dti_iconmappin(;kwargs...)

An IconMapPin component.
...
"""
function dti_iconmappin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmappin", "IconMapPin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
