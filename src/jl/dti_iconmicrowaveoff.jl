...
export dti_iconmicrowaveoff

"""
    dti_iconmicrowaveoff(;kwargs...)

An IconMicrowaveOff component.
...
"""
function dti_iconmicrowaveoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicrowaveoff", "IconMicrowaveOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
