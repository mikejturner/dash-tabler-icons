...
export dti_iconcurrencywon

"""
    dti_iconcurrencywon(;kwargs...)

An IconCurrencyWon component.
...
"""
function dti_iconcurrencywon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencywon", "IconCurrencyWon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
