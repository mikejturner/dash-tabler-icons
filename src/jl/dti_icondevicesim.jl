...
export dti_icondevicesim

"""
    dti_icondevicesim(;kwargs...)

An IconDeviceSim component.
...
"""
function dti_icondevicesim(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicesim", "IconDeviceSim", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
