...
export dti_icongaugeoff

"""
    dti_icongaugeoff(;kwargs...)

An IconGaugeOff component.
...
"""
function dti_icongaugeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongaugeoff", "IconGaugeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
