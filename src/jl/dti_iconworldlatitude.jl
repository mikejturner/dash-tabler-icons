...
export dti_iconworldlatitude

"""
    dti_iconworldlatitude(;kwargs...)

An IconWorldLatitude component.
...
"""
function dti_iconworldlatitude(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworldlatitude", "IconWorldLatitude", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
