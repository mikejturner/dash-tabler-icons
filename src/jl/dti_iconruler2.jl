...
export dti_iconruler2

"""
    dti_iconruler2(;kwargs...)

An IconRuler2 component.
...
"""
function dti_iconruler2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconruler2", "IconRuler2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
