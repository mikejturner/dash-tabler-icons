...
export dti_icondetails

"""
    dti_icondetails(;kwargs...)

An IconDetails component.
...
"""
function dti_icondetails(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondetails", "IconDetails", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
