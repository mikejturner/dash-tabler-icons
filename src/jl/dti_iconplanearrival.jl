...
export dti_iconplanearrival

"""
    dti_iconplanearrival(;kwargs...)

An IconPlaneArrival component.
...
"""
function dti_iconplanearrival(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplanearrival", "IconPlaneArrival", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
