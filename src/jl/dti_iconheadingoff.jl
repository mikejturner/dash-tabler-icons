...
export dti_iconheadingoff

"""
    dti_iconheadingoff(;kwargs...)

An IconHeadingOff component.
...
"""
function dti_iconheadingoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheadingoff", "IconHeadingOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
