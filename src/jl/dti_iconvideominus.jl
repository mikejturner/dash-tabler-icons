...
export dti_iconvideominus

"""
    dti_iconvideominus(;kwargs...)

An IconVideoMinus component.
...
"""
function dti_iconvideominus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvideominus", "IconVideoMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
