...
export dti_iconcurrencyriyal

"""
    dti_iconcurrencyriyal(;kwargs...)

An IconCurrencyRiyal component.
...
"""
function dti_iconcurrencyriyal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyriyal", "IconCurrencyRiyal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
