...
export dti_icontoolskitchen

"""
    dti_icontoolskitchen(;kwargs...)

An IconToolsKitchen component.
...
"""
function dti_icontoolskitchen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontoolskitchen", "IconToolsKitchen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
