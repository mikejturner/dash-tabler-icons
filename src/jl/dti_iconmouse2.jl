...
export dti_iconmouse2

"""
    dti_iconmouse2(;kwargs...)

An IconMouse2 component.
...
"""
function dti_iconmouse2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmouse2", "IconMouse2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
