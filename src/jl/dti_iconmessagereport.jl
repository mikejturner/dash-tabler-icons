...
export dti_iconmessagereport

"""
    dti_iconmessagereport(;kwargs...)

An IconMessageReport component.
...
"""
function dti_iconmessagereport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessagereport", "IconMessageReport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
