...
export dti_iconchevronsdown

"""
    dti_iconchevronsdown(;kwargs...)

An IconChevronsDown component.
...
"""
function dti_iconchevronsdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchevronsdown", "IconChevronsDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
