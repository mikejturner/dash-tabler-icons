...
export dti_icontallymark1

"""
    dti_icontallymark1(;kwargs...)

An IconTallymark1 component.
...
"""
function dti_icontallymark1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontallymark1", "IconTallymark1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
