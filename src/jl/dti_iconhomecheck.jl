...
export dti_iconhomecheck

"""
    dti_iconhomecheck(;kwargs...)

An IconHomeCheck component.
...
"""
function dti_iconhomecheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomecheck", "IconHomeCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
