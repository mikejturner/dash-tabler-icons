...
export dti_iconarrowsshuffle2

"""
    dti_iconarrowsshuffle2(;kwargs...)

An IconArrowsShuffle2 component.
...
"""
function dti_iconarrowsshuffle2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsshuffle2", "IconArrowsShuffle2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
