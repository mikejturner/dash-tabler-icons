...
export dti_icontemplateoff

"""
    dti_icontemplateoff(;kwargs...)

An IconTemplateOff component.
...
"""
function dti_icontemplateoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemplateoff", "IconTemplateOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
