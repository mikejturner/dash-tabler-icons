...
export dti_iconarrowbackup

"""
    dti_iconarrowbackup(;kwargs...)

An IconArrowBackUp component.
...
"""
function dti_iconarrowbackup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbackup", "IconArrowBackUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
