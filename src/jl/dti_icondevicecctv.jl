...
export dti_icondevicecctv

"""
    dti_icondevicecctv(;kwargs...)

An IconDeviceCctv component.
...
"""
function dti_icondevicecctv(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicecctv", "IconDeviceCctv", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
