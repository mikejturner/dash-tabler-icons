...
export dti_iconbook2

"""
    dti_iconbook2(;kwargs...)

An IconBook2 component.
...
"""
function dti_iconbook2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbook2", "IconBook2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
