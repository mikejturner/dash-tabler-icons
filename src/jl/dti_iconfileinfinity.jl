...
export dti_iconfileinfinity

"""
    dti_iconfileinfinity(;kwargs...)

An IconFileInfinity component.
...
"""
function dti_iconfileinfinity(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileinfinity", "IconFileInfinity", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
