...
export dti_iconmoodnerd

"""
    dti_iconmoodnerd(;kwargs...)

An IconMoodNerd component.
...
"""
function dti_iconmoodnerd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodnerd", "IconMoodNerd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
