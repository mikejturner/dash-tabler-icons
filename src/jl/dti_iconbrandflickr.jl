...
export dti_iconbrandflickr

"""
    dti_iconbrandflickr(;kwargs...)

An IconBrandFlickr component.
...
"""
function dti_iconbrandflickr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandflickr", "IconBrandFlickr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
