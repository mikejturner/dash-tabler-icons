...
export dti_iconmultiplier2x

"""
    dti_iconmultiplier2x(;kwargs...)

An IconMultiplier2x component.
...
"""
function dti_iconmultiplier2x(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmultiplier2x", "IconMultiplier2x", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
