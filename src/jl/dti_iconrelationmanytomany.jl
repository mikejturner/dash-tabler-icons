...
export dti_iconrelationmanytomany

"""
    dti_iconrelationmanytomany(;kwargs...)

An IconRelationManyToMany component.
...
"""
function dti_iconrelationmanytomany(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrelationmanytomany", "IconRelationManyToMany", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
