...
export dti_iconheartplus

"""
    dti_iconheartplus(;kwargs...)

An IconHeartPlus component.
...
"""
function dti_iconheartplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartplus", "IconHeartPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
