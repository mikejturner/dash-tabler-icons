...
export dti_iconmoodsad

"""
    dti_iconmoodsad(;kwargs...)

An IconMoodSad component.
...
"""
function dti_iconmoodsad(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsad", "IconMoodSad", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
