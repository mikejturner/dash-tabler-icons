...
export dti_iconletterb

"""
    dti_iconletterb(;kwargs...)

An IconLetterB component.
...
"""
function dti_iconletterb(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterb", "IconLetterB", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
