...
export dti_iconmushroomoff

"""
    dti_iconmushroomoff(;kwargs...)

An IconMushroomOff component.
...
"""
function dti_iconmushroomoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmushroomoff", "IconMushroomOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
