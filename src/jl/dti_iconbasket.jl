...
export dti_iconbasket

"""
    dti_iconbasket(;kwargs...)

An IconBasket component.
...
"""
function dti_iconbasket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbasket", "IconBasket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
