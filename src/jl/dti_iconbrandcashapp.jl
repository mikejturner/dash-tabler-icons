...
export dti_iconbrandcashapp

"""
    dti_iconbrandcashapp(;kwargs...)

An IconBrandCashapp component.
...
"""
function dti_iconbrandcashapp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcashapp", "IconBrandCashapp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
