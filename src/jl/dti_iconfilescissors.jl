...
export dti_iconfilescissors

"""
    dti_iconfilescissors(;kwargs...)

An IconFileScissors component.
...
"""
function dti_iconfilescissors(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilescissors", "IconFileScissors", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
