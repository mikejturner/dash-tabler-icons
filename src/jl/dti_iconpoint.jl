...
export dti_iconpoint

"""
    dti_iconpoint(;kwargs...)

An IconPoint component.
...
"""
function dti_iconpoint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpoint", "IconPoint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
