...
export dti_iconcircuitswitchclosed

"""
    dti_iconcircuitswitchclosed(;kwargs...)

An IconCircuitSwitchClosed component.
...
"""
function dti_iconcircuitswitchclosed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitswitchclosed", "IconCircuitSwitchClosed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
