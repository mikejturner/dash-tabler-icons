...
export dti_iconaugmentedreality

"""
    dti_iconaugmentedreality(;kwargs...)

An IconAugmentedReality component.
...
"""
function dti_iconaugmentedreality(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaugmentedreality", "IconAugmentedReality", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
