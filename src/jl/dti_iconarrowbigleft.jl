...
export dti_iconarrowbigleft

"""
    dti_iconarrowbigleft(;kwargs...)

An IconArrowBigLeft component.
...
"""
function dti_iconarrowbigleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbigleft", "IconArrowBigLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
