...
export dti_iconlayoutsidebarright

"""
    dti_iconlayoutsidebarright(;kwargs...)

An IconLayoutSidebarRight component.
...
"""
function dti_iconlayoutsidebarright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutsidebarright", "IconLayoutSidebarRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
