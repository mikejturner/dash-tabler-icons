...
export dti_icondice1

"""
    dti_icondice1(;kwargs...)

An IconDice1 component.
...
"""
function dti_icondice1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondice1", "IconDice1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
