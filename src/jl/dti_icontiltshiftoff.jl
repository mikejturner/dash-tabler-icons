...
export dti_icontiltshiftoff

"""
    dti_icontiltshiftoff(;kwargs...)

An IconTiltShiftOff component.
...
"""
function dti_icontiltshiftoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontiltshiftoff", "IconTiltShiftOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
