...
export dti_iconcoffee

"""
    dti_iconcoffee(;kwargs...)

An IconCoffee component.
...
"""
function dti_iconcoffee(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoffee", "IconCoffee", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
