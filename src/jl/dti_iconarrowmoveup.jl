...
export dti_iconarrowmoveup

"""
    dti_iconarrowmoveup(;kwargs...)

An IconArrowMoveUp component.
...
"""
function dti_iconarrowmoveup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmoveup", "IconArrowMoveUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
