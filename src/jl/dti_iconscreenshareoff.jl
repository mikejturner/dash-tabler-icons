...
export dti_iconscreenshareoff

"""
    dti_iconscreenshareoff(;kwargs...)

An IconScreenShareOff component.
...
"""
function dti_iconscreenshareoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscreenshareoff", "IconScreenShareOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
