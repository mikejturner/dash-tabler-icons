...
export dti_iconarrowautofitleft

"""
    dti_iconarrowautofitleft(;kwargs...)

An IconArrowAutofitLeft component.
...
"""
function dti_iconarrowautofitleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowautofitleft", "IconArrowAutofitLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
