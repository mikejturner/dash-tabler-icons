...
export dti_iconinbox

"""
    dti_iconinbox(;kwargs...)

An IconInbox component.
...
"""
function dti_iconinbox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinbox", "IconInbox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
