...
export dti_iconcreativecommonsnc

"""
    dti_iconcreativecommonsnc(;kwargs...)

An IconCreativeCommonsNc component.
...
"""
function dti_iconcreativecommonsnc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommonsnc", "IconCreativeCommonsNc", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
