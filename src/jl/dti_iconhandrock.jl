...
export dti_iconhandrock

"""
    dti_iconhandrock(;kwargs...)

An IconHandRock component.
...
"""
function dti_iconhandrock(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandrock", "IconHandRock", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
