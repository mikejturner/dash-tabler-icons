...
export dti_iconjumprope

"""
    dti_iconjumprope(;kwargs...)

An IconJumpRope component.
...
"""
function dti_iconjumprope(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconjumprope", "IconJumpRope", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
