...
export dti_iconlayoutnavbarcollapse

"""
    dti_iconlayoutnavbarcollapse(;kwargs...)

An IconLayoutNavbarCollapse component.
...
"""
function dti_iconlayoutnavbarcollapse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutnavbarcollapse", "IconLayoutNavbarCollapse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
