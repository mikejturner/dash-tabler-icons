...
export dti_iconumbrella

"""
    dti_iconumbrella(;kwargs...)

An IconUmbrella component.
...
"""
function dti_iconumbrella(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconumbrella", "IconUmbrella", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
