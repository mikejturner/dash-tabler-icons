...
export dti_iconsalad

"""
    dti_iconsalad(;kwargs...)

An IconSalad component.
...
"""
function dti_iconsalad(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsalad", "IconSalad", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
