...
export dti_iconspacingvertical

"""
    dti_iconspacingvertical(;kwargs...)

An IconSpacingVertical component.
...
"""
function dti_iconspacingvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspacingvertical", "IconSpacingVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
