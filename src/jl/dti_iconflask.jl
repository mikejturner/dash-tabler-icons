...
export dti_iconflask

"""
    dti_iconflask(;kwargs...)

An IconFlask component.
...
"""
function dti_iconflask(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflask", "IconFlask", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
