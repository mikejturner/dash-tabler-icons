...
export dti_iconbranddcos

"""
    dti_iconbranddcos(;kwargs...)

An IconBrandDcos component.
...
"""
function dti_iconbranddcos(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddcos", "IconBrandDcos", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
