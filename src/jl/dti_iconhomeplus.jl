...
export dti_iconhomeplus

"""
    dti_iconhomeplus(;kwargs...)

An IconHomePlus component.
...
"""
function dti_iconhomeplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeplus", "IconHomePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
