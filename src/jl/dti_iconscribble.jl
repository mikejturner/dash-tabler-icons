...
export dti_iconscribble

"""
    dti_iconscribble(;kwargs...)

An IconScribble component.
...
"""
function dti_iconscribble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscribble", "IconScribble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
