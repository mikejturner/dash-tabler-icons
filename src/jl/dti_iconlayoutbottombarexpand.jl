...
export dti_iconlayoutbottombarexpand

"""
    dti_iconlayoutbottombarexpand(;kwargs...)

An IconLayoutBottombarExpand component.
...
"""
function dti_iconlayoutbottombarexpand(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutbottombarexpand", "IconLayoutBottombarExpand", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
