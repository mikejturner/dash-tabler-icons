...
export dti_iconhexagonletterl

"""
    dti_iconhexagonletterl(;kwargs...)

An IconHexagonLetterL component.
...
"""
function dti_iconhexagonletterl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterl", "IconHexagonLetterL", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
