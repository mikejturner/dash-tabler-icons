...
export dti_iconsturnleft

"""
    dti_iconsturnleft(;kwargs...)

An IconSTurnLeft component.
...
"""
function dti_iconsturnleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsturnleft", "IconSTurnLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
