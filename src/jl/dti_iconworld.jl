...
export dti_iconworld

"""
    dti_iconworld(;kwargs...)

An IconWorld component.
...
"""
function dti_iconworld(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworld", "IconWorld", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
