...
export dti_iconhexagonnumber9

"""
    dti_iconhexagonnumber9(;kwargs...)

An IconHexagonNumber9 component.
...
"""
function dti_iconhexagonnumber9(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber9", "IconHexagonNumber9", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
