...
export dti_iconsausage

"""
    dti_iconsausage(;kwargs...)

An IconSausage component.
...
"""
function dti_iconsausage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsausage", "IconSausage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
