...
export dti_iconlogicxnor

"""
    dti_iconlogicxnor(;kwargs...)

An IconLogicXnor component.
...
"""
function dti_iconlogicxnor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicxnor", "IconLogicXnor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
