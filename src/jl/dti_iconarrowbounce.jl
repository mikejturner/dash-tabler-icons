...
export dti_iconarrowbounce

"""
    dti_iconarrowbounce(;kwargs...)

An IconArrowBounce component.
...
"""
function dti_iconarrowbounce(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbounce", "IconArrowBounce", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
