...
export dti_icondotsdiagonal2

"""
    dti_icondotsdiagonal2(;kwargs...)

An IconDotsDiagonal2 component.
...
"""
function dti_icondotsdiagonal2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondotsdiagonal2", "IconDotsDiagonal2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
