...
export dti_iconlogicnor

"""
    dti_iconlogicnor(;kwargs...)

An IconLogicNor component.
...
"""
function dti_iconlogicnor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicnor", "IconLogicNor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
