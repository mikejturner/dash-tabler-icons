...
export dti_icontrafficlights

"""
    dti_icontrafficlights(;kwargs...)

An IconTrafficLights component.
...
"""
function dti_icontrafficlights(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrafficlights", "IconTrafficLights", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
