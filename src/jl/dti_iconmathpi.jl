...
export dti_iconmathpi

"""
    dti_iconmathpi(;kwargs...)

An IconMathPi component.
...
"""
function dti_iconmathpi(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathpi", "IconMathPi", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
