...
export dti_iconboxaligntopleft

"""
    dti_iconboxaligntopleft(;kwargs...)

An IconBoxAlignTopLeft component.
...
"""
function dti_iconboxaligntopleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxaligntopleft", "IconBoxAlignTopLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
