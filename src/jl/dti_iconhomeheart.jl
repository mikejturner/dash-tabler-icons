...
export dti_iconhomeheart

"""
    dti_iconhomeheart(;kwargs...)

An IconHomeHeart component.
...
"""
function dti_iconhomeheart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeheart", "IconHomeHeart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
