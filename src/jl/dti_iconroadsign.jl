...
export dti_iconroadsign

"""
    dti_iconroadsign(;kwargs...)

An IconRoadSign component.
...
"""
function dti_iconroadsign(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconroadsign", "IconRoadSign", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
