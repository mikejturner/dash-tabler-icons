...
export dti_iconrefresh

"""
    dti_iconrefresh(;kwargs...)

An IconRefresh component.
...
"""
function dti_iconrefresh(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrefresh", "IconRefresh", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
