...
export dti_iconsortascending2

"""
    dti_iconsortascending2(;kwargs...)

An IconSortAscending2 component.
...
"""
function dti_iconsortascending2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortascending2", "IconSortAscending2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
