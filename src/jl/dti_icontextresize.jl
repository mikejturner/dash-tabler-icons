...
export dti_icontextresize

"""
    dti_icontextresize(;kwargs...)

An IconTextResize component.
...
"""
function dti_icontextresize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextresize", "IconTextResize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
