...
export dti_iconcloud

"""
    dti_iconcloud(;kwargs...)

An IconCloud component.
...
"""
function dti_iconcloud(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloud", "IconCloud", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
