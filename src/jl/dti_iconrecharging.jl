...
export dti_iconrecharging

"""
    dti_iconrecharging(;kwargs...)

An IconRecharging component.
...
"""
function dti_iconrecharging(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrecharging", "IconRecharging", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
