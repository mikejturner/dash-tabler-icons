...
export dti_iconpills

"""
    dti_iconpills(;kwargs...)

An IconPills component.
...
"""
function dti_iconpills(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpills", "IconPills", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
