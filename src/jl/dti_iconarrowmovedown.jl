...
export dti_iconarrowmovedown

"""
    dti_iconarrowmovedown(;kwargs...)

An IconArrowMoveDown component.
...
"""
function dti_iconarrowmovedown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmovedown", "IconArrowMoveDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
