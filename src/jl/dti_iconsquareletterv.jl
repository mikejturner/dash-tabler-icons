...
export dti_iconsquareletterv

"""
    dti_iconsquareletterv(;kwargs...)

An IconSquareLetterV component.
...
"""
function dti_iconsquareletterv(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterv", "IconSquareLetterV", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
