...
export dti_iconslash

"""
    dti_iconslash(;kwargs...)

An IconSlash component.
...
"""
function dti_iconslash(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconslash", "IconSlash", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
