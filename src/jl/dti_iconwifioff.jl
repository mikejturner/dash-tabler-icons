...
export dti_iconwifioff

"""
    dti_iconwifioff(;kwargs...)

An IconWifiOff component.
...
"""
function dti_iconwifioff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwifioff", "IconWifiOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
