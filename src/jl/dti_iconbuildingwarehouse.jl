...
export dti_iconbuildingwarehouse

"""
    dti_iconbuildingwarehouse(;kwargs...)

An IconBuildingWarehouse component.
...
"""
function dti_iconbuildingwarehouse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingwarehouse", "IconBuildingWarehouse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
