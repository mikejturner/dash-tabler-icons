...
export dti_icongogame

"""
    dti_icongogame(;kwargs...)

An IconGoGame component.
...
"""
function dti_icongogame(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongogame", "IconGoGame", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
