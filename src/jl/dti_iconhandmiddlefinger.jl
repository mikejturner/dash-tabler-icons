...
export dti_iconhandmiddlefinger

"""
    dti_iconhandmiddlefinger(;kwargs...)

An IconHandMiddleFinger component.
...
"""
function dti_iconhandmiddlefinger(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandmiddlefinger", "IconHandMiddleFinger", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
