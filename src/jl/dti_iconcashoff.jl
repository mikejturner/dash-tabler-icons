...
export dti_iconcashoff

"""
    dti_iconcashoff(;kwargs...)

An IconCashOff component.
...
"""
function dti_iconcashoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcashoff", "IconCashOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
