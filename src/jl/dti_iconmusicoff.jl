...
export dti_iconmusicoff

"""
    dti_iconmusicoff(;kwargs...)

An IconMusicOff component.
...
"""
function dti_iconmusicoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmusicoff", "IconMusicOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
