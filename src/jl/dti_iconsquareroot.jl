...
export dti_iconsquareroot

"""
    dti_iconsquareroot(;kwargs...)

An IconSquareRoot component.
...
"""
function dti_iconsquareroot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareroot", "IconSquareRoot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
