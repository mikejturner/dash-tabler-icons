...
export dti_icontelescopeoff

"""
    dti_icontelescopeoff(;kwargs...)

An IconTelescopeOff component.
...
"""
function dti_icontelescopeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontelescopeoff", "IconTelescopeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
