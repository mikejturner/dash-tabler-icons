...
export dti_iconmoodsmilebeam

"""
    dti_iconmoodsmilebeam(;kwargs...)

An IconMoodSmileBeam component.
...
"""
function dti_iconmoodsmilebeam(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsmilebeam", "IconMoodSmileBeam", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
