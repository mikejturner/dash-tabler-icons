...
export dti_iconfloweroff

"""
    dti_iconfloweroff(;kwargs...)

An IconFlowerOff component.
...
"""
function dti_iconfloweroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfloweroff", "IconFlowerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
