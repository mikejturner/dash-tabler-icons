...
export dti_iconwritingoff

"""
    dti_iconwritingoff(;kwargs...)

An IconWritingOff component.
...
"""
function dti_iconwritingoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwritingoff", "IconWritingOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
