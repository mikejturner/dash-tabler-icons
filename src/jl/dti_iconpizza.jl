...
export dti_iconpizza

"""
    dti_iconpizza(;kwargs...)

An IconPizza component.
...
"""
function dti_iconpizza(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpizza", "IconPizza", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
