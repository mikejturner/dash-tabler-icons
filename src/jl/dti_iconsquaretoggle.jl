...
export dti_iconsquaretoggle

"""
    dti_iconsquaretoggle(;kwargs...)

An IconSquareToggle component.
...
"""
function dti_iconsquaretoggle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaretoggle", "IconSquareToggle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
