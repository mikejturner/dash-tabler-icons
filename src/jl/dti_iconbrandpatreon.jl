...
export dti_iconbrandpatreon

"""
    dti_iconbrandpatreon(;kwargs...)

An IconBrandPatreon component.
...
"""
function dti_iconbrandpatreon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpatreon", "IconBrandPatreon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
