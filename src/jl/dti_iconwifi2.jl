...
export dti_iconwifi2

"""
    dti_iconwifi2(;kwargs...)

An IconWifi2 component.
...
"""
function dti_iconwifi2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwifi2", "IconWifi2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
