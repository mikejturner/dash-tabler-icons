...
export dti_iconplugx

"""
    dti_iconplugx(;kwargs...)

An IconPlugX component.
...
"""
function dti_iconplugx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplugx", "IconPlugX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
