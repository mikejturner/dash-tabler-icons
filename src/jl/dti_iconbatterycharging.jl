...
export dti_iconbatterycharging

"""
    dti_iconbatterycharging(;kwargs...)

An IconBatteryCharging component.
...
"""
function dti_iconbatterycharging(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbatterycharging", "IconBatteryCharging", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
