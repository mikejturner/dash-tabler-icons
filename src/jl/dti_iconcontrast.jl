...
export dti_iconcontrast

"""
    dti_iconcontrast(;kwargs...)

An IconContrast component.
...
"""
function dti_iconcontrast(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcontrast", "IconContrast", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
