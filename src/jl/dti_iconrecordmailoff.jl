...
export dti_iconrecordmailoff

"""
    dti_iconrecordmailoff(;kwargs...)

An IconRecordMailOff component.
...
"""
function dti_iconrecordmailoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrecordmailoff", "IconRecordMailOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
