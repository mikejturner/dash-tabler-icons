...
export dti_iconarrowguide

"""
    dti_iconarrowguide(;kwargs...)

An IconArrowGuide component.
...
"""
function dti_iconarrowguide(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowguide", "IconArrowGuide", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
