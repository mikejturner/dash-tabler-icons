...
export dti_iconcurrencydollaroff

"""
    dti_iconcurrencydollaroff(;kwargs...)

An IconCurrencyDollarOff component.
...
"""
function dti_iconcurrencydollaroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydollaroff", "IconCurrencyDollarOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
