...
export dti_iconarrowrightbar

"""
    dti_iconarrowrightbar(;kwargs...)

An IconArrowRightBar component.
...
"""
function dti_iconarrowrightbar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrightbar", "IconArrowRightBar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
