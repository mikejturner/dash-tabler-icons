...
export dti_iconfilecheck

"""
    dti_iconfilecheck(;kwargs...)

An IconFileCheck component.
...
"""
function dti_iconfilecheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilecheck", "IconFileCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
