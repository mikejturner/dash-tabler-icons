...
export dti_iconeggcracked

"""
    dti_iconeggcracked(;kwargs...)

An IconEggCracked component.
...
"""
function dti_iconeggcracked(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeggcracked", "IconEggCracked", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
