...
export dti_iconuserminus

"""
    dti_iconuserminus(;kwargs...)

An IconUserMinus component.
...
"""
function dti_iconuserminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuserminus", "IconUserMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
