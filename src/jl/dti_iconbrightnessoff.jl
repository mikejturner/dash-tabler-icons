...
export dti_iconbrightnessoff

"""
    dti_iconbrightnessoff(;kwargs...)

An IconBrightnessOff component.
...
"""
function dti_iconbrightnessoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrightnessoff", "IconBrightnessOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
