...
export dti_iconhandringfinger

"""
    dti_iconhandringfinger(;kwargs...)

An IconHandRingFinger component.
...
"""
function dti_iconhandringfinger(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandringfinger", "IconHandRingFinger", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
