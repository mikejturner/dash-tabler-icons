...
export dti_iconsquareletterz

"""
    dti_iconsquareletterz(;kwargs...)

An IconSquareLetterZ component.
...
"""
function dti_iconsquareletterz(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterz", "IconSquareLetterZ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
