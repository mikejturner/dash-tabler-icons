...
export dti_iconbrandwix

"""
    dti_iconbrandwix(;kwargs...)

An IconBrandWix component.
...
"""
function dti_iconbrandwix(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwix", "IconBrandWix", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
