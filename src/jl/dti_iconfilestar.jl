...
export dti_iconfilestar

"""
    dti_iconfilestar(;kwargs...)

An IconFileStar component.
...
"""
function dti_iconfilestar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilestar", "IconFileStar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
