...
export dti_iconironingsteam

"""
    dti_iconironingsteam(;kwargs...)

An IconIroningSteam component.
...
"""
function dti_iconironingsteam(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconironingsteam", "IconIroningSteam", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
