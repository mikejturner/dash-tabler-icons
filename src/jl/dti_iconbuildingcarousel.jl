...
export dti_iconbuildingcarousel

"""
    dti_iconbuildingcarousel(;kwargs...)

An IconBuildingCarousel component.
...
"""
function dti_iconbuildingcarousel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingcarousel", "IconBuildingCarousel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
