...
export dti_iconbrandmonday

"""
    dti_iconbrandmonday(;kwargs...)

An IconBrandMonday component.
...
"""
function dti_iconbrandmonday(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmonday", "IconBrandMonday", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
