...
export dti_iconbrandsocketio

"""
    dti_iconbrandsocketio(;kwargs...)

An IconBrandSocketIo component.
...
"""
function dti_iconbrandsocketio(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsocketio", "IconBrandSocketIo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
