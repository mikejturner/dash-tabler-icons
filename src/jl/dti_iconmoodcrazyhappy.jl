...
export dti_iconmoodcrazyhappy

"""
    dti_iconmoodcrazyhappy(;kwargs...)

An IconMoodCrazyHappy component.
...
"""
function dti_iconmoodcrazyhappy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodcrazyhappy", "IconMoodCrazyHappy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
