...
export dti_iconbrandchrome

"""
    dti_iconbrandchrome(;kwargs...)

An IconBrandChrome component.
...
"""
function dti_iconbrandchrome(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandchrome", "IconBrandChrome", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
