...
export dti_iconcirclenumber6

"""
    dti_iconcirclenumber6(;kwargs...)

An IconCircleNumber6 component.
...
"""
function dti_iconcirclenumber6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclenumber6", "IconCircleNumber6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
