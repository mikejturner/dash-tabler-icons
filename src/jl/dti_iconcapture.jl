...
export dti_iconcapture

"""
    dti_iconcapture(;kwargs...)

An IconCapture component.
...
"""
function dti_iconcapture(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcapture", "IconCapture", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
