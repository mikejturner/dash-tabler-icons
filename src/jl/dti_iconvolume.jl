...
export dti_iconvolume

"""
    dti_iconvolume(;kwargs...)

An IconVolume component.
...
"""
function dti_iconvolume(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvolume", "IconVolume", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
