...
export dti_iconmicrowave

"""
    dti_iconmicrowave(;kwargs...)

An IconMicrowave component.
...
"""
function dti_iconmicrowave(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicrowave", "IconMicrowave", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
