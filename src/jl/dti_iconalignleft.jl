...
export dti_iconalignleft

"""
    dti_iconalignleft(;kwargs...)

An IconAlignLeft component.
...
"""
function dti_iconalignleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignleft", "IconAlignLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
