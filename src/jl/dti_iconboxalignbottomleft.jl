...
export dti_iconboxalignbottomleft

"""
    dti_iconboxalignbottomleft(;kwargs...)

An IconBoxAlignBottomLeft component.
...
"""
function dti_iconboxalignbottomleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxalignbottomleft", "IconBoxAlignBottomLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
