...
export dti_iconcloudlockopen

"""
    dti_iconcloudlockopen(;kwargs...)

An IconCloudLockOpen component.
...
"""
function dti_iconcloudlockopen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudlockopen", "IconCloudLockOpen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
