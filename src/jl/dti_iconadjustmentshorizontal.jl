...
export dti_iconadjustmentshorizontal

"""
    dti_iconadjustmentshorizontal(;kwargs...)

An IconAdjustmentsHorizontal component.
...
"""
function dti_iconadjustmentshorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconadjustmentshorizontal", "IconAdjustmentsHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
