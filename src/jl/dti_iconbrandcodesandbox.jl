...
export dti_iconbrandcodesandbox

"""
    dti_iconbrandcodesandbox(;kwargs...)

An IconBrandCodesandbox component.
...
"""
function dti_iconbrandcodesandbox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcodesandbox", "IconBrandCodesandbox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
