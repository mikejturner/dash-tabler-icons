...
export dti_iconmathintegralx

"""
    dti_iconmathintegralx(;kwargs...)

An IconMathIntegralX component.
...
"""
function dti_iconmathintegralx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathintegralx", "IconMathIntegralX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
