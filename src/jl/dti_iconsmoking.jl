...
export dti_iconsmoking

"""
    dti_iconsmoking(;kwargs...)

An IconSmoking component.
...
"""
function dti_iconsmoking(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsmoking", "IconSmoking", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
