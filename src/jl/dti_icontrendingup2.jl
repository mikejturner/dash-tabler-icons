...
export dti_icontrendingup2

"""
    dti_icontrendingup2(;kwargs...)

An IconTrendingUp2 component.
...
"""
function dti_icontrendingup2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrendingup2", "IconTrendingUp2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
