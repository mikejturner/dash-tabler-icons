...
export dti_iconanchor

"""
    dti_iconanchor(;kwargs...)

An IconAnchor component.
...
"""
function dti_iconanchor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconanchor", "IconAnchor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
