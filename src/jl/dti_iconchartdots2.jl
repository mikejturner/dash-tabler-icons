...
export dti_iconchartdots2

"""
    dti_iconchartdots2(;kwargs...)

An IconChartDots2 component.
...
"""
function dti_iconchartdots2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdots2", "IconChartDots2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
