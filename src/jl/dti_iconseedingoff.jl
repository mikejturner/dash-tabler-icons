...
export dti_iconseedingoff

"""
    dti_iconseedingoff(;kwargs...)

An IconSeedingOff component.
...
"""
function dti_iconseedingoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconseedingoff", "IconSeedingOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
