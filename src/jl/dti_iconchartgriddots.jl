...
export dti_iconchartgriddots

"""
    dti_iconchartgriddots(;kwargs...)

An IconChartGridDots component.
...
"""
function dti_iconchartgriddots(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartgriddots", "IconChartGridDots", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
