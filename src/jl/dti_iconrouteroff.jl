...
export dti_iconrouteroff

"""
    dti_iconrouteroff(;kwargs...)

An IconRouterOff component.
...
"""
function dti_iconrouteroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrouteroff", "IconRouterOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
