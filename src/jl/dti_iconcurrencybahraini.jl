...
export dti_iconcurrencybahraini

"""
    dti_iconcurrencybahraini(;kwargs...)

An IconCurrencyBahraini component.
...
"""
function dti_iconcurrencybahraini(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencybahraini", "IconCurrencyBahraini", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
