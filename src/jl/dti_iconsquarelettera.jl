...
export dti_iconsquarelettera

"""
    dti_iconsquarelettera(;kwargs...)

An IconSquareLetterA component.
...
"""
function dti_iconsquarelettera(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarelettera", "IconSquareLetterA", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
