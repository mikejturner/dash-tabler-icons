...
export dti_iconhomeinfinity

"""
    dti_iconhomeinfinity(;kwargs...)

An IconHomeInfinity component.
...
"""
function dti_iconhomeinfinity(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomeinfinity", "IconHomeInfinity", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
