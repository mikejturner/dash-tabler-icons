...
export dti_iconarrowbarup

"""
    dti_iconarrowbarup(;kwargs...)

An IconArrowBarUp component.
...
"""
function dti_iconarrowbarup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbarup", "IconArrowBarUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
