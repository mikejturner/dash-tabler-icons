...
export dti_iconmathmin

"""
    dti_iconmathmin(;kwargs...)

An IconMathMin component.
...
"""
function dti_iconmathmin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathmin", "IconMathMin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
