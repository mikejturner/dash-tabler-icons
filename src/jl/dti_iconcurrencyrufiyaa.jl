...
export dti_iconcurrencyrufiyaa

"""
    dti_iconcurrencyrufiyaa(;kwargs...)

An IconCurrencyRufiyaa component.
...
"""
function dti_iconcurrencyrufiyaa(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyrufiyaa", "IconCurrencyRufiyaa", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
