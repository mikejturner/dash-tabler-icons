...
export dti_iconclockrecord

"""
    dti_iconclockrecord(;kwargs...)

An IconClockRecord component.
...
"""
function dti_iconclockrecord(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockrecord", "IconClockRecord", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
