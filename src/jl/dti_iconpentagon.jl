...
export dti_iconpentagon

"""
    dti_iconpentagon(;kwargs...)

An IconPentagon component.
...
"""
function dti_iconpentagon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpentagon", "IconPentagon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
