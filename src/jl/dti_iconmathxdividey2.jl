...
export dti_iconmathxdividey2

"""
    dti_iconmathxdividey2(;kwargs...)

An IconMathXDivideY2 component.
...
"""
function dti_iconmathxdividey2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxdividey2", "IconMathXDivideY2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
