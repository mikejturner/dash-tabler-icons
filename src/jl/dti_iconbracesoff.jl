...
export dti_iconbracesoff

"""
    dti_iconbracesoff(;kwargs...)

An IconBracesOff component.
...
"""
function dti_iconbracesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbracesoff", "IconBracesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
