...
export dti_iconworldwww

"""
    dti_iconworldwww(;kwargs...)

An IconWorldWww component.
...
"""
function dti_iconworldwww(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconworldwww", "IconWorldWww", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
