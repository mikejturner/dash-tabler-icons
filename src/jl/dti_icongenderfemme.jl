...
export dti_icongenderfemme

"""
    dti_icongenderfemme(;kwargs...)

An IconGenderFemme component.
...
"""
function dti_icongenderfemme(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderfemme", "IconGenderFemme", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
