...
export dti_icontextplus

"""
    dti_icontextplus(;kwargs...)

An IconTextPlus component.
...
"""
function dti_icontextplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextplus", "IconTextPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
