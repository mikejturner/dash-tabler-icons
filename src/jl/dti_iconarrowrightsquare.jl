...
export dti_iconarrowrightsquare

"""
    dti_iconarrowrightsquare(;kwargs...)

An IconArrowRightSquare component.
...
"""
function dti_iconarrowrightsquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrightsquare", "IconArrowRightSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
