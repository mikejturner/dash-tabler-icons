...
export dti_iconarrownarrowup

"""
    dti_iconarrownarrowup(;kwargs...)

An IconArrowNarrowUp component.
...
"""
function dti_iconarrownarrowup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrownarrowup", "IconArrowNarrowUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
