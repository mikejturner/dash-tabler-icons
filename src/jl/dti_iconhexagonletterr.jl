...
export dti_iconhexagonletterr

"""
    dti_iconhexagonletterr(;kwargs...)

An IconHexagonLetterR component.
...
"""
function dti_iconhexagonletterr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterr", "IconHexagonLetterR", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
