...
export dti_iconengine

"""
    dti_iconengine(;kwargs...)

An IconEngine component.
...
"""
function dti_iconengine(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconengine", "IconEngine", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
