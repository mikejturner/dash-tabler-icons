...
export dti_iconhexagonletterg

"""
    dti_iconhexagonletterg(;kwargs...)

An IconHexagonLetterG component.
...
"""
function dti_iconhexagonletterg(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterg", "IconHexagonLetterG", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
