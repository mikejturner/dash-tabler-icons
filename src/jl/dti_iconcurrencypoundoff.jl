...
export dti_iconcurrencypoundoff

"""
    dti_iconcurrencypoundoff(;kwargs...)

An IconCurrencyPoundOff component.
...
"""
function dti_iconcurrencypoundoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencypoundoff", "IconCurrencyPoundOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
