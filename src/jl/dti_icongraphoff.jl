...
export dti_icongraphoff

"""
    dti_icongraphoff(;kwargs...)

An IconGraphOff component.
...
"""
function dti_icongraphoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongraphoff", "IconGraphOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
