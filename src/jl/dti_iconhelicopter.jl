...
export dti_iconhelicopter

"""
    dti_iconhelicopter(;kwargs...)

An IconHelicopter component.
...
"""
function dti_iconhelicopter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhelicopter", "IconHelicopter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
