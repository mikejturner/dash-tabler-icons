...
export dti_iconbrandpicsart

"""
    dti_iconbrandpicsart(;kwargs...)

An IconBrandPicsart component.
...
"""
function dti_iconbrandpicsart(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpicsart", "IconBrandPicsart", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
