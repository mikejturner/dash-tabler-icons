...
export dti_iconbarbelloff

"""
    dti_iconbarbelloff(;kwargs...)

An IconBarbellOff component.
...
"""
function dti_iconbarbelloff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarbelloff", "IconBarbellOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
