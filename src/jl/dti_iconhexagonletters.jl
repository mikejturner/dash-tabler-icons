...
export dti_iconhexagonletters

"""
    dti_iconhexagonletters(;kwargs...)

An IconHexagonLetterS component.
...
"""
function dti_iconhexagonletters(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletters", "IconHexagonLetterS", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
