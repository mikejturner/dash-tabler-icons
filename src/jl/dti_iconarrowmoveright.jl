...
export dti_iconarrowmoveright

"""
    dti_iconarrowmoveright(;kwargs...)

An IconArrowMoveRight component.
...
"""
function dti_iconarrowmoveright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowmoveright", "IconArrowMoveRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
