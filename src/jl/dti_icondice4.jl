...
export dti_icondice4

"""
    dti_icondice4(;kwargs...)

An IconDice4 component.
...
"""
function dti_icondice4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondice4", "IconDice4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
