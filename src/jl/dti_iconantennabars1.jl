...
export dti_iconantennabars1

"""
    dti_iconantennabars1(;kwargs...)

An IconAntennaBars1 component.
...
"""
function dti_iconantennabars1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennabars1", "IconAntennaBars1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
