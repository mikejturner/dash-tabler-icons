...
export dti_iconstarhalf

"""
    dti_iconstarhalf(;kwargs...)

An IconStarHalf component.
...
"""
function dti_iconstarhalf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstarhalf", "IconStarHalf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
