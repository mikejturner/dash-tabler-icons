...
export dti_iconsquarearrowdown

"""
    dti_iconsquarearrowdown(;kwargs...)

An IconSquareArrowDown component.
...
"""
function dti_iconsquarearrowdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarearrowdown", "IconSquareArrowDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
