...
export dti_iconfishbone

"""
    dti_iconfishbone(;kwargs...)

An IconFishBone component.
...
"""
function dti_iconfishbone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfishbone", "IconFishBone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
