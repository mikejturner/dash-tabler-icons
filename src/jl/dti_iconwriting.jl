...
export dti_iconwriting

"""
    dti_iconwriting(;kwargs...)

An IconWriting component.
...
"""
function dti_iconwriting(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwriting", "IconWriting", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
