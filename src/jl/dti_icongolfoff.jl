...
export dti_icongolfoff

"""
    dti_icongolfoff(;kwargs...)

An IconGolfOff component.
...
"""
function dti_icongolfoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongolfoff", "IconGolfOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
