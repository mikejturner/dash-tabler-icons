...
export dti_iconmathxdividey

"""
    dti_iconmathxdividey(;kwargs...)

An IconMathXDivideY component.
...
"""
function dti_iconmathxdividey(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathxdividey", "IconMathXDivideY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
