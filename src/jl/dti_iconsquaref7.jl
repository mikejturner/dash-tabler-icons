...
export dti_iconsquaref7

"""
    dti_iconsquaref7(;kwargs...)

An IconSquareF7 component.
...
"""
function dti_iconsquaref7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref7", "IconSquareF7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
