...
export dti_iconcaretright

"""
    dti_iconcaretright(;kwargs...)

An IconCaretRight component.
...
"""
function dti_iconcaretright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaretright", "IconCaretRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
