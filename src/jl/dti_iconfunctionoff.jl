...
export dti_iconfunctionoff

"""
    dti_iconfunctionoff(;kwargs...)

An IconFunctionOff component.
...
"""
function dti_iconfunctionoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfunctionoff", "IconFunctionOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
