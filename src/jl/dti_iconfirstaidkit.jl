...
export dti_iconfirstaidkit

"""
    dti_iconfirstaidkit(;kwargs...)

An IconFirstAidKit component.
...
"""
function dti_iconfirstaidkit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfirstaidkit", "IconFirstAidKit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
