...
export dti_iconcloudupload

"""
    dti_iconcloudupload(;kwargs...)

An IconCloudUpload component.
...
"""
function dti_iconcloudupload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcloudupload", "IconCloudUpload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
