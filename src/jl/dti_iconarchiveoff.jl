...
export dti_iconarchiveoff

"""
    dti_iconarchiveoff(;kwargs...)

An IconArchiveOff component.
...
"""
function dti_iconarchiveoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarchiveoff", "IconArchiveOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
