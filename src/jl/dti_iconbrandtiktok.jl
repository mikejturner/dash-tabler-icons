...
export dti_iconbrandtiktok

"""
    dti_iconbrandtiktok(;kwargs...)

An IconBrandTiktok component.
...
"""
function dti_iconbrandtiktok(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtiktok", "IconBrandTiktok", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
