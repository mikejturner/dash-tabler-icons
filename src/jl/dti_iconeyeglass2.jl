...
export dti_iconeyeglass2

"""
    dti_iconeyeglass2(;kwargs...)

An IconEyeglass2 component.
...
"""
function dti_iconeyeglass2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeyeglass2", "IconEyeglass2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
