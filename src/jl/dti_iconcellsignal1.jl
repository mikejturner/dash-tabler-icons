...
export dti_iconcellsignal1

"""
    dti_iconcellsignal1(;kwargs...)

An IconCellSignal1 component.
...
"""
function dti_iconcellsignal1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcellsignal1", "IconCellSignal1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
