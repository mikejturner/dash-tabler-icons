...
export dti_iconmaximize

"""
    dti_iconmaximize(;kwargs...)

An IconMaximize component.
...
"""
function dti_iconmaximize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmaximize", "IconMaximize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
