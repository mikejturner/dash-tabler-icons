...
export dti_iconpentagram

"""
    dti_iconpentagram(;kwargs...)

An IconPentagram component.
...
"""
function dti_iconpentagram(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpentagram", "IconPentagram", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
