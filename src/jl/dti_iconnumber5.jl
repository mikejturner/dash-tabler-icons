...
export dti_iconnumber5

"""
    dti_iconnumber5(;kwargs...)

An IconNumber5 component.
...
"""
function dti_iconnumber5(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber5", "IconNumber5", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
