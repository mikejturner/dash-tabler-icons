...
export dti_iconcornerrightdowndouble

"""
    dti_iconcornerrightdowndouble(;kwargs...)

An IconCornerRightDownDouble component.
...
"""
function dti_iconcornerrightdowndouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerrightdowndouble", "IconCornerRightDownDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
