...
export dti_iconatomoff

"""
    dti_iconatomoff(;kwargs...)

An IconAtomOff component.
...
"""
function dti_iconatomoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconatomoff", "IconAtomOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
