...
export dti_iconsquareletterf

"""
    dti_iconsquareletterf(;kwargs...)

An IconSquareLetterF component.
...
"""
function dti_iconsquareletterf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterf", "IconSquareLetterF", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
