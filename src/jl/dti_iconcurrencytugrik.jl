...
export dti_iconcurrencytugrik

"""
    dti_iconcurrencytugrik(;kwargs...)

An IconCurrencyTugrik component.
...
"""
function dti_iconcurrencytugrik(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencytugrik", "IconCurrencyTugrik", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
