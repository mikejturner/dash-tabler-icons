...
export dti_iconswipe

"""
    dti_iconswipe(;kwargs...)

An IconSwipe component.
...
"""
function dti_iconswipe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswipe", "IconSwipe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
