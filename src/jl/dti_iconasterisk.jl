...
export dti_iconasterisk

"""
    dti_iconasterisk(;kwargs...)

An IconAsterisk component.
...
"""
function dti_iconasterisk(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconasterisk", "IconAsterisk", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
