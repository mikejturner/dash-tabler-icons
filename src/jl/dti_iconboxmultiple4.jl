...
export dti_iconboxmultiple4

"""
    dti_iconboxmultiple4(;kwargs...)

An IconBoxMultiple4 component.
...
"""
function dti_iconboxmultiple4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple4", "IconBoxMultiple4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
