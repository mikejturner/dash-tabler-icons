...
export dti_icon360view

"""
    dti_icon360view(;kwargs...)

An Icon360View component.
...
"""
function dti_icon360view(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icon360view", "Icon360View", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
