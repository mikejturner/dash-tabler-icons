...
export dti_iconbuildingfactory2

"""
    dti_iconbuildingfactory2(;kwargs...)

An IconBuildingFactory2 component.
...
"""
function dti_iconbuildingfactory2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildingfactory2", "IconBuildingFactory2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
