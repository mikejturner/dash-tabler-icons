...
export dti_iconbrandbitbucket

"""
    dti_iconbrandbitbucket(;kwargs...)

An IconBrandBitbucket component.
...
"""
function dti_iconbrandbitbucket(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbitbucket", "IconBrandBitbucket", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
