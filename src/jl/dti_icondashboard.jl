...
export dti_icondashboard

"""
    dti_icondashboard(;kwargs...)

An IconDashboard component.
...
"""
function dti_icondashboard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondashboard", "IconDashboard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
