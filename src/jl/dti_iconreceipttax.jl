...
export dti_iconreceipttax

"""
    dti_iconreceipttax(;kwargs...)

An IconReceiptTax component.
...
"""
function dti_iconreceipttax(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreceipttax", "IconReceiptTax", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
