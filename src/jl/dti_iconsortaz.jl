...
export dti_iconsortaz

"""
    dti_iconsortaz(;kwargs...)

An IconSortAZ component.
...
"""
function dti_iconsortaz(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsortaz", "IconSortAZ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
