...
export dti_iconbrandbing

"""
    dti_iconbrandbing(;kwargs...)

An IconBrandBing component.
...
"""
function dti_iconbrandbing(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbing", "IconBrandBing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
