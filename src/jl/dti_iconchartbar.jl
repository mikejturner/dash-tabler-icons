...
export dti_iconchartbar

"""
    dti_iconchartbar(;kwargs...)

An IconChartBar component.
...
"""
function dti_iconchartbar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartbar", "IconChartBar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
