...
export dti_iconviewportnarrow

"""
    dti_iconviewportnarrow(;kwargs...)

An IconViewportNarrow component.
...
"""
function dti_iconviewportnarrow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconviewportnarrow", "IconViewportNarrow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
