...
export dti_iconfileimport

"""
    dti_iconfileimport(;kwargs...)

An IconFileImport component.
...
"""
function dti_iconfileimport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileimport", "IconFileImport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
