...
export dti_iconuserexclamation

"""
    dti_iconuserexclamation(;kwargs...)

An IconUserExclamation component.
...
"""
function dti_iconuserexclamation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuserexclamation", "IconUserExclamation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
