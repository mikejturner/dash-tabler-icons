...
export dti_iconmoodannoyed2

"""
    dti_iconmoodannoyed2(;kwargs...)

An IconMoodAnnoyed2 component.
...
"""
function dti_iconmoodannoyed2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodannoyed2", "IconMoodAnnoyed2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
