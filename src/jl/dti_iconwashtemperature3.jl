...
export dti_iconwashtemperature3

"""
    dti_iconwashtemperature3(;kwargs...)

An IconWashTemperature3 component.
...
"""
function dti_iconwashtemperature3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtemperature3", "IconWashTemperature3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
