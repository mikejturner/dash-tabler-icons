...
export dti_iconantennaoff

"""
    dti_iconantennaoff(;kwargs...)

An IconAntennaOff component.
...
"""
function dti_iconantennaoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconantennaoff", "IconAntennaOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
