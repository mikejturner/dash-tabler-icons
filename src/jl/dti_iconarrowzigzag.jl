...
export dti_iconarrowzigzag

"""
    dti_iconarrowzigzag(;kwargs...)

An IconArrowZigZag component.
...
"""
function dti_iconarrowzigzag(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowzigzag", "IconArrowZigZag", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
