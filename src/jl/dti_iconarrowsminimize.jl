...
export dti_iconarrowsminimize

"""
    dti_iconarrowsminimize(;kwargs...)

An IconArrowsMinimize component.
...
"""
function dti_iconarrowsminimize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsminimize", "IconArrowsMinimize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
