...
export dti_iconmaximizeoff

"""
    dti_iconmaximizeoff(;kwargs...)

An IconMaximizeOff component.
...
"""
function dti_iconmaximizeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmaximizeoff", "IconMaximizeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
