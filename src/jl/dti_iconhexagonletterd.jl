...
export dti_iconhexagonletterd

"""
    dti_iconhexagonletterd(;kwargs...)

An IconHexagonLetterD component.
...
"""
function dti_iconhexagonletterd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterd", "IconHexagonLetterD", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
