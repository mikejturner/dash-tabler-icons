...
export dti_iconchairdirector

"""
    dti_iconchairdirector(;kwargs...)

An IconChairDirector component.
...
"""
function dti_iconchairdirector(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchairdirector", "IconChairDirector", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
