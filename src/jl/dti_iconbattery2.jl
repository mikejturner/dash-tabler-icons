...
export dti_iconbattery2

"""
    dti_iconbattery2(;kwargs...)

An IconBattery2 component.
...
"""
function dti_iconbattery2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbattery2", "IconBattery2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
