...
export dti_iconpennant

"""
    dti_iconpennant(;kwargs...)

An IconPennant component.
...
"""
function dti_iconpennant(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpennant", "IconPennant", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
