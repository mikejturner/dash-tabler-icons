...
export dti_iconbrandredux

"""
    dti_iconbrandredux(;kwargs...)

An IconBrandRedux component.
...
"""
function dti_iconbrandredux(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandredux", "IconBrandRedux", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
