...
export dti_iconplaystationtriangle

"""
    dti_iconplaystationtriangle(;kwargs...)

An IconPlaystationTriangle component.
...
"""
function dti_iconplaystationtriangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaystationtriangle", "IconPlaystationTriangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
