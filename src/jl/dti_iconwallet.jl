...
export dti_iconwallet

"""
    dti_iconwallet(;kwargs...)

An IconWallet component.
...
"""
function dti_iconwallet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwallet", "IconWallet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
