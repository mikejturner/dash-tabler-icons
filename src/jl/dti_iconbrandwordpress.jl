...
export dti_iconbrandwordpress

"""
    dti_iconbrandwordpress(;kwargs...)

An IconBrandWordpress component.
...
"""
function dti_iconbrandwordpress(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandwordpress", "IconBrandWordpress", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
