...
export dti_icondevicesoff

"""
    dti_icondevicesoff(;kwargs...)

An IconDevicesOff component.
...
"""
function dti_icondevicesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicesoff", "IconDevicesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
