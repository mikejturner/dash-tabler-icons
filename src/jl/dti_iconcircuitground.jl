...
export dti_iconcircuitground

"""
    dti_iconcircuitground(;kwargs...)

An IconCircuitGround component.
...
"""
function dti_iconcircuitground(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitground", "IconCircuitGround", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
