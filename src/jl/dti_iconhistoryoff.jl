...
export dti_iconhistoryoff

"""
    dti_iconhistoryoff(;kwargs...)

An IconHistoryOff component.
...
"""
function dti_iconhistoryoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhistoryoff", "IconHistoryOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
