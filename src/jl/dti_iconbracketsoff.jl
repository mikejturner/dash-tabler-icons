...
export dti_iconbracketsoff

"""
    dti_iconbracketsoff(;kwargs...)

An IconBracketsOff component.
...
"""
function dti_iconbracketsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbracketsoff", "IconBracketsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
