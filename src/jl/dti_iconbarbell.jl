...
export dti_iconbarbell

"""
    dti_iconbarbell(;kwargs...)

An IconBarbell component.
...
"""
function dti_iconbarbell(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbarbell", "IconBarbell", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
