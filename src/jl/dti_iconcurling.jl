...
export dti_iconcurling

"""
    dti_iconcurling(;kwargs...)

An IconCurling component.
...
"""
function dti_iconcurling(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurling", "IconCurling", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
