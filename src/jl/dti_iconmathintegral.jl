...
export dti_iconmathintegral

"""
    dti_iconmathintegral(;kwargs...)

An IconMathIntegral component.
...
"""
function dti_iconmathintegral(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathintegral", "IconMathIntegral", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
