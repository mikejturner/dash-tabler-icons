...
export dti_iconskull

"""
    dti_iconskull(;kwargs...)

An IconSkull component.
...
"""
function dti_iconskull(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconskull", "IconSkull", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
