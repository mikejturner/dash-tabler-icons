...
export dti_iconpokeballoff

"""
    dti_iconpokeballoff(;kwargs...)

An IconPokeballOff component.
...
"""
function dti_iconpokeballoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpokeballoff", "IconPokeballOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
