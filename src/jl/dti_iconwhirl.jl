...
export dti_iconwhirl

"""
    dti_iconwhirl(;kwargs...)

An IconWhirl component.
...
"""
function dti_iconwhirl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwhirl", "IconWhirl", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
