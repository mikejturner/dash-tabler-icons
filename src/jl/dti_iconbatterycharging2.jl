...
export dti_iconbatterycharging2

"""
    dti_iconbatterycharging2(;kwargs...)

An IconBatteryCharging2 component.
...
"""
function dti_iconbatterycharging2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbatterycharging2", "IconBatteryCharging2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
