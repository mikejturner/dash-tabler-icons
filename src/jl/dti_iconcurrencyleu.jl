...
export dti_iconcurrencyleu

"""
    dti_iconcurrencyleu(;kwargs...)

An IconCurrencyLeu component.
...
"""
function dti_iconcurrencyleu(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyleu", "IconCurrencyLeu", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
