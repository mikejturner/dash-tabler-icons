...
export dti_iconinfinityoff

"""
    dti_iconinfinityoff(;kwargs...)

An IconInfinityOff component.
...
"""
function dti_iconinfinityoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinfinityoff", "IconInfinityOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
