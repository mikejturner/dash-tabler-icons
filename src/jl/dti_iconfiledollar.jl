...
export dti_iconfiledollar

"""
    dti_iconfiledollar(;kwargs...)

An IconFileDollar component.
...
"""
function dti_iconfiledollar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledollar", "IconFileDollar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
