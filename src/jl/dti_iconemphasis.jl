...
export dti_iconemphasis

"""
    dti_iconemphasis(;kwargs...)

An IconEmphasis component.
...
"""
function dti_iconemphasis(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconemphasis", "IconEmphasis", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
