...
export dti_iconreportsearch

"""
    dti_iconreportsearch(;kwargs...)

An IconReportSearch component.
...
"""
function dti_iconreportsearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreportsearch", "IconReportSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
