...
export dti_iconphotocancel

"""
    dti_iconphotocancel(;kwargs...)

An IconPhotoCancel component.
...
"""
function dti_iconphotocancel(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotocancel", "IconPhotoCancel", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
