...
export dti_iconbluetoothconnected

"""
    dti_iconbluetoothconnected(;kwargs...)

An IconBluetoothConnected component.
...
"""
function dti_iconbluetoothconnected(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbluetoothconnected", "IconBluetoothConnected", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
