...
export dti_iconlockopen

"""
    dti_iconlockopen(;kwargs...)

An IconLockOpen component.
...
"""
function dti_iconlockopen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlockopen", "IconLockOpen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
