...
export dti_iconplayereject

"""
    dti_iconplayereject(;kwargs...)

An IconPlayerEject component.
...
"""
function dti_iconplayereject(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayereject", "IconPlayerEject", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
