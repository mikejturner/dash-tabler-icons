...
export dti_iconfiledescription

"""
    dti_iconfiledescription(;kwargs...)

An IconFileDescription component.
...
"""
function dti_iconfiledescription(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfiledescription", "IconFileDescription", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
