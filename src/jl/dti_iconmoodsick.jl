...
export dti_iconmoodsick

"""
    dti_iconmoodsick(;kwargs...)

An IconMoodSick component.
...
"""
function dti_iconmoodsick(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodsick", "IconMoodSick", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
