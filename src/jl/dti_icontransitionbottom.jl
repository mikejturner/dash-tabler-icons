...
export dti_icontransitionbottom

"""
    dti_icontransitionbottom(;kwargs...)

An IconTransitionBottom component.
...
"""
function dti_icontransitionbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontransitionbottom", "IconTransitionBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
