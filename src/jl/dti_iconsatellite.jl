...
export dti_iconsatellite

"""
    dti_iconsatellite(;kwargs...)

An IconSatellite component.
...
"""
function dti_iconsatellite(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsatellite", "IconSatellite", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
