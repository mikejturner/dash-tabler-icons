...
export dti_iconvirussearch

"""
    dti_iconvirussearch(;kwargs...)

An IconVirusSearch component.
...
"""
function dti_iconvirussearch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvirussearch", "IconVirusSearch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
