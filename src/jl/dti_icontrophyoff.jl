...
export dti_icontrophyoff

"""
    dti_icontrophyoff(;kwargs...)

An IconTrophyOff component.
...
"""
function dti_icontrophyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrophyoff", "IconTrophyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
