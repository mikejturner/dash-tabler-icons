...
export dti_iconsitemap

"""
    dti_iconsitemap(;kwargs...)

An IconSitemap component.
...
"""
function dti_iconsitemap(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsitemap", "IconSitemap", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
