...
export dti_iconstepinto

"""
    dti_iconstepinto(;kwargs...)

An IconStepInto component.
...
"""
function dti_iconstepinto(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstepinto", "IconStepInto", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
