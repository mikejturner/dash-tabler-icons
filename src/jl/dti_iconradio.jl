...
export dti_iconradio

"""
    dti_iconradio(;kwargs...)

An IconRadio component.
...
"""
function dti_iconradio(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconradio", "IconRadio", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
