...
export dti_icondatabaseexport

"""
    dti_icondatabaseexport(;kwargs...)

An IconDatabaseExport component.
...
"""
function dti_icondatabaseexport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondatabaseexport", "IconDatabaseExport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
