...
export dti_iconeraser

"""
    dti_iconeraser(;kwargs...)

An IconEraser component.
...
"""
function dti_iconeraser(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeraser", "IconEraser", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
