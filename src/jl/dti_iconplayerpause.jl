...
export dti_iconplayerpause

"""
    dti_iconplayerpause(;kwargs...)

An IconPlayerPause component.
...
"""
function dti_iconplayerpause(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplayerpause", "IconPlayerPause", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
