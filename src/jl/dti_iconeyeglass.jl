...
export dti_iconeyeglass

"""
    dti_iconeyeglass(;kwargs...)

An IconEyeglass component.
...
"""
function dti_iconeyeglass(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconeyeglass", "IconEyeglass", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
