...
export dti_icondeviceanalytics

"""
    dti_icondeviceanalytics(;kwargs...)

An IconDeviceAnalytics component.
...
"""
function dti_icondeviceanalytics(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondeviceanalytics", "IconDeviceAnalytics", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
