...
export dti_iconlogicxor

"""
    dti_iconlogicxor(;kwargs...)

An IconLogicXor component.
...
"""
function dti_iconlogicxor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogicxor", "IconLogicXor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
