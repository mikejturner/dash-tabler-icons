...
export dti_iconcircuitcellplus

"""
    dti_iconcircuitcellplus(;kwargs...)

An IconCircuitCellPlus component.
...
"""
function dti_iconcircuitcellplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitcellplus", "IconCircuitCellPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
