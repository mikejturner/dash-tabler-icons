...
export dti_iconlayoutrows

"""
    dti_iconlayoutrows(;kwargs...)

An IconLayoutRows component.
...
"""
function dti_iconlayoutrows(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutrows", "IconLayoutRows", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
