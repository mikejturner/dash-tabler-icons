...
export dti_iconbrandguardian

"""
    dti_iconbrandguardian(;kwargs...)

An IconBrandGuardian component.
...
"""
function dti_iconbrandguardian(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandguardian", "IconBrandGuardian", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
