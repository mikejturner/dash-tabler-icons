...
export dti_iconinfosquare

"""
    dti_iconinfosquare(;kwargs...)

An IconInfoSquare component.
...
"""
function dti_iconinfosquare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinfosquare", "IconInfoSquare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
