...
export dti_iconcurrencydogecoin

"""
    dti_iconcurrencydogecoin(;kwargs...)

An IconCurrencyDogecoin component.
...
"""
function dti_iconcurrencydogecoin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencydogecoin", "IconCurrencyDogecoin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
