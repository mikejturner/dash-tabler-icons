...
export dti_iconboxmultiple7

"""
    dti_iconboxmultiple7(;kwargs...)

An IconBoxMultiple7 component.
...
"""
function dti_iconboxmultiple7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple7", "IconBoxMultiple7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
