...
export dti_iconcodeminus

"""
    dti_iconcodeminus(;kwargs...)

An IconCodeMinus component.
...
"""
function dti_iconcodeminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcodeminus", "IconCodeMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
