...
export dti_icontrash

"""
    dti_icontrash(;kwargs...)

An IconTrash component.
...
"""
function dti_icontrash(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrash", "IconTrash", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
