...
export dti_iconscooter

"""
    dti_iconscooter(;kwargs...)

An IconScooter component.
...
"""
function dti_iconscooter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscooter", "IconScooter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
