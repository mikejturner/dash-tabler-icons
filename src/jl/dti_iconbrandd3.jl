...
export dti_iconbrandd3

"""
    dti_iconbrandd3(;kwargs...)

An IconBrandD3 component.
...
"""
function dti_iconbrandd3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandd3", "IconBrandD3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
