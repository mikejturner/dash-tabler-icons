...
export dti_iconbrandmessenger

"""
    dti_iconbrandmessenger(;kwargs...)

An IconBrandMessenger component.
...
"""
function dti_iconbrandmessenger(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandmessenger", "IconBrandMessenger", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
