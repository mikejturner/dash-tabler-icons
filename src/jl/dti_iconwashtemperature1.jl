...
export dti_iconwashtemperature1

"""
    dti_iconwashtemperature1(;kwargs...)

An IconWashTemperature1 component.
...
"""
function dti_iconwashtemperature1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtemperature1", "IconWashTemperature1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
