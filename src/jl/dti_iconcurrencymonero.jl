...
export dti_iconcurrencymonero

"""
    dti_iconcurrencymonero(;kwargs...)

An IconCurrencyMonero component.
...
"""
function dti_iconcurrencymonero(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencymonero", "IconCurrencyMonero", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
