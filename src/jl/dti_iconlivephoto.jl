...
export dti_iconlivephoto

"""
    dti_iconlivephoto(;kwargs...)

An IconLivePhoto component.
...
"""
function dti_iconlivephoto(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlivephoto", "IconLivePhoto", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
