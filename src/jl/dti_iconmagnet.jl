...
export dti_iconmagnet

"""
    dti_iconmagnet(;kwargs...)

An IconMagnet component.
...
"""
function dti_iconmagnet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmagnet", "IconMagnet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
