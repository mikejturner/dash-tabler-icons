...
export dti_iconbrandedge

"""
    dti_iconbrandedge(;kwargs...)

An IconBrandEdge component.
...
"""
function dti_iconbrandedge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandedge", "IconBrandEdge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
