...
export dti_iconbranddiscord

"""
    dti_iconbranddiscord(;kwargs...)

An IconBrandDiscord component.
...
"""
function dti_iconbranddiscord(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddiscord", "IconBrandDiscord", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
