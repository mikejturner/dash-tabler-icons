...
export dti_iconmeteoroff

"""
    dti_iconmeteoroff(;kwargs...)

An IconMeteorOff component.
...
"""
function dti_iconmeteoroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmeteoroff", "IconMeteorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
