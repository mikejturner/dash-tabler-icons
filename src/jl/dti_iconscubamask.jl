...
export dti_iconscubamask

"""
    dti_iconscubamask(;kwargs...)

An IconScubaMask component.
...
"""
function dti_iconscubamask(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscubamask", "IconScubaMask", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
