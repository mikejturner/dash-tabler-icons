...
export dti_iconcomet

"""
    dti_iconcomet(;kwargs...)

An IconComet component.
...
"""
function dti_iconcomet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcomet", "IconComet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
