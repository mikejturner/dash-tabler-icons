...
export dti_iconnotesoff

"""
    dti_iconnotesoff(;kwargs...)

An IconNotesOff component.
...
"""
function dti_iconnotesoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnotesoff", "IconNotesOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
