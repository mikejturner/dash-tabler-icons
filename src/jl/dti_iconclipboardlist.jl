...
export dti_iconclipboardlist

"""
    dti_iconclipboardlist(;kwargs...)

An IconClipboardList component.
...
"""
function dti_iconclipboardlist(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclipboardlist", "IconClipboardList", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
