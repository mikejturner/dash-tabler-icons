...
export dti_iconvaccineoff

"""
    dti_iconvaccineoff(;kwargs...)

An IconVaccineOff component.
...
"""
function dti_iconvaccineoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvaccineoff", "IconVaccineOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
