...
export dti_iconanalyze

"""
    dti_iconanalyze(;kwargs...)

An IconAnalyze component.
...
"""
function dti_iconanalyze(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconanalyze", "IconAnalyze", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
