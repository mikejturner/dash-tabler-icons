...
export dti_iconmathyminusy

"""
    dti_iconmathyminusy(;kwargs...)

An IconMathYMinusY component.
...
"""
function dti_iconmathyminusy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathyminusy", "IconMathYMinusY", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
