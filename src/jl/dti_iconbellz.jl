...
export dti_iconbellz

"""
    dti_iconbellz(;kwargs...)

An IconBellZ component.
...
"""
function dti_iconbellz(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellz", "IconBellZ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
