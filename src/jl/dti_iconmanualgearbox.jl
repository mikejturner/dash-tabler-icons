...
export dti_iconmanualgearbox

"""
    dti_iconmanualgearbox(;kwargs...)

An IconManualGearbox component.
...
"""
function dti_iconmanualgearbox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmanualgearbox", "IconManualGearbox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
