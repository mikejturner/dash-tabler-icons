...
export dti_iconpassword

"""
    dti_iconpassword(;kwargs...)

An IconPassword component.
...
"""
function dti_iconpassword(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpassword", "IconPassword", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
