...
export dti_iconinnershadowright

"""
    dti_iconinnershadowright(;kwargs...)

An IconInnerShadowRight component.
...
"""
function dti_iconinnershadowright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowright", "IconInnerShadowRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
