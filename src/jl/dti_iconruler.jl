...
export dti_iconruler

"""
    dti_iconruler(;kwargs...)

An IconRuler component.
...
"""
function dti_iconruler(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconruler", "IconRuler", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
