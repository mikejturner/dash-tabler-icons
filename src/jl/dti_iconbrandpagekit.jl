...
export dti_iconbrandpagekit

"""
    dti_iconbrandpagekit(;kwargs...)

An IconBrandPagekit component.
...
"""
function dti_iconbrandpagekit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpagekit", "IconBrandPagekit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
