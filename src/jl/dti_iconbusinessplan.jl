...
export dti_iconbusinessplan

"""
    dti_iconbusinessplan(;kwargs...)

An IconBusinessplan component.
...
"""
function dti_iconbusinessplan(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbusinessplan", "IconBusinessplan", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
