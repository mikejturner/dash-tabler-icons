...
export dti_icondevicespeaker

"""
    dti_icondevicespeaker(;kwargs...)

An IconDeviceSpeaker component.
...
"""
function dti_icondevicespeaker(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicespeaker", "IconDeviceSpeaker", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
