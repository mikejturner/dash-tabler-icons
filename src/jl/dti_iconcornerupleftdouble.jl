...
export dti_iconcornerupleftdouble

"""
    dti_iconcornerupleftdouble(;kwargs...)

An IconCornerUpLeftDouble component.
...
"""
function dti_iconcornerupleftdouble(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcornerupleftdouble", "IconCornerUpLeftDouble", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
