...
export dti_iconhomestar

"""
    dti_iconhomestar(;kwargs...)

An IconHomeStar component.
...
"""
function dti_iconhomestar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhomestar", "IconHomeStar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
