...
export dti_icondrone

"""
    dti_icondrone(;kwargs...)

An IconDrone component.
...
"""
function dti_icondrone(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondrone", "IconDrone", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
