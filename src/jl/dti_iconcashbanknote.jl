...
export dti_iconcashbanknote

"""
    dti_iconcashbanknote(;kwargs...)

An IconCashBanknote component.
...
"""
function dti_iconcashbanknote(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcashbanknote", "IconCashBanknote", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
