...
export dti_iconmouse

"""
    dti_iconmouse(;kwargs...)

An IconMouse component.
...
"""
function dti_iconmouse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmouse", "IconMouse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
