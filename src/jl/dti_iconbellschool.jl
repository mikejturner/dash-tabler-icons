...
export dti_iconbellschool

"""
    dti_iconbellschool(;kwargs...)

An IconBellSchool component.
...
"""
function dti_iconbellschool(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellschool", "IconBellSchool", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
