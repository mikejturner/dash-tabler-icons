...
export dti_icongenderdemiboy

"""
    dti_icongenderdemiboy(;kwargs...)

An IconGenderDemiboy component.
...
"""
function dti_icongenderdemiboy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderdemiboy", "IconGenderDemiboy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
