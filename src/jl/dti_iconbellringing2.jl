...
export dti_iconbellringing2

"""
    dti_iconbellringing2(;kwargs...)

An IconBellRinging2 component.
...
"""
function dti_iconbellringing2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbellringing2", "IconBellRinging2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
