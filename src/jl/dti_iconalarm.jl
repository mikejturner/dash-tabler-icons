...
export dti_iconalarm

"""
    dti_iconalarm(;kwargs...)

An IconAlarm component.
...
"""
function dti_iconalarm(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalarm", "IconAlarm", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
