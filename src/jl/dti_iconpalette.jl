...
export dti_iconpalette

"""
    dti_iconpalette(;kwargs...)

An IconPalette component.
...
"""
function dti_iconpalette(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpalette", "IconPalette", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
