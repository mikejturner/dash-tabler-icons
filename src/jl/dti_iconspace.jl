...
export dti_iconspace

"""
    dti_iconspace(;kwargs...)

An IconSpace component.
...
"""
function dti_iconspace(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspace", "IconSpace", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
