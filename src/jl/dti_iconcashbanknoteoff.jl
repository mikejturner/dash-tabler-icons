...
export dti_iconcashbanknoteoff

"""
    dti_iconcashbanknoteoff(;kwargs...)

An IconCashBanknoteOff component.
...
"""
function dti_iconcashbanknoteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcashbanknoteoff", "IconCashBanknoteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
