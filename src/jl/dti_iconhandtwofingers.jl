...
export dti_iconhandtwofingers

"""
    dti_iconhandtwofingers(;kwargs...)

An IconHandTwoFingers component.
...
"""
function dti_iconhandtwofingers(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandtwofingers", "IconHandTwoFingers", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
