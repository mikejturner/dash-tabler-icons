...
export dti_iconbattery1

"""
    dti_iconbattery1(;kwargs...)

An IconBattery1 component.
...
"""
function dti_iconbattery1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbattery1", "IconBattery1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
