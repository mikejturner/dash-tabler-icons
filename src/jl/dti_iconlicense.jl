...
export dti_iconlicense

"""
    dti_iconlicense(;kwargs...)

An IconLicense component.
...
"""
function dti_iconlicense(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlicense", "IconLicense", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
