...
export dti_iconhexagonletteri

"""
    dti_iconhexagonletteri(;kwargs...)

An IconHexagonLetterI component.
...
"""
function dti_iconhexagonletteri(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletteri", "IconHexagonLetterI", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
