...
export dti_iconscript

"""
    dti_iconscript(;kwargs...)

An IconScript component.
...
"""
function dti_iconscript(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscript", "IconScript", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
