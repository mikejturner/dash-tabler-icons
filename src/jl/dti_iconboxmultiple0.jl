...
export dti_iconboxmultiple0

"""
    dti_iconboxmultiple0(;kwargs...)

An IconBoxMultiple0 component.
...
"""
function dti_iconboxmultiple0(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple0", "IconBoxMultiple0", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
