...
export dti_iconhexagonnumber3

"""
    dti_iconhexagonnumber3(;kwargs...)

An IconHexagonNumber3 component.
...
"""
function dti_iconhexagonnumber3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonnumber3", "IconHexagonNumber3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
