...
export dti_iconicecream

"""
    dti_iconicecream(;kwargs...)

An IconIceCream component.
...
"""
function dti_iconicecream(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconicecream", "IconIceCream", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
