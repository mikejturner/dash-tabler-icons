...
export dti_iconcurrencyethereum

"""
    dti_iconcurrencyethereum(;kwargs...)

An IconCurrencyEthereum component.
...
"""
function dti_iconcurrencyethereum(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyethereum", "IconCurrencyEthereum", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
