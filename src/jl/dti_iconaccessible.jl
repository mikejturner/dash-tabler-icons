...
export dti_iconaccessible

"""
    dti_iconaccessible(;kwargs...)

An IconAccessible component.
...
"""
function dti_iconaccessible(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaccessible", "IconAccessible", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
