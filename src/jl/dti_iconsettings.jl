...
export dti_iconsettings

"""
    dti_iconsettings(;kwargs...)

An IconSettings component.
...
"""
function dti_iconsettings(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsettings", "IconSettings", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
