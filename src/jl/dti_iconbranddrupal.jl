...
export dti_iconbranddrupal

"""
    dti_iconbranddrupal(;kwargs...)

An IconBrandDrupal component.
...
"""
function dti_iconbranddrupal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddrupal", "IconBrandDrupal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
