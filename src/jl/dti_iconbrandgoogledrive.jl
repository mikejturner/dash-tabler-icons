...
export dti_iconbrandgoogledrive

"""
    dti_iconbrandgoogledrive(;kwargs...)

An IconBrandGoogleDrive component.
...
"""
function dti_iconbrandgoogledrive(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgoogledrive", "IconBrandGoogleDrive", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
