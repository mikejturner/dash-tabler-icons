...
export dti_iconwashdrya

"""
    dti_iconwashdrya(;kwargs...)

An IconWashDryA component.
...
"""
function dti_iconwashdrya(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdrya", "IconWashDryA", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
