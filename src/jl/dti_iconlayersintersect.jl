...
export dti_iconlayersintersect

"""
    dti_iconlayersintersect(;kwargs...)

An IconLayersIntersect component.
...
"""
function dti_iconlayersintersect(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayersintersect", "IconLayersIntersect", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
