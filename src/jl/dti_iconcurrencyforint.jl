...
export dti_iconcurrencyforint

"""
    dti_iconcurrencyforint(;kwargs...)

An IconCurrencyForint component.
...
"""
function dti_iconcurrencyforint(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyforint", "IconCurrencyForint", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
