...
export dti_iconcontrast2

"""
    dti_iconcontrast2(;kwargs...)

An IconContrast2 component.
...
"""
function dti_iconcontrast2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcontrast2", "IconContrast2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
