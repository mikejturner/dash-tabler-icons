...
export dti_iconbackhoe

"""
    dti_iconbackhoe(;kwargs...)

An IconBackhoe component.
...
"""
function dti_iconbackhoe(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbackhoe", "IconBackhoe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
