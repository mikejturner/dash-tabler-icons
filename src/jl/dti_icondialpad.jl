...
export dti_icondialpad

"""
    dti_icondialpad(;kwargs...)

An IconDialpad component.
...
"""
function dti_icondialpad(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondialpad", "IconDialpad", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
