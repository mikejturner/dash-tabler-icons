...
export dti_iconbrandalpinejs

"""
    dti_iconbrandalpinejs(;kwargs...)

An IconBrandAlpineJs component.
...
"""
function dti_iconbrandalpinejs(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandalpinejs", "IconBrandAlpineJs", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
