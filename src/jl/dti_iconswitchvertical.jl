...
export dti_iconswitchvertical

"""
    dti_iconswitchvertical(;kwargs...)

An IconSwitchVertical component.
...
"""
function dti_iconswitchvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconswitchvertical", "IconSwitchVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
