...
export dti_iconmedal

"""
    dti_iconmedal(;kwargs...)

An IconMedal component.
...
"""
function dti_iconmedal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmedal", "IconMedal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
