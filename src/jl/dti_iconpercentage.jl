...
export dti_iconpercentage

"""
    dti_iconpercentage(;kwargs...)

An IconPercentage component.
...
"""
function dti_iconpercentage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpercentage", "IconPercentage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
