...
export dti_iconaperture

"""
    dti_iconaperture(;kwargs...)

An IconAperture component.
...
"""
function dti_iconaperture(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconaperture", "IconAperture", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
