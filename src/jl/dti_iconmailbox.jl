...
export dti_iconmailbox

"""
    dti_iconmailbox(;kwargs...)

An IconMailbox component.
...
"""
function dti_iconmailbox(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmailbox", "IconMailbox", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
