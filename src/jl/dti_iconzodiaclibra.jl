...
export dti_iconzodiaclibra

"""
    dti_iconzodiaclibra(;kwargs...)

An IconZodiacLibra component.
...
"""
function dti_iconzodiaclibra(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiaclibra", "IconZodiacLibra", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
