...
export dti_iconchessbishop

"""
    dti_iconchessbishop(;kwargs...)

An IconChessBishop component.
...
"""
function dti_iconchessbishop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchessbishop", "IconChessBishop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
