...
export dti_iconminus

"""
    dti_iconminus(;kwargs...)

An IconMinus component.
...
"""
function dti_iconminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconminus", "IconMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
