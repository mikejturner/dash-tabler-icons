...
export dti_iconmathnot

"""
    dti_iconmathnot(;kwargs...)

An IconMathNot component.
...
"""
function dti_iconmathnot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmathnot", "IconMathNot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
