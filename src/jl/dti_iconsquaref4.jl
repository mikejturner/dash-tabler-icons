...
export dti_iconsquaref4

"""
    dti_iconsquaref4(;kwargs...)

An IconSquareF4 component.
...
"""
function dti_iconsquaref4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquaref4", "IconSquareF4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
