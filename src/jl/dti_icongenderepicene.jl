...
export dti_icongenderepicene

"""
    dti_icongenderepicene(;kwargs...)

An IconGenderEpicene component.
...
"""
function dti_icongenderepicene(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderepicene", "IconGenderEpicene", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
