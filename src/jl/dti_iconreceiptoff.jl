...
export dti_iconreceiptoff

"""
    dti_iconreceiptoff(;kwargs...)

An IconReceiptOff component.
...
"""
function dti_iconreceiptoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconreceiptoff", "IconReceiptOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
