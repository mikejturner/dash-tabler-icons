...
export dti_iconbrandvolkswagen

"""
    dti_iconbrandvolkswagen(;kwargs...)

An IconBrandVolkswagen component.
...
"""
function dti_iconbrandvolkswagen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandvolkswagen", "IconBrandVolkswagen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
