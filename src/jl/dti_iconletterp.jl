...
export dti_iconletterp

"""
    dti_iconletterp(;kwargs...)

An IconLetterP component.
...
"""
function dti_iconletterp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterp", "IconLetterP", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
