...
export dti_iconbrandgithubcopilot

"""
    dti_iconbrandgithubcopilot(;kwargs...)

An IconBrandGithubCopilot component.
...
"""
function dti_iconbrandgithubcopilot(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgithubcopilot", "IconBrandGithubCopilot", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
