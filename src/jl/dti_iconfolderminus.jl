...
export dti_iconfolderminus

"""
    dti_iconfolderminus(;kwargs...)

An IconFolderMinus component.
...
"""
function dti_iconfolderminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolderminus", "IconFolderMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
