...
export dti_iconbadgesd

"""
    dti_iconbadgesd(;kwargs...)

An IconBadgeSd component.
...
"""
function dti_iconbadgesd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgesd", "IconBadgeSd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
