...
export dti_iconcircledashed

"""
    dti_iconcircledashed(;kwargs...)

An IconCircleDashed component.
...
"""
function dti_iconcircledashed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircledashed", "IconCircleDashed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
