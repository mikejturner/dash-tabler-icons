...
export dti_iconcandyoff

"""
    dti_iconcandyoff(;kwargs...)

An IconCandyOff component.
...
"""
function dti_iconcandyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcandyoff", "IconCandyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
