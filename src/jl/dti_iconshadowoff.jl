...
export dti_iconshadowoff

"""
    dti_iconshadowoff(;kwargs...)

An IconShadowOff component.
...
"""
function dti_iconshadowoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshadowoff", "IconShadowOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
