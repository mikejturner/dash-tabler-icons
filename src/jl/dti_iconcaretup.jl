...
export dti_iconcaretup

"""
    dti_iconcaretup(;kwargs...)

An IconCaretUp component.
...
"""
function dti_iconcaretup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaretup", "IconCaretUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
