...
export dti_iconborderright

"""
    dti_iconborderright(;kwargs...)

An IconBorderRight component.
...
"""
function dti_iconborderright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderright", "IconBorderRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
