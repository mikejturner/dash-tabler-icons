...
export dti_iconcircuitresistor

"""
    dti_iconcircuitresistor(;kwargs...)

An IconCircuitResistor component.
...
"""
function dti_iconcircuitresistor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitresistor", "IconCircuitResistor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
