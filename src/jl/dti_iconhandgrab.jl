...
export dti_iconhandgrab

"""
    dti_iconhandgrab(;kwargs...)

An IconHandGrab component.
...
"""
function dti_iconhandgrab(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandgrab", "IconHandGrab", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
