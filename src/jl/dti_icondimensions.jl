...
export dti_icondimensions

"""
    dti_icondimensions(;kwargs...)

An IconDimensions component.
...
"""
function dti_icondimensions(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondimensions", "IconDimensions", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
