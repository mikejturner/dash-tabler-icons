...
export dti_iconcurrencyguarani

"""
    dti_iconcurrencyguarani(;kwargs...)

An IconCurrencyGuarani component.
...
"""
function dti_iconcurrencyguarani(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyguarani", "IconCurrencyGuarani", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
