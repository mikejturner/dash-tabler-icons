...
export dti_iconcircleletterg

"""
    dti_iconcircleletterg(;kwargs...)

An IconCircleLetterG component.
...
"""
function dti_iconcircleletterg(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterg", "IconCircleLetterG", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
