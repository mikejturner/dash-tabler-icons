...
export dti_iconvaccinebottle

"""
    dti_iconvaccinebottle(;kwargs...)

An IconVaccineBottle component.
...
"""
function dti_iconvaccinebottle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvaccinebottle", "IconVaccineBottle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
