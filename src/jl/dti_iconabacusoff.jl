...
export dti_iconabacusoff

"""
    dti_iconabacusoff(;kwargs...)

An IconAbacusOff component.
...
"""
function dti_iconabacusoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconabacusoff", "IconAbacusOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
