...
export dti_iconcoinmonero

"""
    dti_iconcoinmonero(;kwargs...)

An IconCoinMonero component.
...
"""
function dti_iconcoinmonero(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinmonero", "IconCoinMonero", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
