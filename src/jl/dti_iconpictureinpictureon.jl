...
export dti_iconpictureinpictureon

"""
    dti_iconpictureinpictureon(;kwargs...)

An IconPictureInPictureOn component.
...
"""
function dti_iconpictureinpictureon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpictureinpictureon", "IconPictureInPictureOn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
