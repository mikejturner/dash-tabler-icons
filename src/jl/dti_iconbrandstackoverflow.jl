...
export dti_iconbrandstackoverflow

"""
    dti_iconbrandstackoverflow(;kwargs...)

An IconBrandStackoverflow component.
...
"""
function dti_iconbrandstackoverflow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandstackoverflow", "IconBrandStackoverflow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
