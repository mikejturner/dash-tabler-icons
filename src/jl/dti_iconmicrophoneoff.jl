...
export dti_iconmicrophoneoff

"""
    dti_iconmicrophoneoff(;kwargs...)

An IconMicrophoneOff component.
...
"""
function dti_iconmicrophoneoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmicrophoneoff", "IconMicrophoneOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
