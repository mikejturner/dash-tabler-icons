...
export dti_iconbrandamazon

"""
    dti_iconbrandamazon(;kwargs...)

An IconBrandAmazon component.
...
"""
function dti_iconbrandamazon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandamazon", "IconBrandAmazon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
