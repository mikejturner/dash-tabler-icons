...
export dti_iconsignal5g

"""
    dti_iconsignal5g(;kwargs...)

An IconSignal5g component.
...
"""
function dti_iconsignal5g(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignal5g", "IconSignal5g", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
