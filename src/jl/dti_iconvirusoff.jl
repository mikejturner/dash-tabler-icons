...
export dti_iconvirusoff

"""
    dti_iconvirusoff(;kwargs...)

An IconVirusOff component.
...
"""
function dti_iconvirusoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvirusoff", "IconVirusOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
