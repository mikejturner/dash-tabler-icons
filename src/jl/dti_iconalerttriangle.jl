...
export dti_iconalerttriangle

"""
    dti_iconalerttriangle(;kwargs...)

An IconAlertTriangle component.
...
"""
function dti_iconalerttriangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalerttriangle", "IconAlertTriangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
