...
export dti_iconspacinghorizontal

"""
    dti_iconspacinghorizontal(;kwargs...)

An IconSpacingHorizontal component.
...
"""
function dti_iconspacinghorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspacinghorizontal", "IconSpacingHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
