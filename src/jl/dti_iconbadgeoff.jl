...
export dti_iconbadgeoff

"""
    dti_iconbadgeoff(;kwargs...)

An IconBadgeOff component.
...
"""
function dti_iconbadgeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbadgeoff", "IconBadgeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
