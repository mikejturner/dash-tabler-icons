...
export dti_iconfloatcenter

"""
    dti_iconfloatcenter(;kwargs...)

An IconFloatCenter component.
...
"""
function dti_iconfloatcenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfloatcenter", "IconFloatCenter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
