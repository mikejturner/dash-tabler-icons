...
export dti_iconplaycardoff

"""
    dti_iconplaycardoff(;kwargs...)

An IconPlayCardOff component.
...
"""
function dti_iconplaycardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaycardoff", "IconPlayCardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
