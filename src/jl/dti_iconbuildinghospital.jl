...
export dti_iconbuildinghospital

"""
    dti_iconbuildinghospital(;kwargs...)

An IconBuildingHospital component.
...
"""
function dti_iconbuildinghospital(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbuildinghospital", "IconBuildingHospital", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
