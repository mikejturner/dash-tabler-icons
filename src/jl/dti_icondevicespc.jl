...
export dti_icondevicespc

"""
    dti_icondevicespc(;kwargs...)

An IconDevicesPc component.
...
"""
function dti_icondevicespc(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicespc", "IconDevicesPc", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
