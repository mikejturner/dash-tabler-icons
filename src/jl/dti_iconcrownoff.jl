...
export dti_iconcrownoff

"""
    dti_iconcrownoff(;kwargs...)

An IconCrownOff component.
...
"""
function dti_iconcrownoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrownoff", "IconCrownOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
