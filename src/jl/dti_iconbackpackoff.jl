...
export dti_iconbackpackoff

"""
    dti_iconbackpackoff(;kwargs...)

An IconBackpackOff component.
...
"""
function dti_iconbackpackoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbackpackoff", "IconBackpackOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
