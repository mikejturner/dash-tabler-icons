...
export dti_icondnaoff

"""
    dti_icondnaoff(;kwargs...)

An IconDnaOff component.
...
"""
function dti_icondnaoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondnaoff", "IconDnaOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
