...
export dti_iconstormoff

"""
    dti_iconstormoff(;kwargs...)

An IconStormOff component.
...
"""
function dti_iconstormoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconstormoff", "IconStormOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
