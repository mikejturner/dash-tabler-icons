...
export dti_iconbandage

"""
    dti_iconbandage(;kwargs...)

An IconBandage component.
...
"""
function dti_iconbandage(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbandage", "IconBandage", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
