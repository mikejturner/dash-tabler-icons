...
export dti_iconlocation

"""
    dti_iconlocation(;kwargs...)

An IconLocation component.
...
"""
function dti_iconlocation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlocation", "IconLocation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
