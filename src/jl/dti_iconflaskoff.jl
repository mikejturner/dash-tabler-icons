...
export dti_iconflaskoff

"""
    dti_iconflaskoff(;kwargs...)

An IconFlaskOff component.
...
"""
function dti_iconflaskoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflaskoff", "IconFlaskOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
