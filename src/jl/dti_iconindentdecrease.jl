...
export dti_iconindentdecrease

"""
    dti_iconindentdecrease(;kwargs...)

An IconIndentDecrease component.
...
"""
function dti_iconindentdecrease(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconindentdecrease", "IconIndentDecrease", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
