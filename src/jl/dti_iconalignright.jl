...
export dti_iconalignright

"""
    dti_iconalignright(;kwargs...)

An IconAlignRight component.
...
"""
function dti_iconalignright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignright", "IconAlignRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
