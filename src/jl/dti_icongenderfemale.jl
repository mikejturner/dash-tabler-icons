...
export dti_icongenderfemale

"""
    dti_icongenderfemale(;kwargs...)

An IconGenderFemale component.
...
"""
function dti_icongenderfemale(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderfemale", "IconGenderFemale", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
