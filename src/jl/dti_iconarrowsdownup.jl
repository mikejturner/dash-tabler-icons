...
export dti_iconarrowsdownup

"""
    dti_iconarrowsdownup(;kwargs...)

An IconArrowsDownUp component.
...
"""
function dti_iconarrowsdownup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdownup", "IconArrowsDownUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
