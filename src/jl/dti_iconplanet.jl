...
export dti_iconplanet

"""
    dti_iconplanet(;kwargs...)

An IconPlanet component.
...
"""
function dti_iconplanet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplanet", "IconPlanet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
