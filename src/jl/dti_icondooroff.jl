...
export dti_icondooroff

"""
    dti_icondooroff(;kwargs...)

An IconDoorOff component.
...
"""
function dti_icondooroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondooroff", "IconDoorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
