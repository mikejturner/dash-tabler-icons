...
export dti_iconarrowwaveleftdown

"""
    dti_iconarrowwaveleftdown(;kwargs...)

An IconArrowWaveLeftDown component.
...
"""
function dti_iconarrowwaveleftdown(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowwaveleftdown", "IconArrowWaveLeftDown", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
