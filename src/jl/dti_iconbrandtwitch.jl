...
export dti_iconbrandtwitch

"""
    dti_iconbrandtwitch(;kwargs...)

An IconBrandTwitch component.
...
"""
function dti_iconbrandtwitch(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandtwitch", "IconBrandTwitch", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
