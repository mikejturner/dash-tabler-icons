...
export dti_iconcategory

"""
    dti_iconcategory(;kwargs...)

An IconCategory component.
...
"""
function dti_iconcategory(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcategory", "IconCategory", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
