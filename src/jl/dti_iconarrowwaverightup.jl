...
export dti_iconarrowwaverightup

"""
    dti_iconarrowwaverightup(;kwargs...)

An IconArrowWaveRightUp component.
...
"""
function dti_iconarrowwaverightup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowwaverightup", "IconArrowWaveRightUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
