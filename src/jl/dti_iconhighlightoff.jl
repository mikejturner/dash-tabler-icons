...
export dti_iconhighlightoff

"""
    dti_iconhighlightoff(;kwargs...)

An IconHighlightOff component.
...
"""
function dti_iconhighlightoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhighlightoff", "IconHighlightOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
