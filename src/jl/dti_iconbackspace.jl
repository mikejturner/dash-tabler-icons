...
export dti_iconbackspace

"""
    dti_iconbackspace(;kwargs...)

An IconBackspace component.
...
"""
function dti_iconbackspace(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbackspace", "IconBackspace", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
