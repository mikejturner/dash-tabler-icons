...
export dti_iconhighlight

"""
    dti_iconhighlight(;kwargs...)

An IconHighlight component.
...
"""
function dti_iconhighlight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhighlight", "IconHighlight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
