...
export dti_iconshipoff

"""
    dti_iconshipoff(;kwargs...)

An IconShipOff component.
...
"""
function dti_iconshipoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshipoff", "IconShipOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
