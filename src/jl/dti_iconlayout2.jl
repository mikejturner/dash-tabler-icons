...
export dti_iconlayout2

"""
    dti_iconlayout2(;kwargs...)

An IconLayout2 component.
...
"""
function dti_iconlayout2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayout2", "IconLayout2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
