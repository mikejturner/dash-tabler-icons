...
export dti_iconurgent

"""
    dti_iconurgent(;kwargs...)

An IconUrgent component.
...
"""
function dti_iconurgent(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconurgent", "IconUrgent", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
