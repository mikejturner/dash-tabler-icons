...
export dti_iconcertificate2

"""
    dti_iconcertificate2(;kwargs...)

An IconCertificate2 component.
...
"""
function dti_iconcertificate2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcertificate2", "IconCertificate2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
