...
export dti_iconalertcircle

"""
    dti_iconalertcircle(;kwargs...)

An IconAlertCircle component.
...
"""
function dti_iconalertcircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalertcircle", "IconAlertCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
