...
export dti_iconfolderplus

"""
    dti_iconfolderplus(;kwargs...)

An IconFolderPlus component.
...
"""
function dti_iconfolderplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolderplus", "IconFolderPlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
