...
export dti_iconcrutches

"""
    dti_iconcrutches(;kwargs...)

An IconCrutches component.
...
"""
function dti_iconcrutches(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcrutches", "IconCrutches", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
