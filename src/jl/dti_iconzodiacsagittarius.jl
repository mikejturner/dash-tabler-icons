...
export dti_iconzodiacsagittarius

"""
    dti_iconzodiacsagittarius(;kwargs...)

An IconZodiacSagittarius component.
...
"""
function dti_iconzodiacsagittarius(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacsagittarius", "IconZodiacSagittarius", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
