...
export dti_iconwandoff

"""
    dti_iconwandoff(;kwargs...)

An IconWandOff component.
...
"""
function dti_iconwandoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwandoff", "IconWandOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
