...
export dti_iconrollercoaster

"""
    dti_iconrollercoaster(;kwargs...)

An IconRollercoaster component.
...
"""
function dti_iconrollercoaster(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrollercoaster", "IconRollercoaster", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
