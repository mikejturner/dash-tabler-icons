...
export dti_icondogbowl

"""
    dti_icondogbowl(;kwargs...)

An IconDogBowl component.
...
"""
function dti_icondogbowl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondogbowl", "IconDogBowl", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
