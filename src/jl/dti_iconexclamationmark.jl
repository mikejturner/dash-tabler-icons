...
export dti_iconexclamationmark

"""
    dti_iconexclamationmark(;kwargs...)

An IconExclamationMark component.
...
"""
function dti_iconexclamationmark(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexclamationmark", "IconExclamationMark", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
