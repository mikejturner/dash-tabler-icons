...
export dti_iconsailboat

"""
    dti_iconsailboat(;kwargs...)

An IconSailboat component.
...
"""
function dti_iconsailboat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsailboat", "IconSailboat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
