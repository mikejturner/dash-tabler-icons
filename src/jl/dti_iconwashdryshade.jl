...
export dti_iconwashdryshade

"""
    dti_iconwashdryshade(;kwargs...)

An IconWashDryShade component.
...
"""
function dti_iconwashdryshade(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashdryshade", "IconWashDryShade", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
