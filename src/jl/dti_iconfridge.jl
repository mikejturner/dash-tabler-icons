...
export dti_iconfridge

"""
    dti_iconfridge(;kwargs...)

An IconFridge component.
...
"""
function dti_iconfridge(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfridge", "IconFridge", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
