...
export dti_iconnumber6

"""
    dti_iconnumber6(;kwargs...)

An IconNumber6 component.
...
"""
function dti_iconnumber6(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber6", "IconNumber6", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
