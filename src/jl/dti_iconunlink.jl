...
export dti_iconunlink

"""
    dti_iconunlink(;kwargs...)

An IconUnlink component.
...
"""
function dti_iconunlink(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconunlink", "IconUnlink", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
