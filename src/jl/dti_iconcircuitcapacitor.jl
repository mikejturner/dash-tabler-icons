...
export dti_iconcircuitcapacitor

"""
    dti_iconcircuitcapacitor(;kwargs...)

An IconCircuitCapacitor component.
...
"""
function dti_iconcircuitcapacitor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitcapacitor", "IconCircuitCapacitor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
