...
export dti_icondevicetablet

"""
    dti_icondevicetablet(;kwargs...)

An IconDeviceTablet component.
...
"""
function dti_icondevicetablet(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicetablet", "IconDeviceTablet", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
