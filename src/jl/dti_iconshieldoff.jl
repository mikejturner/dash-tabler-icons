...
export dti_iconshieldoff

"""
    dti_iconshieldoff(;kwargs...)

An IconShieldOff component.
...
"""
function dti_iconshieldoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshieldoff", "IconShieldOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
