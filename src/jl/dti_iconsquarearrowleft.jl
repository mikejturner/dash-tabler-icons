...
export dti_iconsquarearrowleft

"""
    dti_iconsquarearrowleft(;kwargs...)

An IconSquareArrowLeft component.
...
"""
function dti_iconsquarearrowleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarearrowleft", "IconSquareArrowLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
