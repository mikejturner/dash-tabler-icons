...
export dti_iconzoommoney

"""
    dti_iconzoommoney(;kwargs...)

An IconZoomMoney component.
...
"""
function dti_iconzoommoney(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoommoney", "IconZoomMoney", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
