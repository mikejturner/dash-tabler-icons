...
export dti_iconplaycard

"""
    dti_iconplaycard(;kwargs...)

An IconPlayCard component.
...
"""
function dti_iconplaycard(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaycard", "IconPlayCard", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
