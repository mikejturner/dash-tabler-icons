...
export dti_iconcreativecommonsoff

"""
    dti_iconcreativecommonsoff(;kwargs...)

An IconCreativeCommonsOff component.
...
"""
function dti_iconcreativecommonsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommonsoff", "IconCreativeCommonsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
