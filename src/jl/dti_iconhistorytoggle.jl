...
export dti_iconhistorytoggle

"""
    dti_iconhistorytoggle(;kwargs...)

An IconHistoryToggle component.
...
"""
function dti_iconhistorytoggle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhistorytoggle", "IconHistoryToggle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
