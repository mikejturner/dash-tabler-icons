...
export dti_iconbranddrops

"""
    dti_iconbranddrops(;kwargs...)

An IconBrandDrops component.
...
"""
function dti_iconbranddrops(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddrops", "IconBrandDrops", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
