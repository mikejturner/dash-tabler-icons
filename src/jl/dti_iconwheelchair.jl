...
export dti_iconwheelchair

"""
    dti_iconwheelchair(;kwargs...)

An IconWheelchair component.
...
"""
function dti_iconwheelchair(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwheelchair", "IconWheelchair", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
