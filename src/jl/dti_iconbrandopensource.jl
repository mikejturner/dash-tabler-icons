...
export dti_iconbrandopensource

"""
    dti_iconbrandopensource(;kwargs...)

An IconBrandOpenSource component.
...
"""
function dti_iconbrandopensource(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandopensource", "IconBrandOpenSource", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
