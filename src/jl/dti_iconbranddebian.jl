...
export dti_iconbranddebian

"""
    dti_iconbranddebian(;kwargs...)

An IconBrandDebian component.
...
"""
function dti_iconbranddebian(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddebian", "IconBrandDebian", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
