...
export dti_iconchartcircles

"""
    dti_iconchartcircles(;kwargs...)

An IconChartCircles component.
...
"""
function dti_iconchartcircles(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartcircles", "IconChartCircles", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
