...
export dti_iconlistcheck

"""
    dti_iconlistcheck(;kwargs...)

An IconListCheck component.
...
"""
function dti_iconlistcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlistcheck", "IconListCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
