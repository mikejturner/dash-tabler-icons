...
export dti_icontextrecognition

"""
    dti_icontextrecognition(;kwargs...)

An IconTextRecognition component.
...
"""
function dti_icontextrecognition(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextrecognition", "IconTextRecognition", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
