...
export dti_iconrazor

"""
    dti_iconrazor(;kwargs...)

An IconRazor component.
...
"""
function dti_iconrazor(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrazor", "IconRazor", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
