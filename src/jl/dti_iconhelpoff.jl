...
export dti_iconhelpoff

"""
    dti_iconhelpoff(;kwargs...)

An IconHelpOff component.
...
"""
function dti_iconhelpoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhelpoff", "IconHelpOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
