...
export dti_iconclockhour12

"""
    dti_iconclockhour12(;kwargs...)

An IconClockHour12 component.
...
"""
function dti_iconclockhour12(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclockhour12", "IconClockHour12", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
