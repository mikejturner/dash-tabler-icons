...
export dti_iconfileexport

"""
    dti_iconfileexport(;kwargs...)

An IconFileExport component.
...
"""
function dti_iconfileexport(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileexport", "IconFileExport", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
