...
export dti_iconboxmultiple3

"""
    dti_iconboxmultiple3(;kwargs...)

An IconBoxMultiple3 component.
...
"""
function dti_iconboxmultiple3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconboxmultiple3", "IconBoxMultiple3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
