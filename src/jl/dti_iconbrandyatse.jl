...
export dti_iconbrandyatse

"""
    dti_iconbrandyatse(;kwargs...)

An IconBrandYatse component.
...
"""
function dti_iconbrandyatse(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandyatse", "IconBrandYatse", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
