...
export dti_iconwheelchairoff

"""
    dti_iconwheelchairoff(;kwargs...)

An IconWheelchairOff component.
...
"""
function dti_iconwheelchairoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwheelchairoff", "IconWheelchairOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
