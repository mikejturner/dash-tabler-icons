...
export dti_iconsignatureoff

"""
    dti_iconsignatureoff(;kwargs...)

An IconSignatureOff component.
...
"""
function dti_iconsignatureoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsignatureoff", "IconSignatureOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
