...
export dti_iconmessages

"""
    dti_iconmessages(;kwargs...)

An IconMessages component.
...
"""
function dti_iconmessages(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessages", "IconMessages", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
