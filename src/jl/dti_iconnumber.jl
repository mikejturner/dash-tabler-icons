...
export dti_iconnumber

"""
    dti_iconnumber(;kwargs...)

An IconNumber component.
...
"""
function dti_iconnumber(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber", "IconNumber", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
