...
export dti_iconartboardoff

"""
    dti_iconartboardoff(;kwargs...)

An IconArtboardOff component.
...
"""
function dti_iconartboardoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconartboardoff", "IconArtboardOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
