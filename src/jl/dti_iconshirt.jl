...
export dti_iconshirt

"""
    dti_iconshirt(;kwargs...)

An IconShirt component.
...
"""
function dti_iconshirt(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshirt", "IconShirt", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
