...
export dti_iconsunrise

"""
    dti_iconsunrise(;kwargs...)

An IconSunrise component.
...
"""
function dti_iconsunrise(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunrise", "IconSunrise", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
