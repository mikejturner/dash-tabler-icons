...
export dti_iconhandlittlefinger

"""
    dti_iconhandlittlefinger(;kwargs...)

An IconHandLittleFinger component.
...
"""
function dti_iconhandlittlefinger(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhandlittlefinger", "IconHandLittleFinger", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
