...
export dti_iconperspectiveoff

"""
    dti_iconperspectiveoff(;kwargs...)

An IconPerspectiveOff component.
...
"""
function dti_iconperspectiveoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconperspectiveoff", "IconPerspectiveOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
