...
export dti_iconbrandsass

"""
    dti_iconbrandsass(;kwargs...)

An IconBrandSass component.
...
"""
function dti_iconbrandsass(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsass", "IconBrandSass", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
