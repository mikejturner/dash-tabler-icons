...
export dti_iconarrowwaveleftup

"""
    dti_iconarrowwaveleftup(;kwargs...)

An IconArrowWaveLeftUp component.
...
"""
function dti_iconarrowwaveleftup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowwaveleftup", "IconArrowWaveLeftUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
