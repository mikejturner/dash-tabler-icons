...
export dti_iconzodiacaquarius

"""
    dti_iconzodiacaquarius(;kwargs...)

An IconZodiacAquarius component.
...
"""
function dti_iconzodiacaquarius(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacaquarius", "IconZodiacAquarius", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
