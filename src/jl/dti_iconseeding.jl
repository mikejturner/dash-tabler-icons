...
export dti_iconseeding

"""
    dti_iconseeding(;kwargs...)

An IconSeeding component.
...
"""
function dti_iconseeding(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconseeding", "IconSeeding", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
