...
export dti_iconcircuitbattery

"""
    dti_iconcircuitbattery(;kwargs...)

An IconCircuitBattery component.
...
"""
function dti_iconcircuitbattery(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircuitbattery", "IconCircuitBattery", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
