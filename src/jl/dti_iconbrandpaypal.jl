...
export dti_iconbrandpaypal

"""
    dti_iconbrandpaypal(;kwargs...)

An IconBrandPaypal component.
...
"""
function dti_iconbrandpaypal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandpaypal", "IconBrandPaypal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
