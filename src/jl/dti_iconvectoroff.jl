...
export dti_iconvectoroff

"""
    dti_iconvectoroff(;kwargs...)

An IconVectorOff component.
...
"""
function dti_iconvectoroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvectoroff", "IconVectorOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
