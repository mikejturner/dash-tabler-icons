...
export dti_iconbrandsnapseed

"""
    dti_iconbrandsnapseed(;kwargs...)

An IconBrandSnapseed component.
...
"""
function dti_iconbrandsnapseed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsnapseed", "IconBrandSnapseed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
