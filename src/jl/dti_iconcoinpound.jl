...
export dti_iconcoinpound

"""
    dti_iconcoinpound(;kwargs...)

An IconCoinPound component.
...
"""
function dti_iconcoinpound(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinpound", "IconCoinPound", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
