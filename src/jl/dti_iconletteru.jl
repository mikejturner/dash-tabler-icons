...
export dti_iconletteru

"""
    dti_iconletteru(;kwargs...)

An IconLetterU component.
...
"""
function dti_iconletteru(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletteru", "IconLetterU", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
