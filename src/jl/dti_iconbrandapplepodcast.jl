...
export dti_iconbrandapplepodcast

"""
    dti_iconbrandapplepodcast(;kwargs...)

An IconBrandApplePodcast component.
...
"""
function dti_iconbrandapplepodcast(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandapplepodcast", "IconBrandApplePodcast", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
