...
export dti_iconusercircle

"""
    dti_iconusercircle(;kwargs...)

An IconUserCircle component.
...
"""
function dti_iconusercircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconusercircle", "IconUserCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
