...
export dti_iconheadsetoff

"""
    dti_iconheadsetoff(;kwargs...)

An IconHeadsetOff component.
...
"""
function dti_iconheadsetoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheadsetoff", "IconHeadsetOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
