...
export dti_iconsunlow

"""
    dti_iconsunlow(;kwargs...)

An IconSunLow component.
...
"""
function dti_iconsunlow(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsunlow", "IconSunLow", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
