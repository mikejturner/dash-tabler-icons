...
export dti_icontilde

"""
    dti_icontilde(;kwargs...)

An IconTilde component.
...
"""
function dti_icontilde(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontilde", "IconTilde", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
