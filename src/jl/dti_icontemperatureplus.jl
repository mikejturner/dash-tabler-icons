...
export dti_icontemperatureplus

"""
    dti_icontemperatureplus(;kwargs...)

An IconTemperaturePlus component.
...
"""
function dti_icontemperatureplus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontemperatureplus", "IconTemperaturePlus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
