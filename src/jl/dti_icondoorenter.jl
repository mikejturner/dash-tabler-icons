...
export dti_icondoorenter

"""
    dti_icondoorenter(;kwargs...)

An IconDoorEnter component.
...
"""
function dti_icondoorenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondoorenter", "IconDoorEnter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
