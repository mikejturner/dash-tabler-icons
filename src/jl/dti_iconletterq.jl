...
export dti_iconletterq

"""
    dti_iconletterq(;kwargs...)

An IconLetterQ component.
...
"""
function dti_iconletterq(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterq", "IconLetterQ", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
