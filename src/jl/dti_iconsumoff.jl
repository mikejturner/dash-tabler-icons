...
export dti_iconsumoff

"""
    dti_iconsumoff(;kwargs...)

An IconSumOff component.
...
"""
function dti_iconsumoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsumoff", "IconSumOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
