...
export dti_iconpyramidoff

"""
    dti_iconpyramidoff(;kwargs...)

An IconPyramidOff component.
...
"""
function dti_iconpyramidoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpyramidoff", "IconPyramidOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
