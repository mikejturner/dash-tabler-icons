...
export dti_iconmoodwrrr

"""
    dti_iconmoodwrrr(;kwargs...)

An IconMoodWrrr component.
...
"""
function dti_iconmoodwrrr(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodwrrr", "IconMoodWrrr", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
