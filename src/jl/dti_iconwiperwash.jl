...
export dti_iconwiperwash

"""
    dti_iconwiperwash(;kwargs...)

An IconWiperWash component.
...
"""
function dti_iconwiperwash(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwiperwash", "IconWiperWash", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
