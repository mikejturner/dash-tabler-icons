...
export dti_iconsquarenumber7

"""
    dti_iconsquarenumber7(;kwargs...)

An IconSquareNumber7 component.
...
"""
function dti_iconsquarenumber7(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber7", "IconSquareNumber7", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
