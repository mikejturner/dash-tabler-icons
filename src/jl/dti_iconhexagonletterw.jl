...
export dti_iconhexagonletterw

"""
    dti_iconhexagonletterw(;kwargs...)

An IconHexagonLetterW component.
...
"""
function dti_iconhexagonletterw(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonletterw", "IconHexagonLetterW", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
