...
export dti_iconripple

"""
    dti_iconripple(;kwargs...)

An IconRipple component.
...
"""
function dti_iconripple(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconripple", "IconRipple", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
