...
export dti_iconfolder

"""
    dti_iconfolder(;kwargs...)

An IconFolder component.
...
"""
function dti_iconfolder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfolder", "IconFolder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
