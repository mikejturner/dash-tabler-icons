...
export dti_iconcactusoff

"""
    dti_iconcactusoff(;kwargs...)

An IconCactusOff component.
...
"""
function dti_iconcactusoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcactusoff", "IconCactusOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
