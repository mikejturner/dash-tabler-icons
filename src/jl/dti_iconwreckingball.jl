...
export dti_iconwreckingball

"""
    dti_iconwreckingball(;kwargs...)

An IconWreckingBall component.
...
"""
function dti_iconwreckingball(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwreckingball", "IconWreckingBall", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
