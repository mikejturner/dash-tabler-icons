...
export dti_iconnumber3

"""
    dti_iconnumber3(;kwargs...)

An IconNumber3 component.
...
"""
function dti_iconnumber3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber3", "IconNumber3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
