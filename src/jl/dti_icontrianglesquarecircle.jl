...
export dti_icontrianglesquarecircle

"""
    dti_icontrianglesquarecircle(;kwargs...)

An IconTriangleSquareCircle component.
...
"""
function dti_icontrianglesquarecircle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrianglesquarecircle", "IconTriangleSquareCircle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
