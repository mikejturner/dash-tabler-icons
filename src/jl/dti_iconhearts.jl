...
export dti_iconhearts

"""
    dti_iconhearts(;kwargs...)

An IconHearts component.
...
"""
function dti_iconhearts(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhearts", "IconHearts", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
