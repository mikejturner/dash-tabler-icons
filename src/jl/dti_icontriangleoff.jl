...
export dti_icontriangleoff

"""
    dti_icontriangleoff(;kwargs...)

An IconTriangleOff component.
...
"""
function dti_icontriangleoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontriangleoff", "IconTriangleOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
