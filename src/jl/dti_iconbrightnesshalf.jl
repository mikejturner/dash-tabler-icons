...
export dti_iconbrightnesshalf

"""
    dti_iconbrightnesshalf(;kwargs...)

An IconBrightnessHalf component.
...
"""
function dti_iconbrightnesshalf(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrightnesshalf", "IconBrightnessHalf", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
