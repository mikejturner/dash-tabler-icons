...
export dti_iconnotification

"""
    dti_iconnotification(;kwargs...)

An IconNotification component.
...
"""
function dti_iconnotification(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnotification", "IconNotification", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
