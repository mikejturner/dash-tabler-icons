...
export dti_iconcirclex

"""
    dti_iconcirclex(;kwargs...)

An IconCircleX component.
...
"""
function dti_iconcirclex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcirclex", "IconCircleX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
