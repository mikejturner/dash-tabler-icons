...
export dti_iconalignboxbottomcenter

"""
    dti_iconalignboxbottomcenter(;kwargs...)

An IconAlignBoxBottomCenter component.
...
"""
function dti_iconalignboxbottomcenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxbottomcenter", "IconAlignBoxBottomCenter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
