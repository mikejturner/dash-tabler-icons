...
export dti_iconcircleletterd

"""
    dti_iconcircleletterd(;kwargs...)

An IconCircleLetterD component.
...
"""
function dti_iconcircleletterd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcircleletterd", "IconCircleLetterD", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
