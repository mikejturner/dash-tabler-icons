...
export dti_iconbookupload

"""
    dti_iconbookupload(;kwargs...)

An IconBookUpload component.
...
"""
function dti_iconbookupload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbookupload", "IconBookUpload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
