...
export dti_iconfingerprintoff

"""
    dti_iconfingerprintoff(;kwargs...)

An IconFingerprintOff component.
...
"""
function dti_iconfingerprintoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfingerprintoff", "IconFingerprintOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
