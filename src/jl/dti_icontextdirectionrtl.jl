...
export dti_icontextdirectionrtl

"""
    dti_icontextdirectionrtl(;kwargs...)

An IconTextDirectionRtl component.
...
"""
function dti_icontextdirectionrtl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontextdirectionrtl", "IconTextDirectionRtl", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
