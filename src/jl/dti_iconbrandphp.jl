...
export dti_iconbrandphp

"""
    dti_iconbrandphp(;kwargs...)

An IconBrandPhp component.
...
"""
function dti_iconbrandphp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandphp", "IconBrandPhp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
