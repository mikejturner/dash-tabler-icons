...
export dti_iconbranddjango

"""
    dti_iconbranddjango(;kwargs...)

An IconBrandDjango component.
...
"""
function dti_iconbranddjango(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddjango", "IconBrandDjango", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
