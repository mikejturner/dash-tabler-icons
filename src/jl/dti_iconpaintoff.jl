...
export dti_iconpaintoff

"""
    dti_iconpaintoff(;kwargs...)

An IconPaintOff component.
...
"""
function dti_iconpaintoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpaintoff", "IconPaintOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
