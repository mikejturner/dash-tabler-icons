...
export dti_iconcurrencyrupeenepalese

"""
    dti_iconcurrencyrupeenepalese(;kwargs...)

An IconCurrencyRupeeNepalese component.
...
"""
function dti_iconcurrencyrupeenepalese(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencyrupeenepalese", "IconCurrencyRupeeNepalese", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
