...
export dti_iconhexagonsoff

"""
    dti_iconhexagonsoff(;kwargs...)

An IconHexagonsOff component.
...
"""
function dti_iconhexagonsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconhexagonsoff", "IconHexagonsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
