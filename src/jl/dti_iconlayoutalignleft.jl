...
export dti_iconlayoutalignleft

"""
    dti_iconlayoutalignleft(;kwargs...)

An IconLayoutAlignLeft component.
...
"""
function dti_iconlayoutalignleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutalignleft", "IconLayoutAlignLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
