...
export dti_icongrillfork

"""
    dti_icongrillfork(;kwargs...)

An IconGrillFork component.
...
"""
function dti_icongrillfork(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongrillfork", "IconGrillFork", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
