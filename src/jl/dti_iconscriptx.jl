...
export dti_iconscriptx

"""
    dti_iconscriptx(;kwargs...)

An IconScriptX component.
...
"""
function dti_iconscriptx(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscriptx", "IconScriptX", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
