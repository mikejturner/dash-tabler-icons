...
export dti_icontallymark3

"""
    dti_icontallymark3(;kwargs...)

An IconTallymark3 component.
...
"""
function dti_icontallymark3(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontallymark3", "IconTallymark3", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
