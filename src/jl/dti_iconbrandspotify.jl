...
export dti_iconbrandspotify

"""
    dti_iconbrandspotify(;kwargs...)

An IconBrandSpotify component.
...
"""
function dti_iconbrandspotify(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandspotify", "IconBrandSpotify", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
