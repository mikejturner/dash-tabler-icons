...
export dti_iconvariableminus

"""
    dti_iconvariableminus(;kwargs...)

An IconVariableMinus component.
...
"""
function dti_iconvariableminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvariableminus", "IconVariableMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
