...
export dti_iconcreativecommonsby

"""
    dti_iconcreativecommonsby(;kwargs...)

An IconCreativeCommonsBy component.
...
"""
function dti_iconcreativecommonsby(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcreativecommonsby", "IconCreativeCommonsBy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
