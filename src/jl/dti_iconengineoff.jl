...
export dti_iconengineoff

"""
    dti_iconengineoff(;kwargs...)

An IconEngineOff component.
...
"""
function dti_iconengineoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconengineoff", "IconEngineOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
