...
export dti_iconlinedashed

"""
    dti_iconlinedashed(;kwargs...)

An IconLineDashed component.
...
"""
function dti_iconlinedashed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlinedashed", "IconLineDashed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
