...
export dti_iconclothesrackoff

"""
    dti_iconclothesrackoff(;kwargs...)

An IconClothesRackOff component.
...
"""
function dti_iconclothesrackoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconclothesrackoff", "IconClothesRackOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
