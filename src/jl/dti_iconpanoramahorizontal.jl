...
export dti_iconpanoramahorizontal

"""
    dti_iconpanoramahorizontal(;kwargs...)

An IconPanoramaHorizontal component.
...
"""
function dti_iconpanoramahorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpanoramahorizontal", "IconPanoramaHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
