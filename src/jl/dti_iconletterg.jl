...
export dti_iconletterg

"""
    dti_iconletterg(;kwargs...)

An IconLetterG component.
...
"""
function dti_iconletterg(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterg", "IconLetterG", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
