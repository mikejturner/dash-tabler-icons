...
export dti_iconarrowsdoubleswne

"""
    dti_iconarrowsdoubleswne(;kwargs...)

An IconArrowsDoubleSwNe component.
...
"""
function dti_iconarrowsdoubleswne(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsdoubleswne", "IconArrowsDoubleSwNe", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
