...
export dti_iconcomponentsoff

"""
    dti_iconcomponentsoff(;kwargs...)

An IconComponentsOff component.
...
"""
function dti_iconcomponentsoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcomponentsoff", "IconComponentsOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
