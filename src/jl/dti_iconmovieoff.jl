...
export dti_iconmovieoff

"""
    dti_iconmovieoff(;kwargs...)

An IconMovieOff component.
...
"""
function dti_iconmovieoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmovieoff", "IconMovieOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
