...
export dti_icondna2off

"""
    dti_icondna2off(;kwargs...)

An IconDna2Off component.
...
"""
function dti_icondna2off(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondna2off", "IconDna2Off", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
