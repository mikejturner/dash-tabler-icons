...
export dti_iconbible

"""
    dti_iconbible(;kwargs...)

An IconBible component.
...
"""
function dti_iconbible(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbible", "IconBible", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
