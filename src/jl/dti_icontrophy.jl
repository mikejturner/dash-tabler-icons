...
export dti_icontrophy

"""
    dti_icontrophy(;kwargs...)

An IconTrophy component.
...
"""
function dti_icontrophy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrophy", "IconTrophy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
