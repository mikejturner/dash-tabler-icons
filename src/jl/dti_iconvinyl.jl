...
export dti_iconvinyl

"""
    dti_iconvinyl(;kwargs...)

An IconVinyl component.
...
"""
function dti_iconvinyl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvinyl", "IconVinyl", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
