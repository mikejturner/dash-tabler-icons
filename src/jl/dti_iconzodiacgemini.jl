...
export dti_iconzodiacgemini

"""
    dti_iconzodiacgemini(;kwargs...)

An IconZodiacGemini component.
...
"""
function dti_iconzodiacgemini(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzodiacgemini", "IconZodiacGemini", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
