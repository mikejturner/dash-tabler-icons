...
export dti_iconinnershadowbottomleft

"""
    dti_iconinnershadowbottomleft(;kwargs...)

An IconInnerShadowBottomLeft component.
...
"""
function dti_iconinnershadowbottomleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowbottomleft", "IconInnerShadowBottomLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
