...
export dti_iconcalendarstats

"""
    dti_iconcalendarstats(;kwargs...)

An IconCalendarStats component.
...
"""
function dti_iconcalendarstats(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendarstats", "IconCalendarStats", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
