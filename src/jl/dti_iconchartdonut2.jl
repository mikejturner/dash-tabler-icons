...
export dti_iconchartdonut2

"""
    dti_iconchartdonut2(;kwargs...)

An IconChartDonut2 component.
...
"""
function dti_iconchartdonut2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchartdonut2", "IconChartDonut2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
