...
export dti_iconphonecheck

"""
    dti_iconphonecheck(;kwargs...)

An IconPhoneCheck component.
...
"""
function dti_iconphonecheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphonecheck", "IconPhoneCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
