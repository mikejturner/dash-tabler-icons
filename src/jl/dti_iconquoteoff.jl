...
export dti_iconquoteoff

"""
    dti_iconquoteoff(;kwargs...)

An IconQuoteOff component.
...
"""
function dti_iconquoteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconquoteoff", "IconQuoteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
