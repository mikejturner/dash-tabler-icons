...
export dti_iconscreenshare

"""
    dti_iconscreenshare(;kwargs...)

An IconScreenShare component.
...
"""
function dti_iconscreenshare(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconscreenshare", "IconScreenShare", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
