...
export dti_iconspeedboat

"""
    dti_iconspeedboat(;kwargs...)

An IconSpeedboat component.
...
"""
function dti_iconspeedboat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspeedboat", "IconSpeedboat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
