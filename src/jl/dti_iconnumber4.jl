...
export dti_iconnumber4

"""
    dti_iconnumber4(;kwargs...)

An IconNumber4 component.
...
"""
function dti_iconnumber4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnumber4", "IconNumber4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
