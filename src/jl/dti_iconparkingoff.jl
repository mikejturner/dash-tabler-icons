...
export dti_iconparkingoff

"""
    dti_iconparkingoff(;kwargs...)

An IconParkingOff component.
...
"""
function dti_iconparkingoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconparkingoff", "IconParkingOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
