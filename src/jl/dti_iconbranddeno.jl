...
export dti_iconbranddeno

"""
    dti_iconbranddeno(;kwargs...)

An IconBrandDeno component.
...
"""
function dti_iconbranddeno(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbranddeno", "IconBrandDeno", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
