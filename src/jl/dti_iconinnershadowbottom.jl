...
export dti_iconinnershadowbottom

"""
    dti_iconinnershadowbottom(;kwargs...)

An IconInnerShadowBottom component.
...
"""
function dti_iconinnershadowbottom(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconinnershadowbottom", "IconInnerShadowBottom", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
