...
export dti_iconarrowsright

"""
    dti_iconarrowsright(;kwargs...)

An IconArrowsRight component.
...
"""
function dti_iconarrowsright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsright", "IconArrowsRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
