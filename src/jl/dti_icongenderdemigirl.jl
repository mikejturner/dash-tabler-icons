...
export dti_icongenderdemigirl

"""
    dti_icongenderdemigirl(;kwargs...)

An IconGenderDemigirl component.
...
"""
function dti_icongenderdemigirl(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongenderdemigirl", "IconGenderDemigirl", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
