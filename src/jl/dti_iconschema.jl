...
export dti_iconschema

"""
    dti_iconschema(;kwargs...)

An IconSchema component.
...
"""
function dti_iconschema(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconschema", "IconSchema", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
