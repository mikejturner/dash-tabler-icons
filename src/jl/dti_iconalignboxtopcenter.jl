...
export dti_iconalignboxtopcenter

"""
    dti_iconalignboxtopcenter(;kwargs...)

An IconAlignBoxTopCenter component.
...
"""
function dti_iconalignboxtopcenter(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxtopcenter", "IconAlignBoxTopCenter", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
