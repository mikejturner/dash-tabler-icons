...
export dti_iconsnowflakeoff

"""
    dti_iconsnowflakeoff(;kwargs...)

An IconSnowflakeOff component.
...
"""
function dti_iconsnowflakeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsnowflakeoff", "IconSnowflakeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
