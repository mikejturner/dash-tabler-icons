...
export dti_iconbrandcodepen

"""
    dti_iconbrandcodepen(;kwargs...)

An IconBrandCodepen component.
...
"""
function dti_iconbrandcodepen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandcodepen", "IconBrandCodepen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
