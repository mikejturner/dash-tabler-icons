...
export dti_iconmoodannoyed

"""
    dti_iconmoodannoyed(;kwargs...)

An IconMoodAnnoyed component.
...
"""
function dti_iconmoodannoyed(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoodannoyed", "IconMoodAnnoyed", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
