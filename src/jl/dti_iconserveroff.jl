...
export dti_iconserveroff

"""
    dti_iconserveroff(;kwargs...)

An IconServerOff component.
...
"""
function dti_iconserveroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconserveroff", "IconServerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
