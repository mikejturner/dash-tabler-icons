...
export dti_iconrouteoff

"""
    dti_iconrouteoff(;kwargs...)

An IconRouteOff component.
...
"""
function dti_iconrouteoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrouteoff", "IconRouteOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
