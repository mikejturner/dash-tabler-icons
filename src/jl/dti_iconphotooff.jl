...
export dti_iconphotooff

"""
    dti_iconphotooff(;kwargs...)

An IconPhotoOff component.
...
"""
function dti_iconphotooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconphotooff", "IconPhotoOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
