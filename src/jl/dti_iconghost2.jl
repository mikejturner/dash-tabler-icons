...
export dti_iconghost2

"""
    dti_iconghost2(;kwargs...)

An IconGhost2 component.
...
"""
function dti_iconghost2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconghost2", "IconGhost2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
