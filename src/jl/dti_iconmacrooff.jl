...
export dti_iconmacrooff

"""
    dti_iconmacrooff(;kwargs...)

An IconMacroOff component.
...
"""
function dti_iconmacrooff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmacrooff", "IconMacroOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
