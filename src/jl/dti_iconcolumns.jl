...
export dti_iconcolumns

"""
    dti_iconcolumns(;kwargs...)

An IconColumns component.
...
"""
function dti_iconcolumns(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcolumns", "IconColumns", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
