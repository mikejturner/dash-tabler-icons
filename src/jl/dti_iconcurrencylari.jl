...
export dti_iconcurrencylari

"""
    dti_iconcurrencylari(;kwargs...)

An IconCurrencyLari component.
...
"""
function dti_iconcurrencylari(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcurrencylari", "IconCurrencyLari", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
