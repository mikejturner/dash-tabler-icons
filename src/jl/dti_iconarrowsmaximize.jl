...
export dti_iconarrowsmaximize

"""
    dti_iconarrowsmaximize(;kwargs...)

An IconArrowsMaximize component.
...
"""
function dti_iconarrowsmaximize(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowsmaximize", "IconArrowsMaximize", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
