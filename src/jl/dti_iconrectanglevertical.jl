...
export dti_iconrectanglevertical

"""
    dti_iconrectanglevertical(;kwargs...)

An IconRectangleVertical component.
...
"""
function dti_iconrectanglevertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrectanglevertical", "IconRectangleVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
