...
export dti_iconmilitaryaward

"""
    dti_iconmilitaryaward(;kwargs...)

An IconMilitaryAward component.
...
"""
function dti_iconmilitaryaward(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmilitaryaward", "IconMilitaryAward", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
