...
export dti_icontrendingup

"""
    dti_icontrendingup(;kwargs...)

An IconTrendingUp component.
...
"""
function dti_icontrendingup(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrendingup", "IconTrendingUp", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
