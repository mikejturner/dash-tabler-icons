...
export dti_iconzoomreset

"""
    dti_iconzoomreset(;kwargs...)

An IconZoomReset component.
...
"""
function dti_iconzoomreset(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomreset", "IconZoomReset", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
