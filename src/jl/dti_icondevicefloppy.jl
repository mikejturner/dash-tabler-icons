...
export dti_icondevicefloppy

"""
    dti_icondevicefloppy(;kwargs...)

An IconDeviceFloppy component.
...
"""
function dti_icondevicefloppy(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondevicefloppy", "IconDeviceFloppy", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
