...
export dti_iconbrandgraphql

"""
    dti_iconbrandgraphql(;kwargs...)

An IconBrandGraphql component.
...
"""
function dti_iconbrandgraphql(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandgraphql", "IconBrandGraphql", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
