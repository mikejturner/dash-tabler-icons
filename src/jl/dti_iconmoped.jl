...
export dti_iconmoped

"""
    dti_iconmoped(;kwargs...)

An IconMoped component.
...
"""
function dti_iconmoped(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmoped", "IconMoped", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
