...
export dti_iconshredder

"""
    dti_iconshredder(;kwargs...)

An IconShredder component.
...
"""
function dti_iconshredder(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshredder", "IconShredder", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
