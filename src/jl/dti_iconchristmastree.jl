...
export dti_iconchristmastree

"""
    dti_iconchristmastree(;kwargs...)

An IconChristmasTree component.
...
"""
function dti_iconchristmastree(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchristmastree", "IconChristmasTree", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
