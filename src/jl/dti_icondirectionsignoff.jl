...
export dti_icondirectionsignoff

"""
    dti_icondirectionsignoff(;kwargs...)

An IconDirectionSignOff component.
...
"""
function dti_icondirectionsignoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondirectionsignoff", "IconDirectionSignOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
