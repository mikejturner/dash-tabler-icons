...
export dti_iconupload

"""
    dti_iconupload(;kwargs...)

An IconUpload component.
...
"""
function dti_iconupload(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconupload", "IconUpload", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
