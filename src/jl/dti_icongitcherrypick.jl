...
export dti_icongitcherrypick

"""
    dti_icongitcherrypick(;kwargs...)

An IconGitCherryPick component.
...
"""
function dti_icongitcherrypick(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongitcherrypick", "IconGitCherryPick", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
