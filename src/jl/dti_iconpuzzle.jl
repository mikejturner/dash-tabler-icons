...
export dti_iconpuzzle

"""
    dti_iconpuzzle(;kwargs...)

An IconPuzzle component.
...
"""
function dti_iconpuzzle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpuzzle", "IconPuzzle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
