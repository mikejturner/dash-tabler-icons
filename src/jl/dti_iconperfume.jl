...
export dti_iconperfume

"""
    dti_iconperfume(;kwargs...)

An IconPerfume component.
...
"""
function dti_iconperfume(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconperfume", "IconPerfume", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
