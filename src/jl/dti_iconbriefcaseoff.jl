...
export dti_iconbriefcaseoff

"""
    dti_iconbriefcaseoff(;kwargs...)

An IconBriefcaseOff component.
...
"""
function dti_iconbriefcaseoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbriefcaseoff", "IconBriefcaseOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
