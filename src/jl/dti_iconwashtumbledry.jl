...
export dti_iconwashtumbledry

"""
    dti_iconwashtumbledry(;kwargs...)

An IconWashTumbleDry component.
...
"""
function dti_iconwashtumbledry(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconwashtumbledry", "IconWashTumbleDry", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
