...
export dti_iconplaylistadd

"""
    dti_iconplaylistadd(;kwargs...)

An IconPlaylistAdd component.
...
"""
function dti_iconplaylistadd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconplaylistadd", "IconPlaylistAdd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
