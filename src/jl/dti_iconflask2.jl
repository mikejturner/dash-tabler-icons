...
export dti_iconflask2

"""
    dti_iconflask2(;kwargs...)

An IconFlask2 component.
...
"""
function dti_iconflask2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconflask2", "IconFlask2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
