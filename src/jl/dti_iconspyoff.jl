...
export dti_iconspyoff

"""
    dti_iconspyoff(;kwargs...)

An IconSpyOff component.
...
"""
function dti_iconspyoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconspyoff", "IconSpyOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
