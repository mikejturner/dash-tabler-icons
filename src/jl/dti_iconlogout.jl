...
export dti_iconlogout

"""
    dti_iconlogout(;kwargs...)

An IconLogout component.
...
"""
function dti_iconlogout(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlogout", "IconLogout", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
