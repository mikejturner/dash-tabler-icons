...
export dti_iconballpen

"""
    dti_iconballpen(;kwargs...)

An IconBallpen component.
...
"""
function dti_iconballpen(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconballpen", "IconBallpen", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
