...
export dti_icontrees

"""
    dti_icontrees(;kwargs...)

An IconTrees component.
...
"""
function dti_icontrees(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontrees", "IconTrees", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
