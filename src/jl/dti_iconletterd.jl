...
export dti_iconletterd

"""
    dti_iconletterd(;kwargs...)

An IconLetterD component.
...
"""
function dti_iconletterd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconletterd", "IconLetterD", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
