...
export dti_iconrating21plus

"""
    dti_iconrating21plus(;kwargs...)

An IconRating21Plus component.
...
"""
function dti_iconrating21plus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconrating21plus", "IconRating21Plus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
