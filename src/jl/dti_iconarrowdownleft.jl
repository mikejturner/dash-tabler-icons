...
export dti_iconarrowdownleft

"""
    dti_iconarrowdownleft(;kwargs...)

An IconArrowDownLeft component.
...
"""
function dti_iconarrowdownleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowdownleft", "IconArrowDownLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
