...
export dti_iconfileinvoice

"""
    dti_iconfileinvoice(;kwargs...)

An IconFileInvoice component.
...
"""
function dti_iconfileinvoice(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfileinvoice", "IconFileInvoice", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
