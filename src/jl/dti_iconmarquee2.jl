...
export dti_iconmarquee2

"""
    dti_iconmarquee2(;kwargs...)

An IconMarquee2 component.
...
"""
function dti_iconmarquee2(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmarquee2", "IconMarquee2", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
