...
export dti_iconlayoutcards

"""
    dti_iconlayoutcards(;kwargs...)

An IconLayoutCards component.
...
"""
function dti_iconlayoutcards(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutcards", "IconLayoutCards", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
