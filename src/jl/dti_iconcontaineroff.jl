...
export dti_iconcontaineroff

"""
    dti_iconcontaineroff(;kwargs...)

An IconContainerOff component.
...
"""
function dti_iconcontaineroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcontaineroff", "IconContainerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
