...
export dti_iconbrandredhat

"""
    dti_iconbrandredhat(;kwargs...)

An IconBrandRedhat component.
...
"""
function dti_iconbrandredhat(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandredhat", "IconBrandRedhat", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
