...
export dti_iconsquarenumber1

"""
    dti_iconsquarenumber1(;kwargs...)

An IconSquareNumber1 component.
...
"""
function dti_iconsquarenumber1(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber1", "IconSquareNumber1", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
