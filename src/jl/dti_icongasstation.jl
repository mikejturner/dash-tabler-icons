...
export dti_icongasstation

"""
    dti_icongasstation(;kwargs...)

An IconGasStation component.
...
"""
function dti_icongasstation(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icongasstation", "IconGasStation", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
