...
export dti_iconsquareletterp

"""
    dti_iconsquareletterp(;kwargs...)

An IconSquareLetterP component.
...
"""
function dti_iconsquareletterp(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquareletterp", "IconSquareLetterP", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
