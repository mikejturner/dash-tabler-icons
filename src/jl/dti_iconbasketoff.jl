...
export dti_iconbasketoff

"""
    dti_iconbasketoff(;kwargs...)

An IconBasketOff component.
...
"""
function dti_iconbasketoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbasketoff", "IconBasketOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
