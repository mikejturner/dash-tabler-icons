...
export dti_iconbrandappstore

"""
    dti_iconbrandappstore(;kwargs...)

An IconBrandAppstore component.
...
"""
function dti_iconbrandappstore(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandappstore", "IconBrandAppstore", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
