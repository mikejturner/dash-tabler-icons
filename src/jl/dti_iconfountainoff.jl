...
export dti_iconfountainoff

"""
    dti_iconfountainoff(;kwargs...)

An IconFountainOff component.
...
"""
function dti_iconfountainoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfountainoff", "IconFountainOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
