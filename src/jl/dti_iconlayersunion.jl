...
export dti_iconlayersunion

"""
    dti_iconlayersunion(;kwargs...)

An IconLayersUnion component.
...
"""
function dti_iconlayersunion(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayersunion", "IconLayersUnion", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
