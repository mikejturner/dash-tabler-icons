...
export dti_iconitalic

"""
    dti_iconitalic(;kwargs...)

An IconItalic component.
...
"""
function dti_iconitalic(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconitalic", "IconItalic", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
