...
export dti_iconzoomin

"""
    dti_iconzoomin(;kwargs...)

An IconZoomIn component.
...
"""
function dti_iconzoomin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzoomin", "IconZoomIn", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
