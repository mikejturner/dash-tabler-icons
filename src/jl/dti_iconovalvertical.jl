...
export dti_iconovalvertical

"""
    dti_iconovalvertical(;kwargs...)

An IconOvalVertical component.
...
"""
function dti_iconovalvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconovalvertical", "IconOvalVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
