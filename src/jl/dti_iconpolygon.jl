...
export dti_iconpolygon

"""
    dti_iconpolygon(;kwargs...)

An IconPolygon component.
...
"""
function dti_iconpolygon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpolygon", "IconPolygon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
