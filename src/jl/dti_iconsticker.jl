...
export dti_iconsticker

"""
    dti_iconsticker(;kwargs...)

An IconSticker component.
...
"""
function dti_iconsticker(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsticker", "IconSticker", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
