...
export dti_iconborderstyle

"""
    dti_iconborderstyle(;kwargs...)

An IconBorderStyle component.
...
"""
function dti_iconborderstyle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconborderstyle", "IconBorderStyle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
