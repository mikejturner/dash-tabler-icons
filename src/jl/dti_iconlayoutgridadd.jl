...
export dti_iconlayoutgridadd

"""
    dti_iconlayoutgridadd(;kwargs...)

An IconLayoutGridAdd component.
...
"""
function dti_iconlayoutgridadd(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutgridadd", "IconLayoutGridAdd", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
