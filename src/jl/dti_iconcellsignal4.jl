...
export dti_iconcellsignal4

"""
    dti_iconcellsignal4(;kwargs...)

An IconCellSignal4 component.
...
"""
function dti_iconcellsignal4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcellsignal4", "IconCellSignal4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
