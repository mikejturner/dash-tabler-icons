...
export dti_iconheartminus

"""
    dti_iconheartminus(;kwargs...)

An IconHeartMinus component.
...
"""
function dti_iconheartminus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartminus", "IconHeartMinus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
