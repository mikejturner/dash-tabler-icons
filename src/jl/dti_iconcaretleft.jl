...
export dti_iconcaretleft

"""
    dti_iconcaretleft(;kwargs...)

An IconCaretLeft component.
...
"""
function dti_iconcaretleft(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcaretleft", "IconCaretLeft", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
