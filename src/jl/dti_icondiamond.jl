...
export dti_icondiamond

"""
    dti_icondiamond(;kwargs...)

An IconDiamond component.
...
"""
function dti_icondiamond(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icondiamond", "IconDiamond", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
