...
export dti_iconbrandsublimetext

"""
    dti_iconbrandsublimetext(;kwargs...)

An IconBrandSublimeText component.
...
"""
function dti_iconbrandsublimetext(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandsublimetext", "IconBrandSublimeText", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
