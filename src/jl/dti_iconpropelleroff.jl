...
export dti_iconpropelleroff

"""
    dti_iconpropelleroff(;kwargs...)

An IconPropellerOff component.
...
"""
function dti_iconpropelleroff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpropelleroff", "IconPropellerOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
