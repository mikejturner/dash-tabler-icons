...
export dti_iconarrowrotaryfirstright

"""
    dti_iconarrowrotaryfirstright(;kwargs...)

An IconArrowRotaryFirstRight component.
...
"""
function dti_iconarrowrotaryfirstright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotaryfirstright", "IconArrowRotaryFirstRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
