...
export dti_iconuvindex

"""
    dti_iconuvindex(;kwargs...)

An IconUvIndex component.
...
"""
function dti_iconuvindex(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconuvindex", "IconUvIndex", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
