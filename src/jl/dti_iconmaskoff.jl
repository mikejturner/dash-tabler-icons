...
export dti_iconmaskoff

"""
    dti_iconmaskoff(;kwargs...)

An IconMaskOff component.
...
"""
function dti_iconmaskoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmaskoff", "IconMaskOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
