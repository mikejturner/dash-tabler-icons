...
export dti_iconlayoutkanban

"""
    dti_iconlayoutkanban(;kwargs...)

An IconLayoutKanban component.
...
"""
function dti_iconlayoutkanban(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlayoutkanban", "IconLayoutKanban", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
