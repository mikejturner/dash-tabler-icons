...
export dti_icontriangle

"""
    dti_icontriangle(;kwargs...)

An IconTriangle component.
...
"""
function dti_icontriangle(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_icontriangle", "IconTriangle", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
