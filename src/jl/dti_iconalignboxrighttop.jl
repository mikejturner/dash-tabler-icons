...
export dti_iconalignboxrighttop

"""
    dti_iconalignboxrighttop(;kwargs...)

An IconAlignBoxRightTop component.
...
"""
function dti_iconalignboxrighttop(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconalignboxrighttop", "IconAlignBoxRightTop", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
