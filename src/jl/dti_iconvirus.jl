...
export dti_iconvirus

"""
    dti_iconvirus(;kwargs...)

An IconVirus component.
...
"""
function dti_iconvirus(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconvirus", "IconVirus", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
