...
export dti_iconseparatorvertical

"""
    dti_iconseparatorvertical(;kwargs...)

An IconSeparatorVertical component.
...
"""
function dti_iconseparatorvertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconseparatorvertical", "IconSeparatorVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
