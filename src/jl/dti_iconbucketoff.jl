...
export dti_iconbucketoff

"""
    dti_iconbucketoff(;kwargs...)

An IconBucketOff component.
...
"""
function dti_iconbucketoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbucketoff", "IconBucketOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
