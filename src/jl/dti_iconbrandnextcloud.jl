...
export dti_iconbrandnextcloud

"""
    dti_iconbrandnextcloud(;kwargs...)

An IconBrandNextcloud component.
...
"""
function dti_iconbrandnextcloud(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandnextcloud", "IconBrandNextcloud", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
