...
export dti_iconmessage2share

"""
    dti_iconmessage2share(;kwargs...)

An IconMessage2Share component.
...
"""
function dti_iconmessage2share(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconmessage2share", "IconMessage2Share", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
