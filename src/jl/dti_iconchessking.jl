...
export dti_iconchessking

"""
    dti_iconchessking(;kwargs...)

An IconChessKing component.
...
"""
function dti_iconchessking(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconchessking", "IconChessKing", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
