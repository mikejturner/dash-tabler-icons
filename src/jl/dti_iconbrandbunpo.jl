...
export dti_iconbrandbunpo

"""
    dti_iconbrandbunpo(;kwargs...)

An IconBrandBunpo component.
...
"""
function dti_iconbrandbunpo(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconbrandbunpo", "IconBrandBunpo", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
