...
export dti_iconserver

"""
    dti_iconserver(;kwargs...)

An IconServer component.
...
"""
function dti_iconserver(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconserver", "IconServer", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
