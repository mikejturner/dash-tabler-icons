...
export dti_iconzeppelin

"""
    dti_iconzeppelin(;kwargs...)

An IconZeppelin component.
...
"""
function dti_iconzeppelin(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconzeppelin", "IconZeppelin", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
