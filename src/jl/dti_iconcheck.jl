...
export dti_iconcheck

"""
    dti_iconcheck(;kwargs...)

An IconCheck component.
...
"""
function dti_iconcheck(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcheck", "IconCheck", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
