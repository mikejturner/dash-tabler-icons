...
export dti_iconcoinrupee

"""
    dti_iconcoinrupee(;kwargs...)

An IconCoinRupee component.
...
"""
function dti_iconcoinrupee(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcoinrupee", "IconCoinRupee", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
