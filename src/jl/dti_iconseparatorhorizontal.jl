...
export dti_iconseparatorhorizontal

"""
    dti_iconseparatorhorizontal(;kwargs...)

An IconSeparatorHorizontal component.
...
"""
function dti_iconseparatorhorizontal(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconseparatorhorizontal", "IconSeparatorHorizontal", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
