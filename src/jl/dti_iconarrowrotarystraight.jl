...
export dti_iconarrowrotarystraight

"""
    dti_iconarrowrotarystraight(;kwargs...)

An IconArrowRotaryStraight component.
...
"""
function dti_iconarrowrotarystraight(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowrotarystraight", "IconArrowRotaryStraight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
