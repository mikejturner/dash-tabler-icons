...
export dti_iconlemon

"""
    dti_iconlemon(;kwargs...)

An IconLemon component.
...
"""
function dti_iconlemon(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconlemon", "IconLemon", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
