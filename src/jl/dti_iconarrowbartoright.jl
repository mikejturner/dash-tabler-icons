...
export dti_iconarrowbartoright

"""
    dti_iconarrowbartoright(;kwargs...)

An IconArrowBarToRight component.
...
"""
function dti_iconarrowbartoright(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconarrowbartoright", "IconArrowBarToRight", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
