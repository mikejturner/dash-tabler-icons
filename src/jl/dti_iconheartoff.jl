...
export dti_iconheartoff

"""
    dti_iconheartoff(;kwargs...)

An IconHeartOff component.
...
"""
function dti_iconheartoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconheartoff", "IconHeartOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
