...
export dti_iconfilelambda

"""
    dti_iconfilelambda(;kwargs...)

An IconFileLambda component.
...
"""
function dti_iconfilelambda(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconfilelambda", "IconFileLambda", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
