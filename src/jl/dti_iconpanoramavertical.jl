...
export dti_iconpanoramavertical

"""
    dti_iconpanoramavertical(;kwargs...)

An IconPanoramaVertical component.
...
"""
function dti_iconpanoramavertical(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconpanoramavertical", "IconPanoramaVertical", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
