...
export dti_iconcalendar

"""
    dti_iconcalendar(;kwargs...)

An IconCalendar component.
...
"""
function dti_iconcalendar(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconcalendar", "IconCalendar", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
