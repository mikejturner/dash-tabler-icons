...
export dti_iconshapeoff

"""
    dti_iconshapeoff(;kwargs...)

An IconShapeOff component.
...
"""
function dti_iconshapeoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconshapeoff", "IconShapeOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
