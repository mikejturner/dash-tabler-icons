...
export dti_iconnavigationoff

"""
    dti_iconnavigationoff(;kwargs...)

An IconNavigationOff component.
...
"""
function dti_iconnavigationoff(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconnavigationoff", "IconNavigationOff", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
