...
export dti_iconsquarenumber4

"""
    dti_iconsquarenumber4(;kwargs...)

An IconSquareNumber4 component.
...
"""
function dti_iconsquarenumber4(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconsquarenumber4", "IconSquareNumber4", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
