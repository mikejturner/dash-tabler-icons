...
export dti_iconexplicit

"""
    dti_iconexplicit(;kwargs...)

An IconExplicit component.
...
"""
function dti_iconexplicit(; kwargs...)
        available_props = Symbol[:id, :className, :color, :size, :stroke, :style]
        wild_props = Symbol[]
        return Component("dti_iconexplicit", "IconExplicit", "dash_tabler_icons", available_props, wild_props; kwargs...)
end
